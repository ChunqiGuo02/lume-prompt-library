---
id: "architecture-the-subject-exactly-001"
...
# 正文 prompt
{
  ...
  "scene": {
    ...
    "background": "Matte {"background color" "blue"} walls and blue floor, tight enclosed corner, clean minimal environment",
...
```json
{
  "task": "创建一张 iPhone 风格的照相亭拼贴画（2x2 网格，4 张照片）",
  "subjects": [
    {
      "id": "主体 1",
  ...
  "scene": {
    "location": "在一个小型 BOX 照相亭内",
    "background": "哑光 {\"background color\" \"blue\"} 蓝色墙壁和蓝色地板，紧凑的封闭角落，干净简约的环境",
    "camera_look": "超广角/轻微鱼眼镜头效果，具有照相亭相机典型的轻微透视畸变。iPhone 17 Pro，照相亭广角。",
    "lighting": "明亮的纯白色闪光灯，均匀照亮面部，蓝色墙壁上柔和的阴影渐变，细节清晰，皮肤纹理逼真。直射纯白色闪光（无黄色/无暖色调）。",
    "aesthetic": "4K，业余照相亭美学，高对比度但依然自然，无电影调色，无重度美颜滤镜，无模糊，无文字，无水印。"
  },
  "layout": {
    "type": "2x2 网格拼贴画",
  ...
  "frames": [
    {
      "position": "左上",
      "content": "主体 1 从左前方斜向镜头倾斜，一只手臂向下伸展，表情顽皮而严肃；主体 2 站在后方中央，手臂举起并像“大力士”一样展示肌肉，面带微笑。"
    },
    {
      "position": "右上",
      "content": "主体 2 身体前倾靠近镜头，双手放在膝盖上，表情好奇；主体 1 从右侧非常靠近镜头进入画面，歪着头，一只手臂拱起在头顶上方，做出半心形姿势，面带甜美微笑。"
    },
    {
      "position": "左下",
    ...
    {
      "position": "右下",
      "content": "主体 2 侧身弯腰/前倾，表情滑稽；主体 1 站在后面，在主体 2 的头顶上方做出顽皮的“爪子/角”手势，略微撅嘴以示趣味。"
    }
  ]
}
```
