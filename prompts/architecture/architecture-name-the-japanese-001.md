---
id: "architecture-name-the-japanese-001"
title: "四格日式商业广告排版参考"
category: architecture
subcategory: "03_创意广告品牌设计"
aesthetic: japanese-zen-garden
tags: ["日式", "简约", "现代", "商业", "广告", "护肤", "美妆", "软件"]
recommended_models: []
recommended_params:
  aspect_ratio: "1:1"
  quality: null
...
## 中文译文（源站提供）
{"type":"四格日式促销横幅展示图","style":"用于排版和字体参考的整洁商业广告样机项目，2x2 正方形网格，精致的现代品牌设计，柔和的高级感光效，写实的产品与生活方式图像，融合了 App 营销设计","canvas":{"aspect_ratio":"1:1","background":"白色","grid":{"columns":2,"rows":2,"divider_color":"浅灰色","divider_thickness":"细线"}},"layout":{"sections":[{"title":"护肤精华横幅","position":"左上","count":8,"labels":["素肌が、目を覚ます。","うるおい満ちる、透明ハリ肌へ。","LUNÉA","ルネア","モイストリペア セラム","美容液 30mL","発売記念 10%OFF 5.31まで","詳しくはこちら"],"design":"奢华极简风化妆品广告，左侧配有优雅的日式衬线标题，居中展示磨砂玻璃材质的精华液瓶及滴管，瓶后有半透明液体涂抹效果，散落的水滴，淡粉色与薰衣草色调，圆形折扣徽章，垂直对齐的小型成分图标及简短功效列表"},{"title":"笔记 App 横幅","position":"右上","count":7,"labels":["考える時間を、もっと創造的に。","アイデアをカタチにする新しいノート。","notero","ノテロ","AIがアイデアを整理","マルチデバイス対応","無料で始める"],"design":"现代 SaaS App 广告，采用白与浅蓝渐变背景，醒目的日式无衬线标题，其中“新しい”一词为亮蓝色，标题下方为 App Logo，配有描述性文案，底部排列圆角功能胶囊按钮，右侧展示大型智能手机样机，呈现简洁的任务与摘要界面，右下角有微妙的蓝色波浪形状"},{"title":"旅游横幅","position":"左下","count":7,"labels":["まだ見ぬ景色が、きっとあなたを待っている。","瀬戸内、ゆるり旅。","心ほどける、島時間。","期間限定 6/1(金)〜6/30(月) 新作プラン登場 最大20%OFF","直行フェリーで楽々","絶景スポット多数","おすすめプランを見る"],"design":"明亮风景旅游广告，呈现生动的蓝色大海、绿色岛屿，前景为白色露台建筑，右侧边缘点缀花朵，空气感夏日天空配有大朵云彩，天空与水面上方为醒目的白色日式标题，圆形粉色折扣徽章，底部半透明条带内含三个小型旅游特色图标，青色圆角行动呼吁按钮"},{"title":"抹茶饮品横幅","position":"右下","count":8,"labels":["季節限定","抹茶ティラミスラテ","New!","香り高い抹茶となめらかなマスカルポーネのハーモニー。ほろ苦く、やさしい余韻を。","Regular ¥680(税込)","Tall ¥730(税込)","メニューをチェック","テイクアウトOK"],"design":"优雅的咖啡馆季节性菜单海报，暖奶油色背景，编辑级日式衬线字体，右侧展示写实的大杯冰抹茶提拉米苏拿铁，顶部有撒上抹茶粉的马斯卡彭奶酪奶油，前景配有盛放抹茶粉的小碗和木勺，右上角有绿叶伸入，精致的自然配色，绿色圆角行动呼吁按钮"}],"consistency":"四个横幅虽为不同品牌，但呈现为一个具有专业间距、日式字体、强烈层级感和写实高端样机渲染的统一广告灵感项目"},"customization":{"brand names":["LUNÉA","notero","HARUKA CAFE"],"main travel destination":"{argument name=\"destination name\" default=\"瀬戸内\"}","app name":"{argument name=\"app name\" default=\"notero\"}","cosmetic brand":"{argument name=\"cosmetic brand\" default=\"LUNÉA\"}","cafe name":"{argument name=\"cafe name\" default=\"HARUKA CAFE\"}","seasonal drink name":"{argument name=\"drink name\" default=\"抹茶ティラミスラテ\"}"}}
