---
id: "architecture-the-stone-subject-002"
title: "罗马黄昏下的优雅女性写真"
category: architecture
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["罗马", "建筑", "阳台", "黄昏", "酒红", "礼服", "优雅", "精致"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
  ...
  "image_description": {
    "scene": {
      "location": {
        ...
        "details": "场景设置在一个经典的石质阳台上，可以一览无余地欣赏罗马的古老建筑、纪念碑和城市天际线。温暖的金色自然光在石头上投下柔和的阴影，突显了城市建筑的精美细节。"
      },
      "environment": {
        "elements": [
          "带有华丽栏杆的石质阳台",
      ...
      "lighting": {
        "type": "自然日光",
        "effect": "光线柔和而清晰，以柔和的光芒突显建筑纹理和主体。阴影被柔化，营造出一种诱人而高雅的氛围。"
      }
    },
    "subject": {
      "identity": "安娜·德·阿玛斯",
      ...
      "outfit": {
        "top": {
          "type": "结构化的束身衣式上衣",
          "color": "深红色",
          "style": "时尚杂志风格，现代而经典，旨在凸显身材。束身衣线条锐利分明，剪裁干净利落，与自然环境形成鲜明对比。"
        },
        "bottom": {
          "type": "高腰裙",
          "details": "裙子是高腰的，两侧有戏剧性的高开衩，赋予其前卫而精致的感觉。面料飘逸流畅，突显了主体的女性魅力和现代优雅。"
        }
      },
      "hair_and_makeup": {
        "hair": {
          "style": "柔和波浪",
          "details": "她的头发造型为自然的柔和波浪，随意垂坠，为整体造型增添了动感和活力。波浪富有光泽，呈现出精致而随性的风格。"
        },
        "makeup": {
          "style": "精致自然",
          "details": "妆容通过微妙的修容和柔和的高光增强了她的自然美。她的眼睛用淡眼线勾勒，嘴唇涂抹中性色调，营造出精致而永恒的妆容。"
        }
      },
      "composition": {
        "aspect_ratio": "3:4",
