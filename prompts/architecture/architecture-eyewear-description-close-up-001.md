---
id: "architecture-eyewear-description-close-up-001"
title: "夜城红镜男特写"
category: architecture
subcategory: "04_创意脑洞特效合成"
aesthetic: null
tags: ["男性", "红色", "眼镜", "黑色", "毛衣", "皮质", "手套", "夜晚"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
# 正文 prompt
{
  ...
  "Persona_Details": {
    "Subject": "Man",
    "Appearance_Elements": {
      "Eyewear": "{"eyewear" "Round red-tinted glasses"}",
      "Clothing": [
        "Black turtleneck",
        "Leather gloves"
      ],
...
```json
{
  "Objective": "创建一个超现实的电影级特写肖像描述，适用于图像生成模型。",
  "Persona_Details": {
    "Subject": "男性",
    "Appearance_Elements": {
      "Eyewear": "{\"eyewear\" \"圆形红色镜片眼镜\"}",
      "Clothing": [
        "黑色高领毛衣",
        "皮手套"
      ],
      "Expression": "眼神锐利，直视镜头"
    }
  },
  "Scene_Description": {
    "Environment": "夜晚阴郁的城市",
  ...
  "Task_Instructions": {
    "Use_Case": "图像生成或视觉提示构建",
    "Requirements": {
      "Retain all high-detail realism cues": "保留所有高细节写实提示",
      "Preserve cinematic and luxury tone": "保持电影感和奢华格调",
      "Emphasize sharpness and texture": "强调锐度和纹理"
    }
  }
}
```
