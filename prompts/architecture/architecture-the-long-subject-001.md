---
id: "architecture-the-long-subject-001"
title: "楼梯夜拍少女与打哈欠猫咪的潮流街拍"
category: architecture
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["女生", "猫咪", "楼梯", "背包", "夜晚", "白色", "黑色", "粉色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
```json
{
  "image_analysis": {
    "subject": {
      "description": "一位年轻女性，留着长直金发，发根颜色较深，中分。她拥有心形脸、高颧骨和清晰的下颌线。妆容精致，画着浓重的上扬眼线，睫毛浓密卷翘，双唇饱满，涂着粉色唇彩。",
      "expression": "温柔自信的微笑，直视镜头",
      "pose": "站在楼梯上，做出“害羞”的姿势（食指相触）",
      "clothing": {
        "top": "白色宽松拉链连帽衫，帽子带有仿皮草饰边",
        "bottoms": "黑色宽松休闲裤，上面有重复的小白色标志图案",
        "accessories": "粉色背包，上面有卡通人物图案"
      }
    },
    "background": {
      "setting": "室外水泥楼梯",
      "time_of_day": "夜晚",
      "key_element": "一只虎斑猫坐在主体身后的楼梯上，张大嘴巴打着哈欠"
    },
    "technical_style": {
      "lighting": "直射相机闪光灯，硬阴影，高对比度，写实纹理",
      "aesthetic": "抓拍，Z 世代街头风格，有趣的背景细节，病毒式传播的迷因美学"
    }
  }
}
```
