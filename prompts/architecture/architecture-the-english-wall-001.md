---
id: "architecture-the-english-wall-001"
title: "实体店旅行翻译"
category: architecture
subcategory: "06_图文排版视觉传达"
aesthetic: null
tags: ["餐饮", "菜单", "价目表", "生煎", "面食", "小吃", "市井", "红色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
## 中文译文（源站提供）
为外国游客翻译墙上菜单上的中国菜名。纹理保护：至关重要！保持墙壁/纸张原有的老化、油腻和纹理外观。新的英文文本应该看起来像是在同一表面上书写/印刷的，有轻微的褪色或磨损。货币：保持“”符号和价格数字的原样；不要兑换货币。布局：将英文翻译与中文字符对齐或自然替换。
