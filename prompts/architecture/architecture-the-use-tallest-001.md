---
id: "architecture-the-use-tallest-001"
title: "城市最高的三栋建筑同框"
category: architecture
subcategory: "04_创意脑洞特效合成"
aesthetic: null
tags: ["3D", "建筑", "模型", "纽约", "简约", "浅灰", "摩天楼", "渲染"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
# 正文 prompt
Generate three tallest buildings from your city as models in Nano Banana Pro. 



Make sure to use the "Thinking" option. 
...
## 中文译文（源站提供）
在 Nano Banana Pro 中，将你所在城市中最高的三个建筑物生成为模型。
...
以清晰的侧面微缩 3D 卡通视图展示[您的城市]最高的三座建筑。使用极简的纹理，采用逼真的材质，并运用柔和自然的灯光和阴影。构图简洁明了，清晰地展现索波特最高的三座建筑，并严格按照从左到右的高度递减顺序排列。最高的建筑必须明显高于第一座，第二座必须明显低于第一座，第三座必须明显低于第二座。
...
建筑物顶部不得与上方文字重叠或接触。请使用基于真实世界的精确建筑比例，并采用一致的拍摄角度和相同的比例尺来制作每个建筑模型。
