---
id: "architecture-the-her-hair-001"
title: "监狱主题电影角色定妆照"
category: architecture
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["写实", "摄影", "光影", "女性", "囚犯", "长发", "脏污", "橙色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
"Holding a black and white clapperboard/slate in front of her chest."  
 ...
 "main_text": "🚫 ARRESTED 🚫 For illegally {"crime description" "Money"}",       "date": "{"date" "12-28 25-26"}"    
 } 
  }, 
  "environment":
 {   
...
```json
{
  "parameters": {
    "aspect_ratio": "2:3",
    "version": "6.0",
    "style_type": "逼真的照片、电影级布光、高细节、粗犷的纹理"
  },
  "subject_description": {
    "demographics": "美丽的年轻女性，白皙的皮肤。",
    "hair": "深色长发，黑色，几缕发丝垂落在额头。",
    "details": "脸部、颈部和手上沾有一些黑色烟灰和污垢（量不多）。"
  },
  "attire": {
    "outerwear": "亮橙色囚犯连体服（锅炉服），略微宽松。破旧且肮脏，沾满黑色烟灰污渍。",
    "details": "胸部右侧印有大号黑色字体“000”。",
    "under_layer": "内搭灰色圆领 T 恤，可见。",
    "accessories": "手指上戴有银戒指。"
  },
  "pose_and_expression": {
    "stance": "以嫌犯拍照姿势站立。与相机进行直接眼神交流。",
    "expression": "面无表情、严肃、漫不经心，看起来不以为然或感到无聊。",
    "right_hand_action": "随意抬起，手指触碰右耳/颈部区域的头发。",
    "left_hand_action": "胸前拿着一块黑白场记板/拍板。"
  },
  "props": {
    "slate_board_content": {
      "main_text": "🚫 被捕 🚫 因非法 {\"crime description\" \"金钱\"}",
      "date": "{\"date\" \"12-28 25-26\"}"
    }
  },
  "environment": {
    "setting": "一个粗犷、破旧的房间。后面的墙壁剥落、开裂、有纹理，类似于废弃的混凝土建筑或破败的警察局。",
    "background_elements": [
      "墙上的身高测量表。",
      "墙壁左上方写有“POLCIE”字样。"
    ]
