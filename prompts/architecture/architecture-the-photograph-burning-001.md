---
id: "architecture-the-photograph-burning-001"
title: "雪夜街头女子焚照点烟，彰显反抗姿态"
category: architecture
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["城市", "雪景", "夜晚", "写实", "摄影", "抗议", "火焰", "女性"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
# 正文 prompt
{
  "prompt": "An evocative, photorealistic image of a western woman of 20 age on a snowy city street in daylight, using a burning photograph of Benjamin Netanyahu to light a cigarette in a powerful act of defiance.",
  "composition": {
  ...
  "subject": {
    ...
    "actions_and_objects": [
      ...
      },
      {
        ...
        "object": "A portrait-style photograph of Ayatollah Ali Khamenei.",
...
```json
{
  "prompt": "一张引人入胜的超写实图像，描绘了一位 20 岁的西方女性在白雪皑皑的城市街道上，白天，她用一张燃烧着的 {\"political figure\" \"Benjamin Netanyahu\"} 的照片点燃香烟，这是一个充满反抗意味的有力举动。",
  "composition": {
    "shot_type": "中景",
    "angle": "平视",
    "focus": "女性和燃烧的照片清晰对焦，城市背景柔和模糊。"
  },
  "subject": {
    "description": "一位神情坚定的年轻西方女性，低头看着火焰。",
    "hair": {
      "color": "金色",
      "style": "齐肩长发，因天气略显凌乱。"
    },
    ...
    "actions_and_objects": [
      ...
      {
        "action": "手持一张燃烧的照片",
        "object": "一张 {\"burning photo subject\" \"Ayatollah Ali Khamenei\"} 的肖像照。",
        "state": "照片的顶部边缘正在燃烧，可见橙色火焰和焦黑的边缘。"
      }
    ]
  },
  "setting": {
    "location": "夜间城市街道的人行道。",
    "environment": "地面和街道被雪覆盖。",
    "time_of_day": "白天",
    "background_elements": [
      "亮着灯的现代化高层建筑。",
      "路灯投射出冷色调的光芒。",
  ...
  "lighting": {
    "key_light": "燃烧照片发出的明亮、温暖的橙色火焰，照亮她的脸和手。",
    "ambient_light": "路灯和周围城市发出的冷蓝色调环境光。",
    "effect": "火焰温暖而强烈的光芒与寒冷、黑暗的城市环境形成强烈对比。",
    "details": "香烟和燃烧的照片都冒出可见的烟雾。"
  },
  "style_and_mood": {
    "style": "抓拍式新闻摄影，超写实。",
    "mood": "反抗、叛逆、政治色彩浓厚、紧张。",
    "color_palette": "以冷蓝色、白色和灰色为主，辅以强烈的火红色和黄色点缀。"
  }
}
```
