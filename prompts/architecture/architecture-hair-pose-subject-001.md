---
id: "architecture-hair-pose-subject-001"
...
```json
{
  "prompt_details": {
    "subjects": [
      {
        ...
        "appearance": {
          ...
          "skin_tone": "白皙",
          "hair": "深棕色长发，波浪散开，中分",
          "makeup": "全妆，浓重修容，裸色唇，精致眉毛"
        },
        "pose": "站立，靠在置物架上，重心放在左腿，右腿膝盖弯曲（火烈鸟姿势），左手触碰头发，右臂搭在置物架上，不看镜头",
        "outfit": {
          "garment": "{\"standing dress color\" \"灰褐色/米色\"} 挂脖迷你连衣裙，深 V 领，束身胸衣式系带上身，修身裙摆，背面有垂坠拖尾",
          "shoes": "透明/银色细带高跟鞋",
          "accessories": "大金色垂坠耳环，细项链，叠戴钻石手链"
        }
      },
      {
        "id": "subject_crouching",
        ...
        "pose": "侧身蹲/低蹲，头转向直接看向镜头，手放在下巴附近",
        "outfit": {
          "garment": "{\"crouching dress color\" \"白色\"} 挂脖迷你连衣裙，与站立主体款式相同，束身胸衣式系带细节，修身轮廓",
          "shoes": "银色金属高跟凉鞋",
          "accessories": "手腕上的钻石手链"
        }
      }
    ],
    "environment": {
      "location": "奢华步入式衣帽间",
      "architecture": "白色嵌入式置物单元，极简设计",
      "props": [
        "置物架上展示的各种奢侈手袋（爱马仕 Birkin/Kelly 款式，粉色、绿色、白色、黑色）",
        "设计师手拿包",
        "下层置物架上可见金色高跟鞋"
      ],
      "flooring": "米色纹理地毯"
    ...
    "lighting": {
      "style": "直射闪光摄影",
      "quality": "硬光，高对比度，主体后方白墙上投射出清晰阴影",
      "atmosphere": "夜间外出，派对准备，专属，网红美学"
    },
    "camera_settings": {
      "viewpoint": "视线水平",
      "shot_type": "全身 / 中广角镜头",
      "style": "编辑式抓拍",
      "resolution": "8k",
      "realism": "超逼真，高保真纹理（皮肤毛孔，织物编织，皮革纹理）"
    }
  }
}
```
