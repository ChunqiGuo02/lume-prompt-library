---
id: "architecture-object-technical-the-002"
title: "帝舵北极旗腕表技术解析图"
category: architecture
subcategory: "06_图文排版视觉传达"
aesthetic: null
tags: ["帝舵", "手表", "手绘", "标注", "技术", "图解", "黑白", "金属"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
# 正文 prompt
Create an infographic image of {"object" "Tudor North Flag"}, combining a realistic photograph or photorealistic render of the object with technical annotation overlays placed directly on top.
...
## 中文译文（源站提供）
创建一个 {"object" "Tudor North Flag"} 的信息图，将该物体的真实照片或超写实渲染图与直接叠加在其上的技术注释相结合。

在纯白色工作室背景上，使用黑色墨水风格的线条图和文字（技术笔/建筑草图风格）。
...
将标题 {"object title" "[OBJECT]"} 放在一个手绘技术注释框内，置于一角。
