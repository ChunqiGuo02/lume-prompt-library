---
id: "architecture-subject-tea-clothing-001"
title: "咖啡馆里情侣温馨对视的浪漫插画"
category: architecture
subcategory: "04_创意脑洞特效合成"
aesthetic: null
tags: ["咖啡馆", "情侣", "约会", "浪漫", "温暖", "暖色调", "插画", "半写实"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
```json
{
  "scene_overview": {
    "setting": "室内咖啡馆或茶馆",
    "mood": "亲密、温馨、浪漫、沉思",
    "narrative": "两人共享茶饮和交谈的宁静而深情的时刻"
  },
  "composition": {
    "framing": "中景特写，半身像",
    "orientation": "垂直肖像",
    "subject_placement": "两位人物紧密并坐，略微偏左居中，脸部朝向彼此",
    "depth": "浅景深，背景轮廓柔和且简化",
    "foreground_elements": "茶杯和茶碟置于底部边缘中央",
    "balance": "通过对比的服装颜色和对视的目光形成不对称平衡"
  },
  "subjects": {
    "left_subject": {
      "gender_presentation": "男性",
      "age_range": "20 岁末至 30 岁中",
      "appearance": {
        "hair": "短发，浓密，波浪状，深色",
        "facial_hair": "络腮胡和胡须",
        "skin_tone": "中等暖棕色"
    ...
    "right_subject": {
      ...
      "age_range": "20 岁中至 30 岁初",
      "appearance": {
        "hair": "长发，深色，略带波浪的随意造型",
        "skin_tone": "浅至中等暖棕色"
      },
      "clothing": {
        "type": "飘逸的传统风格上衣或连衣裙",
      ...
      "accessories": {
        "earrings": "金色 Jhumka 风格耳环，带有垂坠细节"
      },
      "expression_pose": {
        "expression": "温柔的微笑，若有所思",
        "gaze": "看向男性人物",
        "pose": "手托下巴，手肘放在桌上"
      }
    }
  ...
  "background": {
    "style": "简化的、绘画风格的剪影",
    "elements": "模糊的人物暗示其他顾客，垂直的窗框",
    "detail_level": "低细节，以保持对主体的关注",
    "color_palette": "柔和的米色、棕褐色和橄榄色调"
  },
  "lighting": {
    "type": "柔和的环境光",
    "direction": "漫射，可能来自窗户一侧",
    "contrast": "低至中等",
    "highlights": "面部和服装褶皱上的柔和高光",
    "shadows": "柔和，极少硬朗的阴影"
  },
  "color_palette": {
    "dominant_colors": [
    ...
    "temperature": "暖色调",
    "saturation": "中等，略微柔和，营造舒适感"
  },
  "art_style": {
    "medium": "数字插画",
    "style": "半写实绘画风格插画",
    "line_work": "干净、受控的轮廓线，带有有机变化",
    "shading": "柔和渐变"
  }
}
```
