---
id: "architecture-spiral-overall-subject-001"
...
{
  "subject": {
    "core": "{"主体" "bright orange low-profile streamlined sports car"}",
  ...
  "art_style": {
    "reference": "{"艺术风格" "Blade Runner 2049"}",
...
{
  "subject": {
    "core": "{\"subject\" \"亮橙色低矮流线型跑车\"}",
    "action_pose": "沿右上方螺旋弧线快速加速，车身略微前倾，车轮呈现运动模糊效果"
  },
  "environment_set_design": {
    "overall_environment": "纽约市上空的空中螺旋高速公路",
    "details_props": [
      {
        "object": "螺旋形沥青悬浮赛道",
        "surface": "灰色沥青纹理，带有白色箭头和道路标记",
        "position": "前景对角线向右上方延伸"
      },
      {
        "object": "静止的摩天大楼群",
        "arrangement": "沿水平中心轴垂直镜像对称布局，上半部分是倒置的摩天大楼和街区，与下半部分直立的城市建筑相连",
        "density": "两侧密集的几何建筑群"
      }
    ]
  },
  "composition_camera": {
    "camera_angle": "高空俯视视角",
    "composition_logic": "螺旋形高速公路和白色引导线形成对角引导线，主体位于右侧黄金分割点",
    "shot_type_focal_length": "中景特写，等效 35-50mm 中焦距",
    "focus_point": "车身前部和前轮，背景建筑适度模糊以突出主体"
  },
  "atmosphere_mood": {
    "overall_mood": "动感、紧张、电影般的真实感",
    "time_of_day": "早晨",
    "weather_air": "晴空万里，阳光温暖，无云"
  },
  "lighting_color": {
    "lighting_setup": "主光源为前方侧面的直射阳光，城市建筑反射自然补光",
  ...
  "art_style": {
    "reference": "{\"art style\" \"银翼杀手 2049\"}",
    "render_quality": "电影静态画面档案风格"
  },
  "color_grading": {
    "grading_strategy": "整体冷蓝色调，带有温暖的金色高光，阴影呈炭灰色以增强对比度",
    "film_simulation_lut": "带有冷色调和中性暗部的电影 LUT",
    "highlight_tone": "冷蓝色",
    "shadow_tone": "深蓝色和炭灰色",
