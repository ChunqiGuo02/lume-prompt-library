---
id: "architecture-the-glass-subject1-001"
title: "双人咖啡馆写实肖像"
category: architecture
subcategory: "09_故事分镜角色设定"
aesthetic: biophilic
tags: ["咖啡馆", "写实", "摄影", "双人", "绿植", "暖调", "饮品", "分屏"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
```json
{
  "title": "超写实双联 iPhone 人像 — 咖啡馆（主体 1 + 主体 2）",
  "mode": "text_to_image",
  "format": "two_panel_vertical",
  "output_size": "2048x3072",
  "references": {
  ...
  "prompt": "超写实、超摄影感的双联 iPhone 人像，描绘两位真人，面部与提供的参考图像完全匹配（无面部改动）。两幅画面共享相同的角度、间距、镜头透视和构图，使其看起来像是在同一家郁郁葱葱的咖啡馆的同一个座位上拍摄的匹配双联画。环境：温暖的木桌周围环绕着茂密的竹子和热带植物，温暖的漫射日光在皮肤、玻璃、植物和木材上营造出柔和的高光和柔和自然的阴影。上幅画面 — 主体 1：坐着，手持一部反光的银色手机，上面有一个镶嵌珠宝的指环扣，捕捉到微小的光线闪烁；深红色美甲；蓝白格纹露肩连衣裙，带有微妙的泡泡纱纹理；白色蕾丝头巾，带有精致的穿孔；手持一杯冰镇抹茶，可见凝结的水珠，玻璃上有淡淡的指纹污迹，杯口有抹茶和泡沫的漩涡渐变。下幅画面 — 主体 2：坐着，模仿相同的随意姿势，手持一部哑光金属手机，上面有微小的划痕和柔和的反光；穿着米色亚麻衬衫，带有天然的竹节纹理，棕色卡车司机帽（网眼高光），以及串珠配饰；举起一杯高大的冰拿铁，显示出牛奶和咖啡的分层色调，融化的冰块和朦胧的凝结水珠。两幅画面中：微小细节 — 桌上的水渍、玻璃隔板上的污迹、植物叶片颜色不均、微妙的镜头眩光、金属和玻璃上的微小反光、微小的织物磨损和自然的皮肤毛孔；保持逼真的纹理和微小瑕疵以增强真实感。光照：柔和、温暖、漫射的日光，美丽的肤色，玻璃和金属上精致的镜面高光，皮肤上准确的次表面散射。相机：iPhone 人像风格构图，浅景深，自然散景，面部和手持玻璃杯上的焦点清晰，两幅画面之间的焦距和角度匹配。色彩/色调：自然、电影般的动态范围，无过度饱和；保留抹茶和咖啡微妙的色调变化。构图：两幅垂直堆叠的画面，匹配的构图，一致的透视和比例，使两个主体看起来像是同一会话的拍摄。严格要求：面部必须 100% 与提供的参考图像匹配 — 不得改变面部特征、表情或身份。输出应具有照片级真实感，与高端手机摄影无异。",
  "negative_prompt": "卡通、绘画、CGI、3D 渲染、动漫、风格化、过度饱和、过度对比、多余肢体、变异、变形、模糊、低分辨率、"
}
```
