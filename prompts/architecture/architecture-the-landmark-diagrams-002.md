---
id: "architecture-the-landmark-diagrams-002"
title: "prompt_1_2-地标建筑信息图"
category: architecture
subcategory: "08_图像分析信息拆解"
aesthetic: null
tags: ["地标", "建筑", "蓝图", "手绘", "摄影", "标注", "数据", "科普"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
version: "1.0.0"
related_to: ["architecture-the-landmark-diagrams-001"]
---
...
## 中文译文（源站提供）
创建[LANDMARK]的信息图图像，将地标的真实照片与叠加在图像上的蓝图风格技术注释和图表相结合。在角落的手绘框中包含标题“[LANDMARK]”。添加白色粉笔风格的草图，显示关键结构数据、重要测量值、材料数量、内部图表、荷载流箭头、横截面、平面图以及显著的建筑或工程特征。风格：蓝图美学，照片上有白线图，技术/建筑注释风格，教育信息图感，注释背后可见真实环境
