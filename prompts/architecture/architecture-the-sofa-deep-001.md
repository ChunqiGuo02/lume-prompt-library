---
id: "architecture-the-sofa-deep-001"
title: "巴洛克奢华贵妇品葡图"
category: architecture
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["巴洛克", "奢华", "复古", "时尚", "女性", "葡萄", "沙发", "皮草"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
{
  "prompt_details": {
    "scene": "{"scene description" "An opulent, decadent, and Baroque-inspired indoor setting."}",
    ...
    "subject": {
      "main_figure": {
        ...
        "attire": "{"attire" "A deep, rich brown or plum-colored satin slip dress or bias-cut gown, worn with a luxurious, dark brown fur stole or trimmed coat draped over her body/shoulders. She is wearing dark, strappy high-heeled sandals."}",
    ...
    "setting": {
      "sofa": "{"sofa description" "An antique, tufted velvet chesterfield sofa in a rich, deep emerald green or olive green color. It has elaborate, ornate wood or gold detailing."}",
