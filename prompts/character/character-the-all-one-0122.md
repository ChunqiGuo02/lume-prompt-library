---
id: character-the-all-one-0122
title: "生成日式贴纸风多人互动漫画"
category: character
subcategory: "10_卡通漫画电影角色"
aesthetic: japanese-zen-garden
tags: ["日系", "简约", "卡通", "漫画", "拔河", "男生", "团队", "趣味"]
recommended_models: []
recommended_params:
  aspect_ratio: "3:1"
  quality: null
...
## 中文译文（源站提供）
仅使用输入的照片来识别每个人的身份。将我们9个人全部重新绘制成一张超宽格式的图片，采用非常简约的、具有超现实风格的日本贴纸风格漫画形象：长而细的脖子、表情呆板的小脸、极简的黑色轮廓线、平淡的色彩、几乎没有明暗效果、很少的面部细节、简化的发型、大量的空白区域、纯白色的背景，整体造型略显笨拙却又十分有趣。画面中我们要自然地聚集在地板上的一张巨大纸张周围，从不同的角度俯身在纸上作画，每个人都在积极参与同一幅大型未完成作品的创作，而不是各自绘制独立的小图案。最终呈现出的画面应该像一张连贯的海报一样，展现出完整的场景。
