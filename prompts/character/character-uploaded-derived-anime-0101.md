---
id: character-uploaded-derived-anime-0101
title: "死神同框镜自拍"
category: character
subcategory: "10_卡通漫画电影角色"
aesthetic: null
tags: ["自拍", "混搭", "动漫", "琉克", "潮装", "米色", "室内", "休闲"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
## 中文译文（源站提供）
**创作要求：**  
- 制作一张融合了[上传图片]与2D动漫元素的Z世代动漫风格街头服饰镜像自拍。  

**创意说明：**  
- 风格特点：将Z世代街头服饰与2D动漫元素相结合，营造出轻松、俏皮的氛围；同时融合可爱造型与哥特式动漫恐怖元素，搭配色彩鲜艳的鞋履，展现室内镜像自拍的独特美感。  
- 主题方向：动漫文化、街头服饰、混合现实、休闲时尚。  
- 情感基调：充满活力、自信、古怪又时尚。  
- 关键词：镜像自拍、街头服饰、动漫特效、混合媒体、Z世代时尚、休闲
