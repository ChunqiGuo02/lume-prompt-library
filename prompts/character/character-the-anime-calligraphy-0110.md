---
id: character-the-anime-calligraphy-0110
title: "炎柱炼狱杏寿郎火焰艺术图"
category: character
subcategory: "10_卡通漫画电影角色"
aesthetic: japanese-zen-garden
tags: ["日漫", "动漫", "鬼灭", "炎柱", "火焰", "和风", "暖色调", "书法"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:2"
...
# 正文 prompt
Nano Banana Proで使えるプロンプト集①
元画像から鬼滅の刃風の筆文字入りイラストが作れます🔥
元画像は写真・イラストどちらでもOK
使う際は「炎柱」 and 「煉獄杏寿郎」を自由に描きかえて下さい
#NanoBananaPro #鬼滅の刃
📝プロンプト
...
## 中文译文（源站提供）
将原始图片转换成融入《鬼灭之刃》风元素的插画作品🔥  

1. **图像转换：** 将用户上传的图片（照片或插画）转化为具有日本风情的动漫风格作品。  
   - 仅保留图片中的主体（人物），完全忽略或删除原始背景。  
   - 如果图片是插画，需将其重新绘制为精美的动漫风格，加入细腻的三维阴影、渐变效果和明亮的高光，以呈现精致的效果。
