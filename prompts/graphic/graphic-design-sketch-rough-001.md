---
id: "graphic-design-sketch-rough-001"
title: "UI手绘草图转高保真原型"
category: graphic
subcategory: "06_图文排版视觉传达"
aesthetic: null
tags: ["UI", "设计", "移动端", "高保真", "原型", "应用", "现代", "清爽"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: null
...
## 中文译文（源站提供）
将这个粗略的线框草图转换为移动应用程序的高保真UI设计模型。设计系统：应用类似于iOS 18或Material Design 3的现代、干净的美学。使用圆角、柔和的阴影和鲜艳的原色。组件：智能地解释草图：将涂鸦转换为高质量的占位符图像，将粗糙的矩形转换为具有渐变的适当按钮，并将线条转换为逼真的文本块。布局：确保完美的填充和元素之间的一致间距。背景：将设计放在逼真的iPhone 16框架模型中。
