---
id: graphic-card-energy-cards-1240
title: "龙珠卡牌"
category: graphic
subcategory: "06_图文排版视觉传达"
aesthetic: japanese-zen-garden
tags: ["龙珠", "孙悟空", "集换卡", "SSR", "超级赛亚人", "金蓝色", "热血", "动感"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
## 中文译文（源站提供）
这款3x3网格布局的集换式卡牌展示了9种不同的日本高级TCG收藏卡设计，每张卡片都以超级赛亚人形态的孙悟空为特色，并配有独特的战斗场景。

**整体构图：**  
9张纵向排列的集换式卡牌（每张卡牌的比例为9:16），以完美的3x3网格形式排列，卡牌之间的间距很窄。

**每张卡牌的内容：**  
- 孙悟空（SSR稀有度），采用动态冲锋攻击的姿势，双拳紧握；  
- 金色闪电形状的气场从卡片中心向上螺旋扩散，伴有强烈的粒子爆炸效果；  
- 地面布满破碎的岩石，天空中聚集着黑暗的雷云（背景采用动态模糊效果）；  
- 地面中央有放射状的金色速度线条；  
- 前景中有飞散的碎石和能量火花；  
- 能量区域采用全息箔纸材质，并带有发光效果；  
- 左上角有一个带有金色光芒的“SSR”金属徽标；  
- 边框采用未来科技风格设计，点缀有闪电图案；  
- 下方有黑色的六边形标签，“SON GOKU (UI SIGN)”，采用金属金色字体。  
