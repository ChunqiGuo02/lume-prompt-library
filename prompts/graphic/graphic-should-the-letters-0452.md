---
id: graphic-should-the-letters-0452
title: "卡通风格文本标志"
category: graphic
subcategory: "06_图文排版视觉传达"
aesthetic: null
tags: ["卡通", "迷幻", "手绘", "文字", "设计", "蓝色", "白色", "黑色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "16:9"
...
## 中文译文（源站提供）
创建一种具有两层结构的、样式夸张且带有卡通风格的文本设计。顶层文字为“SUPER GNARLY”，采用扭曲的气泡字体书写，呈现出类似鬼魂粘液或神秘黏液的融化、滴落状质感。这些字母应显得笨重而自然，带有一丝迷幻或超自然的氛围。底层文字为“SOCIETY”，采用较小的手写体或草书风格，巧妙地隐藏在顶层文字的下方或间隙中。两层文字均为纯白色，带有粗黑轮廓线，不含任何渐变、阴影或纹理效果。整体布局应充满趣味性且略显混乱，但仍然保持可读性。该设计适合矢量图形处理，并配以蓝色背景和正方形宽高比。
