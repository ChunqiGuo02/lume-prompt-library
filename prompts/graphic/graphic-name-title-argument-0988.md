---
id: graphic-name-title-argument-0988
title: "科幻电影海报与设定集"
category: graphic
subcategory: "06_图文排版视觉传达"
aesthetic: null
tags: ["科幻", "电影", "海报", "设定", "太空", "宇宙", "飞船", "红色"]
recommended_models: []
recommended_params:
  aspect_ratio: null
  quality: null
...
## 中文译文（源站提供）
{
  ...
  "left_panel": {
    ...
    "characters": [
      {
        "name": "{argument name=\"lead character one\" default=\"COMMANDER VERA OKAFOR\"}",
        "description": "黑人女性，表情严肃，深色科幻太空服领口"
      },
      {
        "name": "{argument name=\"lead character two\" default=\"DR. SOREN MALIS\"}",
        "description": "年长白人男性，表情强烈，深色科幻太空服领口"
      }
    ],
    "imagery": "巨大的环形山月球、黑色日食、巨大的环形宇宙飞船、小型登陆艇、底部控制室视角、底部演职员表区域"
  },
  "right_panel": {
    "type": "制作设计图",
    "title": "RED ORBIT 比例与设定图",
    "sections": [
      {
        "title": "宇宙飞船与比例",
        "elements": [
          "红色行星与黑色日食图形",
          "巨型宇宙飞船 {argument name=\"main spaceship\" default=\"CR_01 THE VERDICT\"}",
          "3 个比例对比剪影",
          "小型飞船 VK_01 HERALD",
          "2 个角色比例人偶",
          "3 个发射序列缩略图"
      ...
      },
      {
        "title": "COMMANDER VERA OKAFOR",
        "elements": [
          "4 个全身转向图（正面、背面、侧面、3/4 侧面）",
          "3 个面部表情肖像",
          "8 个细节标注（太空服、头盔、手套、靴子、平板电脑）",
          "2 个全身太空服人偶"
        ]
      },
      {
