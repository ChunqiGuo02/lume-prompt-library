---
id: graphic-leather-page-right-0658
title: "手工皮革日记本静奢展示页"
category: graphic
subcategory: "06_图文排版视觉传达"
aesthetic: null
tags: ["皮革", "笔记本", "手工", "轻奢", "复古", "暖调", "棕色", "图书馆"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "4:3"
...
## 中文译文（源站提供）
温馨宜人的图书馆内景产品展示，桌面端着陆页，16:9 比例。

页面类型：着陆页 - 推广全新系列手工皮革日记本
布局：分屏 - 左侧主视觉图片，右侧细节卡片宾果格

主视觉区（左侧）：
- 图片：一位欧亚裔女性，身着米色羊绒毛衣，坐在光线柔和的图书馆扶手椅中，用钢笔在日记本上书写
- 文字：手工皮革日记本 - 雅致记录您的思绪
- CTA：探索系列

宾果格（右侧）：
- 卡片 1（左上）：皮革纹理细节 - 日记本封面特写，突出皮革纹理
- 卡片 2（右上）：钢笔 - 雅致的钢笔置于翻开的日记本页面上
- 卡片 3（中间）：手工缝线 - 书脊上精细手工缝线的细节
- 卡片 4（左下）：纸张品质 - 高品质纸张纹理特写，附有手写文字
- 卡片 5（右下）：定制压花 - 封面个性化压花示例

背景：光线柔和的图书馆 - 暖色木质书架摆满书籍，古董台灯，皮革扶手椅
灯光：伦勃朗式布光 - 单一光源营造戏剧性阴影，日落时分效果
色调：暖大地色系 - 棕色、米色、金色点缀，浓郁桃花心木色
风格：静奢风 - 优雅、低调，注重工艺
相机：哈苏 H6D，85mm f/1.2，浅景深

风格关键词：手工制作、皮革、日记本、静奢风、图书馆、温暖、纹理。右下角优雅地放置一个时尚的手写签名 Willy，字体较小。
