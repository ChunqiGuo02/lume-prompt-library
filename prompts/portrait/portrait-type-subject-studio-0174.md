---
id: portrait-type-subject-studio-0174
title: "专业影棚半身人像，自然简约风格，高保真写实肖像拍摄"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["棚拍", "半身", "肖像", "女性", "棕发", "皮衣", "浅灰", "简约"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
# 正文 prompt
{
  ...
  "background": {
    ...
    "color": "{"background color" "soft_gradient_neutral"}",
...
```json
{
  ...
  "background": {
    "style": "简洁影棚背景",
    "color": "{\"background color\" \"柔和渐变中性色\"}",
    "texture": "平滑极简",
    "distraction_free": true
  },
  "style": {
