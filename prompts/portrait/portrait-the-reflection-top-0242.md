---
id: portrait-the-reflection-top-0242
title: "优雅女性镜前自拍，举杯笑颜，复古餐厅烛光氛围"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["女性", "对镜", "自拍", "葡萄酒", "复古", "餐厅", "暖色调", "烛光"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
version: "1.0.0"
related_to: ["interior-the-reflection-top-002", "interior-the-reflection-top-003"]
---
...
# 正文 prompt
{
  "prompt_details": {
    ...
    "pose_and_action": {
      ...
      "hands": [
        "Holding a wine glass filled with {"wine color" "white wine"}.",
...
```json
{
  "prompt_details": {
    "subject": {
      "description": "一位年轻女性，留着蓬松的深棕色长发，带有柔和的波浪和中分。她拥有杏仁状的眼睛、上扬的眉毛和分明的面部特征。",
      "expressions": [
        "上半部分：微妙而自信的微笑，与镜中的倒影直接进行眼神交流。",
        "下半部分：真诚而愉快的笑声，双眼紧闭，头部向后仰。"
      ],
      "attire": {
        "top_image": "黑色高领无袖上衣，精致简约。",
        "bottom_image": "黑色抹胸连衣裙，带有微妙的闪光纹理（亮片或微光）。"
      },
      "accessories": [
        "精致的银色项链（网球链式或类似款式）",
        "细款金/银手链",
    ...
    "pose_and_action": {
      "type": "镜面自拍视角。",
      "hands": [
        "手持一个装有 {\"wine color\" \"白葡萄酒\"} 的酒杯。",
        "手持智能手机捕捉倒影。"
      ],
      "posture": "坐在餐桌旁，姿态放松而优雅。"
    },
    "environment": {
      "location": "高档、复古风格的餐厅或小酒馆。",
      "decor": [
        "深色木质护墙板",
        "反射房间的华丽镜子",
        "花卉或挂毯风格的墙纸/软垫",
      ...
      "background_details": "背景中隐约可见其他用餐者，带有流苏灯罩的复古台灯。"
    },
    "lighting": {
      "atmosphere": "昏暗、温暖、私密的夜晚氛围。",
      "sources": [
        "带有暖色灯罩的复古台灯发出的柔和光芒",
        "烛光（下半部分画面中有一支醒目的高大白蜡烛）",
        "镜子反射的环境光"
      ],
      "effect": "室内黄金时段色调，头发和皮肤上的柔和高光，丰富的阴影。"
    },
    "camera_and_tech": {
      "style": "超逼真、8k 分辨率、抓拍式生活摄影。",
      "camera_simulation": "智能手机后置摄像头（iPhone Pro 风格），大光圈 (f/1.8) 以获得景深。",
      "focus": "镜中主体清晰对焦，前景元素（酒杯柄、蜡烛）柔和散景。",
      "color_grading": "温暖、电影感、略带颗粒感的低光纹理，丰富的对比度。"
    },
    "mood": "奢华、喜庆、快乐、时尚、‘夜生活’美学。"
  }
}
```
