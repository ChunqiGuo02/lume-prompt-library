---
id: portrait-wet-fabric-water-1592
title: "湖中情侣亲密拥吻的电影感写真"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["情侣", "湖水", "浪漫", "亲密", "人像", "湿身", "暗绿", "电影感"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
  ...
  "generation_request": {
    ...
    "subjects": {
      "group": {
        ...
        "female_subject": {
          "wardrobe": "{"female attire" "cream/ivory satin or soft fabric dress"}, fully wet, heavier drape, clinging folds, realistic translucency (non-explicit), no modern lingerie look",
...
```json
{
  "generation_request": {
    ...
    "global_scene": {
      "setting": "平静的墨绿色湖水，细微涟漪，无可见岸边，极少干扰",
      "time_of_day": "阴天下午",
      "lighting": "柔和漫射光，轻微对比度，湿润皮肤和湿润织物上逼真的镜面高光",
      "mood": "亲密、浪漫、真实、电影感"
    },
    "subjects": {
      "group": {
        "count": 2,
        "description": "浪漫情侣在湖水中相拥，肢体互动逼真",
        "male_subject": {
          "wardrobe": "白色纽扣衬衫，浸湿后部分半透明，面料自然贴合，无标志",
          "pose": "浸没至胸部，手臂支撑着女子的腰部/臀部，抬头微笑着看她",
          "wetness_detail": "湿发，脸上有水珠，湿衬衫褶皱，织物上有水线痕迹"
        },
        "female_subject": {
          "wardrobe": "{\"female attire\" \"米色/象牙色缎面或柔软面料连衣裙\"}，完全湿透，垂坠感更强，褶皱贴合，逼真的半透明效果（非露骨），无现代内衣感",
          "pose": "坐在/靠在男子的腿部/臀部支撑上，躯干前倾，脸靠近他，眼神亲密",
          "wetness_detail": "湿发丝，肩膀/手臂上有水珠，裙摆浸没并有漂浮的褶皱"
        }
      }
    },
    "physics_realism": {
      "water_interaction": "从身体散发出的逼真涟漪，接触点处的小水花，织物和皮肤周围的弯月面，与姿势一致的浮力",
      "fabric_behavior": "湿织物的重量感可见，逼真的褶皱张力，无僵硬布料",
      "skin_and_hair": "皮肤上的湿润光泽，自然毛孔，散乱的湿发丝"
    }
  }
}
```
