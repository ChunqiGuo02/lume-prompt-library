---
id: portrait-the-studio-should-0256
title: "传统巴伐利亚狄尔ndl裙装的高精度写实摄影提示词"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["女性", "金发", "淡妆", "传统", "服饰", "深蓝", "浅灰", "白色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
```json
{
  "prompt": "一张高分辨率的专业影棚照片，一位面容自然的女性身着传统巴伐利亚紧身连衣裙（dirndl），与参考图片一致——深海军蓝紧身胸衣配银色刺绣，浅灰蓝色围裙配花卉蕾丝边饰，以及白色泡泡袖衬衫。模特应显得真实，而非 AI 生成，拥有自然的皮肤纹理、淡妆和随意造型的柔软金发。她应自然站立，一侧有柔和的日光般照明，以营造柔和逼真的阴影，并展现缎面和蕾丝面料的质感。背景应简洁，以中性色调（浅米色或柔和的灰色）柔和打光，平滑一致，如同影棚墙壁。确保焦点清晰地落在紧身连衣裙的面料细节、蝴蝶结和蕾丝边缘上，同时保持真实的人文色调和真诚的表情。",
  "negative_prompt": "无人工皮肤平滑，无过度曝光，无强烈对比，无虚假反光，无 AI 伪影，无漂浮物体，无背景渐变，无扁平或塑料质感，无不真实的对称。",
  "aspect_ratio": "4:5",
  "style": "超写实影棚摄影",
  "quality": "超高",
  "lighting": "柔和日光影棚",
