---
id: portrait-street-brick-wall-2416
title: "都市黄昏街头少女静坐听歌，展现青春独处与音乐慰藉的沉静瞬间。"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["滑板", "女生", "耳机", "黄昏", "街头", "涂鸦", "砖墙", "路灯"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
# 正文 prompt
{
  ...
  "appearance": {
    "hair": {
      "color": "{"hair color" "Silver-blonde"}",
...
{
  "model": "Nano Banana Pro",
  "scene": "黄昏时分的城市街角，旁边是一面涂鸦砖墙",
  "subject": {
    "type": "年轻女性",
    "pose": "坐在滑板上，膝盖弯曲，背部靠着砖墙",
    "expression": "平静、内省、略显疏离",
    "gaze": "双眼轻闭或低垂，沉浸在音乐中",
    "emotion": "宁静、沉思、安静的超脱"
  },
  "appearance": {
    "hair": {
      "color": "{\"hair color\" \"银金色\"}",
      "style": "蓬松、略显凌乱"
    },
    "accessories": "头戴式黑色耳机",
    "skin": "自然肤色，沐浴在柔和的暮色中"
  ...
  "attire": {
    ...
    "bottoms": "宽松工装裤",
    "footwear": "磨损的白色运动鞋",
    "style_note": "休闲街头服饰，实用且不加修饰"
  },
  "environment": {
    "location": "城市小巷或侧街",
    "background": "带有褪色涂鸦艺术的砖墙",
    "props": [
      "靠墙放着的滑板",
      "上方安装的路灯"
    ],
    "atmosphere": "都市、安静、一天结束时的平静"
  },
  "lighting": {
    "primary": "温暖的路灯光",
    "secondary": "柔和的自然暮光",
    "effect": "砖墙纹理上的金色高光，柔和的阴影"
  },
  "camera": {
    "angle": "低角度四分之三视图",
    "lens": "35mm 电影镜头",
    "depth_of_field": "适中，主体清晰，背景柔和模糊",
    "framing": "垂直构图，强调街道深度和墙壁线条"
  },
  "color_palette": {
    "dominant": ["暖砖红色", "柔和橄榄色", "柔和琥珀色"],
    "accents": ["冷灰色", "褪色涂鸦色调"]
  },
  "mood": "都市、内省、沉稳",
  "style": {
    "aesthetic": "电影感街头摄影",
    "realism": "超写实",
    "texture": "粗糙的砖块、磨损的沥青、织物褶皱",
    "post_processing": "暖色高光，饱和度略微降低"
  },
  "details": {
    "ground": "粗糙的沥青路面，散落着小碎屑",
    "board": "磨损的滑板板面，显示出使用痕迹",
    "motion": "静止画面，无动作或模糊"
  },
  "themes": [
    "都市孤独",
