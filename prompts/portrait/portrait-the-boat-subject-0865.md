---
id: portrait-the-boat-subject-0865
title: "奢华游艇度假写真"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["船只", "海边", "小镇", "意大利", "金发", "女性", "泳装", "暖色调"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
"lighting": {
  "source": "自然日光",
  "quality": "黄金时刻的光线，柔和温暖",
  "shadows": "主体和船只元素投射出的柔和且轮廓分明的阴影",
  "direction": "从右侧照射，带有轻微的背景光",
  "highlights": "水面、船栏杆及主体头发的明亮高光"
},
  "background": {
    "details": "可以看见具体的建筑、教堂圆顶和海滩活动场景",
    "setting": "意大利阿马尔菲海岸
