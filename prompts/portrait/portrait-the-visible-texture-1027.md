---
id: portrait-the-visible-texture-1027
title: "年轻女性居家时尚写真，橄榄绿露肩内衣搭配米色针织裤"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["女性", "长发", "居家", "肖像", "写实", "橄榄绿", "灰色", "沙发"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
  ...
  "prompt": {
    ...
    "clothing": {
      "top": {
        ...
        "brand_text": "'{"brand name" "LOUNGE"}' repeated on the underband",
...
```json
{
  "prompt": {
    "subject": {
      "demographics": "年轻女性，大约 20 岁出头",
      "appearance": {
        "hair": "长深棕色头发，中分，直发垂至肩部",
        "eyes": "大棕色眼睛，画有上扬眼线，直视镜头",
        "skin": "白皙肤色，光滑，锁骨清晰可见",
        "body_details": "右侧肋骨处可见小纹身，肚脐有银色穿环",
        "expression": "柔和、诱人，嘴唇微张"
      },
      "pose": {
        "posture": "坐在灰色沙发上，身体略微前倾",
        "hands": "右手轻触胸部上方/颈部区域，无名指戴有银色戒指；左臂自然垂放于身体一侧"
      }
    },
    "clothing": {
      "top": {
        "item": "橄榄绿抹胸式文胸",
        "brand_text": "底围处重复印有“'{\"brand name\" \"LOUNGE\"}'”字样",
        "style": "肩带滑落至肩部以下（露肩款式），罩杯上有半透明网纱细节"
      },
      "bottom": {
        "item": "米色/米白色针织家居裤",
        "texture": "麻花针织或有纹理的面料",
    ...
    "environment": {
      "location": "室内起居空间",
      "furniture": "带靠垫的纹理灰色布艺沙发",
      "background": "纯色、浅米色或米白色墙壁",
      "props": "右下角可见有纹理的毯子或织物"
    },
    "lighting": {
      "type": "自然散射日光",
      "direction": "正面照明",
      "shadows": "主体身后沙发上有柔和阴影，面部光线均匀"
    },
    "technical_specs": {
      "style": "超写实生活肖像",
      "camera": "高端数码单反相机或无反相机（例如 Sony A7R IV 或 Canon R5）",
      "lens": "50mm 或 85mm 人像镜头",
      "aperture": "f/2.8，用于轻微景深分离",
      "resolution": "8k，高细节",
      "film_grain": "极少或无，干净的数字画面感"
    }
  }
}
```
