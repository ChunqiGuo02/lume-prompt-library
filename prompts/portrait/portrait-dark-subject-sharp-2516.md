---
id: portrait-dark-subject-sharp-2516
title: "镜前自拍：奢华夜宴风情写真"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["自拍", "棕色", "卷发", "皮草", "皮裙", "御姐", "红色", "美甲"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
# 正文 prompt
{
  "image_generation_request": {
    ...
    "subject_identity": {
      "reference_name": "{"subject name" "Ana de Armas (young)"}",
...
```json
{
  "image_generation_request": {
    "framing_and_composition": {
      "shot_type": "中景",
      "orientation": "垂直",
      "composition": "镜面自拍，主体居中",
      "camera_in_shot": "镜面反射中可见智能手机，置于胸部高度",
      "perspective": "随性夜生活"
    },
    "subject_identity": {
      "reference_name": "{\"subject name\" \"Ana de Armas (young)\"}",
      ...
      "identity_fidelity": "100% 面部保留，独特特征零改动"
    },
    "expression_and_pose": {
      "expression": "性感，中性，沉着",
      "gaze": "直视反射的相机镜头",
      "head_pose": "略微倾斜",
      "body_language": "自信，厚重外套随意披挂，露出肩膀",
      "hand_detail": "右手持手机，食指伸出，红色美甲"
    },
    "styling_details": {
      "makeup": {
        "eyes": "犀利的黑色飞翼眼线，下眼线烟熏，浓密睫毛膏",
        "eyebrows": "眉形清晰，自然深色",
        "lips": "柔和哑光玫瑰色，略微外扩唇线",
        "contour": " subtle, 突出颧骨"
      },
      ...
      "outfit": {
        "base_layer": "巧克力棕色金属感单肩紧身连衣裙，带褶皱",
        "outerwear": "厚重棕色仿貂皮大衣，露肩穿着"
      },
      "accessories": {
        "jewelry": "大而粗犷的复古金色耳环",
        "nails": "长，尖头亚克力美甲，亮樱桃红",
        "phone_case": "深色手机壳中的现代智能手机"
      }
    },
    "physical_attributes": {
      "silhouette": "纤细，健美沙漏型",
      "details": "锁骨分明，肩膀纤细，腰部窄，女性曲线"
    },
    "environment_and_lighting": {
      "setting": "黑暗简约的奢华内饰（高端俱乐部/酒廊）",
      "background_elements": "水平黑色瓷砖墙或抛光深色木板",
      "lighting_type": "强烈的镜面闪光",
      "lighting_effects": "中心星爆光斑，高对比度高光，深邃阴影",
      "film_texture": "细微胶片颗粒，低光手机摄影效果"
    },
    "technical_specifications": {
      "aesthetic": "iPhone 拍摄，超现实主义",
      "resolution": "8k，高分辨率纹理，原始照片质量",
      "artifacts": "轻微运动模糊，自然数字噪点",
      "focus": "尽管有闪光，面部特征仍清晰对焦"
    },
    "mood_and_style": {
