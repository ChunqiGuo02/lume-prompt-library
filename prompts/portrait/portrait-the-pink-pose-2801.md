---
id: portrait-the-pink-pose-2801
...

{
  ...
  "fashion_and_apparel": {
    "outerwear": "Oversized, structured {"outerwear color" "pink"} wool trench coat or blazer draped over the shoulders",
    "inner_wear": "Black satin or silk bodysuit with a scoop neckline and sheer corset detailing at the waist",
    "accessories": [
      "Opera-length {"gloves color" "pink"} satin gloves",
...
{
  "subject": {
    "description": "一位迷人的西方女性，留着浓密、蓬松、波浪状的草莓金色长发",
    "pose": "优雅的蹲姿或半蹲姿，一只手优雅地轻触下巴，面部表情中性而精致，直视镜头",
    "features": "白皙的皮肤，上扬的眼线，柔和的粉色哑光唇膏，轮廓分明的面部结构"
  },
  "fashion_and_apparel": {
    "outerwear": "一件超大、有型的 {\"outerwear color\" \"pink\"} 羊毛风衣或西装外套随意披在肩上",
    "inner_wear": "黑色缎面或丝绸紧身衣，带圆领和腰部透明束身衣细节",
    "accessories": [
      "歌剧式长度的 {\"gloves color\" \"pink\"} 缎面手套",
      "金色复古风格的厚重纽扣耳环"
    ],
    "footwear": "经典黑色尖头细高跟鞋"
  },
  "composition_and_setting": {
    "background": "极简主义的纯色浅粉色或米白色摄影棚背景",
    "framing": "全身照，居中构图",
    "perspective": "与视线齐平或略低的视角，以突出姿势和轮廓"
  },
  "lighting_and_aesthetic": {
    "style": "高级时装杂志风格，黑色时尚，永恒的魅力",
    "lighting": "聚光灯效果，在头部后方的背景上形成圆形光晕；来自前方顶部的柔和定向主光，营造微妙的阴影并突出织物质感",
    "color_palette": "单色黑灰色调，头发和肤色带来暖色点缀"
  },
  "technical_details": {
    "camera_feel": "使用 85mm 镜头拍摄，主体对焦锐利，背景柔和虚化，高分辨率，干净的影棚摄影"
  }
}
```
