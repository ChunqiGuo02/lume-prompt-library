---
id: portrait-type-details-face-1958
title: "红裙少女倚石墙，绿靴点缀田园风"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["女性", "休闲", "写真", "石墙", "户外", "红色", "碎花", "短裙"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
  "prompt_details": {
    "subject": {
      "type": "Young woman {"subject name" "Ana de Armas"} ",
      "appearance": {
...
```json
{
  "prompt_details": {
    "subject": {
      "type": "年轻女子 {\"subject name\" \"Ana de Armas\"} ",
      "appearance": {
        "hair": "长款，深栗色，蓬松波浪，垂落脸庞，凌乱美感",
        "skin": "白皙肤色，光滑质地，自然妆效",
        "face": "向下看，脸部部分被头发遮挡，沉思的表情",
        "body_type": "苗条，健美"
      },
      "pose": {
        "stance": "靠着石墙，身体略微倾斜",
    ...
    "clothing": {
      "dress": {
        "style": "露肩迷你连衣裙，田园风/波西米亚风",
        "fabric": "轻质棉麻混纺",
        "color": "红色/偏红色底色",
        "pattern": "小巧精致的碎花图案，带有紫色和黄色野花",
        "details": ["荷叶边分层裙摆", "泡泡短袖", "甜心领口", "束身衣式紧身胸衣结构"]
      },
      "accessories": [
        "细黑色颈圈项链",
        "手指上戴着多个银戒指",
    ...
    "environment": {
      "background": "有纹理的石砌墙",
      "details": "大块不规则的灰色和米色石块，粗糙的质地，自然的建筑背景",
      "setting": "户外或半户外日光环境"
    },
    "lighting": {
      "type": "柔和自然日光",
    ...
    "styling": {
      "aesthetic": "波西米亚风，时尚，女性化，带有柔和的垃圾摇滚底蕴",
      "mood": "休闲，随性，略带忧郁，艺术感"
    },
    "camera_details": {
      "shot_type": "中景（大腿以上）",
