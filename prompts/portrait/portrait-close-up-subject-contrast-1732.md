---
id: portrait-close-up-subject-contrast-1732
title: "电影感写实人像特写"
category: portrait
...
# 正文 prompt
{
  ...
  "Lighting": {
    "Primary": "Dramatic harsh sidelight sculpting the subject’s profile",
...
```json
{
  "Objective": "生成一张具有戏剧性光线和丰富纹理细节的超写实电影级特写肖像。",
  "Prompt_Type": "图像生成",
  "Subject": {
    "Description": "以超详细特写肖像呈现的人像主体",
    "Facial_Details": {
      "Skin": "高度纹理化、逼真的皮肤",
      "Eyes": "深邃、沉思的棕色眼睛，反射着光线"
    },
    "Hair": "被风吹乱的发丝，从后面被照亮，像光纤一样发光",
    "Wardrobe": "磨损、粗糙的深色针织羊毛围巾，提供强烈的纹理对比"
  },
  "Composition": {
    "Framing": "特写肖像",
    "Style": "电影感",
    "Depth": "深邃的阴影，主体与背景强烈分离"
  },
  "Lighting": {
    "Primary": "戏剧性的强烈侧光，勾勒出主体的轮廓",
    "Secondary": "强烈的黄金时段逆光",
    "Effect": "高对比度，雕塑般的面部轮廓"
  },
  "Color_Grading": {
    "Palette": "青色和橙色",
    "Tone": "暖色高光与冷色阴影"
  ...
  "Response_Format": "单个高质量渲染图像，匹配所有列出的属性"
}
```
