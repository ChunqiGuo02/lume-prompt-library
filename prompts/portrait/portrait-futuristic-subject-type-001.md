---
id: "portrait-futuristic-subject-type-001"
title: "赛博朋克雨夜街头，蓝发女子倚墙而立，霓虹光影交织，未来感十足"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["赛博朋克", "雨夜", "都市", "小巷", "涂鸦", "猫咪", "蓝发", "幻彩"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
```json
{
  "scene_overview": {
    "setting": "夜晚狭窄的城市小巷",
    "environment": "下雨，地面湿滑，有反光水坑",
    "atmosphere": "赛博朋克、未来感、霓虹灯、忧郁且富有电影感"
  },
  "primary_subject": {
    "type": "人类女性",
    "pose": "站立，身体微微靠在涂鸦墙上",
    "expression": "平静、自信、略显严肃",
    "gaze": "直视镜头",
    "emotion": "酷炫、沉着、未来主义的优雅"
  },
  "appearance": {
    "hair": {
      "color": "冰蓝色带银色调",
  ...
  "clothing": {
    "outfit_type": "全身未来主义连体衣",
    "material": "光泽、全息、半透明乙烯基类面料",
    "color_palette": [
      "虹彩蓝",
      "粉色",
      "紫色",
  ...
  "lighting": {
    "primary_light": "背景霓虹招牌的光晕",
    "secondary_light": "湿地面的柔和环境反光",
    "color_temperature": [
      "冷蓝色",
      "青色",
      "粉色高光"
