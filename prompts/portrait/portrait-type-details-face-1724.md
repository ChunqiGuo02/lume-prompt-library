---
id: portrait-type-details-face-1724
title: "田园少女风连衣裙造型，自然光影下的温柔姿态"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["少女", "户外", "花园", "绿色", "碎花", "连衣裙", "短靴", "棕色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
  "prompt_details": {
    "subject": {
      "type": "Young woman {"subject name" "Sydney Sweeney"} ",
      "appearance": {
...
        "color": "{"dress color" "Red/off-Red"} base",
...
```json
{
  "prompt_details": {
    "subject": {
      "type": "年轻女性 {\"subject name\" \"Sydney Sweeney\"} ",
      "appearance": {
        "hair": "深栗色长发，波浪松散，垂落在脸庞，凌乱美感",
        "skin": "白皙肤色，光滑质感，自然妆面",
        "face": "向下看，脸部部分被头发遮挡，沉思表情",
        "body_type": "苗条，健美"
      },
      "pose": {
        "stance": "靠着石墙，身体略微倾斜",
        "hands": "右手轻柔地放在胸部/颈部，手指张开；左手在身侧拿着一个绿色物体（靴子）",
        "gaze": "向下看，避免眼神接触"
      }
    },
    "clothing": {
      "dress": {
        ...
        "fabric": "轻质棉或亚麻混纺",
        "color": "{\"dress color\" \"红色/偏红色\"} 底色",
        "pattern": "带有紫色和黄色野花的小巧精致花卉图案",
        "details": [
          "荷叶边分层裙摆",
          "泡泡短袖",
          "心形领口",
    ...
    "styling": {
      "aesthetic": "波西米亚风，时尚，女性化，略带柔和的垃圾摇滚底蕴",
      "mood": "休闲，随性，略带忧郁，艺术感"
    },
    "camera_details": {
      "shot_type": "中景（大腿以上）",
      "angle": "平视",
      "lens": "85mm 定焦镜头，用于讨人喜欢的肖像压缩效果",
      "aperture": "f/2.8，以实现与墙壁的轻微景深分离",
      "focus": "主体和连衣裙纹理清晰对焦"
    },
    "technical_specifications": {
      "quality": "超逼真，8k 分辨率，高度细节",
      "texture_quality": "高保真面料纹理，逼真的皮肤毛孔，细致的石砌结构",
      "engine": "Unreal Engine 5 渲染风格或高端摄影"
    }
  }
}
```
