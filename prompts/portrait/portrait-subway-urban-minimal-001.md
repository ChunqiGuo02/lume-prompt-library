---
id: "portrait-subway-urban-minimal-001"
title: "伦敦地铁站内，年轻女性静坐沉思的写实肖像"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["地铁", "站台", "都市", "通勤", "女性", "肖像", "写实", "电影感"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
```json
{
  "render_goal": "在城市交通环境中，创作一张电影级的写实抓拍肖像",
  "scene": {
    "location": "伦敦地铁站台",
    "time": "三月的一个周三清晨",
    "atmosphere": "平静的通勤人流，宁静的城市节奏"
  },
  "subject": {
    "gender": "女性",
    ...
    "appearance": {
      "expression": "柔和、沉思、内省",
      "gaze": "目光略微偏向一侧",
      "makeup": "精致、考究的妆容，大胆而优雅"
    },
    "clothing": {
      "style": "轻盈、现代的春季服装",
      "details": "修身或极简叠穿，自信时尚，无厚重外套"
    },
    "pose": "独自坐在地铁长凳上，姿态放松，肢体语言自然"
  },
  "camera": {
    "framing": "中景特写，聚焦面部和上半身",
    "focus": "主体对焦锐利",
    "depth_of_field": "景深极浅，背景虚化强烈",
    "motion_effects": "移动的通勤者有微妙的运动模糊"
  },
  "lighting": {
    "type": "柔和的自然晨光与地铁环境光混合",
    "mood": "平衡，柔和的高光与受控的阴影"
  },
  "background": {
    "elements": [
  ...
  "aesthetic": {
    "style": "写实、电影级真实感",
    "vibe": "极简、内省、非摆拍",
    "color_tone": "干净、中性色调，带有微妙对比"
  },
  "quality": {
    "detail_level": "高",
    "texture": "自然的皮肤纹理，逼真的织物细节",
    "output": "超写实，干净的完成度"
  }
}
```
