---
id: portrait-the-relaxed-window-1560
title: "清新居家风女性写真拍摄指南"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["女性", "休闲", "居家", "写实", "肖像", "简约", "白色", "绿色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
```json
{
  "prompt_data": {
    "subject": {
      "description": "年轻女性，留着齐肩的{\"hair color\" \"蜂蜜金色\"}头发，发型是蓬松自然的波浪卷，肤色白皙温暖。",
      "features": "自然的皮肤纹理，鼻子上散布着细微的雀斑，脸颊泛着淡淡的红晕，嘴唇水润有光泽，带着轻松的半微笑，腰部有精致的穿孔饰品。",
      "accessories": "细金链项链，小耳钉，右耳后方有细线纹身。"
    },
    "clothing": {
      "outfit": "休闲夏日风格的家居服。",
      "top": "修身白色罗纹背心，长度略短，采用柔软弹力面料。",
      "bottoms": "浅{\"shorts color\" \"鼠尾草绿\"}抽绳休闲短裤，版型宽松。"
    },
    "pose_and_action": {
      "posture": "在窗边的一张现代扶手椅上盘腿而坐。",
      "body_language": "舒适自在，一只手臂搭在扶手椅上，另一只手随意地触碰膝盖，躯干略微朝向光线。",
      "expression": "平静自信的眼神，带着一丝俏皮的活力。"
    },
    "environment": {
      "setting": "明亮、极简主义的公寓客厅。",
      "furniture": "米色圈绒扶手椅，边缘圆润柔软。",
      "background": "中性米色墙壁，带有柔和的阴影和极少的装饰。",
      "decor": "窗边有一盆大型室内盆栽，一张矮木边桌，以及一个简单的陶瓷花瓶。"
    },
    "lighting": {
      "type": "以自然日光为主。",
      "quality": "柔和的窗户光线漫射在脸部和身体上，营造出柔和的高光和自然的阴影，带来干净、通透的感觉。"
    },
    "styling_and_mood": {
      "aesthetic": "干净的网红生活方式，带着轻松的居家清晨氛围。",
      "mood": "清新、亲密、自信、平静。"
    },
    "camera_specifications": {
      "angle": "与视线齐平的拍摄角度，略微正面。",
      "focus": "面部特征锐利对焦，景深较浅，背景柔和虚化。",
      "lens_suggestion": "50mm 人像镜头。",
      "film_grain": "极轻微的数字颗粒感，营造自然现代的外观。"
    },
    "technical_modifiers": [
      "超写实",
      "8K 分辨率",
