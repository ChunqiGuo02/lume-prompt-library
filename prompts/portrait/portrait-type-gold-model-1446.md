---
id: portrait-type-gold-model-1446
title: "欧洲街头时尚女性写真"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["粉色", "衬衫", "牛仔裤", "破洞", "墨镜", "金发", "女性", "休闲"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
# 正文 prompt
{
  ...
  "subject_definition": {
    "identity": {
      "type": "model",
      "age_appearance": "{"age" "25 years old"}",
      "gender": "female"
    },
    "appearance": {
      "hair": "{"hair style" "blonde wavy, shoulder-length"}",
...
```json
{
  ...
  "environment_definition": {
    "location": "欧式鹅卵石街道",
    "background_elements": {
      "architecture": "带有多个拱门的老旧石砌建筑",
      "decor": "装满五彩天竺葵和常春藤的大型陶土花盆"
    },
    "atmosphere": "温暖，阳光明媚的一天"
  },
  "composition_and_layout": {
    "framing": "全身照片",
    "camera_angle": "平视",
