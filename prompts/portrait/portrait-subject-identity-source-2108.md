---
id: portrait-subject-identity-source-2108
title: "融合名人面容与指定服饰的高精度人像生成"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["人像", "金发", "黑色", "羽绒服", "户外", "逆光", "高清", "暖色调"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
version: "1.0.0"
related_to: ["landscape-subject-ana-armas-001", "landscape-subject-ana-armas-002", "landscape-subject-identity-ana-001", "landscape-subject-identity-ana-002", "landscape-subject-identity-ana-003", "landscape-subject-sydney-sweeney-001"]
---
...
# 正文 prompt
{
  ...
  "source_references": {
    "primary_subject": {
      ...
      "subject_name": "{"identity subject" "Ana de Armas"}",
  ...
  "generation_parameters": {
    "subject_specs": {
      "identity": {
        "face": "{"identity subject" "Ana de Armas"} (reference image 1)",
        "features": "locked",
...
```json
{
  ...
  "generation_parameters": {
    "subject_specs": {
      "identity": {
        "face": "{\"identity subject\" \"Ana de Armas\"} (参考图像 1)",
        "features": "locked",
        "skin_texture": "超逼真，毛孔细节清晰，自然瑕疵"
      },
      "anatomy": {
        "pose": "动态四分之三侧身，手扶臀部",
        "body_type": "与 Sydney Sweeney 保持一致"
      },
      "styling": {
        "outfit": "从图像 2 克隆",
        "hair": "蓬松，自然波浪，捕捉背光"
    ...
    "environment_specs": {
      ...
      "lighting": {
        ...
        "secondary_source": "柔和的轮廓光，将主体与背景分离",
        "hdr_profile": "超高动态范围"
      }
    },
    "camera_specs": {
