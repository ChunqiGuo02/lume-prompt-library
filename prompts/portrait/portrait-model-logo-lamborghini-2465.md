---
id: portrait-model-logo-lamborghini-2465
title: "金黄兰博基尼前的时尚女模写真预设"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["金发", "女模", "黑T恤", "紧身裤", "白鞋", "超跑", "金色", "兰博基尼"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
  ...
  "subject": {
    ...
    "attire": {
      "top": {
        ...
        "detail": "Gold shimmering {"logo text" "Lamborghini"} logo lettering"
      },
...
```json
{
  "subject": {
    ...
    "attire": {
      "top": {
        "type": "修身黑色 T 恤",
        "detail": "金色闪亮 {\"logo text\" \"Lamborghini\"} 标志字母"
      },
      "bottom": "黑色紧身裤",
      "footwear": "修身白色 Skechers 运动鞋"
    }
  },
  "vehicle": {
    "make": "Lamborghini",
    ...
    "color": "纯粹闪耀的金色",
    "finish": "金属编织",
    "details": ["锐利保险杠", "格栅", "柔软皮革内饰", "纹理织物点缀"]
  },
  "environment": {
    "setting": "都市",
    "background_elements": [
