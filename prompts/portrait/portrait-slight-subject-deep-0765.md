---
id: portrait-slight-subject-deep-0765
...
```json
{
  ...
  "subject_morphology": {
    ...
    "hair": {
      "color": "暖金色",
      "style": "齐肩短发，直发带轻微纹理",
      "behavior": "自然垂落，发梢受重力轻微牵引，被人工光源照亮"
    },
    "skin": {
      "tone": "白皙/苍白",
      "texture": "自然光滑，面部略有闪光灯过曝",
      "lighting_reaction": "颧骨和鼻梁有反光光泽"
    }
  },
  "apparel_and_textiles": {
    "garment": "全身紧身连体衣",
    "color": "深黑色",
    "material": "罗纹针织面料",
    "fit": "超强压缩，紧身，精确贴合身体曲线",
    "texture_visibility": "光线照射到曲线处（臀部、腰部、手臂）时，可见垂直罗纹"
  },
  "pose_geometry_and_physics": {
    "overall_orientation": "站立，后斜角（背对镜头，扭身回望）",
    "spine_curvature": {
      "lumbar": "极度腰椎前凸（深陷的下背部弓形）",
      "thoracic": "躯干向主体左侧旋转",
      "cervical": "头部向左旋转约 80 度，向后看"
    },
    "pelvic_state": {
      "tilt": "激进的骨盆前倾",
      "rotation": "与后对角线轴线垂直",
      "visual_dominance": "臀部区域因透视和倾斜而视觉放大"
    },
    "limb_placement": {
      "left_arm": "自然垂于身体一侧，肘部略微弯曲，手放松地靠近大腿",
      "right_arm": "被躯干旋转遮挡，可见肩膀下垂",
      "legs": "直立站立，重心略偏向右腿，膝盖轻微锁定"
    },
    "weight_distribution": "重心集中在脚跟，姿态积极对抗重力以保持曲线"
  },
  "camera_and_framing": {
    "angle": "与主体躯干齐平的视线高度",
    "focal_length": "中广角（智能手机相机美学）",
    "composition": {
      "framing": "主体水平居中，裁剪至大腿中部/膝盖处",
      "foreground": "画面右侧边缘有一棵带灯的棕榈树干",
      "depth": "街道向左延伸的深远透视"
    }
  },
  "lighting_and_atmosphere": {
    "environment": "夜晚的都市豪华街道（人行道）",
    "primary_source": "混合人工街灯",
    "key_light": "正面闪光灯或明亮招牌照亮面部和头发（冷/中性色温）",
    "ambient_light": "缠绕在棕榈树上的串灯发出温暖的黄色光芒",
    "shadows": "地面有柔和的落影，衣物褶皱处有深邃的遮蔽阴影",
    "bokeh": "远处的街灯和店面略微失焦"
  },
  "environmental_details": {
    "location": "高档购物区人行道"
