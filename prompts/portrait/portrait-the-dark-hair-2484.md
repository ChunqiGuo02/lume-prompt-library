---
id: portrait-the-dark-hair-2484
title: "银色亮片礼服夜景人像摄影预设"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["夜晚", "美女", "银色", "亮片", "礼服", "假面", "精致", "华丽"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
# 正文 prompt
{
  "prompt_structure": {
    ...
    "attire_and_accessories": {
      "outfit": "Form-fitting {"dress material" "silver sequin"} midi dress, spaghetti straps, glittering texture reflecting light.",
      "accessories": [
...
```json
{
  "prompt_structure": {
    "subject_description": {
      ...
      "hair": "长而蓬松的深棕色头发，散开的吹风造型，深侧分，披散在左肩上。",
      "face": "五官对称，柔和的魅力妆容，眉毛清晰，涂有睫毛膏，玫瑰色脸颊，光泽的裸粉色嘴唇，表情平静而自信。",
      "pose": "四分之三侧身站立，身体略微靠在石栏杆上，右手抬起，将面具举到脸旁，左臂自然垂在身侧。"
    },
    "attire_and_accessories": {
      "outfit": "修身的 {\"dress material\" \"银色亮片\"} 迷笛连衣裙，细肩带，闪烁的质地反射着光线。",
      "accessories": [
    ...
    "environment_and_atmosphere": {
      ...
      "background": "漆黑的夜空，远处隐约可见建筑轮廓，低光都市氛围。",
      "lighting": "直射相机闪光灯摄影，主体光线强烈，与黑暗背景形成强烈对比，主体身后投射出逼真的阴影。"
    },
    "technical_specifications": {
      "image_quality": "4k, 8k, UHD, 超写实，超细节，原始照片。",
      "camera_style": "35mm 胶片拍摄，富士胶片风格，狗仔队美学，闪光灯摄影。",
      "focus": "面部和眼睛对焦清晰，轻微的景深模糊了黑暗的背景。",
