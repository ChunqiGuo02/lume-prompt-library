---
id: portrait-the-type-fit-2261
title: "超市购物车里的叛逆少女自拍写真"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["超市", "少女", "Y2K", "购物车", "薯片", "蓝色", "泡泡糖", "双马尾"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
# 正文 prompt
{
  "image_generation_prompt": {
    ...
    "hair": {
      "color": "{"hair color" "Golden Blonde"}",
    ...
    "outfit": {
      "top": {
        ...
        "fit": "Tight",
        "detail": "{"top pattern" "Rainbow horizontal stripes"}",
        "style": "Retro 2000s"
      },
      "bottom": {
...
```json
{
  "image_generation_prompt": {
    "scene": {
      ...
      "background": {
        "furniture": "金属购物车",
        "decor": "模糊的货架上摆满了五颜六色的麦片盒和 Sarıyer Kola 瓶罐——包装中清晰可见乌黑的汽水液体，大胆的红色包装和标签，光泽的红色点缀，没有其他可乐品牌",
        "atmosphere": "深夜恶作剧，荧光灯嗡嗡声，混乱的乐趣"
      },
      "props": "拿着一大包辣味薯片，蓝色覆盆子冰沙饮料"
    },
    "subject": {
      "gender": "女性",
      "age": "20 岁",
      "body_type": "健美丰满，皮肤质感柔软",
      "skin_tone": "浅棕褐色，暖色调",
      "vibe": "叛逆，调皮，小恶魔美学，充满活力"
    },
    "face": {
      "structure": "可爱的心形脸",
      "skin": "水润光泽，俏皮表情",
      "eyes": {
        "shape": "杏仁形",
        "color": "亮蓝色",
        "expression": "俏皮地对着镜头眨眼"
      },
      "lips": {
        "shape": "嘟嘟唇",
        "color": "亮樱桃红",
        "expression": "吹着粉色泡泡糖泡泡"
      },
      "makeup": {
        "style": "Y2K 美学",
        "details": "眼睑上有闪粉，锐利的眼线，光泽的唇部"
      }
    },
    "hair": {
      "color": "{\"hair color\" \"金金色\"}",
      "tone": "温暖的蜂蜜色挑染",
      "length": "长发",
      "style": "高双马尾，配彩色发圈",
      "texture": "略显凌乱的波浪"
