---
id: portrait-the-beige-her-2046
title: "艺术工作室少女写真风格预设-2"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["摄影", "女性", "画室", "米色", "低饱和", "宁静", "休闲", "画架"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
version: "1.0.0"
related_to: ["landscape-the-beige-her-001"]
---
...
```json
{
  "prompt": "一张柔和、低调的艺术学院风格照片，一位年轻女子盘腿坐在工作室地板上。她身穿米色连帽衫、米色长裤、白色袜子和黑色低帮运动鞋。她的姿势显得放松而略带笨拙，双手松散地搭在鞋子上。她留着齐肩波浪棕发，化着淡妆，戴着透明边框眼镜。手腕上有一个小星星纹身。背景是一个安静的艺术家工作室，有画架、贴在墙上的未完成素描、装满画笔的罐子和堆叠的书籍。自然窗光营造出柔和的阴影、柔和的色调和温暖、亲密的氛围。图像感觉年轻、真实、随意艺术，而非精致或商业化。",
  "style": "柔和自然摄影，艺术学院美学，极简主义，抓拍肖像",
  "lighting": "漫射自然日光，柔和阴影",
  "color_palette": "柔和中性色，米色，暖白色，微妙大地色",
  "composition": "主体居中，平视角度，亲密构图",
  "mood": "安静，亲密，年轻，平静",
  "camera": "35 毫米镜头，浅景深，自然颗粒感",
  "quality": "高分辨率，写实，未经修饰"
}
```
