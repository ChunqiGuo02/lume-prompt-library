---
id: portrait-the-stone-text-2820
title: "高定花园时尚大片"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: biophilic
tags: ["时尚", "人像", "金发", "制服", "白丝", "花园", "绿植", "石刻"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
        "text_content": "{\"Stone Text\" \"BeautyVerse\"}",
...
```json
{
  "project_title": "高级时装园林专题 — 无边框对角仰卧凝视",
  "structure": "单一全画幅构图。边缘到边缘摄影。无边框或拼贴元素。",
  "aspect_ratio": "3:4",
  "aesthetic_theme": {
    "style": "高级时装园林专题，专业杂志色彩分级",
    "mood": "精致、自信、宁静、高端目录风格",
    "color_grading": "专业时尚滤镜：微妙的柯达 Portra 400 美学，柔和漫射的自然高光，园林部分丰富的绿色，石刻文字略微去饱和的冷色调，以及精致的对比度。",
    "textures": [
      "精细杂志纸张纹理",
      "石刻文字上的陈旧石头和苔藓纹理",
      "左上角郁郁葱葱的植物纹理"
  ...
  "subject_reference": {
    "source": "image_1.png",
    "instruction": "主体的外貌、完整服装和配饰必须与 image_1.png 中的人物完全一致。保持视觉一致性。"
  },
  "composition_details": {
    "main_frame": {
      "type": "概念性全出血肖像",
      "composition_rule": "构图由一条从右上角到左下角的自然物理对角线边界定义。",
      "setting_description": "画幅由主体和结构无缝分割。右下半部分是一个巨大的、坚实的石头“BeautyVerse”结构。左上半部分充满了郁郁葱葱、柔焦的植物园。",
      "subject_pose": "主体沿石结构的对角线边缘仰卧（平躺），身体从右上角向左下角倾斜。**她的头部略微向上转动或倾斜，以便她的眼睛能直接而专注地凝视镜头。**她保持着放松但引人入胜的高级时装表情，同时进行眼神交流。她的背部直接接触石面。",
      "key_element_description": {
        "object": "一个巨大的、填满边缘的地形石碑。",
        "text_content": "{\"Stone Text\" \"BeautyVerse\"}",
        "alignment": "文字结构完全填充画幅的右下对角三角形。这些字母的对角线边缘构成了主体躺卧的“床”。",
        "text_style": "巨大、粗体"
      }
    }
  }
