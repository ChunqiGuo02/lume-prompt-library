---
id: "portrait-expression-hairstyle-studio-001"
title: "九宫格真人表情发型合集"
category: portrait
...
{
  "image.prompt": {
    "criticalInstruction": "绝对优先事项：确保所有照片中的面部结构完全相同。无论呈现哪种表情，都不得改变五官的骨骼结构、鼻子形状、眼睛间距或下颌轮廓。每个人的身份必须在每张照片中都清晰可见。",
    "format": "3x3网格拼贴",
    "subject": {
      "face.reference": "上传的照片",
      "face_identity_lock":
