---
id: portrait-identity-skin-reference-1607
title: "湿发绿眸女性特写，超写实皮肤纹理与身份还原"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["写实", "人像", "湿发", "汗水", "绿瞳", "特写", "微距", "冷色调"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
version: "1.0.0"
related_to: ["portrait-identity-skin-reference-002"]
---
  ...
  "subject_configuration": {
    ...
    "facial_attributes": {
      "eyes": {
        "primary_color": "自然绿色",
        "secondary_color": "淡褐色",
        "reflection_type": "逼真眼神光",
        "aesthetic_constraint": "避免合成光泽或过度闪亮"
      },
      "lips": {
        "state": "微张 / 湿润",
        "surface_texture": "柔软自然纹理",
        "finish": "光泽感，无变形"
      },
      "hair": {
        "color": "深棕色",
        "state": "饱和 / 湿润",
        "styling": "自然发束聚拢，贴服于鬓角和颈部"
      }
    }
  },
  "environmental_rendering": {
    "moisture_fx": {
      "sweat_layer": "鼻梁和额头覆盖一层细密闪亮的薄雾",
      "water_droplets": "颧骨和下颌线散布微小水珠",
      "surface_tension": "液体在皮肤上逼真的附着力"
    },
    "lighting_and_color": {
