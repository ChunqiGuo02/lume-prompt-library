---
id: portrait-facial-identity-fine-art-1410
title: "梦幻花朵动态模糊艺术人像"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["欧美女性", "肖像", "摄影", "花卉", "动态模糊", "灰绿", "宁静", "梦幻"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
# 正文 prompt
{
  ...
  "background": {
    "color_palette": "muted pastel 【sage green】 tones",
...
```json
{
  "meta": {
    ...
    "version": "1.0",
    "type": "image-generation-prompt",
    "quality_target": "超高分辨率 8K"
  },
  "reference": {
    "face_identity": "使用所提供参考图像中精确的面部结构、比例和身份",
    "identity_preservation": "高",
    "notes": "不要改变面部特征、年龄或相似度"
  },
  "subject": {
    "description": "面部特征柔和自然的年轻女性",
    "expression": "平静、内省、情感宁静",
    "makeup": "极简、注重自然肤色的妆容",
    "pose": "正面或略侧面，姿态放松"
  },
  "composition": {
    "style": "编辑艺术摄影",
    "framing": "紧凑的肖像构图",
    "depth_of_field": "浅景深，具有电影般的柔和感",
    "aesthetic": "优雅、极简、绘画般的写实主义"
  },
  "lighting": {
    "type": "柔和的漫射自然光",
    "highlights": "皮肤上柔和光滑的高光",
    "skin_texture": "保留自然纹理，不过度平滑"
  },
  "background": {
    "color_palette": "柔和的粉彩色调 {argument name=\"background color\" default=\"鼠尾草绿\"}",
    "texture": "柔和、无缝、不分散注意力"
  },
  "foreground_effects": {
    "elements": "精致的花朵飘过画面",
    "motion": "有意的慢速快门运动模糊",
    "light_effects": "柔和的光线条纹和梦幻般的光晕"
  },
  "artistic_effects": {
    "double_exposure": "微妙而富有诗意，轻柔地叠加在面部",
    "motion_blur": "柔和、流畅、受慢速快门启发",
    "mood": "梦幻、情感、宁静"
  },
  "rendering": {
    "style": "超现实艺术肖像",
    "sharpness": "面部清晰聚焦，带有柔和的电影般虚化",
    "color_grading": "粉彩、电影感、柔和对比",
    "resolution": "8K 超高清",
    "detail_level": "极致写实与绘画般的柔和感"
  }
}
```
