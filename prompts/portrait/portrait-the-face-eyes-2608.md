---
id: portrait-the-face-eyes-2608
title: "雪中少女回眸，冬日怀旧写真"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["复古", "冬日", "雪景", "少女", "肖像", "清冷", "怀旧", "积雪"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
{
  "subject": {
    "description": "年轻女性，大约十几岁末或二十出头",
    "pose": "身体略微转开，回头看向观者",
    "expression": "平静、中性、略带忧郁，眼神直接接触"
  },
  "face": {
    "skin": "白皙肤色，自然纹理，明显的玫瑰色脸颊和鼻子（冻红）",
    "eyes": "大而清澈的榛绿色眼睛，目光锐利，睫毛修长",
    "lips": "柔和自然的粉色，嘴唇闭合",
    "makeup": "几乎没有可见的妆容，自然外观"
  },
  "hair": {
    "color": "深棕色",
    "style": "松散地向后挽成凌乱的发髻或盘发",
    "details": "脸庞周围有几缕松散的发丝，覆盖着大小不一的白色雪花"
  },
  "clothing": {
    "main_piece": "厚实、有纹理的编织披肩或毯子，裹在肩上",
    "pattern": "褪色的佩斯利或花卉图案",
    "colors": "米色底色，带有柔和的锈橙色和褪色的牛仔蓝色点缀",
    "texture": "羊毛质地，粗糙编织，覆盖着新雪"
  },
  "accessories": [],
  "environment": {
    "setting": "冬季户外场景，乡村",
  ...
  "camera": {
    "perspective": "视平线",
    "shot_type": "中景特写肖像",
    "focus": "浅景深（散景），眼睛和脸部对焦清晰，背景模糊",
    "lens_effect": "人像焦距（约 85 毫米）"
  },
  "style": {
    "aesthetic": "电影写实主义，带有复古或绘画质感",
    "mood": "怀旧、宁静、冬季",
    "visual_treatment": "柔和色彩，轻微胶片颗粒纹理，自然主义"
  }
}
```
