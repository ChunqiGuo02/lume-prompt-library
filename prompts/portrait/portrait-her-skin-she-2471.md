---
id: portrait-her-skin-she-2471
title: "银发女子卧床静读写真特写"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["写实", "银发", "女生", "阅读", "蕾丝", "卧室", "简约", "静谧"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
```json
{
  "prompt": "一张高度写实的编辑风格照片，一位年轻女性，皮肤白皙如瓷，银灰色头发扎成宽松的高马尾。她俯卧在白色床上，双腿向上弯曲，平静地阅读一本小精装书。她穿着一件精致的米色蕾丝吊带睡裙，妆容精致且富有电影感，带有柔和的烟熏棕色眼影、清晰的眉毛和柔和的玫瑰色口红。她的表情沉思而宁静，目光向下专注地看着书。场景是一个极简主义的卧室，配有白色床上用品和干净的白色背景。柔和的自然日光，高调照明，光滑的皮肤纹理，清晰的面部细节，浅景深，时尚编辑摄影，超现实主义，4K 画质。",
  "negative_prompt": "低分辨率，模糊，刺眼的阴影，夸张的解剖结构，卡通，插画，过曝，欠曝，多余的肢体，扭曲的面部，塑料皮肤，水印，文字，标志",
  "style": "写实摄影",
  "camera": {
    "type": "数码单反相机",
    "lens": "85mm",
  ...
  "lighting": "柔和自然日光，漫射，高调",
  "composition": "横向，中景特写，主体居中",
  "quality": "超高",
  "detail_level": "极致写实"
}
```
