---
id: portrait-the-subject-dark-0774
title: "夜景都市女性写真"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["超写实", "人像", "摄影", "夜景", "都市", "女性", "卷发", "黑色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
```json
{
  ...
  "visual_elements": {
    "subject": {
      "description": "一位身材健美、苗条、皮肤白皙的年轻女性。",
      "hair": "深棕色长发，浓密卷曲，略带湿润或光泽感，披在左肩上。",
      "face": "五官分明，光泽裸色唇，精致烟熏眼妆，脸部转向左侧，远离镜头，表情自然放松。",
      "skin_texture": "高细节皮肤毛孔，闪光灯下的自然光泽，逼真的肤色。"
    },
    "appire_and_styling": {
      "outfit": "黑色修身鸡尾酒裙（吊带款式），胸部有蕾丝细节，甜心领口，小系带前襟。细吊带。",
      "accessories": "简约金色吊坠项链，小耳钉。",
      "makeup": "夜间魅力妆容，水润光泽。"
    },
    "pose_and_action": {
      "stance": "身体前倾，靠在银色金属栏杆上。",
      "hands": "双手随意搭在栏杆上，姿态放松。",
      "orientation": "身体略微面向镜头，头部侧向或四分之三侧向。"
    },
    "environment": {
      "setting": "夜间城市滨水区或城市桥梁。",
      "background": "漆黑的夜空，背景虚化的城市灯光（散景）。清晰的垂直黄色灯带和远处模糊的白色标志。栏杆下方可见黑暗的水面。",
      "atmosphere": "城市夜生活，充满活力又略显黑暗，抓拍瞬间。"
    }
  },
  "technical_details": {
    "lighting": {
      "type": "直射机顶闪光灯或频闪灯。",
      "effect": "主体与背景之间形成高对比度。锁骨、肩膀和前额有高光反射。主体身后有清晰的阴影。"
    },
    "camera_gear": {
      "camera": "Sony A7R V 或 Canon EOS R5",
      "lens": "85mm f/1.4 GM",
      "settings": "光圈 f/2.8，ISO 800，快门速度 1/125s",
      "focus": "主体面部对焦清晰，景深较浅（背景虚化）。"
    },
    "quality_tags": [
      "8k 分辨率",
      "超现实",
