---
id: portrait-the-her-slightly-2634
title: "雪地山景中黑衣女子自拍写真"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["冬季", "雪地", "雪山", "滑雪", "松林", "户外", "美女", "黑发"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
"focal_length": "Approximately {"focal length" "35mm"} to mimic a high-end smartphone or wide-angle portrait lens without distortion",
...
{
"subject": {
"description": "一位身材曼妙、五官精致的年轻女性。她拥有橄榄色肤色，肤质自然，毛孔细腻，并带有细微的胎记。她的头发是深棕色，近乎黑色，梳成两条长而紧的麻花辫，垂落在双肩。她有一双杏仁状的榛色大眼睛，睫毛浓密，眉毛浓黑分明，嘴唇丰满，呈自然的哑光质感。她身穿一件紧身哑光黑色长袖紧身衣，深宽的圆领口突显出丰满、沉甸甸且自然突出的胸部。下半身穿着高腰米色滑雪裤，腰部有金色纽扣细节。",
"anatomical_fidelity": "比例参照锁定。主体胸部丰满突出，明显高于平均水平，与参照物完全一致，呈现出受自然重力影响的饱满、沉重感。胸部深度明显大于胸腔深度，具有明显的向前和向外突出。腰部纤细，与胸部和臀部形成鲜明对比。由于姿势原因，肩膀柔软并略微向前弓。手部显示出逼真的皮肤褶皱和指关节细节。",
"clothing_details": "黑色紧身衣具有高品质的罗纹或哑光织物纹理，紧贴皮肤。米色裤子由厚重的专业滑雪服材料制成，带有明显的接缝和腰带环。"
},
"pose": {
"description": "主体以高角度中景拍摄，身体略微前倾，面向镜头。她的右手抬至胸部高度，拇指和食指之间轻柔地捏着右侧麻花辫的末端。她的左臂向下伸展并略微超出画面，暗示着自拍视角，但未显示设备。她的头部略微向右倾斜，目光平静而坚定地直视镜头。",
"weight_distribution": "重心居中但向前倾斜，营造出亲密感和深度。脊柱有自然的轻微弯曲，与坐姿或前倾姿势相符。"
},
"environment": {
"location": "冬季高山滑雪坡。",
"foreground": "一片原始、略带纹理的雪坡，显示出细微的滑雪痕迹。",
"midground": "右侧雪地上可见一副滑雪板和滑雪杖。中景处是一片被积雪覆盖的茂密常青松树林。",
"background": "雄伟、崎岖的山脉被厚厚的积雪覆盖，天空阴沉多云。空气寒冷而清新，能见度很高。",
"camera": {
"shot_type": "中景",
"angle": "略微高角度，俯视主体",
"focal_length": "大约 {\"focal length\" \"35mm\"}，以模仿高端智能手机或广角人像镜头，无畸变",
"perspective": "深邃的三维空间，主体与远山之间有清晰的分离",
"focus": "锐利 f"
}
}
```
