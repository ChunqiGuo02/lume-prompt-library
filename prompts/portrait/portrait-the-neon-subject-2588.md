---
id: portrait-the-neon-subject-2588
title: "雨夜霓虹街头的电影写实肖像"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["特朗普", "雨天", "黄昏", "城市", "街头", "长椅", "霓虹", "写实"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
## 中文译文（源站提供）
{
  "objective": "根据上传的图片生成一张具有电影质感、高度写实感的照片",
  "scene_description": {
    "setting": {
      "location": "黄昏时分、被雨水浸湿的高架桥长椅",
      "environment_details": [
        "潮湿的路面，路面上有水坑的倒影",
        "空气中弥漫着雾气",
        "背景中是绚丽的霓虹灯城市景观",
  ...
  "camera_and_style": {
    "camera_angle": "电影风格的低角度拍摄",
    "focus": {
      "subject_focus": "人物主体部分清晰度达到8K级别",
      "foreground": "前景部分故意模糊处理"
    },
    "color_grading": "温暖的路灯光与冷色调霓虹灯光相结合的柔和色调",
    "lighting": [
      "环境中的霓虹灯光",
      "温暖的街灯光",
      "水坑中的倒影"
