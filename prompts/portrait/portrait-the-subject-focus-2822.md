---
id: portrait-the-subject-focus-2822
title: "高定街头风动态摄影提示词"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: japanese-zen-garden
tags: ["女性", "黑白", "时尚", "潮流", "极简", "悬浮", "羽绒服", "针织帽"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
```json
{
  "subject_gender_placeholder": "[选择：女性]",
  "aesthetic_lodestar": "电影级奢华潮流编辑风格，严格单色，无影静止，深邃浓郁的黑色，单帧照片",
  "composition": {
    "frame": "极简受控影棚，临床般清晰明亮，极其动感的摄影机角度，从极具冲击力的低视角或高视角捕捉动作。无网格布局，主体聚焦于单一对象。",
    "background": "纯净、无缝、曝光过度到极致的白色无限虚空，完全没有地面或墙壁的阴影",
    "focus": "在运动中的整个主体上实现锐利深邃的对焦"
  },
  "subject_action": {
    "pose": "不可能的、反重力的空中扭曲和爆发性的腾空跳跃，在动作的绝对巅峰被定格，身体极度紧绷",
    "energy": "极致的运动张力与高级时装结构相结合，时间中悬浮的受控混乱，在虚空中创造出雕塑般、几乎令人难以置信的轮廓"
  },
  "wardrobe_styling": {
    "vibe": "创意街头时尚 x 前卫剪裁，不具挑衅性，干净且有冲击力的轮廓，搭配多层次穿搭",
    "garment_variations": [
      "开襟羊毛衫叠穿高品质 T 恤",
      "宽松针织衫和有结构感的休闲毛衣",
      "科技感飞行员夹克或棒球夹克",
    ...
    "brands_reference": ["Supreme", "Fear of God", "Maison Margiela", "Martine Rose", "UMBRO", "Aimé Leon Dore", "RHUDE", "Maison Kitsuné", "NikeLab", "Moncler", "Issey Miyake"],
    "accessories": {
      "general": "围巾、颈部头巾、从口袋垂下的佩斯利头巾（谨慎使用，适度点缀）",
      "womens_specific": "前卫风格包袋、Saint Laurent 结构感托特包或斜挎包、设计师棒球帽、卡车司机帽、高品质羊毛冷帽（仅当主体为女性时适用）",
      "details": "头饰仅佩戴在主体头部，不得佩戴在其他位置"
    },
    "key_details": "专注于单一的个性造型，避免过度臃肿，宽松剪裁与利落剪裁形成对比，突出品牌标识，通过纯粹的纹理而非阴影来呈现不同面料的重量"
  },
  "footwear_focus": {
    "models": ["Nike SB Dunk", "Off-White™ x Nike 解构款", "Converse Chuck 70 高级高帮款", "Vans Vault Slip-On", "Adidas Samba", "New Balance 327", "ASICS Onitsuka Tiger 运动鞋"],
    "details": "主体脚上唯一的物品，高度可见且一尘不染，构成动态动作的锚点"
  },
  "visual_color_treatment": {
    "base_spectrum": "纯粹、不妥协的黑白，带有超深、浓郁的黑色调",
    "blend_mode": "极致纹理的和谐融合"
  }
}
```
