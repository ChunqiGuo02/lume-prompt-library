---
id: portrait-not-slightly-real-2574
...
```json
{
  "meta": {
    "aspect_ratio": "9:16",
    "camera": "iPhone 15 Pro Max",
    "look": "真实的 iPhone 照片，抓拍，构图略有不完美"
  },
  "scene": {
    "location": "深夜湿漉漉的街道上的出租车停靠点（市中心）",
    "weather": "小雨，湿沥沥的柏油路面反光",
    "background": "柔和的散景路灯，远处有两名女性模糊的身影，没有男性",
    "vibe": "凌乱的自信，略带毒性，生人勿近的气场"
  },
  "lighting": {
    "type": "路灯 + 店面溢光 + 微妙的手机闪光灯",
    "feel": "忧郁但真实，非电影感，非影棚感"
  },
  "camera_perspective": {
    "shot_by": "一位女性朋友",
    "distance": "约 1 米",
    "angle": "略低",
    "framing": "大腿中部到头部，略微偏离中心，像真实的抓拍",
    "imperfections": "背景有轻微的运动模糊，阴影处有轻微噪点，轻微的曝光不匹配"
  },
  "subject": {
    "female": true,
    "age": "24 岁（明显成年）",
    "ethnicity": "随机（非特定）",
    "beauty_level": "像 Instagram 模特但真实",
    "hair": "深金色，松散的波浪，被雨水略微打湿",
    "expression": "斜视 + 微笑，下巴略微抬起",
    "makeup": "简约精致妆容，唇部有光泽，不过度",
    "pose": "一侧臀部向前，双肩放松，手机垂在身侧（屏幕不可见）",
    "outfit": {
      "top": "薄款罗纹长袖上衣，不透明，未穿胸罩（无肩带，无可见胸罩痕迹）",
      "bottom": "低腰黑色牛仔裤，褶皱自然真实",
      "shoes": "简约踝靴"
    }
  },
  "realism": {
    "skin": "自然肤质，细微毛孔，眼下有淡淡的纹理，一处小瑕疵可接受",
    "details": "几根飞散的头发，牛仔裤上轻微的绒毛，袖子上轻微的雨点痕迹"
  },
  "negative_prompt": [
    "男性",
    "裸露",
