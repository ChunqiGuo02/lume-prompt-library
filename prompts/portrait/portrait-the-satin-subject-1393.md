---
id: portrait-the-satin-subject-1393
title: "梅根·福克斯身着红色镶钻礼服亮相红毯，尽显优雅与性感。"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["红毯", "红色", "缎面", "礼服", "钻石", "珠宝", "性感", "优雅"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
version: "1.0.0"
related_to: ["portrait-blonde-satin-subject-001", "portrait-the-blonde-satin-001", "portrait-the-blonde-satin-002"]
---
...
    },
    "fashion": {
      "garment": "Pale {"dress color" "ice-blue"} custom satin gown open on a toned leg with fishnets",
      "design_details": [
...
```json
{
  "image_prompt_structure": {
    "subject": {
      "demographics": "女明星",
      "hair": "齐肩纹理波波头，发根深黑色，发梢蜂蜜金色波浪，蓬松造型",
      "face": "五官对称，蓝色眼睛，带飞翼眼线，眉毛修整，白皙皮肤，可见纹理和毛孔，裸色亮泽唇，柔和玫瑰色腮红",
      "pose": "正面站立，头部略微转向左侧，直视镜头，手臂自然垂于身体两侧",
      "expression": "沉着，自信，柔和的凝视，优雅"
    },
    "fashion": {
      "garment": "淡{\"dress color\" \"冰蓝色\"}定制缎面礼服，开衩露出健美腿部，搭配渔网袜",
      "design_details": [
        "深垂坠领口，镶水晶饰边",
        "细吊带",
        "露肩水晶镶嵌臂环/袖口",
    ...
    "environment": {
      "location": "红毯活动，背景为重复媒体墙",
      "background": "深海军蓝或黑色新闻墙，带有白色重复徽标（部分可见文字如 'KeorUnreal'），浅景深（散景）以突出主体"
    },
    "lighting": {
      "type": "专业活动闪光摄影",
      "qualities": "明亮正面照明，高对比度，缎面面料和水晶上的镜面高光，眼睛中有清晰的眼神光，极少阴影"
    },
    "technical_specifications": {
      "camera_gear": "Sony A7R V 配 85mm f/1.4 GM 镜头",
      "settings": "f/2.8 光圈，ISO 100，快门速度 1/200",
      "style_modifiers": [
        "超写实主义",
        "超细节",
        "8k 分辨率",
