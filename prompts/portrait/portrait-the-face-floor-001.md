---
id: "portrait-the-face-floor-001"
title: "超现实极简主义人像摄影创作"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["超现实", "极简", "人像", "写实", "冷色调", "浅蓝", "反射", "光线"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
## 中文译文（源站提供）
创作一张超现实极简主义的编辑肖像，以所附面部作为主要主体。精确保留所附面部——相同的比例、表情和超精细的写实主义。

人物侧卧在广阔空旷空间的光滑地板上，背景是柔和的渐变天空，从淡蓝色过渡到柔和的青色。一道明亮的线性光束直接穿过脸部下方的地板，以戏剧性的光芒照亮眼睛和鼻子。

灯光：高度风格化，柔和而有方向性——电影般的光束在脸部创造对比，而环境保持干净和极简。阴影微妙且漫射。

姿势：头部靠在地板上，身体逐渐融入阴影，眼睛睁开并直视镜头。

风格：Nano Banana 编辑超现实主义——超干净的构图、精确的灯光、极简的调色板、柔和的渐变、锐利的面部细节和提升的艺术氛围。

保持完整的构图：低机位视角、居中发光的线条、脸部从下方被照亮、宽敞空旷的背景和光滑的地板反射。

完美保留所附面部——超精细、写实且未作改动。
