---
id: portrait-the-face-rainy-2595
title: "雨日咖啡馆里的温柔静谧时光"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["女生", "雨天", "咖啡", "毛衣", "暖色调", "复古", "胶片", "慵懒"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
{
  "subject": {
    "description": "一位年轻女性，东亚面孔，年龄在十几岁末到二十出头。肤色白皙。她身体前倾，右手托腮，姿态放松而随意。",
    "expression": "柔和、轻盈的微笑，眼神直接而温暖地注视着观者。表情沉思而宁静。",
    "pose": "坐姿，手托着头，另一只手握着马克杯的把手。"
  },
  "clothing": {
    "top": "一件米白色或象牙色的宽松粗棒针麻花毛衣。面料看起来厚实、柔软且富有质感。"
  },
  "hair": {
    "color": "深棕色或黑色。",
    "style": "中等长度，蓬松微卷的波浪发。稀疏的刘海自然地垂落在额头，修饰着脸型。"
  },
  "face": {
    "makeup": "自然清透的“裸妆”效果。嘴唇和脸颊带有柔和的粉色调，眼部有微妙的修饰。"
  },
  "accessories": {
    "items": "一个简单的白色陶瓷马克杯，里面盛着一杯顶部有奶泡的热饮（拿铁或卡布奇诺）。"
  },
  "environment": {
    "setting": "在一个舒适的咖啡馆内，紧邻一扇大玻璃窗而坐。",
    "details": "雨滴密密麻麻地挂在窗玻璃上。透过玻璃，可以看到模糊的城市街景（雨天的灰色调）。主体人物身后，咖啡馆内部有温暖的木质护墙板和装裱好的海报或艺术品。",
    "weather": "下雨，阴天。"
  },
  "lighting": {
    "source": "自然、柔和的窗户光线从画面左侧射入。",
    "quality": "柔和而讨喜，在脸部和头发上形成柔和的高光，同时在右侧投下微妙的阴影。",
    "tone": "温暖而略带怀旧感，尽管窗外是凉爽的雨天。"
  },
  "camera": {
    "shot_type": "中景特写（头部和肩部）。",
    "focus": "焦点清晰地落在主体人物的眼睛和脸部。浅景深（散景）模糊了背景的室内和窗外的雨景街道。",
    "perspective": "平视视角，亲密感十足。"
  },
  "style": {
    "aesthetic": "胶片摄影风格（模拟风格），略带颗粒感，温暖的复古色彩分级。",
    "mood": "舒适、亲密、略带忧郁但又令人感到慰藉，充满“Hygge”氛围，电影般的日常生活片段。"
  }
}
```
