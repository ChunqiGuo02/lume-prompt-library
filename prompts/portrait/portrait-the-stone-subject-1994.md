---
id: portrait-the-stone-subject-1994
title: "罗马阳台上的优雅女性时尚写真"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["罗马", "礼服", "酒红色", "露台", "古建筑", "暖色调", "优雅", "氛围感"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
# 正文 prompt
{
  "image_description": {
    ...
    "subject": {
      "identity": "{"subject identity" "Sydney Sweeney"}",
      "pose": {
  ...
  "image_description": {
    "scene": {
      "location": {
        ...
        "details": "场景设置在一个经典的石质阳台上，可以一览无余地欣赏罗马的古老建筑、纪念碑和城市天际线。温暖的金色自然光在石头上投下柔和的阴影，突显了城市建筑的精巧细节。"
      },
      "environment": {
        "elements": [
          "带有华丽栏杆的石质阳台",
      ...
      "lighting": {
        "type": "自然日光",
        "effect": "光线柔和而清晰，以柔和的光芒突显建筑纹理和主体。阴影被柔化，营造出一种迷人而高雅的氛围。"
      }
    },
    "subject": {
      "identity": "{\"subject identity\" \"Sydney Sweeney\"}",
      "pose": {
        "description": "主体自信地站在石质栏杆旁，凝视着罗马的天际线。她保持着优雅而从容的姿态，展现出优雅和精致，微微的笑容暗示着自信和深思熟虑。"
      },
      "outfit": {
        "top": {
          "type": "结构化的束身衣式上衣",
          "color": "深红色",
          "style": "时尚杂志风格，现代而经典，旨在突显身材。束身衣具有鲜明、清晰的线条和干净、结构化的剪裁，与自然环境形成美丽的对比。"
        },
        "bottom": {
          "type": "高腰裙",
          "details": "这条裙子是高腰的，两侧有戏剧性的高开衩，赋予它前卫而精致的感觉。面料飘逸，突显了主体的女性魅力和现代优雅。"
        }
      },
      "hair_and_makeup": {
        "hair": {
          "style": "柔和的波浪",
          "details": "她的头发被造型成自然的柔和波浪，随意地垂落，为整体造型增添了动感和活力。波浪富有光泽，呈现出精致而随性的风格。"
        },
        "makeup": {
          "style": "精致自然",
          "details": "妆容通过微妙的修容和柔和的高光来增强她的自然美。她的眼睛用淡眼线勾勒，嘴唇涂着中性色调，营造出精致而永恒的造型。"
        }
      }
    },
    "composition": {
