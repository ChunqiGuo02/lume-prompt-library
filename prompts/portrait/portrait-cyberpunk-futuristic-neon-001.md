---
id: "portrait-cyberpunk-futuristic-neon-001"
title: "赛博朋克电影级侧脸特写"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["赛博朋克", "男性", "肖像", "特写", "写实", "蓝色", "紫色", "霓虹"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "16:9"
...
```json
{
  "Objective": "生成一张超现实的电影级特写侧面肖像，营造未来赛博朋克氛围，展现深刻的情感张力与戏剧性光影。",
  "Subject": {
    "Gender": "男性",
    "Age_Group": "青年",
    "Appearance": {
      "Facial_Structure": {
        "Jawline": "线条分明、轮廓清晰、极具雕塑感",
        "Skin": "超逼真的皮肤纹理，毛孔可见，细微瑕疵，自然高光"
      },
      "Expression": "专注、强烈、充满情感的凝视"
    }
  },
  "Lighting": {
    "Style": "赛博朋克电影级光效",
    ...
    "Colors": ["电光蓝", "霓虹洋红", "紫色辉光"],
    "Contrast": "高对比度，深邃阴影与发光高光并存"
  },
  "Camera": {
    "Shot_Type": "极致特写侧面肖像",
    "Lens": "85mm 电影级人像镜头",
  ...
  "Environment": {
    "Background": "抽象的未来城市灯光，模糊的霓虹招牌，赛博朋克氛围",
    "Mood": "黑暗、强烈、未来感、情感充沛"
  },
  "Quality": {
    "Resolution": "8K",
    "Rendering": "超细节、照片级真实感、电影级调色",
    "Style": "高端电影剧照、赛博朋克黑色电影风格"
  }
}
```
