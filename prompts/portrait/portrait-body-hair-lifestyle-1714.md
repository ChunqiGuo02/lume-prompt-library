---
id: portrait-body-hair-lifestyle-1714
title: "生成超写实生活风格女性肖像"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: industrial-loft
tags: ["女性", "人像", "写实", "摄影", "沙发", "皮革", "毛衣", "砖墙"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
```json
{
  ...
  "identity_lock": {
    "rule": "精确保留所有面部特征、身体比例、肤色、发色、发质和整体外观，与参考图像完全一致",
    "no_face_change": true,
    "no_body_change": true,
    "no_hair_change": true
  },
  "subject": {
    "description": "成年女性，面部特征柔美，比例自然，沉着自信",
    "expression": "放松、温暖、略带自信",
    "hair": "保留参考图像中的自然发型和发色",
    "skin": "逼真的皮肤纹理，毛孔可见，柔和自然的光泽"
  },
  "pose": {
    "position": "坐在或跪在皮沙发上",
    "posture": "放松的生活姿态，线条柔和，身体姿态自然",
    "hands": "轻柔地放在大腿或毛衣面料上",
    "gaze": "看向镜头或略微向下，表情平静"
  },
  "wardrobe": {
    "top": "柔软针织毛衣，舒适质感，中性浅色调",
    "bottom": "简约内衣或家居裤，中性色",
    "styling_rule": "雅致、非暴露、生活方式编辑风格的平衡"
  },
  "environment": {
    "location": "现代阁楼风格客厅",
    "elements": [
    ...
    "atmosphere": "平静、舒适、私密而精致"
  },
  "lighting": {
    "type": "自然窗光",
    "direction": "侧光",
    "quality": "柔和高光，轻柔阴影，逼真对比度"
  },
  "photography_style": {
    "genre": "生活方式时尚肖像",
    "focus": "主体清晰，背景柔和模糊",
    "color_tone": "暖中性色调，大地色系"
  },
  "negative_prompt": [
    "面部改变",
    "不同发色",
