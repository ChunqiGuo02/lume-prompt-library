---
id: portrait-celebrity-female-the-1278
title: "明星情侣在不同场景下的浪漫瞬间"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["拼贴", "分屏", "名人", "合影", "户外", "餐厅", "日落", "暖色调"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "16:9"
...
# 正文 prompt
{
  ...
  "left_panel": {
    "primary_subject_female": {
      "name": "{"female celebrity 1" "Sydney Sweeney"}",
    ...
    "primary_subject_male": {
      "name": "{"male celebrity 1" "Cristiano Ronaldo (Lookalike)"}",
  ...
  "right_panel": {
    "primary_subject_male": {
      "name": "{"male celebrity 2" "Elon Musk (Lookalike)"}",
    ...
    "primary_subject_female": {
      "name": "{"female celebrity 2" "Ana de Armas"}",
...
```json
{
  ...
  "left_panel": {
    "primary_subject_female": {
      "name": "{\"female celebrity 1\" \"Sydney Sweeney\"}",
      "hair": "金色长发，波浪卷",
      "expression": "真诚的灿烂笑容，露出牙齿",
      "clothing": "经典蓝色牛仔夹克，内搭浅色上衣",
      "pose": "身体向伴侣倾斜"
    },
    "primary_subject_male": {
      "name": "{\"male celebrity 1\" \"Cristiano Ronaldo (Lookalike)\"}",
      "facial_features": "黝黑的肤色，精心打理的发型，面带微笑",
      "clothing": "棕褐色麂皮飞行员夹克，米色圆领毛衣，深蓝色长裤",
      "accessories": "左手腕戴着奢华腕表"
    },
    "environment": {
      "location": "欧洲城市屋顶或阳台",
      "background_elements": ["鹅卵石街道", "历史建筑", "户外咖啡座", "铺有白色桌布的圆桌"],
      "lighting": "日落时分的金色光芒营造出温暖的氛围"
    }
  },
  "right_panel": {
    "primary_subject_male": {
      "name": "{\"male celebrity 2\" \"Elon Musk (Lookalike)\"}",
      "expression": "专注，低头看着移动设备",
      "clothing": "黑色正式商务套装，洁白衬衫",
      "action": "手持智能手机并进行操作"
    },
    "primary_subject_female": {
      "name": "{\"female celebrity 2\" \"Ana de Armas\"}",
      "hair": "深棕色，齐肩长发",
      "expression": "温柔的微笑，好奇地看向手机",
      "clothing": "黑色 V 领连衣裙，带有红白花卉图案",
      "accessories": "左手腕戴着细金手链"
    }
  },
  "environment": {
    "location": "高端现代摩天大楼内部",
    "background_elements": ["落地玻璃窗", "城市天际线与摩天大楼", "黄昏/夜晚氛围", "现代办公家具"],
    "lighting": "凉爽的蓝色环境暮光与室内温暖的灯光形成对比"
  },
  "technical_details": {
    "image_style": "高保真写实 AI 生成",
    "color_palette": "左侧为暖橙色和棕色；右侧为冷蓝色和黑色"
  }
}
```
