---
id: portrait-the-confident-gen-z-1669
title: "现代简约工作室拍摄，展现Gen-Z时尚女性自信优雅造型"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["现代", "时尚", "简约", "西装", "长裤", "眼镜", "项链", "灰色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
# 正文 prompt
{
  ...
  "environment": {
    "background": "Minimal, seamless studio backdrop in {"background color" "soft grey or off-white"} to keep all attention on her and the outfit.",
...
```json
{
  "scene_description": "一位时尚年轻女性的现代影棚拍摄，与参考图完全一致，散发着自信而随性的 Z 世代时尚气息。她的造型精致、引领潮流，自然而酷炫，这种风格既引人注目又不过分张扬。",
  "subject_details": {
    "appearance": "与参考图片中女性完全一致，表情平静自信，带着一丝微妙而放松的 Z 世代态度。",
    "clothing": "别致、时尚前卫的街头服饰，剪裁考究而版型宽松，多层次搭配（例如短款夹克或时尚西装外套内搭修身款上衣），高腰长裤或时尚半身裙，采用带有微妙纹理的优质面料，整体造型高端且紧随潮流。",
    "accessories": "简约而有格调的配饰，透明或时尚的现代眼镜，精致的珠宝（例如耳环或叠戴项链），以及在不显杂乱的情况下增添精致感的细节。",
    "pose": "自然的时尚大片姿势，重心略微偏向一侧，姿态放松，双手随意地插在口袋里或自然垂放，自信而随性的时尚杂志风格。",
  },
  "environment": {
    "background": "极简、无缝的影棚背景，颜色为 {\"background color\" \"柔和的灰色或米白色\"}，以将所有注意力集中在她和服装上。",
    "lighting": "柔和的漫射影棚光线，光线柔和过渡，细微的阴影，干净而略带情绪化的时尚大片灯光，以突出纹理和造型。",
  },
  "camera_settings": {
    "focus": "面部和造型细节清晰对焦，浅景深营造时尚前卫的肖像效果。",
    "composition": "中景或略微四分之三身肖像，偏离中心的构图营造现代时尚大片感。",
    "quality": "超高分辨率，精致的色调，平滑的纹理，专业的时尚杂志品质。",
  },
  "mood": "时尚、自信、现代的 Z 世代时尚活力，极简的影棚布景，具有强烈的时尚大片风格。"
}
```
