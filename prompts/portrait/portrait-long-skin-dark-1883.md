---
id: portrait-long-skin-dark-1883
title: "紫甲少女时尚特写"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["特写", "肖像", "少女", "美妆", "紫色", "美甲", "黑白", "条纹"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
## 中文译文（源站提供）
{
  "prompt": "这是一张超近距离拍摄的东亚年轻女性的肖像照：她拥有完美无瑕的瓷般肌肤、大而闪亮的深棕色眼睛（配着长长的睫毛）、淡淡的粉色腮红、光泽红润的嘴唇；一头长长的、直顺且丝滑的深棕色头发中还带有细微的挑染。她用双手做出一种俏皮的手指“框住”眼睛的姿势。她的指甲非常精致，呈杏仁形，涂有带有紫色大理石纹和银色铬质图案的美甲，上面点缀着细小的水钻。她穿着一件黑白条纹的宽松针织毛衣，毛衣的袖口带有罗纹设计；脖子上戴着多层精致的银色项链，项链上悬挂着水晶吊坠和小粉宝石。拍摄环境采用柔和的摄影棚灯光，背景为明亮洁白的纯色背景。整个画面呈现出高端时尚的美妆杂志风格，细节处理极为精细，肌肤质感完美且带有自然的光泽，景深较浅。照片使用85毫米镜头（f/1.4光圈）拍摄，具有超现实的逼真效果，分辨率为8K，堪称摄影杰作，画质质量一流。",
  "negative_prompt": "照片模糊、分辨率低；手部变形或出现多余的手指；某些手指缺失；人体结构显示不自然；指甲看起来很糟糕；化妆效果廉价；画面过度曝光或曝光不足；照片中包含文字、水印或品牌标志；画面效果类似卡通或3D渲染；皮肤看起来像塑料材质；面部轮廓不清晰；存在斗鸡眼现象；比例失调；整体给人一种幼稚或老气的印象。",
  "steps": 60,
  "cfg_scale": 7.5,
  "sampler": "DPM++ 2M Karras",
  "width": 832,
