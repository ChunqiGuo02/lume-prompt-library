---
id: "portrait-blonde-satin-subject-001"
title: "红毯女星优雅造型生成提示词"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["女明星", "红毯", "活动", "深蓝色", "黑色", "礼服", "钻石", "项链"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
version: "1.0.0"
related_to: ["portrait-the-blonde-satin-001", "portrait-the-blonde-satin-002", "portrait-the-satin-subject-001"]
---
...
```json
{
  "image_prompt_structure": {
    "subject": {
      "demographics": "女明星",
      "hair": "齐肩波波头，发根深金色，渐变为蜂蜜金波浪，蓬松凌乱风格",
      "face": "五官对称，蓝色眼睛，带飞翼眼线，眉毛修剪整齐，白皙皮肤，可见纹理和毛孔，裸色光泽唇，柔和玫瑰色腮红",
      "pose": "正面站立，头部略微向左转，直视镜头，手臂自然垂于身体两侧",
    ...
    "environment": {
      "location": "红毯活动，背景板",
      "background": "深海军蓝或黑色媒体墙，带有白色重复标志（部分可见文字如 'glaad'），浅景深（散景）以突出主体"
    },
    "lighting": {
      "type": "专业活动闪光摄影",
      "qualities": "明亮正面照明，高对比度，缎面织物和水晶上的镜面高光，眼睛中有清晰眼神光，极少阴影"
    },
    "technical_specifications": {
      "camera_gear": "索尼 A7R V 配 85mm f/1.4 GM 镜头",
