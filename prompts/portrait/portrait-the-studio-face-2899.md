---
id: portrait-the-studio-face-2899
title: "高级定制时装女性模特写真——自信优雅姿态"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["高级", "优雅", "自信", "女性", "长发", "影棚", "深色", "斜肩"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
# 正文 prompt
{
  "image_generation": {
    ...
    "subject": {
      ...
      "pose": {
        "primary": "one hand resting confidently on her hip",
...
## 中文译文（源站提供）
{
  "图像生成": {
    ...
    "面部与身体": {
      "保持原样": true,
      "参照匹配": true,
      "描述": "女性的面部和身体轮廓必须与上传的图像完全一致。不得对身份、比例或面部结构进行任何修改。",
    },
    "模特": {
      "描述": "一位迷人且自信的女性在摄影棚中摆姿势，表情优雅而引人注目。",
      "姿势": {
        "主要姿势": "一只手自信地放在臀部",
        "辅助姿势": "另一只手轻轻调整领带",
        "表情": "目光直视，优雅而自信"
      ...
      "发型": {
        "风格": "长发，颜色深沉，波浪卷曲，造型优雅",
        "效果": "表面光滑、有光泽，具有高级时尚质感"
      },
      "服装": {
        "类型": "单肩连体衣",
        "图案": "醒目的抽象黑白图案",
