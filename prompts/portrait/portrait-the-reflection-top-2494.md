---
id: portrait-the-reflection-top-2494
title: "镜中自拍：烛光晚餐的优雅与欢笑"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["复古", "餐厅", "暖色调", "氛围感", "优雅", "轻奢", "烛光", "晚装"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
version: "1.0.0"
related_to: ["interior-the-reflection-top-001", "interior-the-reflection-top-002"]
---
...
```json
{
  "prompt_details": {
    "subject": {
      ...
      "expressions": [
        "上图：含蓄自信的微笑，眼神直接与镜中倒影对视。",
        "下图：率真开心的笑声，双眼紧闭，头向后仰。"
      ],
      "attire": {
        "top_image": "黑色高领无袖上衣，精致简约。",
        "bottom_image": "黑色无肩带连衣裙，带有细微的闪光纹理（亮片或微光）。"
      },
      "accessories": [
        "精致的银色项链（网球链或类似款式）",
        "细款金/银手链",
    ...
    "environment": {
      ...
      "background_details": "背景中隐约可见其他用餐者，带流苏灯罩的复古台灯。"
    },
    "lighting": {
      ...
      "effect": "室内黄金时段色调，头发和皮肤上有柔和的高光，阴影浓郁。"
    },
    "camera_and_tech": {
      "style": "超写实，8k 分辨率，抓拍式生活摄影。",
      "camera_simulation": "智能手机后置摄像头（iPhone Pro 风格），大光圈（f/1.8）以获得景深。",
      "focus": "镜中主体对焦清晰，前景元素（酒杯柄、蜡烛）有柔和的散景效果。",
