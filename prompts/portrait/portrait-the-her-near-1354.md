---
id: portrait-the-her-near-1354
title: "暗黑高对比音乐海报设计"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["暗黑", "高对比", "海报", "肖像", "女性", "墨镜", "耳机", "黑白"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
## 中文译文（源站提供）
创作一张深色、高对比度的海报，营造出忧郁的地下俱乐部美学风格。构图以一位年轻女性的单色半身肖像为主，从略低的视角拍摄，以展现姿态和力量感。她戴着大型头戴式耳机和反光圆形太阳镜，暖琥珀金色的镜片在黑白肖像中显得格外醒目。一只手举在头部附近，另一只手靠近下巴，营造出一种与沉浸式音乐相关的动感、富有表现力的姿势。她的头部后方有一个巨大的扁平金黄色圆形，如同聚光灯一般，形成强烈的视觉焦点和对比。背景是深黑色，带有微妙的垃圾摇滚纹理、灰尘、划痕和海报磨损的瑕疵，赋予其一种原始的、印刷传单的感觉。使用 4:5 的宽高比。
