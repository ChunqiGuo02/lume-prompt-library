---
id: "portrait-for-the-blur-001"
title: "赛博美学肖像：蓝橙光影下的数字青春梦境"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["肖像", "蓝色", "渐变", "背景", "橙色", "白色", "T恤", "电影感"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
## 中文译文（源站提供）
根据输入照片，创作一张具有电影感、时尚大片风格的半身肖像，营造梦幻般的杂志氛围。使用多重曝光模糊效果，制造重影和垂直条纹。背景为蓝色渐变（从 #0033A0 到 #66CCFF），主体身穿一件宽松的白色 T 恤。运用高对比度照明（冷蓝色调 + 橙色/黄色边缘高光），营造未来感的光芒。表情：中性/内省，眼神柔和。模拟 50-85mm 镜头，f/1.8 光圈，景深较浅。通过运动模糊和色差分离增强效果，同时保持中心细节清晰。目标是营造一种超现实的数字青年氛围，融合极简主义和光影游戏。
