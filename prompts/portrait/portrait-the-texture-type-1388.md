---
id: portrait-the-texture-type-1388
title: "柔美少女风复古花卉裙写真"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["金发", "女性", "温柔", "淡黄色", "碎花", "短裙", "复古", "甜系"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
```json
{
  "prompt_type": "柔美娇俏 / 田园风时尚肖像",
  "subject": {
    "demographics": "年轻女性",
    "appearance": {
      "skin": "白皙至中等肤色，肤质光滑，带有柔和的自然光泽",
      "hair": "长款分层深金色 / 棕金色头发，带有较浅的挑染，造型为蓬松的波浪，柔和地修饰脸部",
      "face": "柔美女性化的五官，温柔的笑容，头部略微侧倾",
      "makeup": "自然“裸妆”魅力，玫瑰色脸颊，裸粉色双唇，睫毛分明"
    },
    "pose": {
      "stance": "俏皮站姿",
      "hands": "藏于身后",
      "body_language": "害羞而自信，甜美亲切"
    }
  },
  "fashion": {
    "garment": {
      "item": "复古风格碎花迷你连衣裙",
      "color_palette": "奶油黄色底色，点缀精致的白色和绿色碎花图案",
      "silhouette": "修身喇叭形 / 溜冰裙款式",
      "details": [
        "泡泡袖",
        "深 V 领口",
        "束身衣式紧身胸衣结构",
    ...
    "aesthetic": "娇俏风、田园风、甜美女孩风、公主风"
  },
  "environment": {
    "location": "经典奢华室内 / 酒店房间或精品店",
    "background_elements": {
      "walls": "奶油色墙壁，带有装饰性线条 / 护墙板",
      "curtains": "厚重及地的米色/金色窗帘，带有褶皱织物质感",
      "fixtures": "墙上可见白色电源插座（增加真实感）"
    },
    "atmosphere": "优雅、温馨、私密"
  },
  "lighting": {
    "type": "柔和的室内环境光",
    "quality": "漫射、柔美、暖色调",
    "direction": "来自窗户（靠近窗帘）的侧光"
  },
  "camera_settings": {
    "shot_type": "中景全身（大腿以上）",
    "perspective": "平视视角",
    "focus": "主体和连衣裙纹理清晰对焦",
    "depth_of_field": "景深略浅，将主体与墙壁分离"
  },
  "technical_details": {
    "resolution": "8k",
    "quality_tags": [
