---
id: portrait-festival-red-crochet-2757
title: "音乐节红发女子时尚写真，阳光下自信微笑"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["写实", "摄影", "音乐节", "红发", "红色", "针织", "流苏", "夏日"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
```json
{
  "prompt": "一位年轻女子，红色的卷发，面带微笑，自信地在户外音乐节上摆姿势，拍摄逼真的节日时尚肖像。她身穿红色钩针两件套，包括抹胸上衣、配套短裤和一件随风飘扬的流苏钩针长马甲。佩戴多层贝壳项链、银手镯和小型有色太阳镜。温暖的黄金时段阳光，湛蓝的天空。背景中大型户外音乐会舞台和人群柔和地虚化。充满活力、无忧无虑的夏日氛围。编辑级节日摄影，真实的皮肤纹理，自然的姿势。",
  "negative_prompt": "模糊、低分辨率、卡通、插画、绘画、过度处理、刺眼阴影、平坦光线、扭曲解剖结构、多余肢体、糟糕的手部、水印、文字、标志",
  "style": "写实摄影",
  "lighting": "自然黄金时段阳光",
  "camera": {
    "lens": "50mm",
