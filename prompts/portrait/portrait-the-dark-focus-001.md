---
id: "portrait-the-dark-focus-001"
title: "超写实8K电影感高角度群像，中心人物被闪光灯包围，展现明星与"
category: portrait
subcategory: "09_故事分镜角色设定"
aesthetic: null
tags: ["写实", "摄影", "明星", "人群", "闪光灯", "相机", "深色", "高对比"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
```json
{
  "prompt": "一张超现实、超精细的 8K 电影级照片，使用广角镜头从高角度俯视拍摄，直接向下看向密集、近乎圆形的 Crowd，营造出强烈的封闭感和聚光灯焦点。\n\n中心站着一位自信的男士，他身穿深色定制西装，内搭深色领衬衫，戴着圆形墨镜。严格使用上传的面部作为参考，以保留确切的身份和面部特征。他的右手朝向镜头举起，手掌向外，做出清晰的“停止”或“不听”手势，传达出权威和控制。\n\n他被一群紧密围绕的微笑女性完全包围，她们在他周围形成一个近乎完美的圆圈。这些女性身着深色、优雅或略带微光的晚礼服。她们的面部和肩膀密集地填充了中景，许多人看向中心的男士或直接看向镜头，增强了关注和混乱感。\n\n在画面底部的前景中，可以看到多名摄影师手持专业单反相机，相机配备大型外置闪光灯。闪光灯正在积极闪烁，对中心人物产生强烈、直接的正面照明。\n\n光线和氛围：戏剧性、高对比度的狗仔队式照明，面部和服装上有过曝的高光，一些人物有锐利的轮廓光，背景中有深邃、近乎黑色的阴影。光线强调了迷人而混乱的狗仔队狂热。\n\n视觉质量：主体对焦极其锐利，皮肤、织物、墨镜和相机设备具有超精细的纹理。电影级色彩分级，逼真的肤色，适当的浅景深，高端编辑摄影美学。",
  "negative_prompt": "低分辨率，模糊，柔焦，卡通，插画，CGI，扭曲的解剖结构，多余的肢体，多余的手指，褪色的颜色，平淡的照明，影棚设置，空背景，水印，标志，文字",
  "aspect_ratio": "2:3",
  "style": "超现实电影级",
  "lighting": "高对比度狗仔队闪光灯照明",
  "camera": "单反相机，广角镜头，高角度拍摄",
  "resolution": "8K",
  "quality": "超高"
}
```
