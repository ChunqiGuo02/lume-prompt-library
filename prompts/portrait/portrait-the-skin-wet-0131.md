...
## 中文译文（源站提供）
{
  "prompt_title": "超写实特写肖像（湿润的皮肤，黄金时刻）",
  "style_and_quality": {
    "rendering_style": "超写实特写",
    "resolution": "8K",
    "focus": "极浅的景深（DoF）",
    "aesthetic_effect": "极致细致的电影级效果，柔和的对比度，金色调和深邃的阴影"
  },
  "photography_equipment": {
    "camera": "哈苏H6D-400c",
    "lens": "100mm f/2.2镜头"
  ...
  "composition_and_framing": {
    "framing": "特写",
    "subject-placement": "仅拍摄面部的左侧",
    "key_focus_point": "眼睛处于绝对清晰的对焦状态，带有明亮的光晕"
  },
  "subject_details": {
    "model_gender": "女性",
    "facial_features_to_maintain": "忠实还原参考照片中的所有面部特征：浓密且轮廓分明的眉毛、长而湿润的睫毛",
    "skin_texture_emphasis": "微妙的纹理细节、毛孔、雀斑以及湿润皮肤的天然质感",
    "lips": "饱满的嘴唇，略微张开且湿润；通过定向照明突出其质感"
  },
  "water_and_texture": {
    "skin_covering": "皮肤上覆盖着自然流动的水滴",
    "highlights": "由于光线角度的作用，产生鲜艳的镜面反光；嘴唇和鼻子上也有湿润的反射光"
  },
  "lighting_setup": {
    "type": "模拟的温暖午后光线（黄金时刻）",
    "main_source": "大型侧置柔光箱",
    "fill_and_bounce": "结合使用金色反光板",
    "effect": "女性脸部的水面呈现出柔和而强烈的光泽，精准地突出了细微的纹理"
  },
  "hair_details": {
    "placement": "湿润的头发垂落在面部的右侧",
    "interaction": "头发紧贴皮肤，不会改变任何面部特征"
  }
}
