---
id: portrait-face-the-hyper-realistic-2215
title: "超写实女性肖像：深蓝荷叶边裙与暗调室内氛围"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["肖像", "写实", "女性", "人像", "长发", "棕发", "藏蓝", "连衣裙"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
## 中文译文（源站提供）
{
  "描述": "这是一张超写实的特写肖像，描绘了一位女性的面部和上半身。",
  "要求": {
    "面部精度": "女性的面部、眼睛和表情必须完全按照上传图片中的样子呈现，保留所有具体的面部特征和眼睛颜色，不得有任何改动。",
    "服装": {
      "套装": "一条飘逸的深蓝色连衣裙",
      "细节": "荷叶边袖子"
    },
