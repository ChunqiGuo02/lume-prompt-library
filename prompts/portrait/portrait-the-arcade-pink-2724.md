---
id: portrait-the-arcade-pink-2724
title: "青春少女骑粉色街机摩托，霓虹灯下活力四射"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["电玩城", "金发", "微笑", "粉色", "街机", "霓虹", "活力", "快乐"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
```json
{
  "prompt_structure": {
    "subject": {
      "appearance": "一位年轻女性，留着金色长卷发，面带灿烂的笑容，表情喜悦而充满活力。",
      "pose": "坐在粉色街机摩托车游戏机上，身体略微前倾，双手握住车把，身体侧向镜头，头部转向面对镜头。"
    },
    "attire": {
      "top": "无肩带橙色针织短款上衣（抹胸款式），带有做旧/破洞纹理，胸前有一条装饰性搭扣带。",
      "bottoms": "配套的紧身橙色短裤。",
      "accessories": "短裤上方露出带有黑色标志文字的白色 Calvin Klein 腰带。"
    },
    "environment": {
      "location": "室内游乐街机厅。",
      "foreground": "亮粉色“SUPER BIKES”街机赛车游戏机，配有逼真的摩托车座椅和仪表盘。",
      "background": "模糊的其他街机游戏机阵列，包括游戏屏幕和一块写有“Fly O'Clock”的霓虹灯牌。",
      "lighting": "充满活力的、高对比度的街机灯光，机器周围有主导的霓虹粉色 LED 灯带，背景是冷蓝色环境光。"
    },
    "style": {
      "aesthetic": "充满活力、俏皮和生动。",
      "color_palette": "饱和的橙色（服装）、霓虹粉、电蓝色和深色阴影。",
      "photography_style": "中景镜头，高闪光灯或明亮的环境照明，主体对焦清晰，背景景深较浅。"
    }
  }
}
```
