---
id: portrait-winter-facial-highlights-2676
title: "雪夜都市男性电影肖像"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["肖像", "冬天", "下雪", "夜晚", "城市", "男性", "胡茬", "围巾"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
# 正文 prompt
{
  ...
  "Wardrobe": {
    ...
    "Accessory": "{"accessory" "Thick knitted scarf"}",
...
```json
{
  "Objective": "创作一张超写实的电影级特写冬季肖像，营造出忧郁的都市氛围，同时平衡冷冽的冬日色调与温暖的城市灯光。",
  "Persona_Details": {
    "Subject": "年轻成年男性",
    "Facial_Features": {
      "Facial_Hair": "浅浅的胡茬",
    ...
    "Appearance_Interaction": {
      "Snow": "柔软的雪花自然地落在头发、围巾和外套上"
    }
  },
  "Wardrobe": {
    "Outerwear": "深色冬款大衣",
    "Accessory": "{\"accessory\" \"厚实针织围巾\"}",
    "Style": "经典、低调的冬季时尚"
  },
  "Scene_and_Environment": {
    "Location": "冬日夜晚的户外城市街道",
    "Atmosphere": {
      "Snowfall": "轻柔、持续的降雪",
      "Mood": "宁静、沉思、电影感"
    },
  ...
  "Lighting_and_Mood": {
    "Key_Light": "照亮面部的冷蓝色冬日光线",
    "Accent_Light": "路灯投射的温暖金色高光",
    "Contrast": "冷暖对比的电影级平衡",
    "Mood": "氛围感、亲密、情感上的沉思"
  },
  "Photography_Style": {
  ...
  "Response_Format": {
    "Type": "单张图片",
    "Aspect_Ratio": "肖像（推荐 4:5 或 3:4）",
    "Use_Case": "电影级肖像摄影、冬季专题、生活方式叙事"
  }
}
```
