---
id: portrait-true-reference-match-0698
title: "复古风格女性四格写真模板"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["复古", "浪漫", "温柔", "少女", "碎花", "蝴蝶结", "花束", "拼贴"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
version: "1.0.0"
related_to: ["interior-true-reference-match-002"]
---
...
```json
{
  "image_prompt": {
    ...
    "composition": {
      "layout": "2x2 拼贴",
      "aspect_ratio": "1:1",
      "pose_matching": "精确匹配参考图像的姿势、角度、构图和身体朝向",
      "no_variation_allowed": true
    },
    "panel_1": {
      "view": "正面肖像",
