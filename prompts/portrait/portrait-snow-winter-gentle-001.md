---
id: "portrait-snow-winter-gentle-001"
title: "冬日雪地艺术写真"
category: portrait
subcategory: "04_创意脑洞特效合成"
aesthetic: null
tags: ["冬季", "雪", "素描", "熊猫", "女性", "浅绿", "温柔", "宁静"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
# 正文 prompt
Which two colors of the rainbow are your favorite ? 🌈
{
"scene": {
"setting": "winter",
"environment": {
...
## 中文译文（源站提供）
{
  "场景": {
    ...
    "环境": {
      "地面": "纯白色的雪",
      "光线": "自然的冬季日光，柔和且分散，光线柔和，没有强烈的明暗对比",
      "氛围": "安静、宁静、富有诗意、梦幻般、充满怀旧感，具有柔和的冬日宁静感",
      "色彩调色板": ["白色", "浅灰色", "淡绿色"]
    }
  },
  "主体": {
