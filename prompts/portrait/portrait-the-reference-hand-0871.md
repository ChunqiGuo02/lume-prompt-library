---
id: portrait-the-reference-hand-0871
title: "奢华睡衣写真：深粉缎面睡裙配真丝浴袍，浪漫私密氛围"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["女性", "金发", "微笑", "酒红", "睡裙", "睡袍", "丝绸", "蕾丝"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
```json
{
  "image_generation_request": {
    ...
    "subject_details": {
      "identity": {
        "reference": "参考图片中的一位女性",
        "fidelity": "严格保持面部特征 (100% 相似度)",
        "demographics": "成年女性"
      },
      "physical_attributes": {
        "hair": {
