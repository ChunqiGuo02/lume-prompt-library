---
id: portrait-the-mediterranean-slightly-0580
title: "地中海奢华夏日写真：红发美人临海回眸"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["写实", "红发", "海岸", "暖阳", "海洋", "城镇", "丝绸", "灰色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
# 正文 prompt
{
  "image_generation_data": {
    ...
    "aspect_ratio": "9:16",
    "subject": {
      "appearance": "Hyper-realistic portrait of {"celebrity name" "Sadie Sink"}, slender yet graceful build, fair skin with a subtle freckled glow, expressive blue eyes, soft facial features. Fiery red hair styled in loose, slightly tousled waves with a natural sunlit sheen.",
    ...
    "attire_details": {
      "upper_body": "Silk camisole in deep {"attire color" "charcoal grey"}, ultra-fine fabric with soft sheen, delicate thin straps, slightly draped neckline subtly revealing collarbone and décolletage.",
...
{
  "image_generation_data": {
    "title": "奢华地中海夏日美学 – 萨迪·辛克（精致性感版）",
    "style_preset": "电影级写实 / 阳光",
    "aspect_ratio": "9:16",
    "subject": {
      "appearance": "超写实肖像，人物为 {\"celebrity name\" \"萨迪·辛克\"}，身材苗条而优雅，皮肤白皙，带有淡淡的雀斑光泽，富有表现力的蓝色眼睛，柔和的面部特征。一头火红的头发，造型为蓬松微乱的波浪，带有自然的阳光光泽。",
      "pose_lock": "轻松地坐在石阶上，身体略微侧向一边，以突出自然曲线，躯干轻微扭转，头部猛地转向肩膀，直视镜头。",
      "expression": "柔和自信的微笑，带有一丝挑逗，双唇微启，眼睛因地中海明亮的阳光而略微眯起，性感而毫不费力。"
    },
    "attire_details": {
      "upper_body": "深 {\"attire color\" \"炭灰色\"} 丝质吊带衫，超细面料，带有柔和光泽，精致的细肩带，略微垂坠的领口，巧妙地露出锁骨和胸部。",
      "lower_body": "配套的深灰色高腰阔腿裤，剪裁合身，突出腰部和臀部线条，优雅流畅。",
      "accessories": "结构化的意式浓缩咖啡棕色皮革单肩包靠在臀部，中等大小的金色环形耳环，细金手链和戒指，简约而奢华。"
    },
    "environment_lock": {
      "location": "俯瞰地中海的海岸露台，阿马尔菲海岸。",
      "foreground": "古老的石墙，垂挂的绿色常春藤轻轻拂过她的手臂。",
      "background": "晶莹剔透的蓝色海洋，远处色彩斑斓的海岸房屋因大气景深而柔和，湛蓝的天空。",
      "lighting": "强烈的地中海自然晨光，在皮肤上形成温暖的高光，微妙的明暗对比塑造颧骨和肩膀，逼真的阳光眯眼和光晕。"
    },
    "technical_specs": {
      "camera": "齐眼高度中景，35mm 镜头，呈现自然透视。",
      "quality": "8K UHD，超高保真，可见自然的皮肤纹理，细微雀斑，逼真的织物垂坠感，电影级色彩分级。",
      "full_prompt": "超写实电影级肖像，萨迪·辛克坐在俯瞰阿马尔菲海岸的石阶上，身体略微扭转以突出自然曲线，头部转向肩膀。她带着柔和、自信、略带诱惑的微笑看向镜头，双唇微启，眼睛在地中海明亮的阳光下眯起。火红的头发自然发光。身穿深炭灰色丝质吊带衫，配有精致肩带和柔和垂坠的领口，搭配配套的高腰阔腿裤，配以金色首饰和意式浓缩咖啡棕色皮革包。强烈的地中海自然晨光，晶莹剔透的蓝色海洋，带有常春藤的古老石墙，电影级写实，35mm 镜头，清晰的面部对焦，超细节的自然皮肤纹理，"
    }
}
```
