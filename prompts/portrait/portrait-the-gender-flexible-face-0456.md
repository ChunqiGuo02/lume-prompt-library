---
id: portrait-the-gender-flexible-face-0456
title: "双屏咖啡奇幻场景：蒸汽穿越屏幕，咖啡精准入杯"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["超写实", "显示器", "咖啡", "蒸汽", "暖色调", "温馨", "错觉", "男人"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
## 中文译文（源站提供）
超现实的 8K 电影级艺术作品，描绘了木桌上两台垂直堆叠的电脑显示器（一台在另一台之上）。上方显示器中，一个角色（性别灵活，面部与上传照片完全一致，头饰相同）身穿休闲海军蓝服装（性别灵活款式），无需手持咖啡杯，正在从法式滤压壶中倒出热气腾腾的咖啡。下方显示器中，同一个角色（性别灵活，面部与上传照片完全一致，头饰相同）——此时身穿白色衬衫和黑色夹克（性别灵活款式）——惊讶地将咖啡杯向上倾斜，咖啡完美地流入杯中。咖啡蒸汽在两台显示器之间视觉上上升，将两个场景连接起来。温暖的咖啡馆风格灯光和柔和的木质纹理营造出舒适的氛围。负面提示词：“模糊的脸部、扭曲的比例、重复的身体部位、不匹配的配饰、不匹配的性别特征、多余的肢体、多余的手指、扭曲的解剖结构、糟糕的灯光、水印、文字、低分辨率、不真实的衣物褶皱、不一致的头部形状、上方显示器中的角色手持咖啡杯、错误的脸部、错误的头发、错误的头部配饰。” 3:4 比例
