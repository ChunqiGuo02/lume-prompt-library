---
id: "portrait-frame-the-angle-001"
title: "2x2网格多角度人物创意摄影提示"
category: portrait
subcategory: "09_故事分镜角色设定"
aesthetic: null
tags: ["网格", "涂鸦", "人像", "摄影", "搞怪", "深红", "深蓝", "白色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "16:9"
...
## 中文译文（源站提供）
创建一个 2x2 网格图像。每个画面中包含一个中景镜头、一个特写镜头、一个俯视的高角度镜头，以及一个从运动鞋向上看的超低角度镜头。每个画面都使用鱼眼镜头透视效果，并采用具有透视缩短效果的唯美姿势。角色穿着深红色飞行员夹克、蓝色牛仔裤和白色 Nike 高帮运动鞋，每个画面都摆出不同的搞怪面部表情。每个画面中，角色周围都包含白色涂鸦手绘元素。在深蓝色背景下进行影棚拍摄。确保背景覆盖整个画面，没有圆形构图。
