---
id: "portrait-neon-glass-the-001"
title: "雨夜霓虹电话亭中的孤独女子写实肖像"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["雨夜", "霓虹", "电话亭", "风衣", "香烟", "女性", "孤独", "忧郁"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
# 正文 prompt
{
  ...
  "subject": {
    ...
    "wardrobe": {
      "outerwear": "oversized {"coat color" "beige"} trench coat, slightly worn texture, damp edges from rain",
...
```json
{
  "prompt_name": "霓虹雨夜电话亭黑色电影",
  "type": "photo_realistic",
  "aspect_ratio": "4:5",
  "scene": {
    "location": "夜晚下雨的城市街道",
    "setting_detail": "人行道边缘的一个玻璃电话亭，湿漉漉的路面反射着霓虹灯招牌",
    "weather": "细雨绵绵，雨滴在玻璃上划出痕迹，水坑和倒影",
    "background": "柔和的散景城市灯光，模糊的车尾灯，远处霓虹闪烁的餐馆招牌发出红蓝光芒",
    "mood": "新黑色电影风格，孤独，电影般的张力，安静的悲伤"
  },
  "subject": {
    "description": "一位年轻女子站在电话亭内，身体微微靠着玻璃板",
    "expression": "疲惫而疏远，空洞的眼神，微妙的忧郁",
    "pose": "一侧肩膀向前，头微微向下倾斜，透过被雨水模糊的玻璃望向镜头",
    "hands": "一只手举着香烟靠近脸部",
    "wardrobe": {
      "outerwear": "宽大的 {\"coat color\" \"米色\"} 风衣，略显磨损的质感，被雨水打湿的边缘",
      "innerwear": "风衣下隐约可见的深色上衣",
      "styling_notes": "极简，沉稳，真实的街头风格"
    },
    "hair": "凌乱湿润的头发，略微贴在前额和脸颊上，自然蓬松",
    "skin_detail": "自然的毛孔，眼下有淡淡的阴影，没有浓妆",
    "smoke": "细细的香烟烟雾向上飘散，微妙而真实"
  },
  "composition": {
    "framing": "中景肖像，腰部以上",
    "camera_angle": "平视视角",
    "subject_position": "画面右侧，利用电话亭的框架作为强烈的垂直引导线",
    "foreground_elements": "玻璃反光，雨滴在窗户某些部分清晰可见",
    "depth_of_field": "浅景深，主体清晰，背景霓虹灯严重模糊",
    "negative_space": "左侧是雨中的街道，霓虹灯散景，电影般的留白空间"
  },
  "camera_and_lens": {
    "camera_type": "电影级全画幅数码相机",
    "lens": "50mm 定焦镜头",
    "aperture": "f/1.8",
    "shutter_speed": "1/200",
    "iso": "2000",
    "focus": "主体眼睛和面部清晰，通过玻璃呈现受控的柔和度"
  },
  "lighting_and_color": {
    "lighting_style": "霓虹实用照明与路灯溢光混合",
    "key_light": "来自外部反射的柔和冷蓝色光",
    "fill_light": "脸颊和风衣边缘微弱的暖红色霓虹反弹光",
    "color_palette": "深蓝色，洋红色/红色霓虹点缀，柔和的肤色，深色阴影",
    "contrast": "中高对比度，高光平滑过渡",
    "reflections": "湿漉漉的地面反光，霓虹光芒在玻璃板上反射"
  },
  "realism_and_texture": {
    "texture_priority": [
      "玻璃上的雨滴",
