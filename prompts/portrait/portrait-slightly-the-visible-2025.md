---
id: portrait-slightly-the-visible-2025
title: "自然光下慵懒卷发少女黑白肖像"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["黑白", "人像", "女性", "卷发", "吊带", "室内", "窗边", "慵懒"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
version: "1.0.0"
related_to: ["landscape-slightly-the-visible-002", "landscape-slightly-the-visible-003"]
---
...
# 正文 prompt
{
  "image_generation_prompt": {
    ...
    "apparel_and_styling": {
      "clothing": "Black spaghetti strap camisole top, V-neck, minimalist style",
    ...
    "technical_specs": {
      "medium": "Black and white photography, monochrome",
...
```json
{
  "image_generation_prompt": {
    "subject_details": {
      ...
      "hair": "纹理感 {\"hair color\" \"金色\"} 卷发，梳成凌乱的发髻/丸子头，脸部周围有松散的细发和碎发，逆光下的飞发",
      "face": "自然的皮肤纹理，鼻部和脸颊有明显的雀斑，高颧骨，浓密上扬的眉毛，丰满的嘴唇，清晰的下颌线，淡雅的自然妆容",
      "gaze": "直视镜头，柔和迷人的表情，嘴唇微张，神态平静"
    },
    "apparel_and_styling": {
      "clothing": "黑色细吊带背心，V 领，极简风格",
      "accessories": "无可见配饰",
      "styling": "不费力的，‘刚睡醒’的审美，休闲时尚"
    },
    "pose_and_composition": {
      "type": "特写肖像，自拍角度",
      "framing": "头部和肩部，居中构图",
      "posture": "肩膀略微倾斜，颈部修长，锁骨可见，头部轻微倾斜"
    },
    "environment_and_background": {
      "setting": "室内，窗户附近的居家环境",
      "backdrop": "带有垂直褶皱的轻薄纹理窗帘，柔软的织物细节",
      "depth": "浅景深，背景略微失焦以突出主体"
    },
    "lighting_and_atmosphere": {
      "type": "柔和的自然窗户光线（漫射）",
      "direction": "正面打光，略带侧光倾向",
    ...
    "technical_specs": {
      ...
      "lens": "35mm 焦距（适合肖像，但对于自拍感略宽）",
      "aperture": "f/2.8",
      "film_grain": "增加细微的胶片颗粒纹理以增加真实感",
      "quality_tags": [
        "超写实",
        "8k 分辨率",
        "高度细致的皮肤毛孔",
