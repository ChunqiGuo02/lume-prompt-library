---
id: portrait-street-city-night-2589
...
```json
{
  "Objective": "创作一张电影感的街头抓拍照片，捕捉霓虹闪烁的城市夜晚中一个宁静而富有情感的瞬间",
  "PersonaDetails": {
    "Subject": {
      "Type": "年轻女性",
      "Pose": "站在拥挤的街道上，头转向身后",
  ...
  "SceneDescription": {
    ...
    "Atmosphere": "忧郁、沉思、都市夜间的活力"
  },
  "Composition": {
    "Framing": "半身抓拍构图",
    "Moment": "非摆拍，捕捉转身瞬间",
    "DepthOfField": "浅景深",
    "Focus": "主体清晰，前景和背景柔和模糊"
  },
  "LightingAndColor": {
    "Lighting": "低光环境下的城市照明",
    "NeonInfluence": "柔和的霓虹灯光洒在主体上",
    "ColorGrading": "青色和橙色的电影级调色",
    "SkinTones": "自然逼真"
  },
  "EnvironmentalEffects": {
    "Rain": "可见的雨丝和雨滴",
    "Reflections": "湿润路面上的散景反射",
    "Glow": "微妙的霓虹光晕和光溢"
  },
  "PhotographyStyle": {
    "Genre": "电影感街头摄影",
    "Aesthetic": "电影剧照般的真实感",
    "LensLook": "85mm 镜头视角",
    "CameraConditions": "低光夜间摄影",
    "DetailLevel": "超细节、照片级真实感"
  },
  "Mood": {
    "Tone": "宁静、情感丰富、忧郁",
    "Energy": "梦幻而又扎根于现实的都市感"
  },
  "NegativePrompt": [
    "白天",
    "摆拍肖像",
