---
id: portrait-the-her-motion-1438
title: "橙色背景下的女性侧影动态肖像，电影感与时尚美学融合"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["女性", "肖像", "侧颜", "橙色", "深灰", "动态模糊", "胶片感", "影棚"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
## 中文译文（源站提供）
一张平移拍摄的神秘女性侧面肖像，她的头部略微向前转动，动感模糊柔和地掠过她的头发和下颌线。她身穿一件边缘柔和的哑光炭灰色羊毛大衣，背景是完全充满画面的纯色 Pantone 137 C 橙色。图像通过慢速快门平移呈现出刻意的水平运动模糊，在保留面部结构的同时，使周边区域产生涂抹感。柔和的影棚灯光，带有柔和的高光、低对比度和提亮的黑色，营造出一种褪色的模拟胶片效果，带有细微的颗粒和柔和的饱和度。使用全画幅相机，50mm 镜头，f/2.8 光圈，ISO 200，快门速度 1/15s 拍摄，垂直构图，紧凑的肖像画幅，浅景深。整体氛围电影感十足，内省，并带有与 032c 和 A24 审美相符的现代编辑视觉语言。
