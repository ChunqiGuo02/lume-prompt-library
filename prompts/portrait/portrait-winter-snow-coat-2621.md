---
id: portrait-winter-snow-coat-2621
title: "雪地优雅女性时尚写真提示词预设"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["冬季", "雪地", "户外", "降雪", "女性", "优雅", "驼色", "大衣"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
```json
{
  ...
  "subject": {
    "gender": "女性",
    "identity": "优雅的普通女性，非特定人物",
    "pose": "一只腿重心转移，姿态优雅",
    "body_language": "沉着、放松、自信",
    "expression": "平静、优雅、沉着",
    "gaze": "略微偏离镜头或柔和地直视"
  },
  ...
  "outfit": {
    ...
    "coat_fit": "结构感强且飘逸",
    "footwear": "及膝长款皮靴",
    "leg_visibility": "大衣下摆下方可见小腿",
    "color_palette": "中性冬季色调，米色、灰色、黑色"
  },

  "styling": {
    "hair": "长发或中长发，随微风轻柔摆动",
    "makeup": "自然冬季柔和光泽妆容",
    "accessories": "极简，无分散注意力的元素"
  },

  "lighting": {
    "type": "柔和漫射自然光",
    "direction": "阴天，光线均匀",
    "highlights": "大衣和头发上微妙的冷色高光"
  },

  "aesthetic": {
    "style": "高级时装杂志风格",
    "mood": "优雅、宁静、永恒",
    "color_grading": "冷白色、柔和蓝色、柔和对比度",
    "realism": "超写实"
  },

  "quality": {
    "resolution": "超高分辨率",
    "details": "面料纹理清晰可见，雪花颗粒分明",
    "noise": "无噪点",
    "artifacts": "无伪影"
  }
}
