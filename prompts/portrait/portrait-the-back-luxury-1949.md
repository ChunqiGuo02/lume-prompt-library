---
id: portrait-the-back-luxury-1949
title: "红裙佳人持玫瑰，古典雅致显奢华"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["红色", "礼服", "玫瑰", "中式", "家具", "女性", "浪漫", "奢华"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
# 正文 prompt
{
  ...
  "visual_composition": {
    ...
    "environmental_props": {
      "primary_prop": "Round luxury box of {"flower color" "red"} roses",
...
```json
{
  "image_metadata": {
    "title": "浪漫奢华",
    "subject_identity": "我上传的人物",
    "aspect_ratio": "3:4",
    "aesthetic_category": "精心策划的奢华 / 戏剧性浪漫"
  },
  "visual_composition": {
    "subject_pose": {
      "body_position": "坐着/身体前倾",
      "head_orientation": "头转向相机",
      "interaction": "打破第四面墙 / 直接眼神接触",
      "expression": "俏皮、自信、心领神会的互动"
    },
    "wardrobe_details": {
      "garment": {
        "type": "{\"garment type\" \"红色连衣裙\"}",
        "color_profile": "鲜艳 / 热情",
        "construction": "露背设计，腰部和臀部有褶皱",
        "texture": "流畅、优雅的动感"
      },
      "adornments": {
        "material": "精致的金色链条首饰",
        "placement": "披在肩部和脊柱上",
        "visual_style": "仪式感、建筑感"
      }
    },
    "environmental_props": {
      "primary_prop": "圆形奢华礼盒，内含 {\"flower color\" \"红色\"} 玫瑰",
      "floral_characteristics": "紧密、重复的形态；密集的排列",
      "symbolic_weight": ["欲望", "奉献", "丰盛"]
    }
  },
  "thematic_analysis": {
    "psychological_layers": {
      "vulnerability": "通过露背设计展现的脆弱性",
      "agency": "通过受控的姿势和凝视，将脆弱性重新定义为力量",
      "intent": "刻意的奢华而非偶然的美丽"
    },
    "visual_contrasts": [
      {
        "element_a": "有机流动性（面料和皮肤）",
        "element_b": "几何重复性（玫瑰和链条）"
      }
    ]
  },
  "artistic_direction": {
    "lighting": "柔和的光线，突出背部和首饰的轮廓",
    "styling": "整洁的发型，精致的妆容",
    "audience_role": "从观察者转变为参与者"
  }
}
```
