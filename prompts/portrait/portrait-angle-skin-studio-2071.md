---
id: portrait-angle-skin-studio-2071
title: "英雄戏剧风影棚人像写真预设"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["棚拍", "人像", "写实", "戏剧感", "暖色调", "橙色", "红色", "女性"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
version: "1.0.0"
related_to: ["portrait-angle-skin-studio-001", "portrait-angle-skin-studio-002"]
---
...
```json
{
  "meta": {
    ...
    "aesthetic": "戏剧化、色彩饱和的影棚布光，营造英雄气概"
  },
  "constraints": {
    "identity_anchor": {
      "source": "所附参考照片",
  ...
  "subject_details": {
    "expression": "严肃、紧张、专注",
    "gaze": "视线离开镜头，望向上方空间",
    "universality": "布光和角度适用于任何性别"
  },
  "composition": {
    "background": "饱和的纯橙红色背景，平滑强烈的渐变，无图案，营造“炽热”氛围",
  ...
  "combined_prompt_text": "世界级杂志肖像，戏剧化影棚布光，英雄气概。[保留参考照片身份]：精确的面部特征、肤色、发型。[服装完全匹配]：合身度和材质无任何改动。表情：严肃、紧张、专注，向上并向远处看。背景：饱和的纯橙红色，平滑强烈的渐变，炽热氛围。相机角度：低角度从下方拍摄以营造主导感。构图：中景特写。布光：明亮的橙色和深红色调，强烈的定向明暗对比主光，将主体与背景分离的强大轮廓光。技术：照片写实主义，高细节，面部锐利对焦，自然的皮肤纹理和毛孔。"
}
```
