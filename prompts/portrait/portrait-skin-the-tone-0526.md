---
id: portrait-skin-the-tone-0526
title: "四位年轻女性身着巴萨球衣球场合影"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["足球", "巴萨", "球衣", "球场", "女性", "青春", "金饰", "暖色调"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
version: "1.0.0"
related_to: ["landscape-skin-the-tone-002"]
---
...
```json
{
  ...
  "attire": {
    "tops": "搭配的 {\"team jersey\" \"巴塞罗那足球队球衣 (2023-2024 赛季主场球衣)\"}",
    "bottoms": [
      "浅蓝色宽松工装牛仔裤",
      "白色长裤"
    ],
    "accessories": {
      "jewelry": "金色大耳环、金色项链、金色腕表、金色手镯",
      "bags": "复古风格棕色皮革单肩包，带前置多功能口袋、银色铆钉细节和链条肩带（由前景中的女性手持）"
    }
  },
  "poses_and_expressions": {
    "foreground_left_woman": "俏皮地眨眼，嘴巴张开呈大笑状，左手举起胜利手势（V 字手势），身体前倾",
    "foreground_right_woman": "盘腿或放松地坐着，笑容灿烂，直视镜头，双手放在膝盖上",
    "background_left_woman": "笑容温暖，略微坐在前景人物身后，手臂搭在另一人的肩膀附近",
    "background_center_woman": "站在或坐在人群的最高点，温柔地微笑，头部略微倾斜"
  },
  "environment": {
    "location": "现代足球场看台（可能是 {\"stadium name\" \"圣地亚哥·伯纳乌球场\"}）",
    "details": "一排排空置的深蓝色塑料体育场座椅，背景是玻璃安全护栏，混凝土台阶",
  ...
  "technical_specs": {
    "resolution": "4K 超高清",
    "aspect_ratio": "9:16",
    "style": "抓拍的网红社交媒体照片，高保真，对焦锐利，色彩鲜艳，电影级景深",
    "camera_settings": "高速快门，大光圈 (f/2.8) 以轻微虚化背景"
  }
}
```
