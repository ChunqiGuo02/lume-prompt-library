---
id: portrait-true-the-storm-2766
title: "风暴海岸上的历史浪漫抉择瞬间"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["爱情", "情侣", "海边", "风暴", "冷色调", "电影感", "浪漫", "悬崖"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
# 正文 prompt
{
  "generation_request":{
    ...
    "creative_prompt":{
      "scene_summary":"Late Ottoman era, a dramatic natural coastline near {"location" "Istanbul"} as a sudden storm approaches.",
...
```json
{
  "generation_request":{
    ...
    "creative_prompt":{
      "scene_summary":"奥斯曼帝国晚期，在 {\"location\" \"Istanbul\"} 附近戏剧性的自然海岸线上，一场突如其来的风暴正在逼近。",

      "foreground_story":"强风吹拂着他们的衣衫和头发。男人略微站在女人身前，一只手臂保护性地环绕着她的肩膀。她一只手紧紧抓住他的外套前襟，另一只手靠在他的胸前。他们深情地凝视着彼此的眼睛，神情严肃而平静——这是一个决定的时刻。没有恐惧，只有决心和信任。",

      "background_story":"博斯普鲁斯海峡上空乌云迅速聚集。海浪拍打着下方的岩石。一艘远处的渔船在风中挣扎，随后掉头驶向岸边。鸟儿四散飞向天空。大自然骤然变化，要求采取行动。",

      "wardrobe":"奥斯曼帝国晚期适合恶劣天气的户外服装——长款外套和多层羊毛面料，完全保守，质地厚重，深色大地色和深海军蓝色调。衣服随风明显摆动。",

      "jewelry_hair_nails":{
        "female":{
          "hair":"部分遮盖或紧紧盘起，发丝随风飘动",
          "nails":"短而自然，干净，无指甲油",
          "jewelry":"极少或没有，仅限符合时代特征的饰品"
        },
        "male":{
          "jewelry":"无"
        }
      ...
      "camera":"85mm 电影人像镜头，中近景构图，面部和手部清晰对焦，风暴柔化背景",

      "lighting":"阴沉的风暴光线，面部有柔和的方向性高光，微妙的对比，无强烈阴影",

      "color_palette":"冷色调的风暴蓝和灰色与温暖自然的肤色形成对比",
