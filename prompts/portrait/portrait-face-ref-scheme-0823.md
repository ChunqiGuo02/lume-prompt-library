---
id: portrait-face-ref-scheme-0823
title: "大唐贵妃巴黎封面大片"
category: portrait
...
Scheme G（石青/翠绿底）： 底色：{"底色1" "翠绿/石青"}（常用的间色） 刺绣/印染：茜红、金色、橘黄、米白 Scheme A（牡丹红底）： 底色：{"底色2" "牡丹红/石榴红"}（最经典的唐风） 刺绣/印染：金色、翠绿、宝蓝、紫 Scheme R（紫底）： 底色：{"底色3" "紫/葡萄色"}（高贵） 刺绣/印染：金色、朱红、草绿、银
