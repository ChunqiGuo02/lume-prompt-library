---
id: portrait-skin-the-stone-2540
title: "阳光花园中白裙美女写真构图指南"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: biophilic
tags: ["金发", "白色", "短裙", "美女", "户外", "花园", "石栏", "绿植"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
version: "1.0.0"
related_to: ["landscape-skin-the-stone-001"]
---
...
    },
    "clothing": {
      "item": "{"clothing item" "White mini corset dress"}",
      "details": [
...
```json
{
  "prompt_structure": {
    "subject": {
      "description": "20 多岁的年轻女性，拥有被阳光亲吻的肌肤和随风轻柔飘扬的金色波浪长发",
      "skin": "白皙肤色",
      "facial_features": "五官对称，淡妆，高光闪耀，裸色亮泽唇，眉毛清晰，目光锐利直视镜头",
      "body": "健美身材，锁骨清晰可见"
    },
    "clothing": {
      "item": "{\"clothing item\" \"白色迷你紧身胸衣连衣裙\"}",
      "details": [
        "荷叶边肩带",
        "褶皱紧身胸衣式上身",
        "泡泡裙摆",
      ...
      "accessories": "精致珍珠项圈，小耳钉，左手腕戴细手链"
    },
    "pose_and_action": {
      "pose": "随意地靠在石制栏杆上，双手放在身后的石扶手上",
      "posture": "一条腿略微抬起/膝盖弯曲，姿态放松但自信",
      "expression": "性感、自信、宁静"
    },
    "environment": {
      "setting": "户外花园或庄园露台",
      "background": "郁郁葱葱的绿色树木和植物，略微模糊（散景效果）",
      "foreground": "带有经典建筑细节的饱经风霜的石制栏杆/扶手"
    },
    "lighting": {
      "type": "明亮的自然阳光（黄金时段或中午）",
      "characteristics": "高对比度，硬朗的阴影勾勒出连衣裙的褶皱，头发上有强烈的轮廓光，阳光普照的氛围"
    },
    "technical_specifications": {
      "camera_type": "数码单反相机",
      "lens": "85 毫米人像镜头",
      "aperture": "f/1.8",
      "focus": "主体对焦清晰，景深使背景树木模糊",
      "resolution": "8k，超高细节",
