---
id: portrait-dark-hair-position-0116
title: "“Chic Rebellion”——一场充满时尚气息的黑色星期五盛宴"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["时尚", "聚会", "活力", "反叛", "暖调", "深色", "写实", "随性"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
version: "1.0.0"
related_to: ["interior-dark-hair-position-002"]
---
  ...
  "prompt": {
    ...
    "人物特征": [
      ...
      },
      {
        "位置": "从右数第二个",
        "特征": "[与罗莎莉亚相似的女性]",
        "头发": "[长发，颜色深，梳成光滑的后脑勺造型]",
        "穿着": "[深色上衣，可能是天鹅绒或缎面材质，无肩带]",
        "配饰": "[嘴唇间夹着一个小物件，可能是香烟或雪茄]",
        "表情": "[放松、淡定]"
      },
      {
        "位置": "右下角",
        "头发": "[卷曲的棕色头发]",
        "可见部分": "[仅露出头顶，暗示桌上还有其他人]"
      }
    ],
    "餐桌": {
      "物品": [
