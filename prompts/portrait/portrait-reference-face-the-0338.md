---
id: portrait-reference-face-the-0338
title: "写实人像摄影：英雄视角与戏剧光影"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["肖像", "写实", "暖色调", "橙红色", "棚拍", "轮廓光", "特写", "严肃"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
version: "1.0.0"
related_to: ["portrait-reference-face-the-002"]
---
...
## 中文译文（源站提供）
根据附带的参考照片，创作一张写实风格的编辑肖像。仅使用上传的自拍照作为面部参考。身份锁定：精确的相似度、面部几何结构/比例、自然的皮肤纹理。无美化。服装风格、颜色、材质和合身度与参考照片保持一致。中景特写（脸部和肩膀），低角度仰视（英雄/主导视角），脸部/眼睛对焦锐利。表情严肃、专注、凝重，目光向上并看向镜头之外（画面之外）。戏剧性的饱和影棚灯光，高对比度明暗对比，深邃的阴影，鲜艳的橙色和深红色调，强烈的轮廓光营造出光晕分离效果。纯色影棚背景，丰富的橙红色平滑渐变，无图案，炽热的光芒氛围。高皮肤纹理保真度（毛孔可见），8k，肖像纵横比，电影级灯光，4:5。
