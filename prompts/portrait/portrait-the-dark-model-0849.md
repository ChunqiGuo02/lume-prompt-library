---
id: portrait-the-dark-model-0849
...
```json
{
  "image_generation_prompt": {
    "subjects": {
      "female_model": {
        "pose": "优雅地站立，身体后倾靠在汽车的后侧围板上",
        "attire": "海军蓝及地晚礼服，深 V 领口，金色几何腰带，高开衩露出腿部，黑色绑带角斗士高跟鞋",
        "appearance": "长而卷曲的深色头发，红色口红，精致的表情，柔软的皮肤质感"
      },
      "male_model": {
        "pose": "坐在敞篷车的驾驶座上，车门大开，一条腿迈出车外踩在人行道上，身体略微前倾",
        "attire": "修身深海军蓝西装，笔挺的白色正装衬衫，领口未扣，未系领带，黑色正装鞋",
        "appearance": "修剪整齐的棕色头发，胡茬，眼神犀利地看向镜头"
      }
    },
    "objects": {
      "vehicle": {
        "type": "兰博基尼 Huracán Spyder 敞篷车",
        "color": "金属深灰色外观",
        "interior": "鲜艳的橙色皮革桶形座椅和内饰",
        "details": "银色合金轮辋，极具侵略性的空气动力学线条，敞篷"
      }
    },
    "environment": {
      "location": "高档热带住宅街道或车道",
      "flora": "前景有一棵枝叶繁茂的大树，开着白色鸡蛋花",
      "background": "模糊的白色殖民风格建筑，豪华别墅，柔和的散景效果"
    },
    "lighting_and_mood": {
      "lighting": "温暖的黄金时段自然阳光，斑驳的光线透过树枝洒落，柔和的镜头眩光，高对比度",
      "mood": "财富，奢华，浪漫，高端时尚杂志风格，电影感，昂贵"
    },
    "technical_specifications": {
      "quality": "超现实，8k 超高清，HDR，照片级真实感，杰作",
      "camera_settings": "使用 85mm 人像镜头拍摄，f/1.8 光圈，浅景深，模特对焦清晰",
      "resolution": "超高分辨率，高度精细的纹理（皮肤、织物、金属）"
    }
  },
  "generation_parameters": {
    "aspect_ratio": "9:16",
