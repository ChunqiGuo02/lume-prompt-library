---
id: portrait-urban-wet-pavement-2399
title: "都市街拍时尚男模"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["街拍", "写实", "男性", "休闲", "时尚", "暖色调", "咖啡馆", "城市"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
## 中文译文（源站提供）
{
  "目标": "根据提供的参考图像，生成一张超逼真的街头时尚肖像，描绘一位自信地在户外行走的年轻男子。",
  "场景描述": {
    "环境": {
      "场景设定": "现代咖啡馆附近的湿漉漉的人行道",
      "背景": {
        "风格": "模糊的城市背景",
        "元素": [
          "棕榈树",
  ...
  "视觉风格": {
    "美学风格": "Instagram风格的街头时尚",
    "质量": "超逼真，细节清晰",
    "色彩搭配": "温暖的阳光色调与柔和的城市氛围形成对比",
    "细节特征": [
      "真实的面料质感",
      "湿漉漉的人行道反光效果",
      "电影般的模糊效果和立体感",
