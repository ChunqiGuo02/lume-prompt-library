---
id: portrait-water-the-texture-0391
title: "冰雪湖面中闭眼仰面漂浮的金发女性肖像"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: japanese-zen-garden
tags: ["女性", "冰水", "冬季", "雪山", "森林", "倒影", "冷调", "写实"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
  ...
  "prompt": {
    "subject": {
      ...
      "appearance": {
        ...
        "skin": {
          "tone": "苍白，冷色调",
          "texture": "超写实，湿润，脸上可见水珠",
          "features": "闭眼，放松的表情，高颧骨，下颌线分明，嘴唇微张"
        },
        "pose": {
          "position": "浸没在水中，直至颈部/耳朵",
          "head_orientation": "完全向后倾斜，脸部与天空平行",
          "reflection": "深色水面下清晰、对称的侧面反射"
        }
      },
      "clothing": "不可见（焦点在头部和颈部）"
    },
    "environment": {
      "setting": "冰冻的湖泊或冰冷的水体",
      "background": {
        "elements": "模糊的深色森林线，远处的雪山",
        "weather": "阴天，情绪化，冬季氛围"
      },
      "foreground": {
        "elements": "主体周围漂浮着碎冰块",
    ...
    "lighting": {
      "type": "自然，柔和，漫射",
      "source": "阴沉的天空（全局照明）",
      "contrast": "中等对比度，水面/背景有深黑色，脸部有柔和高光",
      "mood": "空灵，忧郁，宁静，寒冷，电影感"
    },
    "styling": {
      "makeup": "极简，自然，湿润妆容",
      "aesthetic": "艺术摄影，电影剧照，黑暗自然"
    },
    "camera_details": {
      "angle": "低角度，水面视角（水面高度）",
      "shot_type": "特写 / 肖像",
      "focus": "主体面部清晰对焦，景深较浅（背景虚化）",
      "lens_characteristics": "可能为 85mm 或 50mm 定焦镜头"
    },
    "photorealism": {
      "quality": "8k 分辨率，超细节",
      "texture_details": "逼真的冰块不透明度，水面张力，皮肤毛孔，发丝",
      "style": "写实主义，电影级调色（去饱和的冷色调，青色和灰色）"
    }
  }
}
```
