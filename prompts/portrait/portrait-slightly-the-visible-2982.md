---
id: portrait-slightly-the-visible-2982
title: "黑白自拍肖像：自然慵懒的年轻女性特写"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["黑白", "肖像", "女性", "卷发", "丸子头", "雀斑", "吊带", "室内"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
version: "1.0.0"
related_to: ["landscape-slightly-the-visible-001", "landscape-slightly-the-visible-002"]
---
...
```json
{
  "image_generation_prompt": {
    "subject_details": {
      "demographics": "年轻女性，白种人，估计二十出头",
      "hair": "纹理感金色卷发，盘成凌乱的发髻，脸部周围有几缕松散的碎发和发丝，逆光下的飞发",
      "face": "自然的皮肤纹理，鼻梁和脸颊上有可见的雀斑，高颧骨，浓密的眉毛向上梳理，丰满的嘴唇，清晰的下颌线，淡雅的自然妆容",
      "gaze": "直视镜头，柔和而迷人的表情，嘴唇微张，神态平静"
    },
    "apparel_and_styling": {
      "clothing": "黑色细吊带背心，V 领，极简风格",
      "accessories": "无可见配饰",
      "styling": "毫不费力，‘刚睡醒’的美学，休闲时尚"
    },
    "pose_and_composition": {
      "type": "特写肖像，自拍角度",
      "framing": "头部和肩膀，居中构图",
    ...
    "environment_and_background": {
      "setting": "室内，靠近窗户的居家环境",
      "backdrop": "半透明纹理窗帘，带有垂直褶皱，柔软的织物细节",
      "depth": "浅景深，背景略微失焦以突出主体"
    },
    "lighting_and_atmosphere": {
      "type": "柔和的自然窗户光线（漫射）",
      "direction": "前置光线，略带侧光偏向",
      "highlights": "前额、鼻尖和颧骨上有柔和的镜面高光",
      "shadows": "下巴下方和颈部轮廓处有柔和、不突兀的阴影",
      "mood": "亲密、真实、坦率、宁静、感性"
    },
    "technical_specs": {
      "medium": "黑白摄影，单色",
      "camera_emulation": "iPhone 前置摄像头或 35mm 胶片相机等效效果",
      "lens": "35mm 焦距（适合肖像但略宽以营造自拍感）",
      "aperture": "f/2.8",
