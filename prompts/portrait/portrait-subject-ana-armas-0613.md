---
id: portrait-subject-ana-armas-0613
title: "基于Ana de Armas面部特征与红色上衣黑色短裙造型的"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["欧美", "金发", "红色", "黑色", "户外", "庭院", "写实", "逆光"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
version: "1.0.0"
related_to: ["landscape-subject-ana-armas-002", "landscape-subject-identity-ana-001", "landscape-subject-identity-ana-002", "landscape-subject-identity-ana-003", "landscape-subject-identity-source-001", "landscape-subject-sydney-sweeney-001"]
---
...
    "subject_specs": {
      "identity": {
        "face": "{"subject name" "Ana de Armas"} (reference image 1)",
        "features": "locked",
...
```json
{
  ...
  "generation_parameters": {
    "subject_specs": {
      "identity": {
        "face": "{\"subject name\" \"Ana de Armas\"} (参考图片 1)",
        "features": "locked",
    ...
    "environment_specs": {
      "setting": {
        ...
        "elements": ["柔和的建筑线条", "黄金时段的温暖", "充满活力的绿植"]
      },
      "lighting": {
        "mode": "鲜艳高调",
