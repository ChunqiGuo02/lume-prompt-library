---
id: portrait-top-neon-motion-2352
title: "都市夜景中时尚女性行走的超写实电影感肖像"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["都市", "夜景", "写实", "女性", "时尚", "墨镜", "腕表", "暖色调"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
```json
{
  ...
  "subject": {
    ...
    "pose_and_motion": {
      "body_angle": "3/4 侧面轮廓",
      "action": "行走中",
      "hand_position": "左手在口袋外自然摆动",
      "watch_visibility": "显眼可见且对焦清晰"
    }
  },
  "environment": {
    "location": "夜间都市街道",
    ...
    "atmosphere": "充满活力、电影感、现代夜生活"
  },
  "lighting": {
    "type": "戏剧化且有方向性",
    "source_direction": "左前方上方",
    "effects": [
      "主体上逼真的阴影",
      "衣物和路面上细微的反射",
      "霓虹灯光在腕表上反射出高光"
  ...
  "camera": {
    ...
    "motion_effect": "背景运动模糊以传达速度和动感"
  },
  "quality": {
    "realism": "超高",
    "detail_level": "皮肤、织物和配饰细节丰富",
    "look": "电影感、高端、照片级真实感"
  },
  "constraints": [
    "无卡通或插画风格",
  ...
  "output_goal": "创作一幅超写实的电影感夜间肖像，描绘一位时尚女性走在都市街道上，面部和腕表对焦清晰，霓虹灯光戏剧化，城市背景运动模糊，以营造动感活力。"
}
```
