---
id: portrait-sparkling-ana-side-0188
title: "两位女星闪耀礼服户外合影写真"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["写实", "时尚", "摄影", "礼服", "亮片", "户外", "咖啡馆", "阳光"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
{
  "parameters": {
    "prompt": "高分辨率、8k、杰作、最佳质量、超现实、全身垂直拍摄、安娜·德·阿玛斯（Ana de Armas）和西德尼·斯威尼（Sydney Sweeney）并肩站立，欢快地笑着，头碰着头，互相拥抱，安娜·德·阿玛斯穿着一件无肩带闪亮银蓝色紧身胸衣礼服，带有分层荷叶边和高开衩，西德尼·斯威尼穿着一件无肩带闪亮玫瑰金色紧身胸衣礼服，带有分层荷叶边和高开衩，高度详细的闪亮面料纹理，银色高跟鞋，豪华户外咖啡馆露台背景，玻璃窗，盆栽植物，阳光，电影照明，景深，时尚摄影",
    "negative_prompt": "畸形、糟糕的解剖结构、毁容、面部描绘不佳、变异、突变、多余的肢体、丑陋、令人作呕、手部描绘不佳、肢体缺失、漂浮的肢体、断开的肢体、畸形的手、模糊、变异的手、手指、质量差、颗粒感、低分辨率、水印、文字、签名、裁剪、绘画、素描、插图",
    "steps": 30,
    "cfg_scale": 7.0,
    "sampler_name": "DPM++ 2M Karras",
    "width": 1024,
