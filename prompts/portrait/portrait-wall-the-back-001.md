---
id: "portrait-wall-the-back-001"
title: "夏日街头时尚肖像：阳光下的优雅姿态"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["写实", "人像", "街头", "户外", "阳光", "浅绿", "露腰", "短裙"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
## 中文译文（源站提供）
{
  "prompt": "超写实的8K街头肖像，忠实还原了参考照片中女孩的面部特征。拍摄场景为户外：女孩靠在一面带有纹理的米色灰泥墙上，阳光明媚；她姿态轻松，头部微微后仰，眼睛半闭，面带享受温暖的表情。她穿着一套时尚的服装：长袖短上衣打结系紧，露出腹部；迷你裙的腰间配有细带设计。她的妆容以古铜色和明亮的高光为主，嘴唇涂成裸色哑光效果，颧骨轮廓清晰。头发扎成一个凌乱的发髻，有几缕波浪状的头发自然垂在脸庞两侧。背景是一面粗糙的灰泥墙，树叶在墙上投下清晰的阴影。使用的相机是富士X-T4，模拟Kodak Gold 200胶片的拍摄效果，光圈设置为f/8以使背景更加清晰。光线来自正午的强烈阳光，形成鲜明的明暗对比；植物在皮肤和墙上投下清晰的影子。整体色调以温暖的黄绿色为主，营造出夏日的氛围，画面清晰度极高，具有杂志般的视觉效果。构图采用中景，灰泥墙充满整个画面。",
  "parameters": {
    "--ar": "4:5",
    "--style": "raw",
    "--v": "6.0"
