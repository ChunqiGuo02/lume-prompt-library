---
id: portrait-the-water-face-1600
title: "湿发女子侧脸特写，水珠滑落，展现纯净护肤瞬间"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["肖像", "侧颜", "湿发", "银发", "水滴", "泡沫", "护肤", "宁静"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
```json
{
  ...
  "subject": {
    "demographics": "年轻女性",
    "perspective": "侧面轮廓视图（面向左侧）",
    "appearance": {
      "skin": {
        "texture": "超写实、湿润的皮肤纹理，毛孔可见，脸颊有自然的潮红",
        "details": "多颗清澈的水珠附着在脸上，下颌线、颈部和锁骨处有白色肥皂泡沫/皂沫",
        "wetness": "一滴明显的水珠从下巴滴落"
      },
      "hair": {
        "color": "银色 / 白金金色",
        "style": "向后梳，完全湿润，发丝被水珠勾勒分明",
        "texture": "细直"
      },
      "face": {
        "eyes": "闭合，眼睑放松",
        "brows": "自然，未经修饰",
        "lips": "柔和，自然粉色，微启",
        "expression": "宁静，平静，如水疗般的放松"
      }
    }
  },
  "pose": {
    "head_position": "头部向左转 90 度，展现完整侧面",
    "body": "双肩裸露（暗示裸体或无肩带上衣），颈部修长",
    "action": "洗浴/洗脸时静止站立或坐着"
  },
  "styling": {
    "makeup": "无妆 / 素颜美学",
    "elements": "白色肥皂沫/泡沫流淌过颈部和胸部",
    "vibe": "纯净之美，护肤品广告，原始而有机"
  },
  "environment": {
    "setting": "极简主义工作室或浴室环境",
    "background": "纯色中性米色 / 棕褐色",
    "details": "干净，整洁，完全聚焦于主体"
  },
  "lighting": {
    "type": "柔和漫射工作室灯光",
    "quality": "均匀照明，湿润皮肤和水珠上有柔和高光",
    "shadows": "下颌和耳下有柔和的造型阴影",
    "direction": "侧光突出轮廓"
  },
  "camera_settings": {
    "shot_type": "特写肖像 / 大头照",
    "lens": "85mm 或 105mm 微距镜头",
    "aperture": "f/2.8 至 f/4.0（保持面部清晰，同时略微柔化头发）",
    "focus": "睫毛和脸颊上的水珠对焦锐利",
    "shutter_speed": "1/200s（以凝固滴落的水珠）"
  },
  "technical_details": {
    "resolution": "8k",
    "quality_tags": [
