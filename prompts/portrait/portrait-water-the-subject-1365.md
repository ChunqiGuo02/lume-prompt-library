---
id: portrait-water-the-subject-1365
title: "未来科技感高定礼服人像摄影"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["模特", "未来感", "发光", "浅水", "反光", "冷色调", "蓝色", "科技"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
{
  "model": "Nano Banana Pro",
  "scene": "黑暗而富有氛围感的空间，水面浅浅，有倒影",
  "subject": {
    "type": "女性",
    "pose": "自信地站在浅水中，身体朝前，头部略微转动",
    "expression": "平静、沉着、内敛而强大",
    "gaze": "望向远方，不直接看向镜头",
    "emotion": "沉着、超然、掌控"
  },
  "appearance": {
  ...
  "attire": {
    "dress": "由发光光纤丝制成的半透明未来感长袍",
    "design": "紧身胸衣，向下延伸的流光丝线",
    "material": "虹彩、半透明、发光面料",
    "effect": "生物发光，丝线有微妙的动态"
  },
  "environment": {
    "setting": "极简、抽象的空间",
    "floor": "薄薄的水层，形成镜面般的倒影",
    "atmosphere": "主体周围环绕着冷雾和薄雾"
  },
  "lighting": {
    "primary": "冷蓝色-白色背光，形成光晕效果",
    "secondary": "柔和的环境补光",
    "effects": "体积光线、辉光扩散、水面反射"
  },
  "camera": {
    "angle": "齐眼高度全身照",
    "lens": "电影人像镜头 (50mm)",
    "depth_of_field": "适中景深，主体清晰对焦，背景柔和",
    "framing": "垂直构图，强调对称性和存在感"
  },
  "color_palette": {
    "dominant": ["冷蓝色", "银白色"],
    "accents": ["柔和的紫色", "青色高光"]
  ...
  "mood": "未来感、优雅、空灵、强大",
  "style": {
    "aesthetic": "高级时装科幻写实主义",
    "inspiration": "科技高级定制、未来T台、电影科幻",
    "texture": "光滑的皮肤与发光丝线细节形成对比",
    "post_processing": "清晰高光、冷色调、微妙的辉光泛滥"
  },
  "themes": [
    "科技与人性",
    "光即形态",
  ...
  "quality": "超细节、照片级真实感、高动态范围、电影级布光"
}
```
