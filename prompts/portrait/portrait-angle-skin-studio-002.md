---
id: "portrait-angle-skin-studio-002"
title: "英雄感戏剧肖像：橙红背景低角度光影人像"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["橘红色", "暖色调", "戏剧感", "棚拍", "人像", "写实", "高对比", "氛围感"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
version: "1.0.0"
related_to: ["portrait-angle-skin-studio-001", "portrait-angle-skin-studio-003"]
---
...
# 正文 prompt
{
  ...
  "composition": {
    "background": "Saturated solid {"background color" "orange-red"} backdrop, smooth intense gradients, no patterns, 'hot' atmosphere",
...
```json
{
  ...
  "constraints": {
    "identity_anchor": {
      "source": "所附参考照片",
      "strictness": "严格",
      "instruction": "完美保留精确的面部特征、肤色、发型和自然肖像，不得有任何改动。"
    },
    "clothing_anchor": {
      "source": "与参考照片完全一致",
      "strictness": "严格",
  ...
  "composition": {
    "background": "饱和的纯色 {\"background color\" \"橙红色\"} 背景，平滑强烈的渐变，无图案，营造“炽热”氛围",
  ...
  "combined_prompt_text": "世界级杂志肖像，戏剧化影棚灯光，英雄气概。[参考照片身份保留]：精确的面部特征、肤色、发型。[服装完全匹配]：合身度和材质无改动。表情：严肃、紧张、专注，向上并向远处看。背景：饱和的纯橙红色，平滑强烈的渐变，炽热氛围。拍摄角度：从下方低角度拍摄以营造主导感。构图：中景特写。灯光：明亮的橙色和深红色调，强烈的定向明暗对比主光，将主体与背景分离的强力轮廓光。技术：照片写实主义，高细节，面部锐利对焦，自然的皮肤纹理和毛孔。"
}
```
