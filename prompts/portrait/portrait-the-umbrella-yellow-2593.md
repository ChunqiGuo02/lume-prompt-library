---
id: portrait-the-umbrella-yellow-2593
title: "雨夜黄伞下情侣浪漫对视场景复刻"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["浪漫", "雨", "夜晚", "黄色", "雨伞", "情侣", "对视", "温情"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
  ...
  "generation_request": {
    ...
    "creative_prompt": {
      ...
      "composition_lock": {
        ...
        "umbrella_position": "bright {"umbrella color" "yellow"} umbrella centered at the very top, canopy spanning nearly the full width of the frame, umbrella shaft vertical near the middle",
...
```json
{
  "generation_request": {
    ...
    "creative_prompt": {
      "matchshot_priority": "MAX",
      "scene_summary": "精确匹配参考图的构图：在明亮的黄色雨伞下，一个夜晚大雨中的浪漫时刻。两位成年人紧密站立，彼此面对，垂直构图的全身肖像。雨伞占据图像顶部三分之一，强烈发光，将温暖的黄光投射到他们脸上，而周围环境则保持较冷和较暗。",
      "composition_lock": {
        "framing": "全身 / 3-4 身肖像，两位主体完全可见，居中于雨伞下方",
        "umbrella_position": "明亮的 {\"umbrella color\" \"yellow\"} 雨伞居中于最顶部，伞面几乎横跨整个画面宽度，伞柄垂直于画面中部附近",
        "subject_placement": "男士在左，女士在右，紧密站立，眼神亲密接触，面部无遮挡",
        "background_depth": "他们身后是柔和的焦外虚化和湿润的绿植，雨水呈现为条纹状"
      },
      "subjects": [
        {
          "role": "male",
          "position": "left",
          "wardrobe": "深色西装搭配长款深色大衣，白色衬衫，翻领上有精致的胸花细节",
          "pose": "双手持伞柄至胸部高度，肩膀朝向女士倾斜",
          "expression": "惊讶而温柔，专注地凝视着女士"
        },
        {
          "role": "female",
          "position": "right",
          "wardrobe": "米色风衣内搭长款深色连衣裙，臀部挂着一个小巧的棕色斜挎包/单肩包",
          "pose": "紧密站立，身体略微朝向男士倾斜，手臂自然垂于躯干两侧，抬头看着他",
          "expression": "柔和、专注、情感投入的凝视"
        }
      ],
      "environment": {
        "location": "夜间的户外花园小径 / 入口区域",
        "weather": "瓢泼大雨，雨水条纹清晰可见，湿漉漉的外套和头发细节，雨伞边缘有水滴",
        "background": "郁郁葱葱的绿色灌木/植物，昏暗的环境城市/花园灯光，光滑湿润的表面"
      },
      "lighting": {
        "key_light": "雨伞的光芒是主要主光：温暖的黄光照亮面部和上半身",
        "fill_light": "雨夜提供极少的冷色环境补光"
      }
    }
  }
}
