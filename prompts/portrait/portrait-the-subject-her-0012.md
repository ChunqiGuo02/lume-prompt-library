---
id: portrait-the-subject-her-0012
...
```json
{
  "project_title": "BeautyVerse 杂志封面 - 胸前全息取景器（大型 2026）与俏皮眨眼",
  "structure": "单一全画幅构图。专业影棚摄影。无边框或拼贴元素。",
  "aspect_ratio": "3:4",
  "aesthetic_theme": {
    "style": "高级时装杂志封面美学，带有一丝俏皮的未来感光泽。",
    "mood": "自信、俏皮、活力、精致",
    "color_grading": "棱镜发光效果：以干净的影棚灯光为基础，混合大型全息元素投射出的强烈特定彩色光。高对比度专业时尚修图。",
    "textures": [
      "高清晰度皮肤毛孔和精细织物纹理",
      "手部和胸部强烈光滑的全息光线折射",
      "背景文字采用哑光、大胆印刷的杂志油墨纹理"
    ]
  },
  "framing_and_borders": {
    "type": "无",
  ...
  "subject_reference": {
    "source": "image_1.png",
    "instruction": "保持 image_1.png 中主体的特征和服装，但按照姿势部分的描述改变面部表情。"
  },
  "composition_details": {
    "main_frame": {
      "type": "中景肖像（腰部以上）",
      "composition_rule": "将焦点集中在手中大型发光元素和主体富有表现力的面部，背景是醒目的排版文字。",
      "setting_description": "高端、极简主义的影棚墙壁，作为大型文字的背景。",
      "subject_pose": "主体直视镜头，**一只眼睛俏皮地眨眼，并露出灿烂温暖的笑容**。她双手置于胸前，大拇指和食指形成一个矩形的“相机取景器”手势，正好位于心口区域。在这个手指框内，数字“{\"year\" \"2026\"}”以**大型、醒目且极其鲜艳**的发光全息投影形式出现，**显著填满了手指间的空间**。这个大型发光元素在她的手指、手掌和胸前服装的织物上投射出强烈而明显的柔和彩色光。",
      "key_element_description": {
        "object": "大型背景杂志标题",
        "text_content": "{\"magazine title\" \"BeautyVerse\"}",
        "alignment": "这块单一的文字块位于主体上半身和头部的后方。主体的躯干略微与字母的下半部分重叠，营造出景深感。",
        "text_style": "大胆、高冲击力、权威的杂志社论标题字体（粗体、大写）"
      }
    }
  }
}
