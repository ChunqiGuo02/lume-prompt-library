---
id: portrait-maintain-reference-studio-2807
title: "高定时尚大片：黄金时刻奢华美学"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: fashion-portrait
tags: ["时尚", "高级", "优雅", "暖调", "奢华", "米色", "卷发", "肖像"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
# 正文 prompt
{
  ...
  "subject_details": {
    ...
    "styling": {
      "wardrobe": {
        "garment": "Structured corset dress",
...
```json
{
  ...
  "subject_details": {
    "model_identity": {
      ...
      "complexion": "极致抛光肤质，无瑕妆面"
    },
    "posing_and_attitude": {
      "posture": "优雅入座，沉静而具主导性，毫不费力的优雅",
      "hand_position": "单手轻柔抬至脸旁，受控的时尚姿态",
      "vibe": "精致的性感，时尚电影般的态度"
    },
    "styling": {
      "wardrobe": {
        "garment": "结构感紧身胸衣连衣裙",
        "material": "奢华面料，可见高级定制的张力",
        "silhouette": "雕塑感，高精度剪裁"
      },
      "hair_design": {
        "style": "长发，蓬松，刻意散漫",
        "detail": "柔和发丝垂落脸庞，营造亲密感"
      },
      "makeup": {
        "lashes": "浓密，戏剧化，编辑级",
        "overall": "高端影棚光泽感"
  ...
  "environment_and_props": {
    "location": "极简主义高端影棚",
    "furniture": "雕塑感白色泰迪绒扶手椅",
    "background": "与灯光融为一体的统一极简背景"
  },
  "lighting_and_aesthetics": {
    "primary_source": "黄金时段影棚布光",
