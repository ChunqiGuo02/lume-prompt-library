---
id: "portrait-mood-fashion-studio-002"
title: "北欧风极简秋日时尚人像系列"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: nordic-minimal
tags: ["极简", "时尚", "肖像", "摄影", "北欧", "沉静", "驼色", "毛衣"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
version: "1.0.0"
related_to: ["portrait-mood-fashion-studio-001"]
---
...
```json
{
  "Objective": "创作一组极简主义时尚影棚肖像系列，营造平静、斯堪的纳维亚风格的编辑氛围",
  "PersonaDetails": {
    "Subject": {
      "Type": "年轻女性",
      "Hair": "短款、柔和波浪的深棕色头发",
  ...
  "PhotographyStyle": {
    "Genre": "专业时尚影棚摄影",
    "RealismLevel": "高度写实，克制处理",
    "Finish": "干净、现代、杂志级"
  },
  "Mood": {
    "Tone": "平静、内省、宁静",
    "SeasonalFeel": "秋日的温暖与宁静的优雅"
  },
  "NegativePrompt": [
    "繁忙的背景",
    "刺眼的灯光",
