---
id: portrait-marble-subject-red-0859
...
# 正文 prompt
{
  ...
  "aspect_ratio": "3:4",
  "subject": {
    "identity": "{"subject identity" "Ana de Armas"}",
...
```json
{
  ...
  "subject": {
    ...
    "expression": {
      ...
      "mouth": "红色口红",
      "gaze": "慵懒、自信、派对后的疲惫",
      "mood": "颓废、超现实的魅力、美丽的局促不安"
    },
    "pose": {
      "position": "躺在红黑大理石浴室梳妆台上，看向镜头",
  ...
  "environment": {
    "setting": "凌晨 3:00 的豪华浴室",
    "materials": "红黑大理石台面，金色饰面固定装置",
    "key_elements": "主体身后巨大的落地镜，映照出背部和侧面的多重倒影",
    "props": "散落的香槟杯，颓废的派对残余物"
  },
  "lighting_style": {
    "aesthetic": "盖·伯丁（Guy Bourdin）的超现实主义与 Y2K 千禧年闪光灯的结合",
    "key_light": "直射机内闪光灯（高强度，Y2K 风格）",
    "accent_lights": {
      "camera_left": "亮粉色和洋红色泛光",
      "camera_right": "电青色和蓝色边缘照明"
    },
    "effects": "大理石上的高饱和度光影游戏，镜面反射营造偷窥张力，亮片高光处细微的光晕"
  },
  "technical_specs": {
    "camera": "35mm 胶片美学",
    "lens": "35mm 广角镜头，f/2.8 光圈",
    "angle": "略微低角度，以强调身高和主导性",
    "focus": "对眼睛和连衣裙纹理进行锐利对焦",
    "film_stock_simulation": {
      "contrast": "高",
      "grain": "精细胶片颗粒",
