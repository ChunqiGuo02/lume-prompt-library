---
id: portrait-subject-name-texture-1404
title: "梦幻皇室肖像：蓝裙佳人 staircase 优雅凝视"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["肖像", "写实", "电影感", "宫廷", "金发", "蓝色", "礼服", "花卉"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
{
  "prompt_metadata": {
    "title": "Cinematic Royal Portrait: {"subject name" "Ana de Armas"}",
    "version": "2.0",
  ...
  "subject": {
    "identity": {
      "name": "{"subject name 2" "Billie Eilish"}",
  ...
  "wardrobe": {
    "garment": "Grand Powder-Blue Ball Gown",
    "bodice_details": {
...
{
  "prompt_metadata": {
    "title": "电影级皇家肖像：{\"subject name\" \"Ana de Armas\"}",
    "version": "2.0",
    "generation_type": "超写实电影感",
    "aspect_ratio": "3:4",
    "quality_preset": "超高分辨率 / 8K / RAW",
    "aesthetic_style": "童话皇家 / 飘逸优雅"
  },
  "subject": {
    "identity": {
      "name": "{\"subject name 2\" \"Billie Eilish\"}",
      "likeness_fidelity": "100% 精准的面部特征",
      "ethnicity_match": "真实的肤色和骨骼结构"
    },
    "physical_features": {
      "eyes": {
        "color": "深棕色",
        "details": "明亮眼神光，虹膜纹理清晰聚焦"
      },
      "complexion": {
        "texture": "可见的皮肤毛孔，自然的瑕疵，发光的暖色光泽",
        "finish": "柔焦水润感"
      },
      "hair": {
        "style": "精致的金色盘发",
        "texture": "柔软、松散的卷发环绕面部",
        "detail": "可见细致的单根发丝，丝绸般的光泽"
      },
      "makeup": {
        "style": "自然 / 极简主义",
        "details": "柔和的蜜桃色腮红，裸色光泽唇，淡雅睫毛膏"
      }
    },
    "pose": {
      "composition": "特写肖像",
  ...
  "wardrobe": {
    ...
    "bodice_details": {
      "type": "结构化紧身胸衣",
      "neckline": "露肩荷叶边袖",
      "embellishments": "手工缝制 3D 花卉贴花"
    },
    "skirt_details": {
      "material": "分层丝绸薄纱",
      "volume": "蓬松轻盈",
      "translucency": "光线透过织物层微妙过滤"
    }
  },
  "environment": {
    "location": "宏伟的宫殿内部",
    "architecture": {
      "primary_element": "宽阔的大理石楼梯",
      "material": "抛光白色卡拉拉大理石，带有金色纹理",
      "backdrop": "华丽的栏杆，远处的拱形天花板"
    },
    "atmosphere": {
      "vibe": "梦幻、奢华、永恒",
      "depth": "极浅景深（焦外虚化背景）"
  ...
  "lighting_and_color": {
    "lighting_scheme": {
      "primary_source": "电影级柔光箱模拟",
      "secondary_source": "宫殿吊灯发出的温暖环境光",
      "effects": "微妙的光晕，飘渺的光线，体积感金色黄昏光芒"
    },
    "color_palette": {
      "dominants": ["粉蓝色", "奶油白", "柔和金色"],
      "accents": ["温暖肤色", "深琥珀色高光"]
    }
  },
  "technical_rendering": {
    "camera_settings": {
      "lens": "85mm 定焦镜头模拟",
      "aperture": "f/1.2 营造奶油般虚化效果",
      "sensor": "全画幅数字电影摄影机"
    },
    "image_fidelity": {
      "texture_mapping": "高保真织物纹理和大理石纹理",
      "post_processing": "电影级色彩分级，微调对比度和饱和度，增加胶片颗粒感"
    }
  }
}
```
