---
id: "portrait-type-text-visible-001"
title: "街头风少女写真：绿帽卫衣配运动裤"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["休闲", "街头", "放松", "深绿", "黑色", "白色", "浅灰", "卫衣"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
## 中文译文（源站提供）
{ "composition": { "framing": "中等全身肖像", "orientation": "垂直", "camera_angle": "略高于视线水平", "pose": "坐在地板上，一条腿抬起，头靠在手上", "subject_position": "居中", "depth_of_field": "适中，背景完全清晰", "cropping": "全身在画面内可见" }, "subject": { "gender_presentation": "女性", "approximate_age_range": "青少年至青年", "skin_tone": "浅色，中性底色", "facial_features": { "face_shape": "圆形至椭圆形", "eyes": "浅棕色或淡褐色", "eyebrows": "自然，平直", "nose": "小巧，圆润的鼻尖", "lips": "中等丰满，柔和的粉色", "expression": "放松，略带内省" }, "hair": { "color": "中棕色", "length": "长", "texture": "直发带轻微自然波浪", "parting": "中分", "styling": "两个低辫子，前额有松散发丝" }, "distinct_features": { "freckles": "脸颊和鼻子上可见雀斑" } }, "clothing_and_accessories": { "headwear": { "type": "棒球帽", "color": "深绿色", "text": "IDOL", "style": "休闲街头服饰" }, "top": { "type": "宽松运动衫", "color": "深绿色", "material": "棉绒", "graphics": "大型学院风格字体", "text": "Atlanta Georgia", "details": "白色 V 领边饰，袖子上有标志补丁" }, "bottoms": { "type": "运动裤", "color": "黑色", "material": "丝绒或毛绒面料", "details": "白色侧边条纹" }, "footwear": { "type": "运动鞋", "color": "黑白", "style": "经典滑板或街头运动鞋" }, "jewelry": { "neckwear": "叠戴细链项链", "other": "无可见" } }, "lighting": { "type": "影室灯光", "key_light": "柔和漫射正面光", "fill_light": "柔和补光减少阴影", "highlights": "脸颊和鼻子上柔和高光", "shadows": "极少，边缘柔和", "color_temperature": "中性至略冷" }, "color_palette": { "dominant_colors": [ "深绿色", "黑色", "灰色" ], "accent_colors": [ "白色", "金色", "柔和的黄色" ], "overall_tone": "冷色调，柔和，现代" }, "background": { "environment": "影室设置", "background_type": "无缝背景", "background_color": "浅灰色", "texture": "光滑，哑光", "distractions": "无" }, "technical_traits": { "camera_type": "单反或无反相机", "lens_effect": "标准人像镜头", "estimated_focal_length": "35–50mm 等效", "sharpness": "整体清晰度高", "noise": "无可见噪点", "exposure": "均匀平衡" }, "artistic_style": { "genre": "影室生活方式肖像", "mood": "休闲，放松，青春", "aesthetic": "街头服饰时尚大片", "post_processing": { "skin_retouching": "极少", "color_grading": "冷中性平衡", "contrast": "低至中等", "vignette": "无" } }, "typography": { "text_present": true, "text_style": "学院校队字体", "text_color": "白色和金色", "placement": "胸部中央和袖子" }, "ov
