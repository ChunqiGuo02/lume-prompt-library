---
id: portrait-realism-intimate-body-1574
title: "温馨卧室中女性阅读的超写实生活照"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["卧室", "读书", "休闲", "松弛", "自然光", "暖色调", "舒适", "宁静"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "16:9"
...
```json
{
  "content_goal": "病毒式生活方式 / 休闲床姿帖子",
  "image_type": "超写实室内肖像",
  "visual_style": {
    "aesthetic": "编辑风、舒适、亲密、电影感",
    "vibe": "放松、亲和、柔和",
    "realism": "高端、专业写实"
  },
  "composition": {
    "framing": "中景至全身",
    "camera_angle": "平视或略高于视线",
    "subject_position": "坐在或斜倚在床上",
    "perspective": "自然、镜面式或直视视角"
  },
  "subject": {
    "description": "年轻人，休闲，放松的身体姿态",
    "pose": "腿部弯曲或伸展，双手自然放置",
    "body_language": "平静、亲密、柔和",
    "expression": "温柔、沉思、亲和",
    "gaze": "看向镜头或略微偏离"
  },
  "facial_details": {
    "emotion": "柔和、自然、宁静",
    "micro_details": "逼真的皮肤纹理，微妙的高光"
  },
  "wardrobe": {
    "clothing": "柔软的家居服或睡衣",
    "textures": "棉、亚麻或半透明面料",
    "color_tones": "中性色、柔和色或柔和的白色"
  },
  "environment": {
    "location": "明亮的卧室，装饰简约",
    "background": "白色或柔和色调的床上用品，微妙的花卉或盆栽植物",
    "atmosphere": "舒适、通透、亲密"
  },
  "lighting": {
    "type": "柔和的自然日光",
    "quality": "漫射、柔和、讨人喜欢",
    "direction": "侧面或正面来自窗户",
    "shadow_style": "最小化，柔和的阴影以增强轮廓"
  },
  "color_palette": {
    "primary_colors": ["柔和的白色", "米色", "浅中性色"],
    "mood": "温暖、平静、亲密"
  },
  "camera_details": {
    "camera_type": "智能手机或单反模拟",
    "lens": "广角 (24–28mm)",
    "focus": "主体清晰，景深自然",
    "depth_of_field": "柔和的背景虚化",
    "realism": "超写实"
  },
  "quality_control": {
    "skin_realism": "自然纹理，微妙高光",
    "fabric_realism": "柔软、逼真的垂坠感和褶皱",
    "ai_artifacts": "无",
    "professional_finish": "编辑级"
  },
  "overall_mood": "舒适、亲密、柔和、宁静",
  "intended_use": {
    "primary": "X 上的病毒式生活方式或卧室内容帖子",
    "secondary": "个人品牌、编辑摄影参考"
  }
}
```
