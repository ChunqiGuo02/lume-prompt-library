---
id: portrait-wooden-top-stool-1670
title: "现代简约风室内休闲少女写真"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["简约", "松弛", "休闲", "韩系", "女生", "耳机", "咖啡", "挎包"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
# 正文 prompt
{
  "image_generation": {
    ...
    "outfit": {
      "top": "{"top color" "white"} fitted tank top",
...
```json
{
  "image_generation": {
    "subject": {
      "description": "年轻女子随意地坐在室内",
      "pose": "坐在木凳上，双膝抱起，双手拿着一杯冷饮",
      "expression": "平静、中性、略带内省",
      "gaze": "直视镜头"
    },
    "appearance": {
      "hair": {
    ...
    "camera": {
      ...
      "framing": "中景全身照",
      "lens": "35mm",
      "depth_of_field": "适中，背景柔和对焦"
    },
    "aesthetic": {
      "style": "极简主义生活方式摄影",
      "vibe": "舒适、放松、现代",
      "color_palette": "中性色调，米色、白色、灰色"
    },
    "quality": {
      "realism": "高度写实",
      "resolution": "高分辨率",
