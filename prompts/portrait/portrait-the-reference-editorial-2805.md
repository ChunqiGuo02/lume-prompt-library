---
id: portrait-the-reference-editorial-2805
...
```json
{
  "prompt": "一张超现实的高端时尚杂志编辑肖像，主角是一位成年男性，100% 参照上传的参考图片，精确还原其面部、身份、面部结构和表情（无任何改动或风格化）。主体随意地斜靠在一个极简工作室环境中的高大白色矩形基座上。姿势必须与参考图片完全一致：身体侧向倾斜，左臀部靠在基座上，一只手随意地插在裤兜里，另一只手自然地放在大腿旁。一条腿直立在地面上，另一条腿膝盖微弯，双脚在脚踝处自然交叉。\n\n他身穿一套剪裁合身的浅灰色纹理西装，搭配修身长裤和同款西装外套，内搭一件白色纽扣衬衫，领口随意敞开（不系领带）。脚穿黑色皮乐福鞋，露出脚踝，造型简洁优雅。\n\n面部细节严格保留自参考图片：棱角分明的男性下颌线，浅浅的胡茬，清晰的颧骨，整齐向后梳的深色头发。表情严肃而平静，眼睛略微看向镜头侧面。\n\n灯光效果戏剧化，采用单向硬侧光，营造出强烈、锐利的阴影，并将主体的清晰剪影投射到身后的墙壁上。高对比度的光影几何结构增强了电影般的编辑氛围。\n\n背景由光滑的深灰色工作室墙壁和地板组成，极简且无干扰，除了基座外没有其他道具。奢华时尚杂志美学，超锐利对焦，逼真的皮肤纹理，精致的织物细节，电影般的对比度。单反相机摄影效果，85mm 镜头，浅景深，柔和的中性色彩分级。垂直构图，高端编辑品质，8K 超写实。",
  "aspect_ratio": "4:5",
  "resolution": "8K",
  "camera_lens": "85mm",
  "style": "奢华时尚编辑，电影感",
  "lighting": "戏剧性硬侧光，高对比度",
  "quality": "超现实，高端",
  "reference_image": "严格仅使用上传图片"
}
```
