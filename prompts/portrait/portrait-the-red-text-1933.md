  ...
  "composition": {
    ...
    "branding": {
      ...
      "text_elements": [
        ...
        "Small text: '{"副标题" "红毯之夜"}' (Night of the Red Carpet)",
        "Headline: '{"头条" "独家直击"}' (Exclusive Look)",
        "Bottom text: '{"底部文字" "年度风尚大典"}' (Fashion Awards of the Year)"
      ]
    }
  },
...
{
  "meta": {
    "system_instruction": "创作一张高端时尚杂志封面。严格保留上传面部的身份特征。",
    "aspect_ratio": "3:4",
    "quality": "ultra-detailed",
    "resolution": "8k",
    "style": "Met Gala 红毯活动，直射闪光灯摄影，魅力四射的名人抓拍"
  },
  "reference_usage": {
    "instruction": "严格保留上传参考图中的面部身份特征（眼睛、鼻子、嘴巴）。身体比例应为模特般高挑。",
    "focus": "100% 面部身份匹配"
  },
  "scene": {
    ...
    "atmosphere": "充满活力、独家、巨星气场"
  },
  "lighting": {
    "type": "直射闪光灯（狗仔队风格）",
    "effect": "高对比度硬光，肌肤闪亮，主体背后有锐利阴影，礼服上有明亮反光"
  },
  "subject": {
    "face": {
      "expression": "诱惑自信的微笑，回眸一笑",
      "makeup": "大胆的红唇，精致的修容，闪耀的高光"
    },
    "pose": {
      "action": "转身离开但头部向后转 45 度看向镜头",
      "body": "优雅的姿态，背部略微弓起",
      "hair": "在风中戏剧性地飘扬"
    },
    "outfit": {
      "dress": "未来感液态金属银色礼服",
      "details": "露背设计，反射相机闪光灯，亮片质感",
      "jewelry": "钻石项圈，大颗耳钉"
    }
  },
  "composition": {
    "layout": "杂志封面布局",
    "branding": {
      "main_logo": "顶部有大而醒目的白色或银色 'Harper's BAZAAR' 标志",
      "text_elements": [
        "侧面包含中文副标题",
        "小字: '{\"subtitle\" \"红毯之夜\"}' (红毯之夜)",
        "标题: '{\"headline\" \"独家视角\"}' (独家视角)",
        "底部文字: '{\"bottom text\" \"年度时尚大奖\"}' (年度时尚大奖)"
      ]
    }
  },
  "vibe": "奢华、昂贵、一线明星、光面杂志质感",
  "negative_prompt": "低分辨率，丑陋的手，扭曲的脸，缺少标志，文字错误，水印，休闲服装，白天，柔和的灯光"
}
```
