---
id: portrait-gym-machine-prompt-1651
title: "现代健身房中舒适坐姿的年轻女性"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["健身房", "健身", "女性", "黑发", "黑色", "现代", "活力", "生活风"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
# 正文 prompt
Give this prompt a try using your image on Gemini Nano Banana Pro.
Prompt:
{
"image_prompt": {
"subject": {
...
```json
{
  "image_prompt": {
    "subject": {
      "description": "一位年轻女性坐在现代健身中心的健身器材上",
      "face_preservation": true,
      "pose": {
        "body_position": "舒适地坐在卧推机上",
        "hands": "右手弯曲，手指靠近嘴唇；左臂自然地搭在机器把手上",
        "expression": "
