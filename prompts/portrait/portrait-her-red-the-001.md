---
id: "portrait-her-red-the-001"
title: "梦幻花影舞者：超现实艺术肖像创作提示词"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["超现实", "人像", "摄影", "红色", "黑色", "花朵", "投影", "艺术"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
```json
{
  "prompt": "一幅超现实的艺术肖像，描绘了一位女性在漆黑的背景前优雅地舞动，巨大的红色花瓣投射在她身体和周围空间。一朵发光的红色花朵在她身后绽放，部分与她的轮廓重叠，与她的舞姿无缝融合。她双眼紧闭，表情平静而内省，双臂高举过头，呈流畅的舞蹈姿态。她穿着一件半透明的现代上衣，让红色花卉投影与她的身形互动。灯光富有戏剧性且柔和，深黑色背景与鲜艳的红色花朵色调形成高对比。构图感觉像是美术摄影与当代舞蹈和投影映射的结合。梦幻、情感和诗意的氛围。超细节纹理、柔和阴影、平滑运动模糊、画廊风格的超现实主义。",
  
  "negative_prompt": "低分辨率、刺眼灯光、平淡色彩、杂乱背景、过度曝光、塑料皮肤、扭曲解剖结构、多余肢体、卡通风格、插画、水印、标志、文字",
  
  "style": {
    "aesthetic": "超现实美术摄影、投影艺术",
    "mood": "诗意、情感、内省",
    "color_palette": ["深红色", "绯红色", "黑色", "柔和肤色"]
  },
  ...
  "quality": {
    "resolution": "超高",
    "detail_level": "高",
    "realism": "超现实叠加下的照片级真实感",
    "render_style": "艺术画廊、电影感，无 HDR"
  }
}
```
