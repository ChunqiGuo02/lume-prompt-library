---
id: "portrait-red-the-chicken-001"
title: "红白条纹桶装炸鸡广告"
category: portrait
subcategory: "03_创意广告品牌设计"
aesthetic: null
tags: ["炸鸡", "辣椒", "麦当劳", "美食", "广告", "深红", "红色", "金色"]
recommended_models: []
recommended_params:
  aspect_ratio: "1:1"
  quality: null
...
## 中文译文（源站提供）
一部电影质感的美食广告，画面中心是一个 【红白条纹纸质炸鸡桶】，里面装满了金黄酥脆的炸鸡块，背景为 【深暗红色】，并配有戏剧性的摄影棚灯光。炸鸡桶位于画面中央，溢出的炸鸡块纹理丰富、金黄酥脆，仿佛正在爆炸并向上漂浮。场景周围散落着 【鲜艳的红色、粉色和白色五彩纸屑】，细小的金黄色炸鸡碎屑向四面八方飞溅和漂浮。背景为浓郁的深绯红色，后上方透出柔和的暖色聚光灯，营造出戏剧性的焦外成像氛围。下方表面散落着碎屑和纸屑，地面呈现出微妙的红色反光。超写实商业美食摄影，爆炸性的庆祝能量，高对比度戏剧性灯光，浅景深，飞行碎屑带有动态模糊，8K 超精细纹理，竖屏构图。
