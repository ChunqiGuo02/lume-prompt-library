---
id: portrait-the-character-ultra-realistic-1168
title: "日系校服少女写真预设"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["女生", "短发", "刘海", "制服", "写实", "高清", "深景深", "电影感"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
## 中文译文（源站提供）
把一个漫画人物变成一个超现实的人----提示----将这个漫画角色变成一个超现实的人，同时保留原始的发型、服装、面部表情和整体角色身份。整个场景应该使用深景深，保持模型和环境都非常清晰，创造出身临其境的、电影般的智能手机摄影效果。样式：-电影级超现实时尚摄影-高分辨率智能手机摄像头美学，细节清晰锐利-温暖的工作灯和凉爽的黄昏色调之间形成鲜明的照明对比-模型是主体，同时保留了丰富的环境细节技术规格：-相机：旗舰智能手机相机-镜头：标准内置手机镜头-光圈：f/8–f/11，用于景深-分辨率：4K或更高负面提示：-背景模糊，景深浅，散景-失焦、扭曲的脸-卡通、动漫、CGI角色、插图
