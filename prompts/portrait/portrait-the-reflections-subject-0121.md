---
id: portrait-the-reflections-subject-0121
title: "“Revving Style”系列——Gemini Nano Banana 3.0版本正式发布！"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["展厅", "超跑", "红色", "黑色", "皮革", "轻奢", "时尚", "酷感"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
version: "1.0.0"
related_to: ["interior-the-reflections-subject-002"]
---
...
{
  "prompt": {
    "reference_photo": "使用上传的参考照片。请勿更改人物的面部特征。人物的外貌必须与上传的照片完全一致。",
    "scene": {
      "setting": "时尚、光线柔和的豪华展厅",
      "subject_position": "坐在一把鲜红色的豆袋椅上，位置稍微偏中心",
      "midground": "一辆色彩鲜艳的红色超级跑车，前保险杠线条分明，进气口设计独特，细节部分采用光泽黑色处理",
      "background": {
        "ceiling": "对角线排列的粗黑条纹，通过柔和的反射营造出立体感",
        "right_side": "一个光泽黑色的鳄鱼纹图案行李包，放在布满斑点的混凝土地面上，周围有散射的光线反射",
        "left_side": "另一把红色豆袋椅以及一些简约的赛车主题装饰，为场景增添了适度的色彩点缀",
        "mirrored_wall": "展厅标识、赛车头盔展示架以及风格化的赛道轮廓的倒影"
      }
    },
    "subject": {
      "identity": "人物的外貌必须与参考照片完全一致",
      "outfit": {
        "jacket": "哑光黑色皮夹克，缝线有立体感，袖口部分设计为折叠式",
        "trousers": "宽松的黑色皮裤，裤脚处略微堆积",
        "shoes": "厚底黑色板鞋，表面光泽度高",
        "posture": "双臂交叉，姿势放松自信，通过微妙的反射效果突出皮料的质感"
      },
    "supercar_details": {
      "lighting_effects": "车头引擎盖在深邃的阴影与明亮的反射光之间变换着光泽",
      "rims": "黑色轮圈，安装在空气动力学设计的挡泥板下方",
      "windshield": "经过抛光的挡风玻璃，能捕捉到车内微弱的反射光"
    },
    "micro_details": [
      "混凝土地面上的灰尘颗粒",
      "皮革表面的细微反光",
    ...
    "camera_style": "自然、真实的画质，仿佛是用iPhone相机拍摄的",
    "constraints": "不允许对人物面部进行任何修改——必须保持与参考照片中完全相同的面部特征"
  }
}
