---
id: portrait-the-reflection-top-0885
title: "奢华餐厅镜前自拍，捕捉优雅欢笑瞬间"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["自拍", "餐厅", "复古", "优雅", "浪漫", "暖调", "烛光", "愉悦"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
version: "1.0.0"
related_to: ["interior-the-reflection-top-001", "interior-the-reflection-top-003"]
---
...
```json
{
  "prompt_details": {
    "subject": {
      "description": "年轻女子，留着浓密蓬松的棕色长发，发梢微卷，中分。她杏眼，眉毛弯曲，五官分明。",
      "expressions": [
        "顶部：微妙而自信的微笑，眼神直接与镜中的自己对视。",
        "底部：真诚而开心的笑声，双眼紧闭，头向后仰。"
      ],
      "attire": {
        "top_image": "黑色高领无袖上衣，精致简约。",
        "bottom_image": "黑色无肩带连衣裙，带有微妙的闪光纹理（亮片或微光）。"
      },
      "accessories": [
        "精致的银色项链（网球链或类似款式）",
        "细款金/银手链",
    ...
    "lighting": {
      ...
      "sources": [
        "复古台灯发出的柔和光芒，带有暖色调灯罩",
        "烛光（底部画面中有一支显眼的高大白色蜡烛）",
        "镜子反射的环境光"
      ],
      "effect": "室内黄金时段色调，头发和皮肤上的柔和高光，丰富的阴影。"
    },
    "camera_and_tech": {
      "style": "超写实主义，8k 分辨率，抓拍式生活摄影。",
      "camera_simulation": "智能手机后置摄像头（iPhone Pro 风格），大光圈（f/1.8）以获得景深。",
      "focus": "镜中主体对焦清晰，前景元素（酒杯柄、蜡烛）柔和散景。",
      "color_grading": "温暖、电影感、略带颗粒感的低光纹理，对比度丰富。"
    },
