---
id: portrait-face-beauty-skin-2908
title: "高角度时尚街拍人像"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["亚裔", "街拍", "时尚", "黑发", "红唇", "酒红", "冷调", "高角度"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
version: "1.0.0"
related_to: ["architecture-face-beauty-skin-001"]
---
  ...
  "subject": {
    ...
    "clothing": {
      "top": {
        ...
        "color": "{"top color" "dark crimson red"} ",
...
{
  "subject": {
    "description": "一位时尚亚洲网红的惊艳高角度特写，散发着酷炫迷人的气质。",
    "age": "20多岁",
    "expression": {
      "eyes": {
        "look": "锐利的狐狸眼，目光穿透镜头",
      ...
      "mouth": {
        "position": "放松的嘴唇，微妙的坏笑",
        "energy": "时尚"
      },
      "overall": "惊艳，极具视觉冲击力的美"
    },
    "face": {
      "preserve_original": false,
      "makeup": "高对比度妆容，苍白瓷肌，渐变红唇，下颌线分明，V 形脸",
      "style": "冷色调美感，K-pop 偶像视觉效果"
    },
    "hair": {
      "color": "黑色",
      "style": "长直发，齐刘海",
    ...
    "body": {
      ...
      "pose": {
        "position": "明显前倾",
        "overall": "动态透视缩短，强调头部和上半身"
      },
      "skin": {
        "tone": "冷白皮",
        "lighting_effect": "面部提亮，柔和美颜光，无暗影"
      }
    },
    "clothing": {
      "top": {
        "type": "超细针织上衣",
        "color": "{\"top color\" \"深绯红色\"} ",
        "details": "高领，紧身剪裁，轻薄面料（非厚重）",
        "effect": "完美勾勒身体曲线，质地光滑"
      },
      "bottom": {
        "type": "深色铅笔裙",
        "details": "高腰设计，配有细款奢华腰带"
      }
    }
  },
  "photography": {
    ...
    "shot_type": "中景特写",
    "aspect_ratio": "9:16",
    "texture": "清晰，锐利，略带美颜滤镜",
    "lighting": "阴天冷调日光，柔和散射光"
  },
  "background": {
    "setting": "欧洲古典建筑",
    "atmosphere": "时尚街角",
