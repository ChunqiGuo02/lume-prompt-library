---
id: "portrait-the-container-red-001"
title: "工业风集装箱前的金发女性时尚写真"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: industrial-loft
tags: ["低角度", "女性", "金发", "粉色", "蓝色", "白色", "红色", "集装箱"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
{
  "image_description": "一名年轻的西方女性，金发，以高角度、低视角全身肖像的形式，坐在一艘红色工业集装箱的边缘。",
  "subject": {
    "person": "年轻的西方女性，身材健美，表情严肃，目光从镜头移开，望向远方。",
    "hair_style": "金色长发",
    "clothing": {
      "jacket": "浅灰色菱格纹羽绒飞行员夹克。",
      "undershirt": "纯白色圆领 T 恤。",
      "pants": "经典中度水洗蓝色直筒牛仔裤。",
      "footwear": "干净、亮白的皮革低帮运动鞋。"
    },
    "pose": "轻松地坐在金属集装箱的边缘，双腿悬空，身体稍微向后靠在右手上。"
  },
  "setting": {
    "location": "工业货运堆场或港口。",
    "background_elements": [
      "堆叠的波纹状红色金属集装箱。",
      "主体身后有一个垂直的红色集装箱，形成强烈的引导线。",
      "主体下方集装箱上可见黄色模板字母。"
    ],
    "atmosphere": "都市、粗犷而又整洁，现代街头服饰美学。"
  },
  "composition_and_lighting": {
    "camera_angle": "低角度仰视，营造出规模感和高度感。",
    "lighting": "自然、漫射的日光；柔和的阴影；阴沉的天空提供均匀的照明。",
    "color_palette": [
      "主色调：大胆的工业红",
      "辅助色调：牛仔蓝、浅灰色和纯白色",
      "背景：柔和的灰/白色天空"
    ],
    "lens_effects": "深景深，主体和集装箱的即时纹理清晰对焦。"
  },
  "technical_tags": "街头摄影、建筑线条、超现实主义、8k 分辨率、电影级灯光、工业时尚拍摄。"
}
