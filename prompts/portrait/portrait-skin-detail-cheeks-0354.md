---
id: portrait-skin-detail-cheeks-0354
title: "冬日暖光下的电影感肖像"
category: portrait
...
```json
{
  "Objective": "创作一幅超现实、电影感的肖像画，以温暖、柔和和逼真的细节，传达一种亲密的冬季故事氛围。",
  "Persona_Details": {
    "Subject": "年轻成年女性",
    "Facial_Features": {
      "Eyes": "引人注目的蓝色眼睛",
      "Skin": "柔和的玫瑰色肤色，具有逼真的纹理",
      "Freckles": "鼻子和脸颊上有自然的雀斑",
      "Cheeks": "因寒冷天气而略微泛红的脸颊"
    },
    "Hair": {
      "Color": "深棕色",
      "Style": "松散的发丝环绕脸庞",
    ...
    "Expression": "温柔、平静的表情，带有一丝好奇"
  },
  "Wardrobe_and_Props": {
    "Clothing": {
      "Type": "厚实的针织羊毛衫",
      "Color_Palette": "大地棕色和灰色调"
    },
    "Prop": {
      "Item": "小巧质朴的礼物",
      "Wrapping": "用麻绳捆绑的牛皮纸"
  ...
  "Lighting": {
    "Primary_Light": "柔和的自然窗光",
    "Secondary_Light": "温暖的环境室内照明",
    "Mood": "温暖、亲密、舒适",
    "Shadows": "柔和自然"
  },
  "Photography_Style": {
