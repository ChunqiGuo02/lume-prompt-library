---
id: portrait-the-hotel-slightly-1072
title: "意式度假风写真：阳光下的惬意笑容"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["户外", "露台", "咖啡馆", "夏日", "度假", "白裙", "美女", "愉悦"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
# 正文 prompt
{
  ...
  "environment": {
    ...
    "background_elements": "Historic yellow building with '{"hotel name" "HOTEL FLORENCE"}' signage, lush green mountains in the distance, cloudy blue sky, vintage globe street lamps",
...
```json
{
  "prompt_type": "超逼真图像生成",
  "subject": {
    "description": "年轻女子，一头乌黑亮丽的直发披散在背部",
    "skin_tone": "阳光亲吻般的肤色，容光焕发",
    "features": "侧脸可见，面带微笑/开怀大笑的表情，双手抬起遮住眼睛/脸庞，显得俏皮可爱",
    "details": "红色美甲，佩戴精致首饰，左手戴戒指，手腕戴细手链"
  },
  "fashion_and_styling": {
    "outfit": "白色复古风格紧身胸衣式迷你连衣裙，带有瑞士圆点纹理",
    "garment_details": "甜心领口，荷叶边泡泡袖，正面系带蝴蝶结细节，修身胸衣，荷叶边下摆，面料略带透明感",
    "aesthetic": "娇媚、田园风、柔美奢华、夏日度假风情"
  },
  "pose_and_action": {
    "pose": "优雅地坐在椅子上，身体略微偏离镜头",
    "gesture": "双手抬起遮挡阳光，或在开怀大笑的瞬间，头部微微后仰",
    "interaction": "在咖啡馆桌旁放松地坐着"
  },
  "environment": {
    "setting": "户外豪华酒店露台或咖啡馆阳台，俯瞰风景优美的景色",
    "background_elements": "带有“{\"hotel name\" \"HOTEL FLORENCE\"}”字样的历史悠久的黄色建筑，远处郁郁葱葱的绿色山脉，多云的蓝色天空，复古地球仪路灯",
    "foreground_elements": "圆形玻璃桌面，黑色铸铁花园椅",
    "props": "桌上放着两个带碟子的白色陶瓷咖啡杯，一本平装书"
  },
  "lighting": {
    "type": "自然明亮的日光，午后阳光",
    "quality": "高对比度，在桌上投下清晰的阴影，头发上的逆光营造出光晕效果，阳光普照的氛围",
    "direction": "侧面/正面照明照亮主体"
  },
  "mood_and_atmosphere": {
    "vibe": "欢乐、真诚、奢华、无忧无虑、意大利夏日假期",
    "emotion": "幸福、放松、俏皮"
  },
  "technical_camera_details": {
    "quality": "8k 分辨率，RAW 照片，超现实，高度精细的纹理",
    "camera_simulation": "数码单反相机，85mm 人像镜头",
    "aperture": "f/2.8（浅景深以虚化背景山脉和酒店）",
    "shutter_speed": "1/500s（定格抓拍瞬间）",
    "iso": "100（干净，无噪点图像）",
    "color_grading": "鲜艳、自然的色彩，略带暖色调，清晰的白色"
  }
}
```
