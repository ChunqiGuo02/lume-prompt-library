---
id: portrait-face-reference-features-2827
title: "高定银钻礼服女性写真，精准复刻面部特征"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["肖像", "奢华", "优雅", "自信", "银色", "卷发", "礼服", "水晶"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
version: "1.0.0"
related_to: ["landscape-face-reference-features-001"]
---
...
```json
{
  "image_request": {
    ...
    "face_and_expression": {
      "features": "与参考图像完全一致的引人注目、精致的面部特征",
      "expression": "平静、自信、优雅",
      "skin": {
        "finish": "自然、无瑕、逼真的质感",
        "tone": "温暖、均匀、未经修饰"
