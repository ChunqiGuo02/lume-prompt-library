---
id: portrait-the-glass-red-2559
title: "雨夜出租车内神秘女子的电影感写真"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["电影感", "神秘", "女性", "雨夜", "霓虹", "夜景", "忧郁", "胶片感"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
```json
{
  "image_prompt": {
    ...
    "subject": {
      "description": "24 岁女性，散发着精致、神秘的气息",
      "face": "透过被雨水浸湿的车窗可见，脸贴近玻璃，眼睛凝视着城市灯光",
      "skin": "沐浴在汽车尾灯发出的深红色光芒中，显得柔和而水润",
      "hair": "波浪散发，发梢因雨水而略微湿润",
      "pose": "蜷缩在出租车的皮革后座上，额头抵着玻璃，一只手轻触颈部",
      "outfit": "透明黑色蕾丝上衣，宽松地披着一件超大号皮草外套"
    },
    "environment": {
      "location": "夜间暴雨中行驶的汽车后座",
      "background_elements": [
        "车窗玻璃上大小不一的雨滴模糊了城市散景",
        "深色、昂贵的皮革内饰，带有红色缝线",
        "玻璃上反射的红色霓虹灯“TAXI”标志"
    ...
    "photography_style": {
      "style": "忧郁的电影剧照美学",
      "camera_look": "快速定焦镜头 (85mm)，浅景深",
      "imperfections": "窗户上的冷凝水，雨滴上的色差，真实的胶片颗粒",
      "mood": "亲密、诱惑、忧郁、夜色"
    },
    "render_quality": {
      "realism": "光线穿过水和玻璃的折射",
      "detail_level": "聚焦于玻璃上清晰的雨滴与后面柔焦的脸部之间的对比"
    }
  }
}
```
