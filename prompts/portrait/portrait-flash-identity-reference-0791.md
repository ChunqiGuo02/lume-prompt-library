---
id: portrait-flash-identity-reference-0791
title: "夜色中的深情情侣"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["车内", "夜晚", "雨天", "情侣", "亲密", "黑色", "Y2K", "闪光灯"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
{
  "生成约束条件": {
    "身份保持": "对参考照片中的两个人物都进行严格的身份锁定（确保面部特征完全一致）",
    "面部特征": "不得修改面部、比例或自然表情",
    "风格参考": "原始的Y2K年代夜间照片风格"
  },
  "相机设置": {
    ...
    "角度": "与眼睛平视的角度",
    "构图": "中景拍摄",
    "技术": "使用强直射式前置闪光灯（相机内置闪光灯）"
  },
  "人物细节": {
    "姿势互动": {
      "位置": "两人并坐在汽车后座上",
      "男性动作": "轻轻搂住女性的脖子，亲吻她的太阳穴",
      "女性动作": "轻轻向男性靠拢，眼睛闭上",
      "情绪": "平静、亲密、安详"
    },
    "服装": {
  ...
  "光线与氛围": {
    "主要光源": "强直射式前置闪光灯",
    "环境光线": "车内无自然光线（环境较暗），室外有模糊的暖色调城市灯光",
    "对比度": "人物边缘的对比度较高，人物身后有清晰的阴影",
    "高光效果": "皮肤和湿润玻璃表面有明显的闪光灯高光"
  },
  "环境背景": {
    "场景设置": "夜间在车内",
    "背景元素": "车窗上凝结着雨滴，形成雾蒙蒙的效果",
    "视觉效果": "闪光灯的光线在玻璃上反射，寒冷的夜空中带有轻微的雾气",
    "空间感": "背景保持深沉和昏暗，同时带有柔和的模糊效果"
  }
}
