---
id: portrait-orange-dress-likeness-1437
...
# 正文 prompt
{
  ...
  "environment": {
    ...
    "background": "Solid seamless vibrant orange backdrop and floor",
    "props": "None (clean surface)",
    "lighting": "Soft frontal key light, warm calibration, controlled shadows"
  },
  "subject": {
    "likeness": "{"celebrity likeness" "Sydney Sweeney"}-inspired (not identical)",
...
```json
{
  ...
  "environment": {
    "setting": "极简专业摄影棚",
    "background": "纯色无缝鲜橙色背景和地面",
    "props": "无（干净表面）",
    "lighting": "柔和正面主光，暖色调校准，受控阴影"
  },
  "subject": {
    "likeness": "受 {\"celebrity likeness\" \"Sydney Sweeney\"} 启发（非完全相同）",
    "demographics": "女性，20 多岁，身材苗条健美",
    "features": {
      "skin": "自然白皙，古铜色光泽高光，真实纹理",
      "hair": "长款浅金色，蓬松，侧分",
      "face": "柔和鹅蛋脸，丰满双唇，明亮有神的眼睛",
      "makeup": "高调魅力妆，立体修容，烟熏眼妆，光泽裸色唇"
    }
  },
  "wardrobe": {
    "dress": "无肩带迷你连衣裙，浓密柔软的橙色羽毛质感",
    "shoes": "配套橙色尖头细高跟鞋",
    "jewelry": "金色大耳环，细链，叠戴手镯，戒指"
  },
  "technical": {
    "gear": "全画幅单反相机，85mm 定焦镜头",
    "settings": "光圈 f/4，ISO 100，快门 1/125s",
    "focus": "主体锐利对焦，背景轻微分离"
  },
  "composition": {
    "angles": "平视到轻微低角度",
    "framing": ["全身", "四分之三身", "特写肖像"],
    "poses": [
      "双腿盘坐跪姿",
      "单膝抬起坐姿",
      "翘臀站姿",
  ...
  "consistency_rules": {
    "fixed_elements": ["人物特征", "羽毛连衣裙", "橙色背景"],
    "variable_elements": ["姿势", "拍摄角度", "构图"]
  }
}
```
