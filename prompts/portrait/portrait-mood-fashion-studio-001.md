---
id: "portrait-mood-fashion-studio-001"
title: "北欧极简风女性秋装写真系列"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: nordic-minimal
tags: ["肖像", "极简", "北欧", "时尚", "秋季", "驼色", "暖色调", "眼镜"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
version: "1.0.0"
related_to: ["portrait-mood-fashion-studio-002"]
---
...
# 正文 prompt
{
  ...
  "Wardrobe": {
    "Top": "Chunky {"sweater color" "camel-colored"} knit turtleneck sweater",
...
```json
{
  "Objective": "创作一组极简主义时尚影棚肖像系列，营造宁静的斯堪的纳维亚编辑风格氛围",
  "PersonaDetails": {
    "Subject": {
      "Type": "年轻女性",
      "Hair": "短款、柔和波浪的深棕色头发",
  ...
  "SceneDescription": {
    "Environment": "极简主义影棚",
    "Background": "中性米白色背景",
    "OverallFeel": "干净、通透、低调"
  },
  "PortraitSeries": {
    "SeriesType": "四张图片系列",
    "Poses": [
      {
        "Description": "坐姿，双手轻柔地托住下巴",
        "Mood": "安静、沉思"
      },
      {
        "Description": "正面肖像，双眼低垂",
        "Mood": "柔和、冥想"
      },
      {
        "Description": "四分之三侧面特写，双臂交叉",
        "Mood": "沉着、深思"
      },
      {
        "Description": "特写肖像，毛衣袖子靠近脸部",
        "Mood": "亲密、触感"
      }
    ]
  },
  "Composition": {
    "Framing": "从特写到中景的多种构图",
    "NegativeSpace": "宽裕、平衡的留白",
    "DepthOfField": "浅景深，营造柔和的分离感"
  },
  "LightingAndColor": {
    "Lighting": "柔和、漫射的影棚灯光",
    "Highlights": "微妙、自然的亮点",
    "ColorPalette": "柔和的暖中性色（驼色、米色、米白色）"
  },
  "ArtDirection": {
    "Style": "斯堪的纳维亚编辑摄影",
    "Aesthetic": "极简主义、永恒、低调奢华",
    "TextureEmphasis": "针织面料和自然皮肤细节"
  },
  "PhotographyStyle": {
    "Genre": "专业时尚影棚摄影",
    "RealismLevel": "高写实度，克制处理",
    "Finish": "干净、现代、杂志级效果"
  },
  "Mood": {
    "Tone": "平静、内省、宁静",
    "SeasonalFeel": "秋日温暖与静谧优雅"
  },
  "NegativePrompt": [
    "杂乱的背景",
    "刺眼的灯光",
