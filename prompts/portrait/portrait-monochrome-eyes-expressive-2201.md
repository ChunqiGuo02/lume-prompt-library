---
id: portrait-monochrome-eyes-expressive-2201
title: "超写实单色肖像：眼神与光影的艺术"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["黑白", "肖像", "女性", "短发", "雀斑", "蕾丝", "简约", "艺术"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "16:9"
...
# 正文 prompt
{
  ...
  "subject": {
    ...
    "appearance": {
      ...
      "skin": "fair complexion with subtle freckles and realistic texture",
      "lips": "softly defined, natural shape",
      "expression": "calm, intense, direct gaze"
    },
    "clothing": {
...
## 中文译文（源站提供）
{
  "描述": "这是一幅极具电影感的超写实单色肖像画，描绘了一位年轻女性：她的眼神充满表现力，目光平静而深邃。",
  "主体": {
    "性别": "女性",
    "外貌": {
      "头发": "短发，颜色深沉，造型整齐",
      "眼睛": "引人注目，带有反光的高光，极具表现力",
      "皮肤": "肤色白皙，带有细小的雀斑，质感逼真",
      "嘴唇": "轮廓柔和，形状自然",
      "表情": "目光平静、深邃且直视前方"
    },
    "穿着": "穿着黑色服装，搭配白色纹理领口，形成鲜明对比"
  },
  "环境": {
    "背景": "光滑的单色渐变背景，风格极简，突出了人物的面部特征"
  },
  "光线": {
    "风格": "柔和但对比度强烈的单色光线",
    "细节处理": "面部特征上有淡淡的高光，阴影层次细腻",
    "效果": "具有电影质感，画面干净、精致"
  },
  "摄影设备": {
    "类型": "特写肖像镜头",
    "质量": "超写实，高分辨率，细腻的色调层次",
    "对焦": "眼睛和面部细节清晰可见，背景渐变自然"
  },
  "美学风格": {
    "色调": "极简主义，艺术感强，优雅大气",
    "特点": "高质的纹理细节处理，清晰的单色渲染效果，极高的逼真度"
  }
}
