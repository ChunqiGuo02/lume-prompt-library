---
id: portrait-winter-editorial-ice-2654
title: "雪域高定：冰川上的时尚肖像"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["冬季", "时尚", "人像", "雪山", "雪景", "冰块", "黑色", "白色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
# 正文 prompt
{
  ...
  "subject": {
    ...
    "wardrobe": {
      "outerwear": "{"outerwear" "Black oversized puffer jacket"}",
...
```json
{
  "objective": "在阿尔卑斯山环境中，生成一张具有电影级奢华美学的高级时装冬季编辑肖像。",
  "subject": {
    "type": "human",
    "description": "年轻女性",
    "pose": {
      "body_position": "坐在一块雕刻过的冰块上",
      "legs": "双腿分开",
      "hand_position": "一只戴手套的手轻轻地靠在脸颊上",
      "expression": "放松而有力"
    },
    "wardrobe": {
      "outerwear": "{\"outerwear\" \"黑色超大号羽绒服\"}",
      "pants": "白色阔腿滑雪裤",
      "footwear": "白色奢华冬季靴，配红色鞋带",
      "accessories": "毛绒白色毛皮帽，遮住耳朵",
      "gloves": "冬季手套"
    }
  },
  "environment": {
