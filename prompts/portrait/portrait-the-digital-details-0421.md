---
id: portrait-the-digital-details-0421
title: "千禧镜前自拍少女"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["Y2K", "复古", "库洛米", "肖像", "镜面", "闪光灯", "冷色调", "蓝调"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
## 中文译文（源站提供）
{
  "image_generation_request": {
    "constraints": {
      "preservation Instruction": "请保持我的面部特征完全不变，不要修改任何面部细节。",
      "strictness": "严格"
    },
    "technical_specifications": {
      "camera_device": "佳能IXY/IXUS数码相机",
      "aesthetic_style": [
        "Y2K数字美学风格",
        "网络美妆风格（Cyber Ulzzang）",
        "复古日韩风格",
        "21世纪初的数码照片风格"
      ],
      "lighting": {
    ...
    "composition": {
      "type": "肖像",
      "meta_scene_element": "镜子中的倒影显示另一个女人正在为模特拍照"
    },
    "subject_details": {
      "demographics": "少女",
      "physical_appearance": {
