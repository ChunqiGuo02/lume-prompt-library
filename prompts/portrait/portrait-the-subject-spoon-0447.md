---
id: portrait-the-subject-spoon-0447
title: "厨房少女抱巨勺微笑写真"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["厨房", "少女", "巨型", "勺子", "金属", "棕色", "毛衣", "蓝色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
```json
{
  ...
  "identity_preservation": {
    ...
    "alter_face": false,
    "alter_features": false,
    "notes": "精确保留主体面部特征、比例、皮肤纹理、发型、年龄和性别，与参考图像一致。"
  },
  "environment": {
    "location": "主体自己的厨房",
    "background": [
  ...
  "subject": {
    ...
    "pose": {
      "position": "站立",
      "body_language": "放松自然",
      "hands": "双手环抱一把巨大的金属勺子，置于身体前方"
    },
    "expression": "自然微笑，直视镜头",
    "wardrobe": {
      "top": "棕色针织毛衣",
      "bottom": "蓝色牛仔裤"
    },
  ...
  "camera": {
    ...
    "angle": "平视",
    "focus": "主体和勺子对焦清晰",
    "depth_of_field": "自然景深，背景略微柔化"
  },
  "quality": {
    "realism": "高度写实，自然照片效果",
    "details": "衣物、金属勺和厨房元素的纹理清晰"
  },
  "constraints": [
    "无人工照明效果",
    "无风格化或奇幻元素",
  ...
  "output_goal": "创作一张自然、写实的照片，画面中一位女性站在自己的厨房里，面带微笑地看着镜头，怀抱一把巨大的闪亮金属勺，窗户透进的柔和日光照亮整个场景。"
}
```
