---
id: portrait-full-arm-chest-0257
title: "传统艺伎与满身和风纹身的高对比影棚肖像"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: japanese-zen-garden
tags: ["艺伎", "纹身", "和服", "日式", "人像", "影棚", "传统", "妆容"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
```json
{
  "prompt_type": "generate",
  "scene": {
    "effect_type": "高对比度影棚肖像，具有编辑级的精准度",
    "camera": {
      "position": "中景全身照，与拍摄对象胸部齐高",
      "direction": "正对拍摄对象，拍摄对象四分之三侧身面向镜头",
      "lens_mm": "85-105mm",
      "aperture": "f/8",
      "angle": "平视直拍经典肖像",
      "psychological_intent": "经典肖像权威感——干净、自信、尊重的记录，确保纹身覆盖和艺妓造型清晰且富有表现力"
    }
  },
  "subject": {
    "description": "日本女性，20 多岁中期，传统艺妓造型——面部涂有无瑕的白色白粉，妆容精致，眉毛剃掉后用淡炭笔向上重绘，眼线用朱红色和黑色以传统风格精准描绘，带有微妙的眼尾，嘴唇只在内侧涂红，营造出经典的樱桃小口错觉，精致的岛田发髻漆黑如墨，插有多枚簪子，包括玳瑁梳、银色花卉发簪和摇曳的 Bira-Bira 饰物——全身传统日式入墨纹身清晰可见：双臂纹身从手腕到肩膀连续覆盖，右臂纹有 {\"right arm tattoo\" \"逆流而上的锦鲤，穿梭于汹涌的波涛之中\"}，带有水花细节，左臂纹有 {\"left arm tattoo\" \"盘绕的龙，被风纹和牡丹环绕\"}，鳞片清晰可见，巨大的胸部纹身从锁骨延伸至胸骨，描绘了在菊花丛中腾飞的凤凰，羽毛细节以朱红色和金色呈现，腹部纹身显示了从火焰中浮现的般若面具上半部分，带有渐变色的角，背部纹身是咆哮的老虎穿梭于竹林和枫叶之间，环绕肋骨并延伸至耳后颈部，通体采用大胆的手雕风格轮廓，并以精湛的 Bokashi 渐变阴影技法呈现黑色、灰色、朱红色、金色和玉绿色",
    "action": "静态摆姿",
    "body_position": "站立，重心偏向一侧臀部，形成微妙的 S 形曲线，双臂自然垂于身体两侧，双手略微前伸以展示手部纹身，双肩向后，胸部敞开以展示完整的正面覆盖，头部略微倾斜，下巴微抬",
    "clothing": "黑色丝绸和服从双肩滑落，戏剧性地堆积在腰部，由一条宽大的酒红色腰带系在肋骨下方，传统的白色 Sarashi 胸部束缚带以整齐的水平条带束缚胸部，露出双肩、胸骨、腹部和整个手臂",
    "accessories": "多枚簪子，包括玳瑁梳、银色花卉发簪、捕捉光线的摇曳 Bira-Bira 饰物、精致的玉石耳坠",
    "movement": "无，沉静的姿态",
    "expression": "威严的宁静——目光直视镜头，带着沉静的自信，涂抹的嘴唇微微闭合，暗示着一丝微笑，散发出一种深知自己是谁的平静力量"
  }
}
```
