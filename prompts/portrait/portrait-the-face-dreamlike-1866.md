---
id: portrait-the-face-dreamlike-1866
title: "精准复刻人脸的梦幻写真"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["肖像", "写实", "女性", "黑发", "黑色", "缎面", "长裙", "优雅"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
version: "1.0.0"
related_to: ["portrait-the-face-dreamlike-001"]
---
...
# 正文 prompt
{
  ...
  "subject": {
    ...
    "appearance": {
      ...
      "accessories": [
        "{"accessory 1" "sunglasses creating a cool, effortless aura"}",
        "{"accessory 2" "single thin silver necklace"}"
      ]
    }
  },
  "wardrobe": {
    "top": "{"top garment" "white oversized knitted shirt made of soft, textured fabric"}"
  },
  "environment": {
    "background": {
      "color": "{"background color" "neutral cream wall"}",
...
```json
{
  ...
  "subject": {
    ...
    "appearance": {
      ...
      "accessories": [
        "{\"accessory 1\" \"墨镜，营造出酷炫、不费力的氛围\"}",
        "{\"accessory 2\" \"一条细细的银项链\"}"
      ]
    }
  },
  "wardrobe": {
    "top": "{\"top garment\" \"白色宽松针织衫，由柔软有质感的面料制成\"}"
  },
  "environment": {
    "background": {
      "color": "{\"background color\" \"中性米色墙壁\"}",
      "style": "极简主义且干净"
    }
  },
  "lighting": {
