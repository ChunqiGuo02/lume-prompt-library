---
id: portrait-realism-midjourney-street-2549
title: "雨中少女凝视镜头"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["写实", "电影感", "人像", "人群", "雀斑", "雨天", "红色", "虚化"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
```json
{
  "Objective": "创作一幅电影感十足、情感丰富的 AI 生成街头肖像，风格类似于 Midjourney 的写实主义，适合作为故事轮播图的最后一页。",
  "Narrative_Caption": {
    "Primary_Text": "在熙攘的人群中，那些静止不动的人，发出了最响亮的声音。🎞✨",
    "Description": "Midjourney 创造的电影级写实美学——充满情感，每一张面孔都像一个等待被讲述的故事。"
  },
  "Visual_Style": {
    "Theme": "Midjourney 电影写实主义",
    "Mood": "忧郁、情感丰富、氛围感强",
    "Lighting": "柔和、电影般的对比度，具有戏剧性的焦外虚化景深",
    "Color_Palette": "温暖的街头色调与都市中性色调混合",
    "Depth": "强烈的景深，模糊的人群，清晰的主体",
    "Texture": "高细节写实主义，突出富有表现力的面部纹理"
  },
  "Scene_Description": {
    "Setting": "充满动态和多样人群的都市街头环境",
    "Atmosphere": "繁忙的人群中，一个静止的人物营造出视觉张力和叙事对比",
    "Composition": "大量焦外虚化的人群动态，一个平静的主体锚定画面"
  },
  "Aesthetic_Tags": [
    "midjourney",
    "电影写实主义",
  ...
  "Output_Requirements": {
    "Use_Case": "轮播图最后一页文案、电影级 AI 艺术展示、故事性帖子",
    "Format": "图像或文案元数据",
    "Style": "电影感、叙事驱动、情感丰富"
  }
}
