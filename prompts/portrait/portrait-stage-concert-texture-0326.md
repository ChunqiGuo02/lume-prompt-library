---
id: portrait-stage-concert-texture-0326
title: "全球流行天后舞台表演写真，奢华运动风造型，璀璨灯光氛围"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["女歌手", "演唱会", "舞台", "米色", "浅金发", "麦克风", "观众", "紫色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
# 正文 prompt
{
  "prompt_structure": {
    ...
    "attire_details": {
      "outfit": "Monochromatic premium {"outfit color" "beige"} athleisure set",
...
```json
{
  "prompt_structure": {
    "subject_description": {
      "main_character": "全球流行巨星女歌手站在舞台中央",
      "appearance": "铂金色长发，松散的迷人波浪卷，妆容精致，轮廓分明，唇部丰盈，表情自信",
      "pose": "充满力量的姿态，全身照，双手握着镶钻的银色麦克风"
    },
    "attire_details": {
      "outfit": "单色优质 {\"outfit color\" \"米色\"} 运动休闲套装",
      "top": "短款拉链连帽衫，带结构化衣领",
      "bottoms": "配套的高腰阔腿运动裤，带中央缝线细节",
      "footwear": "厚底白色运动鞋",
      "accessories": "精致的钻戒，闪亮的垂坠耳环"
    },
    "environment_context": {
      "location": "大型室内体育馆演唱会",
      "background": "半暗的观众席中，数千支手机闪光灯亮起，营造出星光斑驳的散景效果",
      "stage_elements": "大型 LED 屏幕显示紫色和紫罗兰色的抽象几何视觉效果，几何舞台地板设计"
    },
    "lighting_atmosphere": {
      "lighting_type": "高规格演唱会灯光，电影级逆光",
      "color_palette": "电光紫，深洋红，柔和的暖米色，冷白色舞台光束",
      "mood": "充满电光，活力四射，狂喜，宏大壮观"
    },
    "technical_specifications": {
      "quality": "超现实，UHD，8k 分辨率，照片级写实杰作",
      "camera_settings": "低角度仰视拍摄，主体清晰对焦，景深模糊远处的观众",
      "texture": "运动服上细致的织物纹理，皮肤纹理，麦克风上的金属光泽"
    }
  },
  "generation_parameters": {
    "aspect_ratio": "9:16",
    "orientation": "垂直 (长)",
    "style_preset": "美学演唱会摄影"
  }
}
```
