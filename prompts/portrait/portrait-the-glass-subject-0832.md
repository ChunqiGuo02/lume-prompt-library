---
id: portrait-the-glass-subject-0832
title: "奇幻时尚：刺绣蝶舞的忧郁才女"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["超现实", "时尚", "复古", "红发", "飞蛾", "放大镜", "丝绒", "绿色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
    ...
    "garments": [
      {
        ...
        "color": "{"blazer color" "Deep Emerald Green and Gold"}",
...
{
  "vibe_title_en": "Eclectic Metamorphosis",
  "master_prompt": "一幅超现实主义的中景照片，描绘了一位杰出的主人公，她化身为“忧郁的天才”，身着大胆的 Gucci 风格高级时装，服饰上点缀着丰富而兼收并蓄的图案和厚重的丝绒质感。场景设定在一个阳光普照、尘土飞扬的植物奇珍书房，里面摆满了干草药和古董动物标本。主人公以 45 度角站立，头部直接转向镜头，眼神忧郁而锐利。超现实元素：主人公翻领上的花卉刺绣正从布料上物理剥落，幻化成超现实的活体阿特拉斯蛾，在她的脸庞附近悬浮飞舞。主人公抬起一只手，拿着一个老式黄铜放大镜，以一种触觉上的好奇心审视着这场转变。灯光温暖而富有体积感，凸显了空气中旋转的尘埃微粒（丁达尔效应）。使用哈苏 H6D-100c 相机和 50mm 镜头拍摄，采用柯达 Portra 400 胶片模拟，以获得柔和的肤色、自然的颗粒感和实用特效美学。",
  "meta": {
    "intent": "带有超现实叙事的时尚大片",
    "priorities": "触觉质感、超现实摄影、情感深度",
    "device_profile": "Hasselblad H6D-100c"
  },
  "frame": {
    "aspect": "4:5",
  ...
  "subject": {
    "gender": "女性",
    "identity": "忧郁的天才",
    "demographics": "中年，杰出，精致",
    "face": "忧郁的专注，自然的皮肤纹理，毛孔和雀斑可见，锐利的目光",
    "hair": "复古蓬松造型，略显凌乱",
    "body": "与相机呈 45 度角，放松而沉着",
    "expression": "内省的忧郁与专注的好奇心交织",
    "pose": "一只手抬起，在胸前拿着放大镜，头转向镜头"
  },
  "wardrobe_accessories": {
    "garments": [
      {
  ...
  "environment": {
    "setting": "植物奇珍书房",
    "surfaces": "老旧木材，布满灰尘的玻璃，丝绒面料",
    "depth": "浅景深，模糊杂乱的背景",
    "atmosphere": "温暖，尘土飞扬，神秘"
  }
}
```
