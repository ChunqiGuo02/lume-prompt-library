---
id: portrait-identity-skin-reference-2239
title: "超写实湿发女性侧脸特写肖像"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["写实", "人像", "湿发", "水珠", "冷色调", "浅景深", "微距", "水润"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
version: "1.0.0"
related_to: ["portrait-identity-skin-reference-001"]
---
...
```json
{
  ...
  "subject_configuration": {
    ...
    "facial_attributes": {
      ...
      "lips": {
        "state": "微张 / 湿润",
        "surface_texture": "柔软的自然唇纹",
        "finish": "光泽感，无失真"
      },
      "hair": {
        "color": "深棕色",
        "state": "饱和 / 湿润",
        "styling": "自然发束聚拢，贴附于太阳穴和颈部"
      }
    }
  },
  "environmental_rendering": {
    "moisture_fx": {
      "sweat_layer": "鼻梁和前额覆盖一层细密的闪亮薄雾",
      "water_droplets": "颧骨和下颌线散布微小水珠",
      "surface_tension": "液体逼真地附着在皮肤上"
    },
    "lighting_and_color": {
      "lighting_style": "柔光箱漫射",
      "temperature": "冷色调",
      "color_palette": ["钢蓝色", "柔和青色", "自然肤色"],
      "background": {
        "description": "极简主义散景",
        "colors": ["浅灰色", "纯白色"],
        "depth_of_field": "浅景深"
