---
id: portrait-aur-par-hai-0884
title: "奢华餐厅中红裙女子品酒优雅写真"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["高级", "餐饮", "时尚", "优雅", "酒红", "金色", "金发", "手包"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
```json
{
  "image_base": {
    "subject": "高端餐饮与时尚",
    "vibe": "精致、宁静、奢华",
    "climax_point": "女士端庄的风格和酒红色礼服"
  },
  "background_details": {
    "walls": "白色护墙板，配有镀金线条",
    "lighting_fixtures": {
      "wall_sconces": "墙上两盏华丽的枝形吊灯（fanus）",
      "table_lamps": "每张桌子上都摆放着散发柔和光线的小型经典台灯"
    },
    "mirrors": "背景处有大型金色边框镜子，增加了房间的深度"
  },
  "central_figure": {
    "face": "五官精致，淡妆，表情平静",
    "hair": "柔软如丝般的金色头发散落在肩上",
    "dress_construction": {
      "bodice": "束身衣般的剪裁，凸显身体曲线",
      "fabric": "礼服面料呈天鹅绒（velvet）或深色缎面质感",
      "shawl": "同色系的披肩或面料柔软地披在手臂上"
    },
    "clutch": "一个小型长方形金色手拿包，放在沙发上女士手下"
  },
  "dining_set_up": {
    "table_setting": {
      "linens": "洁净平整的白色桌布",
      "crockery": "白色陶瓷餐盘和水晶杯",
      "cutlery": "摆放整齐的银质勺子和叉子",
      "glassware": "盛有浅金色饮品的酒杯"
    },
    "furniture": "米色/桃色簇绒沙发，带有垂直缝线"
  },
  "technical_aspects": {
    "focus": "焦点清晰地集中在女士身上，背景略微模糊（散景效果）",
    "color_palette": {
      "primary": "深酒红，香槟金",
      "secondary": "奶油白，暖琥珀色"
    }
