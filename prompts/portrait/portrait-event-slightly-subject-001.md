---
id: "portrait-event-slightly-subject-001"
title: "红毯活动优雅女性肖像"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["写实", "高清", "活动", "肖像", "女性", "纱丽", "酒红", "金色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
# 正文 prompt
{
  "image_generation_task": {
    ...
    "scene": {
      ...
      "clothing": {
        "outfit": "deep {"saree color" "wine-red"} saree with smooth draped pleats and flowing fabric",
  ...
  "image_generation_task": {
    ...
    "scene": {
      ...
      "subject": {
        "label": "女性",
        "pose": {
          "body_angle": "侧身，躯干略微转向镜头",
          "stance": "直立站立，重心放在一条腿上",
          "right_arm": "向前伸展，仿佛在打招呼或互动",
          "left_arm": "轻微弯曲，手持麦克风",
          "head": "略微转动，带着自然的微笑"
        },
        "hair_style": "柔和的波浪发，偏向一侧，一根长辫子垂在前方",
        "expression": "热情、友好且投入"
      },
      "clothing": {
        "outfit": "深色 {\"saree color\" \"酒红色\"} 纱丽，带有平滑的褶皱和飘逸的面料",
        "blouse": "金色刺绣设计师衬衫，细节精致",
        "accessories": [
          "带有活动品牌标志的麦克风"
        ]
      },
