---
id: "portrait-the-face-snow-001"
title: "冬日街景写真：邮筒投信瞬间"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["冬天", "女性", "雪景", "橱窗", "面包", "暖色调", "复古", "电影感"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
## 中文译文（源站提供）
创作一张超现实的冬季场景，一位女性的面部与上传的参考图完全一致（严格保持面部 1:1，无风格化或美化）。场景与构图：苏联风格的蓝色街头邮箱，固定在砖砌入口或粉刷墙壁上；黄昏时分，细雪纷飞。垂直构图 4:5，从腰部到头部。女性侧身站立，轻轻将一张手写的新年明信片塞入投递口（邮票可见）；呼出缕缕白气。背景：庭院花环和附近一棵挂着稀疏银色金属丝的冷杉；温暖的门廊灯泡；远处窗户的微弱散景。自然、抓拍、电影般的瞬间。服装：驼色/棕褐色双面羊皮大衣，领口和翻袖处有毛绒米色羊毛；米色罗纹针织高领毛衣 + 搭配的阔腿裤；白色羊毛乌尚卡帽；针织手套；深棕色羊剪绒踝靴。自然裸妆，带有真实的皮肤微纹理。外观与光线：青色与橙色调；温暖的钠光门廊灯作为主光源；雪地反射的冷蓝色环境补光；乌尚卡帽/羊毛上的柔和轮廓光；灯泡上的轻微光晕；浅景深，带有细腻的 35mm 颗粒感（佳能 AE-1/富士 X100V “经典正片”风格）。色彩与质感：邮箱金属上的霜冻，明信片的纸纤维，针织品和羊剪绒的细节。真实的肤色；无平滑处理。技术标签：50-85 mm 视角，f/2-f/2.8，ISO 800-1250，1/125 s，白平衡 3600-4200 K。轻微暗角，高分辨率。负面提示：错误的面部/身份偏差，手中拿着智能手机，现代 LED 标牌，霓虹 HDR，刺眼闪光灯，塑料感皮肤，过度曝光的雪，卡通/动漫，标志/水印。
