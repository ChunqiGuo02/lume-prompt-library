---
id: portrait-pink-type-makeup-1202
...
# 正文 prompt
{
  ...
  "background": {
    "type": "solid",
    "color": "{"background color" "pastel yellow"}"
  },
  "subject": {
    "gender": "female",
    "appearance": {
...
```json
{
  ...
  "subject": {
    ...
    "appearance": {
      "hair": "长直深色头发",
      "makeup": "光泽感妆容，柔和的粉色腮红，高光颧骨，大胆的眼妆"
    },
    "attire": {
      "top": "修身白色无袖露脐上衣",
      "bottom": "高腰粉色百褶迷你裙",
    ...
    "pose": {
      "position": "身体前倾",
      "interaction": "手臂随意搭在复古 CRT 电视上",
      "expression": "自信",
      "action": "吹着半透明的粉色泡泡糖泡泡"
    }
  },
  "props": {
    "television": {
      "type": "复古 CRT 电视",
      "screen_content": "同一位女性在粉色背景下摆姿势的镜像图像",
      "effect": "双重现实视觉概念"
    }
  },
  "style_tags": [
