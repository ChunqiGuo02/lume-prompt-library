---
id: portrait-the-mood-urban-2363
title: "都市夜景时尚男装写真，奢华都市生活氛围"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["男士", "棕色", "西装", "墨镜", "皮鞋", "正装", "时尚", "商务"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "15:17"
...
"reference_image": "uploaded_photo",
{
  ...
  "Persona_Details": {
    ...
    "Appearance": {
      ...
      "Eyewear": "{"sunglasses style" "Red-tinted aviator-style sunglasses"}"
    },
  ...
  "Secondary_Subject": {
    "Animal": "Small white fluffy dog ({"dog breed" "Maltese or Havanese"} breed)",
...
{
  "reference_image": "uploaded_photo",
  "Objective": "创作一张超现实的电影感全身时尚杂志肖像，营造出现代都市夜景中的奢华生活氛围。",
  "Persona_Details": {
    "Subject": "身材健硕、时尚的年轻成年男性",
    "Appearance": {
      "Facial_Hair": "浓密、修剪整齐的络腮胡和胡须",
      "Hair": "现代渐变发型，顶部梳成庞巴度发型",
      "Expression": "沉着、自信，直视镜头",
      "Eyewear": "{\"sunglasses style\" \"红色镜片飞行员墨镜\"}"
    },
    "Pose_and_Body_Language": {
      "Position": "随意地靠在车辆前部中央",
      "Hand_Action": "右手放在引擎盖上，左手插在裤兜里",
      "Posture": "放松而有力的姿态，位于画面中央"
    }
  },
  "Wardrobe": {
    "Top": "浅天蓝色纽扣衬衫，修身款，顶部纽扣敞开，袖子卷至前臂",
    "Bottoms": "定制黑色休闲裤，搭配黑色皮带",
    "Footwear": "干净、极简的白色皮质运动鞋",
    "Style": "高端都市休闲风"
  },
  "Secondary_Subject": {
    "Animal": "一只白色蓬松的小狗（{\"dog breed\" \"马尔济斯犬或哈威那犬\"}）",
    "Behavior": "乖巧地坐在车引擎盖上，位于男士左侧",
    "Interaction": "平静的陪伴，面向前方"
  },
  "Vehicle": {
    "Type": "现代豪华轿车或 SUV（宝马风格前格栅）",
    "Color": "鲜艳的向日葵黄",
    "Details": "欧式车牌，上面写着“BR 29”，抛光的车漆反射着环境光"
  },
  "Scene_and_Environment": {
    "Location": "夜间露天现代停车场",
    "Setting_Details": {
      "Surface": "光滑的灰色柏油路面，带有干净的白色停车线",
      "Sky": "深蓝色夜空，右上角有一弯细细的新月"
    },
    "Background": {
      "Lighting": "高大、现代的 LED 路灯发出柔和的光芒，远处的城市灯光模糊不清",
      "Atmosphere": "宁静、专属、高端的都市氛围"
    }
  },
  "Lighting_and_Mood": {
    "Lighting_Style": "平衡的电影感灯光，主体有柔和的主光",
    "Primary_Tones": "凉爽的夜晚蓝色和深邃的阴影",
    "Accent_Tones": "汽车的暖黄色，墨镜的红色高光",
    "Mood": "精致、宁静、高端"
  },
  "Photography_Style": {
    "Genre": "商业时尚摄影",
    "Aesthetic": "干净、锐利、高制作水准"
  }
}
```
