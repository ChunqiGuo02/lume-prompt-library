---
id: portrait-night-street-mercedes-2359
title: "都市夜景双车人像写真"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["超写实", "电影感", "都市", "夜景", "人像", "奔驰", "汽车", "雾气"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
```json
{
  "image_generation_task": {
    "metadata": {
      "genre": "城市夜景街头肖像",
      "style": "超逼真、电影质感、高清晰度",
      "lighting": "朦胧的夜光环境，汽车前灯发出强烈光线，城市周围有柔和的光亮"
    },
    "scene": {
      "setting": {
        "location": "夜晚的空荡街道",
        ...
        "subjects": [
          {
            "label": "人物A",
            "position": "站在一辆蓝色梅赛德斯G-Wagon前",
            "clothing": {
              "top": "宽松的米色T恤",
              "bottom": "黑色运动裤",
              "shoes": "白色运动鞋"
            },
            "pose": "放松的姿势，双手放在身体两侧，看向镜头"
          },
          {
            "label": "人物B",
            "position": "站在一辆黑色梅赛德斯G-Wagon前",
            "clothing": {
              "top": "鲜绿色带荧光效果的连帽衫",
              "bottom": "黑色运动裤",
              "shoes": "白色运动鞋"
            },
            "pose": "自信的姿态，双手自然下垂，正对着镜头"
          }
        ],
        "vehicles": [
          {
            "model": "梅赛德斯G-Wagon",
            "color": "蓝色",
            "lights": "前灯点亮，光线穿透雾气显得格外强烈"
          },
          {
            "model": "梅赛德斯G-Wagon",
            "color": "黑色",
            "lights": "前灯照亮车辆轮廓，营造戏剧性效果"
          }
        ],
        "camera": {
          "angle": "平视广角镜头",
          "lens": "35毫米焦距",
          "depth_of_field": "浅景深，具有电影般的虚化效果",
          "vibe": "忧郁、充满力量感，典型的都市电影氛围"
        }
      }
    }
  }
