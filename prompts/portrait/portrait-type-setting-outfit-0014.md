---
id: portrait-type-setting-outfit-0014
title: "2026年社交媒体明星时尚写真生成器"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: biophilic
tags: ["户外", "草地", "绿植", "休闲", "人像", "高清", "芥末黄", "高马尾"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
# 正文 prompt
{
  "celebrity_image_database": {
    "subject_1": {
      "name": "{"subject 1 name" "Sydney Sweeney"}",
      "visual_data": [
        {
    ...
    "subject_2": {
      "name": "{"subject 2 name" "Ana de Armas"}",
      "visual_data": [
        {
  ...
  "celebrity_image_database": {
    "subject_1": {
      ...
      "visual_data": [
        {
          "scene_type": "夏季乘船游",
          "setting": "阳光明媚的湖面上的快艇，森林背景",
          "outfit": "黑白运动拉链式潜水服",
          "features": "金色沙滩波浪发，厚重黑色太阳镜",
          "mood": "活泼开朗，面带笑容"
        },
        {
          "scene_type": "电影室内景",
    ...
    "subject_2": {
      ...
      "visual_data": [
        {
          "scene_type": "高级时装大片",
          "setting": "豪华休息室，黑色皮革沙发，霓虹蓝粉色背景",
          "outfit": "红色亮片西装外套和配套裙子，黑色丝绸内搭",
          "jewelry": "叠戴金色项链，多个金色手镯",
          "pose": "优雅地坐在圆形黑色桌旁"
        },
        {
          "scene_type": "户外花园",
          "setting": "郁郁葱葱的热带植物，带白色坐垫的藤制沙发",
          "outfit": "黄蓝色图案无肩带连衣裙，洋红色高跟鞋",
          "props": "酸橙绿色香槟桶，内有酒瓶"
        },
        {
          "scene_type": "抓拍/粉丝互动",
          "setting": "下雨的街道，黑色雨伞下",
          "outfit": "白色纽扣衬衫，带有装饰性纽扣",
          "hair_style": "凌乱优雅的深色盘发"
        },
        {
          "scene_type": "海滩生活方式",
          "setting": "背景是海浪",
          "outfit": "白色高腰比基尼，菠萝印花上衣",
          "accessories": "圆形太阳镜，蓝色串珠手链"
        },
        {
          "scene_type": "休闲户外",
          "setting": "坐在绿草地上，白色墙壁背景",
          "outfit": "芥末黄色露肩上衣，花卉刺绣短裤",
          "hair_style": "光滑高马尾辫"
        }
      ]
    },
    "technical_meta": {
      "image_quality": "高清，逼真",
      "platform_focus": "社交媒体内容创作 (Twitter/Instagram)",
      "target_year": "2026"
    }
  }
}
