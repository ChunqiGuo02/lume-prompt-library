---
id: portrait-the-red-prompt-0037
title: "90年代复古浴室中的红发少女写真"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: industrial-loft
tags: ["复古", "胶片", "红发", "浴缸", "浴室", "香烟", "蓝色", "红色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
```json
{
  "image_generation_prompt": {
    "subject": {
      "description": "一位时尚的年轻女性，留着波浪状的亮丽姜红色头发和齐刘海。",
      "features": "苍白的皮肤，带有细微的雀斑，涂着鲜艳的红色口红，表情冷淡而忧郁，略微向下看。",
      "pose": "坐在白色瓷浴缸里，膝盖蜷缩到胸前，姿势放松但带有 90 年代前卫风格。",
      "clothing": [
        "{\"top color\" \"Light blue or mint green\"} 无袖背心",
        "厚实的白色针织袜，带有独特的黑红图案（火焰和心形图案）"
      ],
      "accessory": "嘴里随意叼着一支未点燃的香烟。"
    },
    "environment": {
      "setting": "一间 1990 年代的老式或复古风格浴室。",
      "background_details": [
        "浅蓝色方形陶瓷墙砖",
        "墙上工业风金属肥皂或纸巾架",
        "白色浴缸边缘可见",
        "浴缸边缘摆放着极简物品：一个绿色打火机、一包红色香烟和一个黑色小化妆瓶。"
      ]
    },
    "technical_style": {
      "photography_type": "35mm 胶片摄影，怀旧美学",
      "lighting": "硬闪光摄影，略微过曝，营造出锐利的阴影和高对比度。",
      "texture": "可见的胶片颗粒，原始真实的模拟纹理，低保真美学。",
      "color_palette": "瓷砖和上衣的冷蓝色调为主，与头发和口红的暖红色调形成对比。"
    },
    "composition": {
      "aspect_ratio": "9:16",
      "shot_type": "中景，平视角度",
    ...
    "negative_prompt": "现代浴室，数码感，高光泽，光滑皮肤，3D 渲染，卡通，变形的手，明亮的摄影棚灯光，多余的手指，模糊，低分辨率"
  }
}
```
