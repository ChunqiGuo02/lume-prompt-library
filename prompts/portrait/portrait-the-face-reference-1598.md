---
id: portrait-the-face-reference-1598
title: "湖畔黑玫瑰少女"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["肖像", "哥特", "忧郁", "湖边", "阴天", "紫色", "黑色", "玫瑰"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
{
"image_request": {
"goal": "基于提供的参考照片创作一幅电影感肖像，必须完全保留主体面部在参考照片中的原貌（不得更改面部结构、比例、特征或表情）。",
"subject": {
"identity_preservation": {
"description": "面部必须与参考照片完全一致——所有可见的面部细节、比例、轮廓、表情及微特征均需1000%相同。",
"notes": "不得对面部结构进行风格化、变形或重新诠释。仅允许更改场景、姿势和氛围。"
},
"pose": {
"body_position":
