---
id: "portrait-the-her-face-001"
title: "优雅女性黑丝绒礼服写真特写"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["肖像", "写实", "优雅", "黑色", "丝绒", "卷发", "闭眼", "美甲"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
version: "1.0.0"
related_to: ["portrait-the-her-subject-002"]
---
...
# 正文 prompt
{
  ...
  "subject": {
    ...
    "appearance": {
      "attire": [
        "{"clothing item 1" "black velvet corset"}",
        "{"clothing item 2" "expensive black cape"}"
      ],
      "hair": "loose",
      "makeup": {
        "style": "nude",
...
```json
{
  ...
  "subject": {
    ...
    "appearance": {
      "attire": [
        "{\"clothing item 1\" \"黑色天鹅绒紧身胸衣\"}",
        "{\"clothing item 2\" \"昂贵的黑色斗篷\"}"
      ],
      "hair": "散发",
      "makeup": {
        "style": "裸妆",
