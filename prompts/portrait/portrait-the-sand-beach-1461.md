---
id: portrait-the-sand-beach-1461
title: "沙滩心形沙洞中情侣亲吻的浪漫手机实拍"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["情侣", "爱心", "沙滩", "心形", "亲吻", "蓝天", "爱情", "浪漫"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
```json
{
  "generation_request": {
    ...
    "creative_prompt": {
      "scene_summary": "一张通过沙滩上心形镂空拍摄的竖幅智能手机照片，框住了一对非常靠近镜头的情侣。女人亲吻男人的脸颊，男人则闭着眼睛，温柔地微笑。明亮的蓝色天空充满背景。这一刻感觉自然、亲密而真实。",
      "composition": {
        "foreground_frame": "大型心形沙子镂空，在情侣周围形成自然的渐晕效果",
        "perspective": "相机放置在沙心内部/后面，向外拍摄",
        "crop": "特写，面部居中于心形内部",
        "depth_of_field": "沙子边缘略微柔和，面部清晰"
      },
      "subjects": {
        "male": {
          "age_group": "young_adult",
          "pose": "脸部略微转向镜头，闭眼，温柔微笑",
          "wardrobe": "沙滩休闲装，裸露肩膀或简单泳装造型",
          "skin_rendering": "自然纹理，无修饰"
        },
        "female": {
          "age_group": "young_adult",
          "pose": "身体前倾，亲吻他的脸颊",
          "hair": "深色头发被风吹动，自然散乱",
          "wardrobe": "轻薄夏装/沙滩上衣或可见泳装肩带",
          "skin_rendering": "自然纹理，淡妆"
        }
      },
      "environment": {
        "location": "沙滩",
        "background": "晴朗的蓝天，无建筑物，无杂物",
        "lighting": "明亮的自然日光，柔和的阴影，无闪光灯"
      },
      "camera_style": {
        "device_feel": "手机相机写实感",
        "lens_feel": "轻微广角透视，自然畸变",
        "mood": "俏皮、温柔、夏日风情"
      },
      "negative_prompt": "文字叠加、字幕、水印、标志、HDR、人工光泽、过度修饰、塑料感皮肤、夸张的散景、扭曲的面部、多余的手指、变形的手、不正确的沙子纹理、不真实的渐变天空"
    }
  }
}
```
