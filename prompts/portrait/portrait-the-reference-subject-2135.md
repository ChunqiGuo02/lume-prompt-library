---
id: portrait-the-reference-subject-2135
title: "街头潮玩摄影：男子与玩偶的都市漫步"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["超写实", "摄影", "街头", "男人", "潮玩", "玩偶", "毛绒", "斑马线"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
```json
{
  "image_style": {
    "realism_level": "超现实主义",
    "source_format": "iPhone RAW 照片",
    "aspect_ratio": "9:16 竖屏",
    "photography_style": "抓拍街头摄影",
    "color_treatment": "真实色彩平衡",
    "post_processing": "无",
    "aesthetic": "艺术感 Pinterest 风格写实主义"
  },
  "camera_composition": {
    "angle": "略微抬高的广角视角，向下看",
    "reference_match": "相机视角、高度、倾斜度和构图必须与参考图像精确对齐",
    "scene_framing": "宽幅全身照",
    "perspective": "街头俯视视角，水平捕捉整个斑马线",
    "stability": "手持感，带有微妙的自然瑕疵",
    "depth_of_field": "真实景深，主体和周围元素都清晰锐利",
    "crop": "无肖像或特写裁剪"
  },
  "subject": {
    "type": "年轻成年男性",
    "physique": "运动型，自然健壮的身材",
    "action": "在人行横道上迈步向前走",
    "pose_accuracy": "身体朝向、步幅和行走方向必须与参考图像一致",
    "expression": "中性、放松、不摆拍的抓拍表情",
    "skin_detail": "真实的人体皮肤，可见毛孔、自然高光和细微瑕疵"
  },
  "wardrobe": {
    "style": "现代休闲街头服饰",
    "silhouette": "宽松随性",
    "outerwear": "橄榄色、炭灰色或棕色等柔和大地色系的宽松夹克",
    "innerwear": "简约纯色衬衫",
    "bottoms": "宽松直筒裤",
    "footwear": "干净简约运动鞋"
  },
  "environment": {
    "location": "空旷的城市街道",
    "ground": "斑马线，具有真实的沥青纹理和细微磨损",
    "traffic": "无",
    "bystanders": "无",
    "layout": "街道结构和空间深度与参考图像相同"
  },
  "props_characters": {
    "type": "Popmart Skullpanda 人偶",
    "appearance": "柔软毛绒质感，圆润比例",
    "costumes": "各种颜色的蓬松服装",
    "placement": "以与参考图像完全相同的排列、间距和对齐方式围绕主体放置",
    "interaction": "看起来像随意地与人类主体并肩行走"
  },
  "lighting": {
    "source": "上方自然日光",
    "shadows": "柔和、漫射的阴影自然地投射在地面上",
    "exposure": "曝光均衡，无过曝或死黑",
    "contrast": "自然且低调"
  },
  "constraints": {
    "must_match": [
