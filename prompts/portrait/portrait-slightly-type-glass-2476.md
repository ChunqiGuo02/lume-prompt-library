---
id: portrait-slightly-type-glass-2476
title: "银发女子餐厅自拍：红酒虾面，温馨夜宴"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["餐厅", "晚餐", "自拍", "葡萄酒", "意面", "虾仁", "暖光", "氛围"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
```json
{
  ...
  "subject": {
    "physical_characteristics": {
      "hair": "中长、直顺的铂金色头发，略显蓬松，自然分缝",
      "eyes": "清澈的浅蓝色眼睛",
      "skin": "白皙、苍白的肤色，质地光滑",
      "face": "精致的五官，心形脸，自然丰满的嘴唇带有柔和的粉红色调，眉毛清晰且颜色较浅",
      "build": "苗条优雅"
    },
    "emotional_state": {
      "mood": "放松、亲密、略带俏皮",
      "expression": "半闭的眼睛带着柔和的微笑，平静而满足",
      "vibe": "温暖、舒适、情感投入、享受当下",
      "gaze": "略带睡意，放松地凝视镜头"
    },
    "pose_and_gesture": {
      "pose": "坐在餐厅卡座里，手托着头",
  ...
  "food_and_table": {
    "dish": {
      "type": "虾仁意面",
      "size": "奶油状浅色酱汁",
      "presentation": "盛放在白色陶瓷碗中",
      "detail": "虾仁清晰可见地摆在意面顶部"
    },
    "drink": {
      "type": "白葡萄酒",
      "glass": "大号葡萄酒杯，部分已斟满",
    ...
    "table_setting": {
      "tablecloth": "白色",
      "cutlery": "叉子和刀具摆放整齐",
      "additional_objects": "桌上放着一台小型数码相机"
    },
    "lighting": {
      "type": "低光室内环境照明",
      "source": "温暖的顶灯和侧灯",
    ...
    "style": {
      "realism_level": "超写实",
      "retouching": "极少修饰，保留自然瑕疵",
      "color_grading": "暖色调，舒适的夜晚色板"
    }
  }
}
```
