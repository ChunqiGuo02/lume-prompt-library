---
id: portrait-the-right-head-0244
title: "优雅女星银钻礼服写真，闪耀奢华氛围"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["安娜", "女星", "优雅", "奢华", "亮片", "白色", "礼服", "钻石"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
# 正文 prompt
{
  "subject": {
    ...
    "identity_resemblance": "{"celebrity name" "Ana de Armas"}",
...
{
  "subject": {
    "description": "一位年轻女性的肖像，气质迷人而优雅。",
    "identity_resemblance": "{\"celebrity name\" \"Ana de Armas\"}",
    "pose": "头部和肩部特写；右臂抬起，手轻轻搭在前额；头部略微转向右侧，眼睛直视观者。",
    "expression": "柔和、沉思、平静、诱人，双唇微启。"
  },
  "physical_attributes": {
    "hair": {
      "color": "深棕色",
      "style": "盘发或马尾辫",
      "details": "松散、纤细的发丝勾勒出脸部和颈部轮廓"
    },
    "eyes": {
      "color": "榛绿色",
      "gaze": "直视且引人入胜"
    ...
    "makeup": {
      "style": "自然魅力妆容",
      "details": "脸颊玫瑰色腮红，粉色亮泽唇妆，睫毛分明，眉毛柔和"
    }
  },
  "attire": {
    "type": "高领无袖上衣或连衣裙",
    "material": "重工刺绣面料",
    "texture": "覆盖银色和白色亮片、水晶或珠饰",
    "color": "银色/白色",
    "fit": "修身胸衣"
  },
  "accessories": {
    "earrings": "长款垂坠钻石耳环",
    "bracelet": "右腕佩戴精致钻石网球手链"
  },
  "environment": {
    "background": "模糊（散景）的垂直窗帘或幕布",
    "colors": "柔和的米色、香槟色和淡金色调",
    "lighting": "柔和、温暖、讨人喜欢的照明，面部、肩部和手臂有高光；背景有隐约的散景光斑"
  },
  "image_quality": {
    "style": "名人肖像 / 活动摄影",
    "mood": "优雅、宁静、奢华",
    "focus": "面部对焦清晰，景深较浅，背景模糊"
  }
}
```
