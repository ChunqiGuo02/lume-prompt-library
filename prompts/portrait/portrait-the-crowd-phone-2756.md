---
id: portrait-the-crowd-phone-2756
title: "音乐节狂欢人群中的手机记录瞬间"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["夜晚", "人群", "音乐", "霓虹", "狂欢", "兴奋", "手机", "虚化"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
```json
{
  "prompt_name": "音乐节狂欢人群特写",
  "type": "photo_realistic",
  "aspect_ratio": "4:5",
  "scene": {
    "location": "户外音乐节人群",
    "time_of_day": "夜晚",
    "environment": "舞台附近密集的人群，高举双手，腕带可见，远处有发光的灯光",
    "atmosphere": "高能量、混乱、狂喜",
    "background": "舞台灯光和剪影的强烈焦外虚化，无清晰可辨的标识"
  },
  "subject": {
    "description": "一名年轻女子站在人群前排中央，用手机拍摄演出",
    "expression": "纯粹的兴奋，张嘴欢呼，眼睛睁大充满喜悦",
    "pose": "手机举近脸部，一只手臂高举，身体前倾，沉浸在当下",
    "details": {
      "skin": "自然的演唱会汗湿光泽，毛孔可见，颧骨有微光闪粉",
      "hair": "略显凌乱，因跳舞而潮湿",
      "accessories": "音乐节腕带，极简耳环",
      "phone": "智能手机垂直握持，有明亮的闪光反射"
    }
  },
  "composition": {
    "framing": "中近景特写",
    "camera_angle": "人群视角，略低角度",
    "subject_position": "前景突出，略偏画面中心右侧",
    "depth_of_field": "浅景深，背景强烈模糊",
    "foreground_elements": "附近手臂和手的局部剪影，以增加景深",
    "crowd_density": "紧密而沉浸式"
  },
  "camera_and_lens": {
    "camera_type": "全画幅单反相机效果",
    "lens": "35mm",
    "aperture": "f/1.8",
    "shutter_speed": "1/250",
    "iso": "3200",
  ...
  "lighting_and_color": {
    "lighting_style": "演唱会舞台灯光与混合霓虹色调",
    "key_light": "舞台发出的蓝色和洋红色光晕",
    "highlights": "手机屏幕/闪光反射的镜面高光",
    "color_palette": "霓虹蓝、粉、紫与深邃的阴影",
    "contrast": "高对比度，电影感"
  },
  "motion_and_texture": {
    "motion_feel": "背景中的手有轻微运动模糊，主体面部清晰",
    "texture_detail": "汗珠光泽、闪粉颗粒、织物纹理可见",
    "grain": "细微的高 ISO 胶片颗粒，增加真实感"
  },
  "realism_notes": {
    "keep": [
      "自然的皮肤纹理和汗水",
  ...
  "post_processing": {
    "style": "电影纪录片式演唱会照片",
    "film_emulation": "现代数码 + 细微胶片颗粒",
    "saturation": "适中，霓虹色调受控",
    "clarity": "低-中等，以保持高光处的柔和度",
    "vignette": "柔和自然的暗角"
  }
}
```
