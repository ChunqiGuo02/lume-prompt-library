---
id: "portrait-street-but-real-001"
title: "街头纪实摄影：真实瞬间的电影感捕捉"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["纪实", "摄影", "日本", "雨夜", "抽烟", "风衣", "都市", "忧郁"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
```json
{
  "generation_request": {
    ...
    "creative_prompt": {
      "scene_summary": "在 {\"city or neighborhood\" \"[城市/街区]\"} 现场拍摄的抓拍艺术街头摄影。一个真实、未经摆拍的瞬间，充满纪实感和真情实感。",
      "subject": "一位 {\"age\" \"[年龄]\"} 的 {\"gender\" \"[性别]\"}，身着 {\"clothing\" \"[服装]\"}，被捕捉到正在进行 [微小动作] 的瞬间。自然的表情，保留轻微的不对称性。",
      "camera": "35mm 等效镜头，视线水平，距离近但保持尊重，构图不完美，如同真实的街头摄影师，聚焦于眼睛，景深由浅至中。",
      "lighting": "来自 [光源：商店橱窗 / 路灯 / 日落 / 霓虹灯] 的自然光，阴影深邃但细节丰富，无影棚灯光。",
      "environment_details": "街头纹理：磨损的海报，刮花的金属，雨点斑驳的人行道，玻璃上细微的倒影，真实的城市杂物，无干净的影棚背景。",
      "authenticity_markers": "仅背景有细微的运动模糊，高光处有轻微的光晕，微小的胶片门编织纹理，真实的颗粒感，无美颜修饰。",
      "mood": "[情绪：忧郁 / 充满希望 / 紧张 / 宁静的喜悦]，电影感但真实可信。"
    },
    "negative_prompt": [
      "影棚灯光",
      "美颜修饰",
