---
id: portrait-eyes-calm-gentle-1569
title: "温柔女子抱白猫的超现实肖像照"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["写实", "人像", "猫咪", "温馨", "室内", "蓝色", "棕色", "白色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
```json
{
  ...
  "subject": {
    ...
    "features": {
      "eyes": "淡褐色",
      "skin": "白皙，真实的肤色，毛孔可见，带有微妙的自然纹理",
      "makeup": "精致的淡妆，突出唇部和眼部"
    },
    "hair": "长而自然的波浪卷发，棕色",
    "clothing": {
      "item": "{\"sweater color\" \"Blue\"} 宽松罗纹长袖毛衣",
      "details": "领口和袖口有精致的扇贝边，逼真的针织结构，柔软有弹性"
    },
    "expression": "平静，温暖，温柔"
  },
  "interaction": {
    "action": "温柔地将一只毛茸茸的小白波斯猫紧紧抱在胸前",
    "dog": {
      "breed": "波斯猫",
      "fur": "柔软，略微不均匀的天然白色",
