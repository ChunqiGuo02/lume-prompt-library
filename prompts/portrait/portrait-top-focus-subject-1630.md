---
id: portrait-top-focus-subject-1630
title: "热带街头时尚人像摄影预设"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["写实", "摄影", "街拍", "少女", "红色", "蓝色", "编织", "猫咪"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
```json
{
  "prompt_configuration": {
    ...
    "quality_settings": {
      ...
      "style": "超写实",
      "lighting": "自然日光，柔和阴影",
      "camera_focus": "主体对焦锐利，景深较浅"
    }
  },
  "subject": {
    "description": "年轻女子站立在户外",
    "appearance": {
      "hair": "齐肩波浪形赤褐色/棕色头发，半扎发型，头顶有两个小辫子/发髻",
      "skin": "浅肤色，自然妆容",
      "expression": "平静、中性的表情，直视镜头",
      "pose": "舒适地站立，一只手臂放松，一只手靠近裙子"
    }
  },
  "attire": {
    "top": "红色露肩短款上衣，泡泡短袖，甜心领口",
    "bottom": "蓝色牛仔布分层式荷叶边长裙",
    "accessories": [
      "右肩背着一个米色大号钩编/编织手提包",
      "大号花朵垂坠耳环",
      "精致的银项链",
  ...
  "environment": {
    ...
    "background_elements": [
      "白色建筑立面，带有黑色栅栏窗户",
      "大型热带棕榈叶和绿色植物",
      "路牌上写着“NO PARKING”/“NO ESTACIONAR”，带有“San Juan”标志"
    ],
    "props": [
      "一辆深绿色复古丰田轿车停在路边",
      "一只虎斑猫坐在汽车后备箱上"
