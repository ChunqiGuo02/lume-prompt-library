---
id: portrait-dark-hair-slightly-1820
title: "秋林暗影中，少女低眉系扣，哥特风写真"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["哥特", "暗调", "人像", "森林", "秋日", "少女", "冷色调", "薄雾"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
# 正文 prompt
{
  "prompt": "young western woman with pale skin and long dyed dark blonde hair, emo/goth style, sitting on forest ground in autumn woodland, moody dark atmosphere, dim bluish twilight lighting, soft shadows, cinematic low key lighting, slight fog in background",
  "subject": {
...
```json
{
  "prompt": "年轻的西方女性，皮肤白皙，染着长长的深金色头发，哥特/情绪摇滚风格，坐在秋季林地的地面上，阴郁黑暗的氛围，昏暗的蓝紫色暮光照明，柔和的阴影，电影般的低调照明，背景有轻微的薄雾",
  "subject": {
    "description": "20-25 岁的女性，五官精致，疲惫/内省的表情，目光向下，嘴唇微张，自然妆容搭配深色口红",
    "hair": "长直金发，垂落在肩膀和胸前",
    "clothing": {
      "top": "紧身白色蕾丝边吊带背心，细吊带，面料略透，黑色文胸肩带隐约可见",
      "bottom": "宽松低腰中度水洗蓝色牛仔裤，刻意做旧且略显脏污，深棕色腰带松散可见",
      "accessories": [
        "黑色天鹅绒项圈，带小银色吊坠",
        "右手腕戴黑色珠串手链",
        "左手腕戴黑色发圈",
  ...
  "pose": "坐在森林地面上，膝盖弯曲，身体略微前倾，双手放在牛仔裤的顶部纽扣上/解开纽扣，随意亲密的瞬间，低头看着自己的手/衣服",
  "environment": "茂密的秋季森林，落叶，长满苔藓的地面，树干，昏暗的自然光透过树木洒落，冷色调，略带蓝色，忧郁的氛围",
  "style": "写实摄影，胶片颗粒感，电影感，柔和的焦外背景，浅景深，35mm 镜头感，自然的瑕疵，原始的情感肖像，黑暗浪漫美学",
  "lighting": "低调，冷色温 4500-5500K，柔和漫射光，面部和身体有深邃阴影，头发上有微妙的轮廓光",
  "quality_tags": "高度细节，面部和上半身对焦锐利，逼真的皮肤纹理，细致的织物纹理，自然光照，杰作，最佳品质，超现实",
  "negative": "模糊，过曝，明亮的日光，暖色调，微笑，快乐的表情，浓妆，塑料皮肤，卡通，动漫，多余的肢体，变形的手，糟糕的人体结构"
}
```
