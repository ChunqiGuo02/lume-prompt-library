---
id: portrait-the-sunglasses-candid-2594
title: "雨天车内双人复古时尚自拍"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["闺蜜", "自拍", "车内", "雨天", "丝巾", "墨镜", "珍珠", "复古"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
```json
{
  "image_generation_prompt": {
    ...
    "subject_analysis": {
      "characters": [
        {
          "description": "左侧是一位年轻的深褐色头发女性，留着长长的波浪发。",
          "expression": "俏皮的“飞吻脸”或嘟嘴。",
          "accessories": [
            "复古黑色矩形墨镜，深色镜片。",
            "一条丝质头巾（俄罗斯娃娃风格），系在下巴下方，带有粉色、紫色和柔和绿色调的水彩花卉图案。"
          ]
        },
        {
          "description": "右侧是一位年轻的金发女性。",
          "expression": "充满活力，嘴巴张大呈“喊叫”或“尖叫”姿势，舌头可见，略微向上看。",
          "accessories": [
            "复古风格金色边框猫眼墨镜，深色镜片。",
            "一条鲜艳的丝质头巾，带有亮蓝色、黄色和青柠绿的几何花卉图案，系在下巴下方。",
            "一条经典的多股珍珠项链。"
          ]
        }
      ],
      "composition": "特写抓拍自拍，从车内低角度拍摄，头部倾斜在一起，呈现出友好、充满活力的姿势。"
    },
    "environment_and_setting": {
      "location": "现代汽车内部，向上看向车顶。",
      "background_details": [
        "主体上方可见玻璃天窗。",
        "玻璃天窗上散落着清晰的雨滴。",
        "柔和、阴沉的自然日光透过云层和车窗过滤进来。"
      ]
    },
    "style_and_technical_specifications": {
      "aesthetic": "现代美学，“it-girl”风格，复古别致，俏皮而真实的摄影。",
      "camera_details": "使用高端智能手机相机（iPhone 风格）拍摄，24 毫米广角镜头，面部对焦清晰，轻微的运动模糊以增强真实感。",
      "lighting": "雨天自然柔和的漫射光，皮肤和嘴唇上有逼真的高光，墨镜上有微妙的反光。",
      "quality_tags": "照片级真实感，超精细皮肤纹理，8k 分辨率，高度精细的织物纹理，电影级色彩分级，高保真。",
      "negative_prompt": "模糊，扭曲的面部，多余的手指，卡通化，低分辨率，糟糕的解剖结构，平淡的灯光，不真实的皮肤。"
    }
  }
}
```
