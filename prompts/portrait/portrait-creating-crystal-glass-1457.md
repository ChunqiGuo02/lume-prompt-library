---
id: portrait-creating-crystal-glass-1457
title: "水晶折射下的奢华时尚人像摄影"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["折射", "人像", "艺术", "水晶", "吊灯", "玫瑰", "白色", "珠宝"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
"折射摄影",
  ...
  "photography_style": {
    "genre": "高端时尚编辑肖像，带有实验性光学效果",
    "technique": "通过棱镜玻璃和水晶元素拍摄，实现艺术折射效果",
    "era": "2020 年代当代奢华时尚摄影",
    "influences": "Paolo Roversi 的柔焦，Tim Walker 的奇幻优雅，Sofia Coppola 的时代华丽"
  },
  "critical_elements_summary": {
    "must_include": [
      "大块水晶棱镜在画面左侧形成彩虹色散",
      "主体透过中央透明玻璃桌可见，营造出分层效果",
      "右侧花艺布置，花瓣上带有色差",
      "多个水晶吊灯，暖烛光在背景中形成焦外虚化",
      "深黑色背景，主体有选择性照明",
      "精致的钻石项链和耳环捕捉光线",
      "整体柔和梦幻的焦点质量",
      "棱镜折射产生的强烈彩虹光谱颜色——从红色到紫色",
      "透明分层玻璃效果，产生重影和双重影像",
      "背景中散布着温暖的琥珀色烛光散景圆圈",
      "低调戏剧性照明，主体从黑暗中浮现",
      "华丽的正式宴会厅氛围"
