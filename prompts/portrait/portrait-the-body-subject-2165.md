---
id: portrait-the-body-subject-2165
title: "赌场复古风写真：黑裙美女与老虎机"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["赌场", "老虎机", "女性", "黑色", "缎面", "短裙", "高跟鞋", "复古"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
```json
{
  "image_generation_request": {
    ...
    "subject_definition": {
      "identity_source": {
        "method": "Image Reference",
        "instruction": "严格保留上传参考图像中的面部特征和发型。"
      },
      "body_language": {
        "pose": "坐在高脚凳上，身体向左倾斜 30 度，双腿优雅地交叉，以拉长身形轮廓。",
        "hands": "随意地放在大腿上，手指放松，展示戒指。",
        "gaze": "略微向下看向镜头或直接看向闪光灯。"
      }
    },
    "fashion_and_styling": {
      "garment_main": {
    ...
    "environmental_context": {
      ...
      "flooring": {
        "type": "图案地毯",
        "texture": "磨损的尼龙",
        "design": "青色、焦橙色和宝蓝色组成的迷幻漩涡图案",
        "vibe": "复古拉斯维加斯美学"
      },
      "furniture": {
        "item": "赌场吧凳",
        "material": "簇绒红色人造皮革座椅",
        "base": "带有脚踏的做旧青铜或金色金属底座"
      },
      "props_and_background": {
        "primary_prop": "老虎机",
        "prop_details": "发光的招牌显示“TRIPLE JACKPOT GEMS”，发光的按钮，玻璃屏幕反射",
        "atmosphere": "烟雾弥漫、拥挤、背景昏暗，其他机器发出散景光斑"
      }
    },
    "photography_technical": {
      "camera_simulation": "2000 年代初期的数码卡片相机（例如：Sony Cybershot 或 Canon PowerShot）",
      "lighting_style": {
        "type": "直射机顶闪光灯",
        "characteristics": [
          "主体正后方有生硬的阴影",
