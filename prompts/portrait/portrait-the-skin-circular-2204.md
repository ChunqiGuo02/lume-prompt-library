---
id: portrait-the-skin-circular-2204
title: "超写实咖啡馆花环人像定制"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: biophilic
tags: ["写实", "肖像", "咖啡馆", "绿植", "花艺", "暖色调", "优雅", "休闲"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
Soft pastel long-sleeve knit top ({"top color" "dusty pink / muted rose tone"})

High-waisted, straight-fit {"bottom color" "beige or cream"} trousers
...
## 中文译文（源站提供）
创作一张超写实、高端的生活方式肖像，描绘一位成年主体，置身于一个宁静、优雅、现代的咖啡馆环境中。主体随意地坐在一圈嵌入了暖色 LED 环形灯的圆形木框内，周围环绕着郁郁葱葱的绿色植物和柔和的花卉装饰。姿势放松自然：一条腿搭在另一条腿上，身体略微倾斜，肩膀放松，双手自然地捧着一小束鲜花。整体氛围温暖、干净、优雅、年轻、亲和——纯粹的写实主义。无风格化，无奇幻元素，无电影化夸张。

请使用我上传的面部图像作为**唯一**的面部识别参考。

保持 100% 的面部准确性：精确的骨骼结构、眼睛形状、眼睑褶皱、眉毛形状、鼻梁和鼻尖、嘴唇形状、下颌线、下巴、脸颊丰满度、发际线和面部比例。

身份必须在所有角度（正面、3/4 侧面、侧面、坐姿、轻微头部倾斜）保持完美一致。

无面部融合，无美化，无对称校正。

无 AI 面部漂移。

保留真实的皮肤纹理：毛孔、细纹、自然瑕疵。

表情：柔和、自然的微笑，放松而真诚。

柔和的马卡龙色长袖针织上衣（{"top color" "灰粉色 / 柔和玫瑰色调"}）

高腰直筒（{"bottom color" "米色或奶油色"}）长裤

干净的白色厚底运动鞋

仅佩戴极简配饰（简约耳环、智能手表或极简手腕配饰）
