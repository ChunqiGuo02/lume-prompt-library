---
id: portrait-body-type-reference-1656
title: "现代奢华时尚女性阳台写真生成提示词"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["时尚", "现代", "轻奢", "阳台", "户外", "美女", "白色", "红色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
```json
{
  "image_request": {
    ...
    "pose_and_body": {
      "stance": "站在玻璃栏杆旁",
      "legs": {
        "position": "一条腿弯曲，通过高开衩稍微向前抬起",
        "weight_distribution": "重心在后腿"
      },
      "arms": {
        "one_arm": "向外伸展，手轻轻搭在深色垂直柱子上",
        "other_arm": "自然垂放在腰部附近"
      },
      "posture": "放松而诱惑，具有编辑风格的优雅"
    },
    "camera_and_framing": {
      "angle": "与视线齐平，略微向下倾斜",
      "framing": "中等全身（从头到脚）",
      "lens": "自然透视，背景略微压缩",
      "depth_of_field": "浅景深，主体清晰对焦"
    },
    "wardrobe": {
      "top": {
        "type": "白色无袖针织上衣",
