---
id: portrait-slightly-type-visible-2983
title: "黑白色条纹套装时尚写真，金饰点缀，自信优雅"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["时尚", "棚拍", "肖像", "女性", "墨镜", "金饰", "黑白", "条纹"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
# 正文 prompt
{
  ...
  "clothing": {
    ...
    "top": {
      ...
      "pattern": "bold {"pattern color" "black and white"} stripes",
...
```json
{
  "image_type": "高分辨率影棚时尚肖像照",
  "aspect_ratio": "3:4",
  "resolution": "8K",
  "subject": {
    "gender_presentation": "女性",
    "age_range_visible": "青年",
    "pose": {
      "body_position": "坐姿或略微斜倚",
      "upper_body": "躯干略微向右倾斜",
      "head": "头部略微向左倾斜",
      "left_arm": "抬起，手触碰头部附近的头发",
      "right_arm": "弯曲，手放在腰部/臀部附近"
    },
    "expression": {
      "face": "中性到自信",
      "lips": "微张",
  ...
  "clothing": {
    ...
    "top": {
      "style": "长袖露脐上衣",
      "design": "胸部有前结/扭结设计",
      "pattern": "大胆的 {\"pattern color\" \"黑白\"} 条纹",
      "sleeves": "宽松版型，袖口收紧"
    },
    "bottom": {
      "style": "高腰裙",
      "length_visible": "膝盖以上（部分可见）",
      "pattern": "配套的黑白条纹",
      "waist_detail": "前系带或折叠面料细节"
    }
  },
  "body_details": {
    "midriff": "可见",
