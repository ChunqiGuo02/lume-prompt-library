---
id: portrait-type-features-text-1508
title: "浴室镜前自拍，展现休闲性感风格"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["女性", "欧美", "金发", "丸子头", "自拍", "纹身", "棕色", "牛仔"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
# 正文 prompt
{
  ...
  "clothing": {
    "top": {
      ...
      "color": "dark brown",
      "text": "{\"shirt text\" \"EVERYTHING'S BIGGER IN TEXAS\"}",
      "fit": "tight"
    },
    "bottom": {
      "type": "jeans",
...
```json
{
  ...
  "accessories": {
    "tattoos": [
      {"location": "手", "design": "小星星"},
      {"location": "小腹", "design": "小心形"}
    ],
    "nails": "彩色蝴蝶"
  },
  "pose": "浴室镜子自拍",
