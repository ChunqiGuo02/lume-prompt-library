---
id: portrait-texture-angle-lips-2213
title: "超写实女性肖像摄影，展现肌肤光泽与服饰质感"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["超写实", "棚拍", "草莓", "金发", "淡紫", "暖调", "水光", "特写"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
"global_assets": {
  "subject_definition": {
    "hair": {
      "style": "长发，微卷，蓬松",
      "texture": "自然，发丝分明",
      "behavior": "凌乱但有造型感，修饰脸部和肩部"
    },
    "complexion": {
      "skin_texture": "毛孔可见，超真实感",
      "finish": "水润，玻璃肌效果",
      "makeup": {
        "cheeks": "浓郁腮红",
        "lips": "高光泽，饱满，自然粉色",
    ...
    "wardrobe": {
      ...
      "fabric": {
        "material": "柔软针织 / 圈圈呢",
        "tactility": "毛茸茸，纤维反光",
        "color": "{\"dress color\" \"柔和淡紫色\"} 或 中性灰褐色"
      },
      "details": "细肩带，及大腿中部长度"
    }
  },
  "environment_definition": {
    "studio_setup": {
      "background": "无缝背景纸，柔和米白/米色",
      "atmosphere": "干净，温暖，亲密"
    },
    "lighting_rig": {
      "key_light": "大型柔光箱 (左前方)",
      "fill_light": "反光板 (右侧)",
      "highlights": "嘴唇、颧骨和肩膀上的高光"
    }
  }
},
"panel_architecture": [
  ...
  },
  {
    ...
    "composition": {
      "angle": "平视",
      "pose_dynamic": "身体略微前倾，面向镜头"
    },
    "action": {
      "stance": "直立站姿",
      "arms": "自然垂于身体两侧",
      "expression": "直视镜头，诱人嘟嘴"
    },
    "visual_anchors": [
      "针织连衣裙的纹理",
      "锁骨阴影",
