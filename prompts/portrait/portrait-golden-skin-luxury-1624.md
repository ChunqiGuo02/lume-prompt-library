---
id: portrait-golden-skin-luxury-1624
title: "热带度假泳池边的时尚美女写真"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["比基尼", "椰子", "泳池", "度假", "美女", "金发", "棕榈", "奢华"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
## 中文译文（源站提供）
{
  "main_prompt": "一位二十多岁的迷人年轻女子，置身于奢华热带度假村的泳池边，盘腿坐在无边泳池边缘的浅米色亚麻毛巾上，用吸管直接从一个带有薄荷叶装饰的绿色椰子中饮用新鲜椰汁，表情俏皮诱惑，略微嘟嘴，眼神直视镜头，嘴唇丰满自然，涂有光泽的裸粉色唇膏，一头金色波浪长发，发量丰盈，带有金色挑染，瀑布般披散在肩上，晒黑的橄榄色皮肤散发着自然光泽，身穿性感的金属色 {\"bikini color\" \"古铜色/金色闪光\"} 三角比基尼上衣和配套的系带比基尼下装，高开叉巴西风格，隐约可见的乳沟和紧致的腹肌，手指上戴有多枚银戒指，黑色亮面指甲油，佩戴一枚镶有大颗绿色宝石（祖母绿或孔雀石）的醒目银手链，脚踝处戴着细银脚链，手腕上戴着一块可见绿色表盘的奢华手表，衣服某处系着蓝色丝带，奢华度假村背景：大型现代白色和米色建筑，配有玻璃栏杆，多棵高大的棕榈树，茅草遮阳伞，带米色坐垫的木制甲板躺椅，摆放植物的陶罐，背景中模糊的人群，阳光明媚的一天，碧绿清澈的泳池水面泛着轻柔涟漪，黄金时段温暖的阳光，强烈的轮廓光和柔和的补光，细微的镜头光晕，电影般的色彩分级，暖金色调与冷蓝色水面形成对比，超写实，超精细的皮肤纹理，毛孔和晒斑清晰可见，泳池水在皮肤上形成逼真的湿润光泽，胶片颗粒感，使用索尼 A1 相机和 85mm f/1.4 镜头拍摄，浅景深，面部和椰子清晰对焦，梦幻般的度假奢华氛围，高级时装杂志风格",
  "negative_prompt": "模糊、低分辨率、手部畸形、多余手指、解剖结构不良、手指融合、面部绘制不佳、比例失调、多余肢体、变异的手、丑陋、毁容、平铺、超出画面、jpeg 伪影、签名、水印、文字、错误、裁剪、最差质量、低质量、卡通、3D 渲染、塑料皮肤、玩偶般、喷枪处理、过度曝光、曝光不足、平坦光线、正午刺眼阴影、苍白皮肤、无晒黑、冬季服装、室内场景、凌乱房间、香烟、酒瓶、浓妆、小丑妆、夸张滤镜、网红脸、鸭子嘴、可见妊娠纹（除非自然）、肥胖、老年人、儿童、男性、合影焦点、杂乱前景、丑陋度假村、廉价塑料家具、阴天、夜晚、冷色调、去饱和、单色",
  "style_tags": [
    "超写实",
    "奢华时尚摄影",
    "热带度假村杂志风格",
    ...
    "胶片摄影效果",
    "35mm 胶片颗粒",
    "Vogue / Harper's Bazaar 风格"
  ],
  "technical": {
    "aspect_ratio": "4:5（垂直肖像，Instagram / 手机照片风格）",
    "lighting": "明亮的黄金时段阳光"
  }
}
