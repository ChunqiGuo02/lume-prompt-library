---
id: portrait-body-identity-aesthetic-1478
title: "法式海岸高定写真：精准复刻明星神韵"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["时尚", "写真", "海景", "浅色系", "法式", "奢华", "雕塑", "户外"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
version: "1.0.0"
related_to: ["landscape-body-identity-aesthetic-001"]
---
  ...
  "subject": {
    ...
    "outfit": {
      "dress": {
        ...
        "color": "{"dress color" "Neutral light tone"}",
        "details": [
          "Cap sleeves",
          "Deep neckline",
...
```json
{
  ...
  "composition": {
    "orientation": "竖幅",
    "framing": "从腰部到膝盖的三分之二特写"
  },
  "resolution": "RAW 8K",
  "aesthetic": "极致照片写实主义，精致高端时尚杂志美学",
  "identity_preservation": {
    "facial_identity": "100% 一致",
  ...
  "subject": {
    ...
    "pose": {
      "position": "坐于石制栏杆上",
      "location": "法国蔚蓝海岸露台",
      "posture": "躯干略微向左倾斜，双肩放松，下巴轻微朝向镜头",
      "gaze": "自信、平静、略带诱惑，时尚大片感",
      "body_language": "自然、柔美、克制",
      "arms": {
        "hands": "置于迷你手袋上，手指放松",
        "elbows": "柔和、自然"
      }
    ...
    "outfit": {
      "dress": {
        "style": "结构化束身迷你连衣裙",
        "color": "{\"dress color\" \"中性浅色调\"}",
        "details": [
          "插肩袖",
          "深领口",
          "束身衣骨架透过胸衣可见",
          "精致的包扣",
          "雕塑感裙摆 subtly flaring",
          "面料：哑光缎棉混纺，零光泽，挺括质感，真实的褶皱和缝线"
        ]
      }
    },
    "accessories": [
      {
        "type": "迷你绗缝手袋",
        "details": "双手持握，细链肩带，微妙的钻石般斑点细节"
      },
      {
        "type": "极简网球手链和精致戒指",
        "details": "真实的比例和重量，无夸张闪光"
      }
    ]
  },
  "environment": {
    ...
    "additional_elements": [
      "古典白色小天使雕像",
      "柔和虚化的背景，暗示海岸奢华，地中海建筑"
    ]
  },
  "lighting": {
    "type": "明亮的自然日光",
    "shadows": "柔和、真实",
    "highlights": "清晰，勾勒出形体、面料结构和皮肤纹理",
    "exposure": "平衡，时尚大片对比度，无刺眼过曝"
  },
  "camera": {
    "capture_type": "单反美学",
    "lens": "85mm",
    "depth_of_field": "浅景深",
    "focus": "躯干、双手、束身衣结构、面料细节",
    "lens_compression": "自然",
    "color_grading": "电影感但真实"
  },
  "rendering_constraints": {
    "ultra_realism": true,
    "prohibited_artifacts": [
