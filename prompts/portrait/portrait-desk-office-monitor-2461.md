---
id: portrait-desk-office-monitor-2461
title: "金融女白领办公室自拍写真"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["职场", "女性", "金发", "办公", "股票", "金融", "白领", "写实"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
```json
{
  "subject": {
    ...
    "facial_features": {
      "expression": "温柔微笑，自信的眼神",
      "makeup": "自然妆容，上扬眼线，柔和的粉色唇釉",
      "pose": "坐姿，手托下巴，双腿交叉"
    },
    "clothing": {
      "top": "紧身麻灰色长袖开衫",
      "bottom": "黑色迷你短裙",
      "hosiery": "黑色透明连裤袜/丝袜",
      "footwear": "黑色尖头平底鞋，配精致银色脚踝链"
    }
  },
  "environment": {
    "setting": "现代公司办公室 / 交易大厅",
    "workspace": {
      "desk": "白色极简主义办公桌，配浅米色桌面垫",
      "equipment": [
        "双显示器设置",
        "左侧显示器显示金融股票图表和 K 线图",
        "右侧显示器显示 Spotify 桌面应用",
        "白色机械键盘",
        "白色无线鼠标"
      ],
      "decor": "小型木质桌面增高架，暖光圆柱形台灯，粉色文具收纳盒，便利贴"
    },
    "background": "办公室同事在各自的办公桌旁，带城市景观的大窗户，垂直百叶窗，荧光吸顶灯"
  },
  "composition_and_style": {
    "camera_angle": "高角度自拍，广角镜头（轻微透视畸变）",
    "lighting": "头顶冷色调办公室照明与台灯暖色调环境光的混合",
    "color_palette": ["灰色", "黑色", "白色", "暖黄色", "金色"],
    "image_quality": "高分辨率，主体对焦清晰，纹理逼真"
  }
}
```
