---
id: portrait-reference-upload-stack-1641
title: "狂喜的金钱少女"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: japanese-zen-garden
tags: ["日元", "现金", "女生", "卧室", "暖色调", "闪光", "奢华", "开心"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
她似乎拥有各种各样的包包呢😌
不知道是不是中彩票了才买这么多包的。
这些包包都是按照日本的标准设计的，我很高兴能够使用它们！

{
  "subject": "参考上传的图片——确保所有细节都与上传的图片保持一致。一个人坐在床沿上，手里拿着一叠现金，表情夸张地向上看，舌头还微微伸出。",
  "pose": "坐在床沿上，双腿分开，双手在胸前拿着一叠日本1万日元的钞票，头部向后仰，眼睛向上看。",
  "character": {
    "face": "参考上传的图片",
    "hair": "参考上传的图片",
    "body_type": "参考上传的图片",
  ...
  "clothing": "参考上传的图片——确保所有细节都与上传的图片保持一致",
  "accessories": {
    "jewelry": "参考上传的图片",
    "props": "手中拿着一叠摊开的现金钞票，地上散落着一些日本1万日元的钞票，背景中可以看到一个黄色的设计师包",
  },
  "expression": "嘴巴大张，露出一种陶醉、恍惚且难以控制的笑容；眉毛沉重地耷拉着，表情夸张地向上看，充满活力和庆祝的气氛。",
  "environment": {
    "location": "参考上传的图片",
    "setting": "参考上传的图片",
    "background": "参考上传的图片",
  ...
  "lighting": {
    "type": "使用相机闪光灯的夜间摄影",
    "source": "明亮的白色房间灯光，加上相机闪光灯",
    "quality": "温暖的人工光源与闪光灯相结合，营造出对比效果并突出主体",
  },
  "camera": {
    "angle": "低角度拍摄，从下方仰视主体",
    "perspective": "特写，环境肖像",
  ...
  "style": {
    "aesthetic": "奢华的生活方式摄影",
    "mood": "充满活力、庆祝氛围、富有进取心",
    "color_palette": "暖色调，对比强烈的色彩"
  },
  "consistency_note": "所有角色特征（包括面部、发型、体型、肤色、面部结构、服装和配饰）都应参照上传的参考图片来制作。务必与参考图片在视觉上保持严格的一致性。",
  "output": {
    "aspect_ratio": "9:16",
    "orientation": "竖屏"
  }
