---
id: portrait-the-reflections-subject-1257
title: "时尚的设计与超级跑车的优雅气质完美结合"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["奢华", "现代", "酷感", "女性", "展厅", "跑车", "红色", "黑色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
version: "1.0.0"
related_to: ["interior-the-reflections-subject-001"]
---
...
{
  "prompt": {
    "reference_photo": "请使用上传的参考照片。不要更改人物的面部特征。人物必须与上传的照片完全一致。",
    "scene": {
      "setting": "时尚、光线昏暗的豪华展厅",
      ...
      "background": {
        ...
        "right_side": "一个光泽黑色的鳄鱼纹图案行李袋，放在布满斑点的混凝土地面上，地面有散射的光线反射",
        "left_side": "另一把红色豆袋椅以及一些简约的赛车主题装饰，为画面增添了适度的色彩点缀",
        "mirrored_wall": "展厅标识、赛车头盔展示以及风格化的赛道轮廓的倒影"
      }
    },
    "subject": {
      "identity": "人物外貌必须与参考照片完全吻合",
      "outfit": {
        "jacket": "哑光黑色皮夹克，缝线有明显的立体感，袖口部分折叠设计",
        "trousers": "宽松的黑色皮裤，裤脚处略微堆积",
        "shoes": "厚底黑色板鞋，表面光泽度很高",
        "posture": "双臂交叉，呈现出放松自信的姿势，通过微妙的反射效果突出皮料的质感"
      },
    "supercar_details": {
      "lighting_effects": "车头部分从浓厚的阴影逐渐过渡到明亮的光泽效果",
      "rims": "黑色轮圈，安装在空气动力学设计的挡泥板下方",
      "windshield": "经过抛光的挡风玻璃，能够捕捉到车内微弱的光线反射"
    },
    "micro_details": [
      "混凝土地面上的灰尘颗粒",
      "皮革表面的微小反光",
    ...
    "camera_style": "自然、真实的拍摄风格，效果类似用iPhone相机拍摄",
    "constraints": "不允许对人物面部进行任何修改——必须保持与参考照片完全相同的面部特征"
  }
}
