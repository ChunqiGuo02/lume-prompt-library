---
id: portrait-the-stone-left-0246
title: "优雅少女石阶玫瑰写真"
category: portrait
...
```json
{
  "prompt_structure": {
    "subject": {
      "description": "一位身材苗条、曲线优美、肤色略带古铜色的年轻女性。",
      "hair": "深棕色长发，半扎半披，脑后系着一个柔和的粉色丝带蝴蝶结。松散的波浪发丝垂落在她的肩上。",
      "face": "侧面视角，脸朝左侧望去。柔和的魅力妆容，眉毛精致，脸颊有修容，唇部涂有光泽唇彩。"
    },
    "attire": {
      "dress": "一件淡粉色紧身胸衣式迷你连衣裙。特点是结构化的紧身胸衣，带有可见的骨撑，细肩带，领口和裙摆处有蕾丝饰边细节，以及喇叭形褶皱裙摆。",
      "footwear": "赤脚站在石阶上。她右手拿着一双白色尖头小猫跟鞋，手握鞋跟带。",
      "jewelry": "一条珍珠项链，中央有一个精致的蝴蝶结吊坠。小巧的垂坠耳环。"
    },
    "props": {
      "right_hand": "拿着一只白色高跟鞋。",
      "left_hand": "拿着一朵长茎的淡粉色玫瑰。"
    },
    "pose_and_action": {
      "stance": "优雅地站立在室外石阶上。右腿膝盖微曲，重心放在左腿。身体略微朝向镜头，但脸部呈侧面。",
      "expression": "宁静、疏离、优雅。"
    },
    "setting": {
      "location": "通往米色石质建筑的宏伟室外石阶。",
      "background_elements": "背景中可见一扇带有白色窗帘的大型多格窗户。左侧基座上有一个石质花盆/花坛。台阶底部是修剪整齐的绿色草坪。",
      "architecture": "经典、历史悠久的石灰石或砂岩砌体。"
    },
    "lighting_and_atmosphere": {
      "lighting": "明亮的自然日光。台阶上投射出强烈、清晰的阴影，表明阳光从左上方直射。",
      "mood": "浪漫、女性化、娇媚、优雅、梦幻。"
    },
    "technical_specifications": {
      "quality": "4K 超高清，照片级真实感，高分辨率。",
      "style": "时尚摄影，生活方式肖像。",
      "focus": "主体清晰对焦，织物和石头的纹理细节渲染精细。",
      "color_palette": "柔和的粉彩色调，米色，粉色，白色和自然绿色。"
    }
  }
}
```
