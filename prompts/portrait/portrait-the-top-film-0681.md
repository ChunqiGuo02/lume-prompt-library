...
      "attire": {
        "top": "{"top style 1" "Black structured corset-style bodice top with defined bust cups and straps"}.",
...
{
  "prompt": {
    "overall_scene": "一张抓拍的直闪模拟胶片照片，两名年轻女性在昏暗、复古风格的酒吧里享受夜生活，她们紧密地坐在皮革长椅上。整体美学是低保真、颗粒感强、暖色调，并带有硬闪光阴影。",
    "aspect_ratio": "9:16",
    "photography_style": {
      "type": "模拟胶片快照",
      "lighting": "机顶直闪，营造出刺眼的强光和深邃的阴影",
      "texture": "厚重的胶片颗粒感，色彩略微去饱和但偏暖，复古氛围",
      "composition": "垂直肖像，抓拍瞬间"
    },
    "subjects": {
      "count": 2,
      "relationship": "朋友，身体接触亲密，充满活力和玩乐的互动"
    },
    "subject_1_left": {
      "description": "一名皮肤晒黑、留着波浪形渐变金色长发的女性。",
      "action": "身体倾向朋友，正积极地从一个装满冰块和饮料的透明古典杯中啜饮。",
      "attire": {
        "top": "{\"top style 1\" \"黑色结构化紧身胸衣式上衣，带有明确的罩杯和肩带\"}",
        "bottoms": "灰色定制阔腿裤。",
        "accessories": "独特的白色贝壳项链，左手（握着杯子）戴有多枚叠戴的金色戒指。"
      },
      "expression": "专注于饮酒动作，略微向上并看向侧面。"
    },
    "subject_2_right": {
      "description": "一名留着深棕色长发的女性，身体略微靠在卡座的靠背上。",
      "action": "摆出俏皮的姿势，右臂热情地高高举起。",
      "attire": {
        "top": "白色无肩带抹胸上衣，印有红黑报纸/杂志图案（可见的文字碎片包括 'SENSATION', 'PROPAGANDA'）。",
        "bottoms": "浅色水洗蓝色牛仔裤。",
        "accessories": "举起的右腕上戴有多层金色手链，金色戒指。"
      },
      "expression": "喜悦地眯着眼睛，俏皮地吐着舌头。"
    },
    "environment": {
      "seating": "带罗纹、磨损的棕色皮革长椅沙发，纹理和缝线清晰可见。",
      "background_wall": "下半部分是深色木质护墙板。上半部分是一幅大型、老旧的棕褐色壁画或墙纸，描绘了带有重复拱门和立面的欧洲历史建筑。",
      "details": "一部现代智能手机正面朝上地放在右侧女性臀部附近的皮革座垫上。闪光灯范围之外的整体氛围昏暗而富有情调。"
    }
  }
}
```
