---
id: portrait-the-hoodie-gaming-1767
title: "电竞少女沉浸游戏瞬间"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["电竞", "女生", "居家", "游戏", "耳机", "卫衣", "键盘", "显示器"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
# 正文 prompt
{
  "prompt_structure": {
    "subject_details": {
      ...
      "clothing": {
        "top": "Oversized grey heathered hoodie with '{\"hoodie text\" \"Brooklyn\"}' text in faded navy",
...
```json
{
  "prompt_structure": {
    "subject_details": {
      "demographics": "年轻女性，东亚裔，肤色白皙，淡妆，眼线略带小翅膀",
      "facial_features": "心形脸，专注的神情，眼睛映照出电脑显示器的光芒",
      "hair": "短波波头，搭配法式刘海，染成灰金色，发根露出深色，略显凌乱",
      "clothing": {
        "top": "宽松的灰色麻花连帽衫，上面印有褪色的海军蓝文字“{\"hoodie text\" \"Brooklyn\"}”",
        "accessories": "大型白色头戴式游戏耳机戴在头发上"
      },
      "pose": "舒适地瘫坐在黑色网状人体工学游戏椅中。一条腿蜷缩在另一条腿下。左手放在发光的机械键盘上，右手握着白色游戏鼠标。"
    },
    "environment_context": {
      "setting": "舒适、略显杂乱的家庭办公室/游戏设置",
      "background_elements": [
        "双显示器设置，显示复杂的角色扮演游戏界面",
        "半杯冰咖啡，杯壁有冷凝水珠",
        "桌上陶土盆里的小多肉植物",
        "金色夕阳透过百叶窗洒入，在墙上形成“斑马”状光影",
        "洞洞板上挂着线缆和一个小小的霓虹“云朵”标志"
      ]
    },
    "lighting_atmosphere": {
      "primary_source": "侧面射入的强烈金色夕阳光线与显示器发出的冷蓝色光芒混合",
      "quality": "高对比度，电影感，暖橙色高光与冷色调数字阴影形成对比",
      "shadows": "窗户百叶窗在主体面部和连帽衫上投下锐利、清晰的阴影"
    },
    "camera_technical": {
      "style": "抓拍式室内摄影，生活方式照片",
      "simulation": "无反相机搭配 35mm 定焦镜头",
      "angle": "与视线齐平，略微侧面轮廓",
      "focal_length": "35mm",
      "aperture": "f/1.8 (奶油般柔和的背景虚化)",
      "iso": "400 (画面干净，带有非常微妙的有机颗粒感)",
      "focus": "对主体眼睛和连帽衫抽绳的纹理进行锐利对焦"
    },
    "quality_modifiers": {
      "engine": "Nano Banana Pro",
      "details": "超现实主义，8k，照片级真实纹理，可见的散发，阳光中舞动的尘埃，连帽衫面料的编织纹理，键盘按键上的油光。"
    },
    "negative_prompt": "塑料皮肤，喷枪修饰，CGI，电子游戏渲染，对称的脸，完美的头发，影棚灯光，水印，签名"
  }
}
```
