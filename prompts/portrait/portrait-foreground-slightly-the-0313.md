---
id: portrait-foreground-slightly-the-0313
title: "光影中的少女：窗边回眸，温暖氛围感人像"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: japanese-zen-garden
tags: ["少女", "逆光", "暖色调", "氛围感", "胶片", "日系", "复古", "室内"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
{
  "subject": {
    "description": "年轻的东亚女性，侧身回望观者。",
    "pose": "回眸，头部略微倾斜，身体背对镜头。",
    "expression": "柔和、中性略带忧郁、沉思的眼神，嘴唇微启。"
  },
  "clothing": {
    "upper_body": "深色、有型的夹克或西装外套，可能带有细条纹或纹理面料。",
    "visibility": "大部分被阴影和前景元素遮挡。"
  },
  "hair": {
    "color": "深棕色至黑色。",
    "style": "长发，蓬松的波浪卷，略显凌乱。",
    "lighting_interaction": "强烈逆光，在散落的发丝上形成发光光晕效果（轮廓光）。"
  },
  "face": {
    "skin_tone": "白皙/苍白，带有暖色调。",
    "features": "柔和的面部结构，杏仁状眼睛，自然眉毛。",
    "makeup": "极简的“素颜”妆容，自然唇色。"
  },
  "accessories": {
    "visible_items": "由于构图和光线原因，没有清晰可见的物品。"
  },
  "environment": {
    "setting": "杂乱的室内空间，类似于工作室、储藏室或旧书店。",
    "background_elements": "木制货架上堆满了模糊不清的物品、纸张、盒子和塑料包装。",
    "foreground_elements": "模糊的半透明物体（可能是玻璃、塑料片或防尘罩），形成层次和反光。"
  },
  "lighting": {
    "source": "自然阳光从左侧窗户射入。",
    "quality": "黄金时段，温暖、柔和但有方向性。",
    "effects": "头发上的强烈逆光/轮廓光，光线中舞动的体积感尘埃，镜头光晕，柔和眩光，光影之间形成强烈对比。"
  },
  "camera": {
    "perspective": "与视线齐平，透过前景障碍物（玻璃或杂物）拍摄。",
    "focus": "浅景深（散景），眼睛/面部对焦清晰，背景和前景模糊。",
    "lens_character": "柔焦，胶片颗粒模拟，轻微的泛光效果。"
  },
  "style": {
    "aesthetic": "电影感，氛围感，怀旧，生活片段，空灵。",
    "mood": "梦幻，亲密，宁静，感伤。",
    "visual_reference": "胶片摄影，日式写真集风格。"
  }
}
```
