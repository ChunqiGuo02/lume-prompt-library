---
id: "portrait-the-subject-face-001"
title: "雪地冷峻时尚女性蹲姿写真"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["雪地", "冬季", "女性", "墨镜", "皮帽", "金发", "黑色", "蹲姿"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
```json
{
  "subject": {
    ...
    "age_appearance": "young adult, early 20s",
    "ethnicity": "Northern European",
    "emotion": "冷峻自信，沉着，坚忍，高冷时尚感",
    "hair": {
      "color": "冰铂金色",
      "length": "及肩",
      "style": "帽子下露出松散的波浪卷发",
      "texture": "柔软，被冬日空气轻微吹乱",
      "placement": "框住脸庞并垂落在双肩"
    },
    "face": {
      "visibility": "部分可见",
      "profile_visibility": "正脸",
      "skin_tone": "瓷白，苍白",
      "expression": "中性，嘴巴放松，眼镜后是时尚大片般的凝视"
    }
  },
  "meta": {
    "aspect_ratio": "1:1",
    "camera": "iPhone 16 Pro Max 后置主摄像头",
    "lens": "24mm f/1.78 智能手机广角镜头",
    "focal_character": "主体对焦锐利，自然景深",
    "quality": "超现实，高分辨率摄影",
    "style": "户外冬季时尚大片，原始智能手机写实主义，真实皮肤纹理，锐利细节"
  },
  "visibility_rules": {
    "mirror_only": false,
    "no_direct_subject_visibility": false,
  ...
  "camera_angle": {
    "vertical_position": "低角度，相机位于主体膝盖高度，略微向上看",
    "horizontal_alignment": "以主体为中心",
    "tilt": "轻微向上倾斜以捕捉蹲姿",
    "yaw": "相机正对着主体",
    "roll": "0 度，水平线完全水平",
    "distance_to_mirror_meters": 0,
    "handheld_behavior": "稳定手持拍摄"
  },
  "body_angle": {
    "global_orientation": "正对前方，蹲姿",
    "torso_rotation_degrees": 0,
    "shoulder_alignment": "与相机平行",
    "hip_rotation_degrees": 0,
    "weight_distribution": "深蹲时重量均匀分布",
    "posture": "低蹲于地面，保持平衡"
  },
  "head_angle": {
    "rotation_degrees": 0,
  ...
  "pose": {
    ...
    "arms": {
      "right_hand": "手抬至太阳穴，手指轻触太阳镜镜框",
      "left_hand": "手臂向下伸展，手伸向雪面，手指张开"
    }
  },
  "clothing": {
    "outfit_type": "长袖紧身衣",
