---
id: portrait-the-type-candid-2816
title: "高定礼服女性红毯写真，8K超清电影感肖像"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["写实", "人像", "女性", "年轻", "长发", "白裙", "金链", "缎面"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
```json
{
  ...
  "subject_details": {
    "demographics": "年轻女性，20 岁出头，白种人",
    "physique": "苗条，姿态优雅",
    "hair": {
      "color": "深灰褐色",
      "style": "长发，蓬松吹干，松散分层垂至肩部",
      "texture": "丝滑，高光泽，随风飘动"
    },
    "face": {
      "expression": "抓拍，目光转向一侧，嘴唇微张，未察觉到镜头",
      "features": "柔和的下颌线，笔直的鼻子，红润的脸颊，自然精致的妆容",
      "eyes": "目光看向镜头左侧，捕捉到瞬间"
    }
  },
  "wardrobe_schema": {
    ...
    "key_details": {
      "straps": "粗编织金色链条肩带",
      "accessories": "极简，突出裙装的五金件"
    }
  },
  "environment_context": {
    "setting": "拥挤的高端活动或晚会",
    "background": "模糊的人群，面部不清晰，柔和中性的散景",
    "depth": "浅景深，只对主体清晰对焦"
  },
  "lighting_parameters": {
    "type": "柔和漫射的活动灯光",
    "direction": "左前方照明",
    "mood": "电影感，柔和对比，自然肤色",
    "shadows": "柔和的阴影勾勒出锁骨和颈部"
  },
  "technical_specifications": {
    "camera": "Sony A7R IV 或类似的专业全画幅无反相机",
    "lens": "85mm f/1.4 人像镜头",
    "resolution": "最高分辨率，垂直构图",
    "rendering": "虚幻引擎 5 级别的真实感，光线追踪，纹理清晰度"
  }
}
```
