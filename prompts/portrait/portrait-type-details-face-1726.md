---
id: portrait-type-details-face-1726
title: "田园风少女倚石墙，碎花裙配绿靴，柔光下尽显慵懒文艺气质"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["少女", "碎花", "露肩", "短裙", "石墙", "户外", "田园", "复古"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
  ...
  "prompt_details": {
    ...
    "clothing": {
      "dress": {
        ...
        "pattern": "Small, delicate floral print with {"floral color 1" "purple"} and {"floral color 2" "yellow"} wildflowers",
...
```json
{
  "prompt_details": {
    "subject": {
      "type": "年轻女性",
      "appearance": {
        "hair": "长款、深栗色、波浪松散、垂落脸庞、凌乱美感",
        "skin": "白皙肤色、光滑质感、自然妆容",
        "face": "向下看、脸部部分被头发遮挡、内省表情",
        "body_type": "苗条、健美"
      },
      "pose": {
        "stance": "靠着石墙、身体略微倾斜",
        "hands": "右手轻轻放在胸部/颈部、手指张开，左手在身侧拿着一个绿色物体（靴子）",
        "gaze": "向下、避免眼神接触"
      }
    },
    "clothing": {
      "dress": {
        "style": "露肩迷你连衣裙、田园/波西米亚风格",
        "fabric": "轻质棉麻混纺",
        "color": "米色/米白色底色",
        "pattern": "小巧精致的碎花图案，带有 {\"floral color 1\" \"紫色\"} 和 {\"floral color 2\" \"黄色\"} 野花",
        "details": ["荷叶边分层裙摆", "泡泡短袖", "心形领口", "束身衣式紧身胸衣结构"]
      },
      "accessories": [
        "细黑色颈链",
        "手指上戴着多个银戒指",
    ...
    "environment": {
      "background": "有纹理的石砌墙",
      "details": "大块不规则的灰色和米色石块、粗糙质感、自然建筑背景",
      "setting": "户外或半户外日光环境"
    },
    "lighting": {
      "type": "柔和自然日光",
      "quality": "漫射、均匀照明、柔和阴影",
      "direction": "正面打光但柔和"
    },
    "styling": {
      "aesthetic": "波西米亚风、时尚、女性化、带有一丝柔和的垃圾摇滚底蕴",
      "mood": "休闲、随性、略带忧郁、艺术感"
    },
    "camera_details": {
      "shot_type": "中景（大腿以上）",
      "angle": "平视",
      "lens": "85mm 定焦镜头，用于讨喜的人像压缩效果",
      "aperture": "f/2.8，使主体与墙壁之间产生轻微景深分离",
      "focus": "主体和连衣裙纹理清晰对焦"
    },
    "technical_specifications": {
      "quality": "超逼真、8k 分辨率、高度细节化",
      "texture_quality": "高保真织物纹理、逼真的皮肤毛孔、细节丰富的石砌结构",
      "engine": "虚幻引擎 5 渲染风格或高端摄影"
    }
  }
}
```
