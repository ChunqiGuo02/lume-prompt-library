---
id: portrait-neon-skin-subtle-2182
title: "赛博朋克霓虹美人肖像，梦幻闭眼，高对比度光影，超写实质感"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["赛博朋克", "霓虹", "女性", "肖像", "蓝色", "紫色", "蒸汽波", "长发"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "4:3"
...
"Use the face from the reference image as is."
  ...
  "technical": {
    ...
    "lighting": "multi-source neon: strong magenta-pink key from side/front creating rim light a"
  }

## 中文译文（源站提供）
"使用参考图像中的面部特征。"
  "main_prompt": "诱惑的赛博朋克美人肖像，置身于强烈的霓虹灯光下，一位二十出头的年轻女性，拥有白皙的瓷器般肌肤和微妙的自然光泽，一头波浪状的深红褐色/红棕色长发随意地披散在裸露的香肩上，双眼紧闭，沉浸在梦幻般的狂喜中，睫毛浓密纤长，柔软微张的裸粉色光泽双唇，精致的妆容带有微妙的烟熏眼妆和修容的脸颊，上身赤裸，露出香肩和上半背部，肌肤沐浴在充满活力的 {\"neon color 1\" \"洋红色-粉色\"} 和 {\"neon color 2\" \"电光蓝\"} 霓虹光芒中，热粉色的强劲轮廓光勾勒出头发、颈部和锁骨，粉紫色光谱中的体积光线和镜头眩光穿透迷雾般的空气，深蓝紫色阴影与明亮的霓虹高光形成对比，未来感的霓虹俱乐部或工作室背景，带有发光的粉色和蓝色灯管，边缘有严重的色差，形成彩虹般的棱镜条纹，微妙的数字故障和光晕效果，照片般逼真却高度风格化，超详细的皮肤纹理，带有逼真的毛孔、细微的雀斑和自然的瑕疵，每一根发丝都捕捉到霓虹反射和次表面散射，电影般的色彩分级，以热洋红色-粉色和电光蓝为主导，高对比度 HDR 效果，轻微的胶片颗粒感，忧郁性感的赛博朋克美学，使用 Sony A1 相机和 85mm f/1.4 镜头通过棱镜滤镜拍摄，浅景深，焦点集中在面部和头发上，霓虹背景呈现奶油般散景，高级时尚杂志与蒸汽波赛博朋克幻想的结合，亲密而空灵的氛围",
  "negative_prompt": "模糊、低分辨率、变形的手、多余的手指、融合的手指、糟糕的解剖结构、拙劣的面部描绘、比例失调、多余的肢体、变异的手、丑陋、毁容、平铺、超出画面、jpeg 伪影、签名、水印、文字、错误、裁剪、最差质量、低质量、卡通、动漫、3D 渲染、塑料皮肤、玩偶般、喷枪处理的皮肤、过度曝光的霓虹冲刷、曝光不足、平坦的照明、刺眼的阴影、没有光泽的苍白皮肤、浓妆艳抹、网红脸、鸭子嘴、微笑愉快的表情、老年人、儿童、男性、合影、自然日光、干净的白色背景、无霓虹光泽、哑光皮肤、去饱和色彩、单色、廉价效果、合成感、上半身有可见衣物覆盖、长直发、金发/红色不匹配、无色差、无聊的构图",
  "style_tags": [
    "超现实赛博朋克",
    "强烈的洋红色-粉色和电光蓝霓虹",
    "体积光线和镜头眩光",
  ...
  "technical": {
    "aspect_ratio": "3:4 或 4:5（垂直霓虹肖像/壁纸风格）",
    "lighting": "多光源霓虹：侧面/前方强烈的洋红色-粉色主光，形成轮廓光"
  }
