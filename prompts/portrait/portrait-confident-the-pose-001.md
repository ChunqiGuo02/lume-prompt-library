---
id: "portrait-confident-the-pose-001"
title: "高端时尚写真：深绿礼服女性自信姿态全黑背景拍摄"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["绿色", "女性", "棚拍", "黑色", "背景", "优雅", "时尚", "自信"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
## 中文译文（源站提供）
{
  "scene": "专业影棚拍摄，纯黑色无缝背景",
  "subject": {
    "gender": "成年女性",
    "pose": "自信、有力的站姿，与参考姿势完全一致",
    "expression": "自信、沉着、大胆的眼神交流",
    "body_language": "身姿挺拔，肩膀放松，自信的气场"
  },
  "outfit": {
    "style": "优雅、大胆、时尚前卫",
    "details": "无袖修身款上衣，搭配长度及膝的同款半身裙",
    "fit": "剪裁合身，修饰身材，不过分夸张",
    "color": "饱和度高、有吸引力的纯色，与黑色背景形成对比"
  },
  "lighting": {
    "setup": "极简影棚布光",
    "style": "单主光，柔和的衰减效果",
    "focus": "完全聚焦于主体",
    "shadows": "受控的电影感阴影，营造深度"
  },
  "camera": {
    "framing": "中景至七分身特写",
    "angle": "平视视角，时尚杂志编辑风格",
  ...
  "aesthetic": "高端时尚杂志编辑风格，自信、强大、优雅",
  "quality": "超高细节，锐利对焦，逼真的纹理，影棚级清晰度，4K",
  "background": "纯黑色，无渐变，无干扰"
}
