---
id: portrait-the-top-slightly-1396
title: "梦幻动态人像摄影预设"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["复古", "暖色调", "少女", "金发", "砖红", "背心", "牛仔", "弱光"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
Wearing a sleeveless top (tank top/camisole) in {"top color" "brick red or dark pink"} and blue denim pants.
...
Aspect ratio: {"aspect ratio" "square (1:1) or 4:5"}.

## 中文译文（源站提供）
一位年轻女性的艺术肖像，具有强烈的动态模糊（相机抖动效果）和双重曝光。长直发，齐刘海，由于动态效果融入背景。面容姣好，化着淡雅的自然妆容，桃色双唇，带着梦幻或略带微笑的表情看向镜头。
身穿 {"top color" "砖红色或深粉色"} 无袖上衣（背心/吊带衫），搭配蓝色牛仔裤。
姿态动感，仿佛正在移动或向前倾斜，形成重叠且柔和（飘渺）的轮廓。双手向前伸展但模糊不清。
构图：特写到中景。拍摄角度：略微高角度或平视。
光线：柔和但略显昏暗（弱光）或环境室内光线，带有温暖的复古色调。
背景：抽象且非常模糊，隐约可见一个凌乱的房间，墙上贴着海报或画作，失焦处理，营造出梦核或 Y2K lo-fi 美学。
图像质量类似于意外拍摄的模拟照片或慢快门速度的抓拍。
宽高比：{"aspect ratio" "正方形 (1:1) 或 4:5"}。
