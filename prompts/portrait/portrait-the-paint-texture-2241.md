---
id: portrait-the-paint-texture-2241
title: "超写实画家肖像：蓝颜料俏皮沾鼻，工作室阳光洒落"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: industrial-loft
tags: ["写实", "画室", "少女", "颜料", "画架", "画笔", "暖光", "蓝色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
      "expression": "Playfully frustrated pout (resembling the reference photo's charm), a smudge of vibrant {"颜料颜色" "blue"} oil paint accidentally wiped on her {"污渍位置" "nose and cheek"}.",
...
```json
{
  "prompt_type": "hyper_realistic_portrait",
  "subject_details": {
    "demographics": "年轻女艺术家，皮肤白皙，质地自然，身穿沾满颜料的牛仔背带裤和一件简单的白色背心。",
    "facial_features": {
      "features": "面部特征应与参考图片一致。",
      "expression": "俏皮地撅着嘴，略带沮丧（与参考照片的魅力相似），一抹鲜艳的 {\"paint color\" \"蓝色\"} 油画颜料不小心擦到了她的 {\"stain location\" \"鼻子和脸颊\"}。",
      "eyes": "明亮，直视镜头，眼神中带着一丝“帮帮我”的意味。",
      "hair": "凌乱的发髻用画笔固定，几缕发丝垂落在脸庞。"
    },
    "apparel": {
      "outfit": "宽松的牛仔背带裤，上面布满了五颜六色的颜料斑点，看起来随意且有生活气息。",
      "accessories": "无。"
    }
  },
  "pose_and_action": {
    "body_position": "斜靠在木制画架上，姿态放松。",
    "hands": "一只手拿着木制调色板，另一只手拿着沾满颜料的画笔，指向一幅凌乱的抽象画作。"
  },
  "background_environment": {
    "location": "阳光普照的艺术工作室阁楼。",
    "lighting_source": "金色的自然光透过巨大的工业窗户倾泻而入，空气中弥漫着尘埃。",
    "objects": {
      "details": "堆叠的画布、装满画笔的罐子、散落在凳子上的油画颜料管，以及沾有颜料滴的木地板。"
    }
  },
  "technical_specs": {
    "style": "超现实主义摄影，85 毫米镜头人像，眼睛和颜料纹理清晰对焦，背景柔和散景。",
    "visual_fidelity": "高分辨率，捕捉油画颜料的粘稠质感和皮肤的自然毛孔。",
    "aspect_ratio": "4:5"
  },
  "constraints": [
    "保持原始参考图的真实、 candid 感觉",
    "确保颜料纹理看起来真实（湿润且厚重），而非扁平",
    "保持光线自然温暖"
  ],
  "output_goal": "创作一张迷人、超现实的照片，描绘一位年轻艺术家在她凌乱的工作室里休息，俏皮地为自己的失误而撅嘴，鼻子上沾着蓝色颜料。"
}
```
