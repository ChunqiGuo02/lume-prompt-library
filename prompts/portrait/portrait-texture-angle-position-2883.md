---
id: portrait-texture-angle-position-2883
title: "高端美妆摄影拼贴预设"
category: portrait
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["美妆", "写真", "高级", "写实", "草莓", "卷发", "短裙", "光泽"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
{
  "项目规格": {
    "构图方式": "2x2网格拼贴（2x2 Grid Collage）",
    "画面比例": "4:5",
    "美学风格": "高端美妆编辑（High-end Beauty Editorial）",
    "渲染引擎设置提示": {
      "真实感水平": "超写实（Ultra-photorealistic）",
      "纹理质量": "8K分辨率",
      "光照效果": "光线追踪 Studio光照（Ray-traced
