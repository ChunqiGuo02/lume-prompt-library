---
id: ip_design-the-lines-square-0094
title: "大规模建筑改造与破坏物理视频提示"
category: ip_design
subcategory: "04_动漫游戏视觉与IP改编"
aesthetic: null
tags: ["Seedance 2.0", "城市变形", "紫光", "动态构图", "未来科幻", "光影流动", "人物中心", "圆形空洞"]
recommended_models: []
recommended_params:
  aspect_ratio: "16:9"
  quality: null
...
## 中文译文（源站提供）
一位雄伟的存在，披着黑色流动的斗篷，矗立在繁华的城市广场中，其外衣编织着闪烁的紫罗兰线条，勾勒出隐藏的图案——当它抬起手时，这些线条爆发出耀眼的光芒。表面下方出现了细微的变动。广场轻微向下倾斜。

场景随之演化：汽车滑向变化点，水景旋转成空中环形，附近建筑在其基础重新对齐时调整姿态。改变的涟漪向外扩散穿过城市景观。路灯杆倾斜，好像被中央力量吸引。

人物在一个正在变成奇妙空间的街区中移动：地面层位移 → 中层建筑重排 → 屋顶结构开始重新配置。玻璃和钢铁如柔软材料般拉伸弯曲。动态视角环绕形成的不规则形态，碎片在更紧密的轨道上旋转。

场景达到高潮，一座建筑的形式消散。从高处看，城市出现了一个巨大的圆形空洞，空间被重新构想。人物静静站立于其中心。紫色光芒与旋转的碎片以及扭曲的建筑交织舞动。

## 来源备注
- 源站作者：Cyber AI Creator 🎨
- 源站 UUID：bskdn5k0d6
- 源站分类：04_动漫游戏视觉与IP改编
