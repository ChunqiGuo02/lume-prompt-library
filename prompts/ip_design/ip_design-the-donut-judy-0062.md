---
id: ip_design-the-donut-judy-0062
title: "动物之城喜剧甜甜圈追逐短片"
category: ip_design
subcategory: "04_动漫游戏视觉与IP改编"
aesthetic: null
tags: ["Seedance 2.0", "动画短片", "喜剧", "3D动画", "Zootopia风格", "警察局", "兔子角色", "狐狸角色"]
recommended_models: []
recommended_params:
  aspect_ratio: "16:9"
  quality: null
...
0:12–0:15
Tight two-shot. Nick lifts the same donut with two fingers and hands it over with a dry smug grin. Judy instantly switches back to formal police mode, pulls out one clear evidence bag, seals the same donut inside, and proudly presents it to camera like a major arrest. Nick stands beside her with an amused look. In deep background, the sloth clerk slowly raises a stamp. End on a clean comedic freeze frame: evidence bag with the donut

## 中文译文（源站提供）
15秒的喜剧动画短片，世界观与《动物方城市》视觉风格相同。高质量、风格化的3D动画，面部表情生动，干净易读的滑稽动作，明亮的警局内部，抛光反射地板，温暖室内日光。仅视觉喜剧，几乎无对白。

朱迪·霍普斯：小而快的兔子警官，蓝色ZPD制服，超严肃，爆炸式冲刺，精准滑步，决心满面，耳朵尖锐反应。
尼克·韦尔德：高瘦狐狸，绿色衬衫领带，放松姿态，动作最小，干涩的调侃表情。
背景：远处桌子上只有一位懒散树懒职员，从不进入前景。

关键物体：一个草莓果冻甜甜圈，整个片段仅此一枚，落出尼克的小棕色纸袋，滚过地板，被尼克拦住，然后被朱迪塞入透明证据袋。无重复甜甜圈，无额外道具，无连贯性错误。

摄像语言：第三人称电影喜剧，中景镜头，低角度近距离跟踪甜甜圈，一侧追踪镜头，一个最终紧凑的双人镜头。平滑稳定运动，仅在需要时做细微喜剧鞭打校正。始终保持甜甜圈、朱迪和尼克空间可读。

0:00–0:03  
中景，轻度跟踪ZPD大厅。朱迪与尼克并肩走过前台。朱迪手持小剪贴板，尼克手提棕色纸袋。一枚草莓果冻甜甜圈滑出袋子，落地开始滚动。朱迪的耳朵立刻竖起，她像追捕嫌犯一样锁定它。摄像机向下倾斜，保持甜甜圈在前景。

0:03–0:06  
低角度近距离跟踪镜头，同一枚甜甜圈快速滚过闪亮地板。朱迪从背后冲进画面，一只手臂下夹着剪贴板，全力奔跑，两爪向前伸。她几乎抓住，却差点厘米。甜甜圈继续滚动。快速可读的摄像机调整，无混乱运动。

0:06–0:09  
侧中景宽镜头。甜甜圈绕过固定桌腿弯曲。朱迪做出夸张的快步和低滑步试图截住，却再次被甩开。她转身立即追赶。在背景，尼克沿着较短斜向路径平静行走，无急躁。保持同一甜甜圈清晰可见。

0:09–0:12  
正面中近景。甜甜圈朝摄像机滚来。尼克的爪子从画面右侧平稳进入，按住同一枚甜甜圈停止。朱迪从左侧滑入，鼻尖与甜甜圈仅几英寸之隔，仍保持完整逮捕姿势。清晰停留反应节拍。

0:12–0:15  
紧凑双人镜头。尼克用两根手指举起同一枚甜甜圈，并以干涩自鸣得意的笑容递给朱迪。朱迪立即切换回正式警官模式，掏出透明证据袋，将同一枚甜甜圈封入，然后像重大逮捕一样自豪地呈现给摄像机。尼克站在她旁边，表情愉悦。在深背景中，树懒职员慢慢举起印章。以干净喜剧冻结帧结束：证据袋中的甜甜圈。

## 来源备注
- 源站作者：Midjourney Sref and prompt Library
- 源站 UUID：yy7y52njrg
- 源站分类：04_动漫游戏视觉与IP改编
