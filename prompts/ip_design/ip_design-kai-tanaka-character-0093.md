---
id: ip_design-kai-tanaka-character-0093
title: "多镜头动漫战斗编排提示"
category: ip_design
subcategory: "04_动漫游戏视觉与IP改编"
aesthetic: null
tags: ["Seedance 2.0", "动漫", "武道馆", "踢击", "动感模糊", "清晰动作", "中景镜头", "特写镜头"]
recommended_models: []
recommended_params:
  aspect_ratio: "16:9"
  quality: null
...
## 中文译文（源站提供）
@Image1 的角色凯攻击 @Image2 的角色田中老师，在 @Image3 道场。动漫，凯的踢击有运动模糊，田中的动作清晰。

编舞：  
镜头 1 (0.0-2.0s)：中景。凯用高抛式旋转脚踢攻击。田中以前臂挡住，几乎没有偏移。  
镜头 2 (2.0-3.5s)：特写。凯投出一次中等水平的侧踢。田中用小圆形手势将其偏开。  
镜头 3 (3.5-5.0s)：低角度。凯尝试一次低扫腿。田中抬起脚，正好在它下方经过。  
镜头 4 (5.0-7.0s)：特写凯困惑的脸。声音是三拍鼓点，一声响亮的 THUD，一声 WHOOSH，一声 SWISH，然后寂静。
