---
id: ip_design-the-his-medium-0063
title: "动画山羊人茶道序列"
category: ip_design
subcategory: "04_动漫游戏视觉与IP改编"
aesthetic: null
tags: ["Seedance 2.0", "动画", "维多利亚温室", "马（动物）", "阳光/暖色调", "花卉（兰花、蕨类）", "金表", "玻璃天花板"]
recommended_models: []
recommended_params:
  aspect_ratio: "1:1"
  quality: null
...
镜头01（0:00-0:02）：全景。他坐在一张小巧的锻铁桌旁，位于郁郁葱葱、阳光充足的维多利亚式温室内，周围环绕着盛开的兰花和悬挂的蕨类植物。  
镜头02（0:02-0:04）：中景。他优雅地从匹配的托盘上抬起一只精致的瓷茶杯，他的蹄子竟然异常灵活。  
镜头03（0:04-0:07）：特写。他慢慢啜饮，巨大的耳朵微微竖起并因品尝而轻颤，显得满意。  
镜头04（0:07-0:10）：侧面中景。他顺畅地放下茶杯，取出一只闪亮的金色怀表。  
镜头05（0:10-0:13）：脸部特写。他检查时间，用柔和、满足的点头，同时用一根手指调整眼镜。  
镜头06（0:13-0:15）：拉远全景。他深深放松地坐在椅子上，沐浴在透过玻璃天花板洒下的温暖斑驳阳光中。
