---
id: ip_design-game-opponent-knight-0031
title: "二维格斗游戏序列提示2"
category: ip_design
subcategory: "04_动漫游戏视觉与IP改编"
aesthetic: null
tags: ["Seedance 2.0", "二维动漫格斗", "cel阴影", "暗金属石", "动态线条", "血条HUD", "能量球", "夜景屋顶"]
recommended_models: []
recommended_params:
  aspect_ratio: "16:9"
  quality: null
...
# ═══════════════════════════════════════════════
# 项目：2D 格斗游戏序列
# 规格：PlayStation 4 / 30FPS / 预算 5亿日元
# ═══════════════════════════════════════════════

visual_config:
  style: >
    2D 动漫风格的格斗视频游戏截图，
    赛璐珀渲染，粗线条轮廓，暗金属石材建筑调色板，
    漫画式动态线条，街机游戏美学

character_settings:
  player: "左侧角色在 @Image1"
  opponent: "右侧角色在 @Image1"
