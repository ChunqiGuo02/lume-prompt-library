---
id: ip_design-the-rabbit-card-0148
title: "电影街头魔术视频提示"
category: ip_design
subcategory: "04_动漫游戏视觉与IP改编"
aesthetic: null
tags: ["Seedance 2.0", "3D动画", "夜景城市", "人形兔子魔术师", "卡牌表演", "粒子特效", "玻璃建筑", "光网格"]
recommended_models: []
recommended_params:
  aspect_ratio: "9:16"
  quality: null
...
## 中文译文（源站提供）
一幅风格化的电影三维动画，背景设定在夜晚的城市街道，湿润的反光人行道、柔和的路灯以及霓虹灯闪烁。一个拟人化的白兔魔术师站在中央，穿着黑色燕尾服、白衬衫、黑领结和黑顶礼帽，周围环绕着一圈松散的半圆形观众。兔子用标准52张牌的扑克牌进行流畅专业的手法表演。整副牌在胸前均匀展开，所有牌面可见且独特。摄像机的一只手从展开的牌中挑选出一张——红桃A。兔子拿起同样的牌，清晰地面对摄像机。兔子轻轻甩动这张牌。红桃A的边缘开始发光，然后分解成细小的红色和金色颗粒。这些颗粒形成一个受控、连续的流线，并伴随运动轨迹向前流过街道。摄像机跟随颗粒流，直至它们抵达一座大型玻璃建筑立面。撞击时，一点光亮出现并以网格状图案扩散到整个玻璃表面。整座建筑立面被激活，一个巨大的发光红桃A在其上形成，明亮且清晰可辨，并伴有细微的脉动灯光。在短暂保持后，这个巨大红桃A再次分解成颗粒。颗粒反向流回空中，朝兔子方向移动。兔子迈步前进，伸手抓住即将到来的颗粒。特写镜头中，颗粒压缩并重新形成一张完整的扑克牌——仍是红桃A，没有改变。兔子把牌呈现给摄像机。摄像机慢慢拉远，显示观众反应并鼓掌，而城市灯光和倒影在背景中依旧鲜明。
