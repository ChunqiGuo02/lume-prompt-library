---
id: "landscape-the-vector-should-001"
title: "现代矢量海报肖像"
category: landscape
subcategory: "10_卡通漫画电影角色"
aesthetic: null
tags: ["矢量风", "数字艺术", "现代风", "海报", "简约", "男性", "肖像", "红色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
## 中文译文（源站提供）
生成一幅精美的数字艺术作品，以我的头像为素材，采用现代矢量海报肖像的风格进行设计。

**视觉风格与元素：**
- 清晰的矢量美学风格，具有鲜明的线条和流畅的平面色彩渐变效果。
- 应用醒目的高对比度色调：浅桃色的皮肤，搭配柔和的阴影效果。
