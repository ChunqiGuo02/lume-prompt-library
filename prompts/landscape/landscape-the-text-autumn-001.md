---
id: "landscape-the-text-autumn-001"
...
## 中文译文（源站提供）
为[咖啡店]设计一张专业的宣传海报。构图：乡村木桌上一杯热气腾腾的卡布奇诺的电影特写，背景是秋叶（舒适的氛围）。文本集成：
1.主标题：“秋季特辑”，顶部采用优雅的金色衬线字体。
2.优惠：侧面以现代徽章或贴纸风格清晰显示“买一送一”。
3.页脚：底部用简洁的小字体写着“限时”。质量：确保所有文本拼写正确、居中，并融入图像的景深。
