---
id: "landscape-subject-details-chocolate-002"
...
version: "1.0.0"
related_to: ["landscape-subject-details-chocolate-001"]
---
  ...
  "images": [
    {
      ...
      "background": "{"background color 1" "teal-to-navy"} gradient with suspended gold motes",
...
## 中文译文（源站提供）
"style": "超写实美食摄影，奢华编辑风格，微距细节，自然纹理",
  "images": [
    {
      "id": "image_1",
      "subject": "什锦果仁糖塔",
      "composition": "错落有致的垂直塔状，居中构图，松散有机堆叠",
      "details": {
        "fillings": [
          "榛子块不规则地堆积在底部",
          "覆盆子凝胶自然地聚成一滩",
        ...
        "accent": "每种馅料类型在层与层过渡处放置一颗独特的金属金色坚果",
        "stand": "拉丝金色支架，带有微妙的反光"
      },
      "lighting": {
        "type": "戏剧性侧光",
        "angle": "左侧 35 度",
        "effects": "真实的馅料折射，分层阴影效果"
      },
      "background": "{"background color 1" "teal-to-navy"} 渐变色，悬浮金色微粒",
      "mood": "奢华，放纵，匠心独运"
    },
    {
      "id": "image_2",
      "subject": "红宝石巧克力片",
      "composition": "漂浮在黑色纹理纸衬垫上方的六边形巧克力块",
      "details": {
        "surface": "手工调温的不完美表面，半透明的红宝石粉色",
        "inclusions": "嵌入的果肉碎屑透过巧克力可见",
        "motion": "红宝石可可碎粒从其中一块巧克力上以重力弧线落下"
      },
      "lighting": {
        "key": "顶部正上方 12 点钟方向",
        "rim": "柔和的粉色轮廓光，3 点钟方向",
        "effects": "真实的阴影，增强的半透明感"
      },
      "background": "黑到暖粉色的径向渐变，带有微妙的闪光斑点",
      "mood": "现代，活力，漂浮的张力"
    },
    {
      "id": "image_3",
      "subject": "白巧克力夹心糖",
      "composition": "有机地簇拥在透明玻璃支架上",
      "details": {
        "marbling": [
          "中央夹心糖带有不规则的橙色百香果纹路",
          "周围夹心糖带有粉色覆盆子漩涡",
        ...
        "cutaway": "一个夹心糖垂直切开，显示带有真实果肉斑点的凝胶内芯",
        "props": "下方散落的干果碎屑（橙皮卷，覆盆子籽）"
      },
      "lighting": {
        "key": "柔和的高调前光，10 度角",
        "rim": "后方轮廓光，35 度角",
        "effects": "增强的大理石纹对比度和玻璃折射"
      },
      "background": "柔和的灰褐色，带有水果色调的散景",
      "mood": "优雅，清新，手工制作"
    },
    {
      "id": "image_5",
      "subject": "黑巧克力开心果棒",
      "composition": "垂直的巧克力棒居中放置在抛光黑色花岗岩板上",
      "details": {
        "cross_section": "精确的侧切面，展现分层的开心果"
