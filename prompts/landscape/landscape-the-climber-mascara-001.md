---
id: "landscape-the-climber-mascara-001"
title: "微型清洁工攀爬人脸清除睫毛膏污渍"
category: landscape
subcategory: "04_创意脑洞特效合成"
aesthetic: null
tags: ["超现实", "微距", "特写", "写实", "女性", "清洁", "工人", "绳索"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
version: "1.0.0"
related_to: ["landscape-the-climber-mascara-002"]
---
...
```json
{
  "generation_request": {
    ...
    "output_settings": {
      ...
      "orientation": "portrait",，
      "分辨率"："超高分辨率"，
      "render_style": "超写实超现实广告风格",，
      “锐度”：“macro_crisp_skin_texture”，
      "film_grain": "无或极小",，
      “color_grade”：“干净、编辑过、逼真”
    },
    "creative_prompt": {
      "scene_summary": "超写实超现实概念广告图片：女性面部特写，闭着眼睛，脸颊上有一道醒目的黑色睫毛膏/眼影污迹，如同污渍般向下流淌。一个微型高空作业擦窗工/攀爬者正在她的脸颊上攀爬，仿佛那是一堵巨大的墙，他正用小刮板和刷子积极地刮擦和清洁睫毛膏污迹。\n\n微型攀爬者细节完整且逼真：安全带、绳索、登山扣、头盔（{\"climber helmet color\" \"red\"}）、手套、工具腰带，以及一个挂在安全带上的小红桶。绳索垂直穿过脸部，锚定在画框之外，具有可信的张力和阴影。攀爬者的比例可信（微型），透视正确，皮肤上有接触阴影。\n\n皮肤纹理超逼真：毛孔、细小的毳毛、微妙的桃色绒毛、自然的高光和逼真的妆容纹理。睫毛膏污迹具有从湿到干的纹理变化，带有微小的薄片和光泽斑块。清洁区域显示出微妙的“擦拭”痕迹，光泽不同，仿佛污渍正在被清除。\n\n光照：柔和的侧面日光，营造出柔和的阴影，展现皮肤纹理和攀爬者的深度；无刺眼闪光。背景在画框之外；只有脸部充满构图。氛围：巧妙、高端、现代的美容广告概念，简约而引人注目。""
    },
    "composition": {
      "layout": "单帧微距特写，脸部充满画面，攀爬者放置在脸颊污迹附近",，
      “构图”：眼睛、脸颊和部分嘴唇可见；避免强烈的负空间，
      "focus": "睫毛、睫毛膏污迹和攀爬者图像锐利清晰；边缘略有虚化"
    },
    "lighting_and_camera": {
      "lighting": "柔和定向日光 + 柔和补光",，
      "lens": "100mm 微距效果",，
      "光圈"："f/8（微距锐度）",，
      "iso": "100",，
      “快门”：“1/160”
