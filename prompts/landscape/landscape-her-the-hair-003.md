---
id: "landscape-her-the-hair-003"
title: "超写实泳池边女性肖像摄影提示词"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: biophilic
tags: ["超写实", "人像", "女性", "户外", "泳池", "绿植", "木质", "休闲"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
version: "1.0.0"
related_to: ["landscape-her-the-hair-002"]
---
...
```json
{
  "image_generation_prompt": {
    ...
    "subject": {
      ...
      "pose": {
        "angle": "略微后方四分之三角度",
        "posture": "上半身和头部优雅地转向镜头，呈现自然的 S 形曲线",
        "arms": "一只手臂轻轻抬起扶着头发，另一只手臂自然地垂在身侧",
        "vibe": "抓拍，毫不费力"
      },
      "face_and_identity": {
        "constraint": "使用上传的照片作为精确且唯一的参考",
        "preservation": "100% 保留面部结构、骨骼比例、眼睛、鼻子、嘴唇、皮肤纹理、自然不对称性",
      ...
      "outfit": {
        "top": "修身白色露背短款上衣，短袖",
        "bottom": "宽松黑色长裤，舒适地系在腰部",
        "contrast": "干净的黑白对比"
      }
    },
    "environment": {
      "location": "室外，在一个现代景观游泳池旁的木质甲板上",
      "elements": [
        "郁郁葱葱的绿色植物",
        "小树",
        "平静反光的水面",
    ...
    "technical_details": {
      "lighting": "自然柔和的日光（傍晚），均匀照明，颧骨/肩膀/背部有柔和的高光，柔和漫射光，无刺眼阴影",
      "colors": "清新自然的调色板，绿色、柔和的蓝色、温暖的木色调、中性服装",
      "mood": "宁静、时尚、生活化、平和、不费力的时尚感",
      "focus": "自然解剖结构、逼真的皮肤纹理、微妙的高光/反射、摄影景深（编辑感）"
    },
    "full_prompt_text": "一张年轻女性的超现实主义照片，她站在室外一个现代景观游泳池旁的木质甲板上。郁郁葱葱的绿色植物、小树和平静反光的水面环绕着她，远处隐约可见现代建筑。她以略微后方四分之三的角度被捕捉，上半身和头部优雅地转向镜头，姿态呈现自然的 S 形曲线。一只手臂抬起，轻轻扶着头发，而另一只手臂自然地垂在身侧，给人一种抓拍、毫不费力的感觉。面部与身份：使用上传的照片作为精确且唯一的参考。100% 保留面部：面部结构、骨骼比例、眼睛、鼻子、嘴唇、皮肤纹理和自然不对称性。禁止任何修改、滤镜或风格化处理。表情必须保持平静、略带自信、略显好奇。发型与服装：深色、直发、柔顺的头发扎成中高马尾，前额有几缕散发修饰脸型。她穿着"
  }
}
```
