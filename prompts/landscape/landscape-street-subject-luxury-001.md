---
id: "landscape-street-subject-luxury-001"
title: "雪夜名媛出车门"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["优雅", "奢华", "女性", "豪车", "冬季", "飘雪", "都市", "暮色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
[
  {
    ...
    "main_subject": {
      "persona": "优雅的时尚女性",
      "action": "从一辆豪华黑色轿车中走出",
      "physical_appearance": "头发侧分，造型为柔和蓬松的波浪卷，精致的妆容突显雕塑般的颧骨和自然的唇色",
      "expression": "自信而迷人"
    },
    "wardrobe": {
      "main_outfit": "深海军蓝色天鹅绒晚礼服，深 V 领口和高开衩设计",
      "outerwear": "配套的长款海军蓝大衣，衣领和袖口饰有毛绒灰色皮草边饰",
      "accessories": ["黑色菱格纹设计师手拿包，配金色五金件", "闪耀的个性耳环", "尖头金属高跟鞋"]
    },
    "environment": {
      "location": "下雪的城市街道",
      "time_of_day": "黄昏",
      "key_elements": ["车门打开的豪华黑色轿车", "轻轻飘落的雪花", "背景中模糊的城市建筑", "温暖的街灯营造出电影般的散景效果"],
      "mood": ["精致", "寒冬的优雅", "奢华的生活方式"]
    },
    "cinematography": {
      "style": ["超现实主义", "电影时尚大片", "杂志封面品质"],
      "composition": "全身肖像，垂直构图，主体略微偏离中心，汽车和街道形成引导线",
      "lighting": "柔和的自然黄昏光线与温暖的城市街灯混合，微妙的轮廓光，平衡的对比度",
      "technical_details": {
        "camera": "专业单反相机",
        "lens": "85mm 定焦镜头",
        "aperture": "f/1.8（浅景深）",
    ...
    "parameters": {
      "quality": ["超高细节", "逼真的皮肤纹理", "逼真的织物物理效果", "电影般的景深"],
      "negative_prompt": "低分辨率, 模糊, 平面光照, 刺眼阴影, 解剖结构扭曲, 多余的手指, 手部绘制不佳, 不自然的皮肤纹理, 过度处理, 水印, 文字, 标志, 头部被裁剪, 超出画面"
    }
  }
]
```
