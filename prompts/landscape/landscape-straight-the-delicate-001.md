---
id: "landscape-straight-the-delicate-001"
title: "未来感和服造型展示于BeautyVerse橱窗中"
category: landscape
subcategory: "13_虚拟购物试穿试用"
aesthetic: japanese-zen-garden
tags: ["和服", "银发", "霓虹", "未来感", "科技风", "夜晚", "都市", "银灰"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
{
  "subject": {
    "type": "一位令人惊艳的东亚女性，具有日本写真偶像的美感",
    "framing": "中景，腰部以上特写肖像，置身于豪华橱窗内",
    "age_vibe": "青春、纯真、20 岁出头，散发着纯洁治愈的氛围",
    "features": {
      "face_structure": "小巧的鹅蛋脸，柔和青春的轮廓，精致的下巴",
      "eyes": "非常大且完美的圆形鹿眼，朦胧的深棕色，带着柔和、纯真、闪烁的目光，直视镜头",
      "nose": "高挺、突出、笔直的鼻梁，精致小巧的鼻尖",
      "hair": "时尚的高马尾，浅金色，丝滑笔直的质感，搭配轻盈透气的齐刘海",
      "expression": "纯洁治愈的表情，带着柔和、水润的半微笑，散发着温暖和温柔的魅力"
    },
    "skin_texture": {
      "description": "超光滑、无瑕、半透明的肌肤，湿润清透的质感，无痣",
      "details": [
        "零瑕疵，完美清透光滑的表面",
        "无痣或雀斑",
        "柔和自然的皮肤毛孔",
      ...
      "makeup": "自然半透明妆容，湿润感裸粉色唇彩，柔和自然的眉毛"
    },
    "pose_structural_lock": {
      "overall": "模特般的姿态，静态而优雅，站立在极简主义的展示台上，完全正面面向镜头",
      "arms": "一只手臂略微弯曲，以精心设计的时尚姿势拿着一个结构化的手拿包",
      "hands": "纤细的手指展示着独特的戒指，轻柔地握着包",
      "shoulders": "放松的姿势，强调服装的建筑感肩部"
    }
  },
  "apparel_specification": {
    "runway_outfit_main_piece": {
      "description": "未来主义解构新和服高级定制套装",
      "material": "传统丝绸锦缎与微妙的金属银色图案形成鲜明对比，与透明结构化热塑性塑料 (TPU) 和激光切割白色皮革面板拼接而成",
      "silhouette": "结构化、棱角分明、超大尺寸的廓形，带有戏剧性的宽袖和不对称下摆，灵感来自日本传统和服，但融入了未来主义的几何剪裁和现代感"
    }
  }
}
```
