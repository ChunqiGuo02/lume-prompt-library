---
id: "landscape-frame-the-architectural-001"
title: "高定时尚人像拼贴：古典庭院中的优雅姿态"
category: landscape
subcategory: "09_故事分镜角色设定"
aesthetic: deconstructivism
tags: ["刘亦菲", "美女", "长发", "白色", "长裙", "金色", "饰品", "拼贴"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
```json
{
  "project_metadata": {
    "title": "建筑时尚大片",
    "style_category": "高级时尚拼贴画",
    "aspect_ratio": "3:4",
    "composition_logic": "动态多帧网格"
  },
  "composition_engine": {
    "layout_specification": {
      "type": "三联拼贴画",
      "arrangement": "一个主导的垂直框架（右），两个等大的堆叠方形框架（左）",
      "alignment": "严格的几何边框，2 像素白色间隙",
      "focal_points": "交替的平视和略低角度视角"
    },
    "visual_hierarchy": {
      "primary_element": "主体身份一致性",
      "secondary_element": "色彩分区（白色与深红色）",
      "tertiary_element": "建筑纹理（石头和木材）"
    }
  },
  "subject_profile": {
    "identity": "我上传图片中的人物",
    "physical_attributes": {
      "physique": "纤细但健美，自然比例",
      "skin": "白皙光滑，自然纹理，柔和光泽，暖色调",
      "hair": {
        "color": "黑色",
        "length": "及胸长发",
        "texture": "蓬松海滩波浪，风吹蓬松感",
        "styling": "优雅的侧分"
      }
    },
    "performance": {
      "expressions": "高级时尚的空洞凝视，微启的双唇，自信的下巴微抬",
      "poses": [
        "第一帧（高）：全身照，斜靠在石柱上，臀部微翘",
        "第二帧（左上）：半身照，双手抱头，手肘张开以框住脸部",
        "第三帧（左下）：特写，轻微耸肩，手触碰红色门框"
      ]
    }
  },
  "wardrobe_architecture": {
    ...
    "bottom_layer": {
      "style": "蓬松分层超长半身裙",
      "fabric": "半透明真丝雪纺内衬不透明棉布",
      "movement": "捕捉到飘逸的瞬间，边缘呈现空灵的透明感"
    },
    "adornments": {
      "jewelry": [
        "右手腕叠戴 18k 金手镯",
  ...
  "environment_design": {
    "location": "旧世界地中海庭院",
    "key_assets": {
      "doors": "鲜艳、风化的深红色木质双开门，配有黄铜五金件",
      "walls": "阳光漂白的石灰石和古老的石柱",
      "atmosphere": "尘土飞扬、浪漫、具有历史感的欧洲氛围"
    },
    "depth_mapping": {
      "bokeh_strength": "中低（相当于 f/4.0）",
      "background_detail": "柔和模糊，但建筑形状仍可辨认"
    }
  },
  "lightin": null
}
