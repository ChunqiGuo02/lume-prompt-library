---
id: "landscape-flash-car-the-001"
title: "夜拍街头风：金发女郎抱白猫倚蓝色跑车，迷彩裤高跟鞋，硬光闪拍"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["夜晚", "跑车", "浅蓝", "迷彩", "猫咪", "金发", "女性", "酷感"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
# 正文 prompt
{
  ...
  "scene": {
    ...
    "main_prop": {
      "object": "{"car model" "Porsche 911 GT3 RS"}",
...
```json
{
  "meta": {
    ...
    "camera": "带机载闪光灯的单反相机",
    "lens": "35mm 广角镜头",
    "style": "闪光摄影、前卫街头风格、汽车文化奢华、抓拍夜景、原始质感"
  },
  "scene": {
    "location": "黑暗的柏油停车场或街道",
    "environment": [
      "粗糙的柏油路面纹理，带有碎石细节",
      "漆黑的背景（无限黑暗）",
      "豪华跑车侧面轮廓"
    ...
    "time": "深夜",
    "atmosphere": "酷炫、叛逆、奢华的夜生活、无拘无束的态度"
  },
  "lighting": {
    "type": "硬直闪光",
    "key_light": "强烈的正面闪光造成高对比度",
    "shadows": "主体和汽车后面有锐利、硬朗的投影",
    "background_falloff": "背景立即变黑（暗角效果）",
    "reflections": "车门和主体额头/鼻子上的镜面高光"
  },
  "camera_perspective": {
    "pov": "平视/略低角度",
    "framing": "全身坐姿，汽车在左侧被裁剪",
    "focus": "主体和猫咪对焦清晰，由于闪光灯，景深较深"
  },
  "subject": {
    "gender": "女性",
    "age": "20 岁出头",
    "ethnicity": "白种人",
    "body": {
      "posture": "坐在地上，身体微微向后靠在车门上",
      "legs": "膝盖弯曲，舒适地岔开",
      "skin": "苍白肤色，逼真的纹理，高光处有轻微闪光灯冲刷效果"
    },
    "hair": {
      "color": "铂金色，可见深色发根",
      "length": "长发，过肩",
      "texture": "直发但蓬乱，凌乱的“刚起床”造型，发丝被风吹散",
      "shine": "闪光灯带来的高光泽"
    },
    "face": {
      "expression": "诱惑、酷炫、与相机直接眼神交流、嘟嘴",
      "makeup": "浓重的夜间妆容，锐利的飞翼眼线，立体修容，光泽裸色唇",
      "skin_texture": "可见毛孔、妆容质感，未经修饰"
    },
    "outfit": {
      "top": {
        "type": "基本款背心/露脐上衣",
