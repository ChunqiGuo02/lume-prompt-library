---
id: "landscape-motion-film-bicycle-001"
title: "森林单车上的浪漫瞬间"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: japanese-zen-garden
tags: ["情侣", "恋爱", "浪漫", "复古", "自行车", "森林", "户外", "自然"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
```json
{
  "generation_request": {
    ...
    "creative_prompt": {
      "scene_summary": "一个电影般的复古瞬间：一对年轻情侣在宁静的林间小路上共骑一辆经典自行车。女子坐在前面，身穿浅色碎花连衣裙，双臂展开，尽情欢笑；男子在她身后骑行，轻轻环抱着她。场景捕捉了动感、欢声笑语和自由，如同老电影中一闪而过的记忆。",
      "environment": {
        "location": "林荫小径",
        "season": "夏末或初秋",
        "background": "茂密的绿色树林因运动而柔和模糊",
        "ground": "带有细微裂缝和纹理的浅色铺设路面",
        "atmosphere": "平静、怀旧、微风习习"
      },
      "subjects": {
        "female": {
          "wardrobe": "浅色碎花复古连衣裙，及膝浅色靴子",
          "pose": "坐在自行车车架上，双臂张开",
          "expression": "欢笑、喜悦、无忧无虑",
          "hair": "深色头发随运动自然飘动"
        },
        "male": {
          "wardrobe": "大地色系衬衫，浅色长裤，皮鞋",
          "pose": "在后方骑行自行车，双臂保护性地环抱",
          "expression": "专注而微笑，沉着自信"
        }
      },
      "props": {
        "bicycle": "复古奶油色自行车，细轮胎，简约车架",
        "details": "漆面略有磨损，经典设计"
      },
      "camera_style": {
        "pov": "侧向跟踪镜头",
        "lens_feel": "电影镜头感，浅景深",
        "motion": "车轮和背景有意的运动模糊，主体大部分清晰",
        "framing": "主体略微偏右居中，运动前方留有引导空间"
      },
      "aesthetic": {
        "era": "永恒的，1970 年代至 1990 年代独立浪漫风格",
        "vibe": "自由、青春之爱、诗意现实主义"
      },
      "negative_prompt": "现代自行车、头盔、运动骑行装备、HDR、锐利数码感、影棚灯光、油光皮肤、美颜滤镜、夸张模糊、凝固的动作、文字叠加、水印、AI 伪影、多余肢体、变形的手"
    }
  }
}
```
