---
id: "landscape-the-snow-winter-001"
title: "冬日都市情侣与比格犬的时尚街拍"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["冬日", "街拍", "情侣", "比格犬", "雪地", "下雪", "都市", "时尚"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
```json
{
  "prompt_title": "都市冬日情侣肖像：精致优雅",
  "environment": {
    "setting": "冬季，高档都市街角。",
    "architecture": "巨大的灰色石柱/建筑拐角，带有古典细节。",
    "background_elements": "黑色锻铁栅栏，带有装饰性的金色尖顶/尖刺。背景可见古典石材建筑立面。",
    "ground": "覆盖着新鲜洁白的雪。",
    "atmosphere": "小雪飘落，雪花在空中清晰可见。寒冷、清爽的冬日。",
    "color_palette": "冷色调中性色、石灰色、亮白色雪、深黑色、勃艮第酒红点缀。"
  },
  "subjects": [
    {
      "id": "male_subject",
      "appearance": "年轻成年男性，白皙皮肤，短黑发，造型整洁。",
      "clothing": {
        "outerwear": "及膝纹理灰色羊毛大衣（可能是人字纹或粗花呢）。",
        "top": "黑色高领毛衣。",
        "bottoms": "黑色定制长裤，宽松直筒版型。",
        "footwear": "黑色皮质正装鞋或靴子。",
        "accessories": "黑色徒步旅行者风格太阳镜。"
      },
      "pose": "自信挺拔地站立，一只手插在大衣口袋里，另一只手牵着狗绳。略微侧视。"
    },
    {
      "id": "female_subject",
      "appearance": "年轻成年女性，白皙皮肤，深色头发梳成光滑紧致的发髻。",
      "clothing": {
        "outerwear": "长款、宽松黑色羊毛大衣。",
        "top": "黑色修身款高领毛衣。",
        "bottoms": "黑色阔腿裤。",
        "footwear": "勃艮第/栗色绒面革复古运动鞋，带白色条纹（阿迪达斯 Gazelle 款式）。",
        "accessories": "黑色椭圆形太阳镜，细黑色皮带配银色搭扣，小金色耳环，手提黑色皮质托特包。"
      },
      "pose": "站在男性主体旁边，一只手轻触大衣翻领，另一只手将包放在身侧。散发着“酷女孩”的审美气息。"
    }
  ],
  "additional_elements": {
    "animal": {
      "breed": "比格犬。",
      "pose": "听话地坐在男人脚边的雪地上。",
      "appearance": "三色毛发（棕色、黑色、白色），戴着项圈，系着黑色狗绳。"
    }
  },
  "lighting_and_mood": {
    "lighting_type": "柔和、漫射的阴天自然光（冬日日光）。无强烈阴影。",
    "mood": "时尚、极简、‘老钱’审美、静奢、精致、宁静、潮流。",
    "tonality": "略微去饱和，黑色服装与白色雪地之间形成高对比度。"
  },
  "technical_details": {
    "style": "超写实、高端街头摄影风格。",
    "camera_settings": {
      "lens": "85mm 人像镜头。",
      "aperture": "f/2.8，以实现与石材背景的轻微景深分离。",
      "shutter_speed": "足够快以凝固飘落的雪花。",
      "iso": null
    }
  }
}
