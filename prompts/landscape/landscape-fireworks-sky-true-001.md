---
id: "landscape-fireworks-sky-true-001"
title: "烟花夜景下时尚女性写真"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["夜景", "烟花", "城市", "金发", "马尾", "皮衣", "黑色", "庆祝"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
# 正文 prompt
{
  ...
  "subject": {
    ...
    "clothing": {
      "top": "black sleeveless dress",
      "outerwear": "black leather jacket draped off shoulders"
    }
  },
  "lighting": {
...
```json
{
  ...
  "scene": {
    ...
    "background": {
      ...
      "city_elements": {
        "buildings": true,
        "notable_structure": "带有发光标志的高楼"
      }
    }
  },
  "subject": {
    "count": 1,
    "position": "前景，略微侧身，回头看向镜头",
    "appearance": {
      "hair": {
        "color": "{\"hair color\" \"金色\"}",
        "style": "长马尾"
  ...
  "composition": {
    "orientation": "肖像",
    "focus": "前景人物，头顶上方有烟花",
    "contrast": "明亮的烟花与漆黑的夜空形成对比"
  },
  "overall_tone": "时尚，节日，电影感"
}
```
