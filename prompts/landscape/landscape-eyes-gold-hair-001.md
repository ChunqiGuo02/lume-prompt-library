---
id: "landscape-eyes-gold-hair-001"
title: "亚洲女偶像泳装写真风格预设"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["女生", "长发", "黑发", "齐刘海", "藏蓝", "泳衣", "黑丝", "蕾丝"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
        ],
        "branding": "Bold white '{"Outfit Text" "BeautyVerse"}' text logo on bust area"
      },
      "legwear": [
...
```json
{
  "prompt_data": {
    "subject": {
      "basics": "1女孩, 独照",
      "demographics": "20多岁, 惊艳的亚洲女性偶像风格",
      "hair": "齐刘海超长直黑发",
      "eyes": "锐利的浅蓝色眼睛",
      "skin": "无瑕的苍白肌肤",
      "expression": "可爱又诱惑的表情, 看着观者"
    },
    "attire": {
      "main_outfit": {
        "item": "紧身海军蓝竞技泳衣",
        ...
        "branding": "胸部区域有醒目的白色 '{\"Outfit Text\" \"BeautyVerse\"}' 文字标志"
      },
      "legwear": [
        "黑色透明过膝袜",
        "深色蕾丝吊袜带上缘"
    ...
    "pose_and_action": {
      "posture": "随意坐着, 膝盖弯曲",
      "interaction": "靠在现代灰色混凝土墙上"
    },
    "environment": {
      "setting": "简约的灰色房间内部",
      "background_elements": "现代灰色混凝土墙"
    },
    "style_and_technical": [
      "微妙的阴影",
      "电影般的柔和光线",
