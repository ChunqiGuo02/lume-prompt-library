---
id: "landscape-skin-panel-the-001"
title: "超现实美妆前后对比广告图"
category: landscape
subcategory: "04_创意脑洞特效合成"
aesthetic: null
tags: ["对比", "护肤", "超现实", "美妆", "微缩", "人像", "暖色调", "米色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
Keywords: skincare editorial, before and after, surreal beauty, miniature figures, flawless skin, radiant glow, light warm beige, soft pink, comparison layout.. A stylish handwritten signature {"signature name" "Willy"} is elegantly and small letters placed at the Bottom Right corner

## 中文译文（源站提供）
前后对比，并排分割布局，超现实主义时尚大片。

布局：并排分割（50/50），展示护肤品带来的蜕变。

左侧面板（使用前）：女性面部特写，浅暖米色肤色，毛孔清晰可见，略有瑕疵，眼神放松。柔和的玫瑰色嘴唇，柔顺的棕色头发环绕脸庞。身穿白色实验服、戴粉色手套的微型小人正在她的皮肤上“工作”：一个小人拿着放大镜检查毛孔，另一个小人拿着小刷子涂抹产品。

右侧面板（使用后）：同一位女性，相同姿势，皮肤现在完美无瑕，焕发健康光泽。瑕疵消失，微型小人完美地完成了化妆，现在骄傲地拿着微型奖杯摆姿势。眼神更加迷人，嘴唇更加水润。

调色板：

*   肤色：浅暖米色，“使用后”面板中亮度增强。
*   点缀：柔和的粉色手套，浅蓝色外科口罩（两个面板），“使用后”面板中的微型金色奖杯。
*   背景：中性米色，“使用后”面板中略微提亮。

风格：高端时尚美容大片，融入概念超现实主义，护肤品前后对比，超现实，照片级真实感，电影级灯光，8K 分辨率，超精细纹理，锐利焦点，性感诱惑。

关键词：护肤品大片，前后对比，超现实美感，微型小人，无瑕肌肤，焕发光泽，浅暖米色，柔和粉色，对比布局。右下角优雅地放置一个时尚的手写签名 {"signature name" "Willy"}。
