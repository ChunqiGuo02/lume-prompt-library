---
id: "landscape-the-subject-hair-002"
title: "现代版绿野仙踪多萝西造型写真"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["女性", "双马尾", "格纹", "短裙", "白袜", "红鞋", "蝴蝶结", "万圣节"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
# 正文 prompt
{
  "prompt_structure": {
    ...
    "outfit": {
      ...
      "dress": "{"dress pattern" "Blue and white gingham check"} mini dress featuring a corset-style bodice with vertical boning, sweetheart neckline, and white lace ruffle trim at the hem and neckline",
...
```json
{
  "prompt_structure": {
    "subject": {
      "demographics": "身材苗条、健美的年轻女性",
      "hair": "深棕色长发，梳成两条俏皮的辫子（麻花辫），搭在肩上",
      "face": "柔和迷人的五官，略带微笑，目光向上看向右侧，涂着亮红色口红，化着淡雅的眼妆"
    },
    "outfit": {
      "costume_theme": "《绿野仙踪》中桃乐丝·盖尔的现代化美学风格",
      "dress": "{\"dress pattern\" \"蓝白格纹\"} 迷你连衣裙，采用紧身胸衣式上身，带有垂直骨撑，心形领口，下摆和领口处有白色蕾丝荷叶边装饰",
      "legwear": "不透明的白色及膝袜，顶部袜口处系有大号浅蓝色缎带蝴蝶结",
      "footwear": "闪闪发光的红宝石色亮片高跟鞋（玛丽珍款式），带有踝带"
    },
    "accessories": {
      "hair": "每条辫子根部系有红色缎带蝴蝶结",
      "handheld": "右手拿着一个米色编织草编手提包/篮子"
    },
    "pose_and_action": {
      "stance": "全身站立姿势，双腿在脚踝处俏皮地交叉",
      "arms": "右臂向下伸展，拿着包；左臂略微弯曲并向后伸展，仿佛在保持平衡或倚靠",
      "expression": "迷人、自信、异想天开的情绪"
    },
    "environment": {
      "setting": "夜晚的半户外露台或庭院入口",
      "architecture": "背景是带玻璃板的大型木制双开门，白色灰泥墙，前景是深色木制支撑柱",
      "details": "赤陶砖地面，背景中隐约可见栏杆和室内植物，左侧边缘可见一个大镜框"
    },
    "lighting": {
      "style": "直射式机顶闪光灯摄影",
      "characteristics": "硬光在主体身后的墙壁上投射出清晰的阴影，被照亮的主体与较暗的背景形成高对比度，捕捉到鞋子的闪光和面料的光泽"
    },
    "camera_technical": {
      "perspective": "与视线齐平或略低的全身镜头",
      "focal_length": "35mm 焦距，营造生活快照感",
      "quality": "超逼真，8K 分辨率，主体对焦清晰",
      "textures": "格纹面料的精细编织纹理，鞋子上逼真的亮片纹理，皮肤纹理可见"
    }
  }
}
```
