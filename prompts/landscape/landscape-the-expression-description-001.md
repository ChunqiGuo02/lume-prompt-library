---
id: "landscape-the-expression-description-001"
title: "雪地里的可爱瞬间：女孩与小白狗"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["少女", "小狗", "冬季", "雪地", "户外", "可爱", "自然", "浅色调"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
  ...
  "image_description": {
    "subject": {
      "face": {
        "preserve_original": true,
        "reference_match": true,
        "description": "女孩的面部特征、表情和身份必须与参考图像完全一致。",
      },
      "girl": {
        "age": "年轻",
        "hair": "长而波浪形的棕色头发",
    ...
    "mood": "可爱、自然、冬季户外氛围",
    "camera_style": "柔和的景深效果、自然日光、淡淡的冬季色调"
  }
}
