---
id: "landscape-the-screen-phone-001"
title: "手机屏幕穿出时尚女孩"
category: landscape
subcategory: "04_创意脑洞特效合成"
aesthetic: null
tags: ["视错觉", "秋日", "公园", "创意", "穿搭", "写实", "手机", "棕色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
{
  "主题": {
    "描述": "一张超级逼真的视觉错觉照片。一位年轻的白人女性仿佛正从手中握着的智能手机屏幕中走出来。屏幕上显示着相机界面，拍着她的靴子，而她的上半身则从手机中延伸出来，出现在现实世界中。",
    "镜像规则": "确保手机屏幕上清晰地显示iOS相机界面（快门按钮、模式文字）。手写的注释必须清晰可读且没有镜像效果。",
    "年龄": "20多岁",
    "表情": {
      "眼睛": {
        "神情": "迷人而俏皮",
