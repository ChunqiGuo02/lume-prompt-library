---
id: "landscape-the-slightly-skin-001"
title: "海边豪车旁的时尚写真"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["冷调", "时尚", "肖像", "跑车", "海滩", "阴天", "西装", "白衬衫"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
version: "1.0.0"
related_to: ["landscape-the-slightly-skin-002"]
---
...
# 正文 prompt
{
  "image_prompt": {
    ...
    "subject": {
      "description": "A very beautiful young Asian woman",
    ...
    "outfit_and_accessories": {
      ...
      "jewelry": {
        "neck": "{\"necklace style\" \"layered chunky silver chain necklaces\"}",
    ...
    "environment": {
      ...
      "background": {
        "location": "{\"location\" \"beach or seaside\"}",
        "details": [
  ...
  "image_prompt": {
    ...
    "subject": {
      ...
      "hair": {
        ...
        "length": "长发",
        "style": "蓬松、波浪状、略显凌乱",
        "details": "几缕发丝部分遮住脸庞，营造出自然、随意的感觉"
      }
    },
    "outfit_and_accessories": {
      "top": {
