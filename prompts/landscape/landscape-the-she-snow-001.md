---
id: "landscape-the-she-snow-001"
title: "雪地木屋前的中国美女雪板写真"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["冬季", "雪景", "滑雪", "美女", "白色", "冷色调", "户外", "木屋"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
{
  "subject": {
    "description": "美丽的年轻中国女性，皮肤白皙，留着长直的自然深色头发（深棕色至黑色）。她拥有健美的丰满沙漏型身材。她穿着一件紧身白色罗纹连体衣，臀部高开衩，展现出臀部的自然曲线。她穿着低腰白色运动裤，位于腰部下方。一件白色羽绒服敞开着，随意地披在肩上。她的头上戴着一副大大的白色毛绒耳罩。",
    "anatomy_and_proportions": {
      "bust": "胸部丰满、突出、饱满，自然受重力影响。视觉质量显著，向前突出。罗纹面料展现出微妙的织物张力，没有人工提升感。",
      "body_type": "健美的丰满沙漏型身材，肌肉线条可见，软组织真实感强。高臀部，身体曲线自然。",
      "skin": "白皙、清透的东亚肤色，具有真实的纹理和细微的毛孔。未经修饰或塑化。"
    }
  },
  "pose": {
    "stance": "站立，身体正对镜头。重心均匀分布。",
    "arms": "手臂自然垂在身体两侧，因羽绒服的蓬松感而略微向外推开。",
    "head": "头部正直，面部朝前，目光直视观者。",
    "expression": "中性至略带嘟嘴的表情，平静而沉着。",
    "orientation": "正面视角，无旋转。"
  },
  "environment": {
    "setting": "户外冬季场景，积雪很厚。",
    "background_elements": [
  ...
  "camera": {
    "shot_type": "中景，从大腿中部向上拍摄。",
    "angle": "与视线齐平，正对。",
    "focal_length": "50mm 至 85mm 人像镜头。",
    "depth_of_field": "背景树木和小木屋有轻微的焦外虚化，同时保持环境背景清晰可辨。",
    "framing": "主体在垂直画幅中水平居中。",
    "perspective": "自然透视，无广角畸变。"
  },
  "lighting": {
    "type": "自然阴天日光。",
    "quality": "柔和、漫射、均匀的光线，面部无明显阴影。",
    "direction": "与多雪阴天一致的全局照明。",
    "tone": "凉爽的冬季色调，周围雪地反射出明亮的白色光芒。"
  },
  "mood_and_expression": {
    "mood": "寒冷、冬日、舒适而自信。",
    "expression": "直接、平静、自信。"
  ...
  "style_and_realism": {
    "style": "原始写实主义，手机相机美学。",
    "rendering": "高保真度、未经修饰的写实主义，捕捉到罗纹面料、羽绒服材质、人造毛耳罩和自然人体皮肤等独特的材质纹理。",
    "fidelity": "基于物理的渲染"
  }
}
```
