---
id: "landscape-texture-garment-type-001"
title: "蓝裙女模沙漠写真，超现实高调风格"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["时尚", "沙丘", "沙漠", "金发", "宝蓝", "丝绒", "金饰", "蓝天"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
# 正文 prompt
{
  "image_metadata": {
    ...
    "camera_settings": {
      ...
      "focus": "ultra-sharp",
      "detail_level": "high_fidelity_texture"
    }
  },
  "subject": {
    ...
    "attire": {
      "garment": "{"garment color" "royal_blue"}_velvet_strapless_swimsuit",
...
```json
{
  ...
  "subject": {
    "identity": "参考面部 100% 保留",
    "pose": "棱角分明、内省的蹲姿",
    "position": "白色沙丘顶端",
    "attire": {
      "garment": "{\"garment color\" \"royal_blue\"} 丝绒无肩带泳衣",
      "texture": "毛绒丝绒",
      "accessories": [
        "厚重超大金色手镯"
      ]
  ...
  "constraints": {
    "facial_integrity": "精确特征，无改动",
    "color_retention": "严格保留原始颜色"
  }
}
```
