---
id: "landscape-celebrity-subject-file-001"
title: "明星多场景形象塑造与氛围呈现"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["咖啡馆", "金发", "黑色", "毛衣", "暖光", "室内", "肖像", "休闲"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "16:9"
...
# 正文 prompt
{
  "celebrity_image_analysis": [
    {
      "subject": "{"celebrity 1" "Ana de Armas"}",
    ...
    {
      "subject": "{"celebrity 2" "Sydney Sweeney"}",
  ...
  "celebrity_image_analysis": [
    {
      ...
      "visual_details": {
        ...
        "apparel": "脏粉色运动背心",
        "props": "标有“40 KG”的哑铃",
        "physical_state": "皮肤出汗，面部表情极度紧张，凌乱的马尾辫",
        "lighting": "冷色调荧光健身房灯光"
      },
      "vibe": "决心、力量、毅力"
    },
    {
      ...
      "visual_details": {
        "action": "微笑着向人群挥手",
        "apparel": "黑白拼色晚礼服",
        "background": "狗仔队、人群和“SYDNEY SWEENEY”数字标牌",
        "hair_makeup": "老好莱坞风格金色波浪卷发，上扬眼线"
      },
      "vibe": "魅力四射、明星范、开朗"
    },
    {
      ...
      "visual_details": {
        "action": "用斧头砍柴",
        "apparel": "格子法兰绒衬衫、蓝色牛仔裤、皮质工作手套",
        "props": "斧头、木柴",
        "atmosphere": "质朴的秋季森林背景"
      },
      "vibe": "粗犷、勤劳、行动力强"
    },
    {
