---
id: "landscape-back-car-top-001"
title: "银发少女车内回眸写真"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["车内", "美女", "银发", "抹胸", "格纹", "短裙", "黑丝", "汽车"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
# 正文 prompt
{
  ...
  "outfit": {
    "top": {
      ...
      "neckline": "straig{"top neckline" "ht across strapless"}",
...
```json
{
  ...
  "subject": {
    "character": "铂金发色女孩，二十出头，娇小纤细",
    
    "face": {
      "structure": "柔和精致的五官，圆润的脸颊，娃娃脸",
      "skin": "瓷白肤色，脸颊有浓重的粉红色腮红",
      "eyes": {
        "shape": "大而圆的鹿眼",
        "color": "浅绿灰色",
        "expression": "回头看向镜头，柔和无辜的眼神"
      },
      "mouth": {
        "lips": "丰满，自然粉色，略微嘟嘴"
      },
      "makeup": "自然底妆，浓郁粉色腮红，精致眼妆"
    },
    ...
    "hair": {
      ...
      "length": "中长，过肩",
      "texture": "直发带微卷，柔软",
      "style": "中分，蓬松自然，一侧头发别在耳后",
      "shine": "健康柔和的光泽"
    }
  },

  "pose": {
    "overall": "坐在汽车驾驶座上，扭身回头看",
    
    "position": {
      "base": "坐在豪车驾驶座上",
      "orientation": "身体朝前，躯干扭向后方对着镜头"
    },
    
    "torso": {
      "direction": "扭身向后看",
      "curve": "因扭身而背部略微弓起",
      "exposure": "可见下背部，腰部有空隙露出"
    },
    ...
    "head": {
      "turn": "回头 OVER SHOULDER 看向镜头",
      "expression": "柔和，略带惊讶，无辜"
    }
  },
  ...
  "environment": {
    ...
    "car_interior": {
      "seats": "黑色皮革运动座椅，带对比色缝线",
      "style": "豪华跑车，可能是宝马或奔驰",
      "console": "带换挡杆的现代中央扶手箱",
      "steering": "可见运动方向盘"
    },
    "view_through": ""
  }
