---
id: "landscape-the-her-winter-002"
title: "雪地阳台上的白色毛绒时尚写真"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["冬日", "皮草", "白色", "美女", "雪山", "松树", "阳台", "户外"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
## 中文译文（源站提供）
{
  "subject_pose": "一位年轻女子摆出轻松自信的姿势，背部靠在木制阳台栏杆上。她一条腿伸直，另一条腿膝盖弯曲，脚轻轻地放在身后较低的栏杆结构上。她的身体略微朝向镜头，一只手垂在身侧，握着一个包的提手。",
  "outfit": "她身穿一套迷人的全白色冬季套装，包括一件柔软蓬松的白色毛绒露脐上衣，露出腰部，以及一条配套的白色迷你裙，裙摆处有厚实的毛绒边饰。她还戴着一顶大而圆的白色毛绒帽子，覆盖着额头。",
  "background": "场景设置在一个木制阳台上，拥有令人惊叹的冬季美景。女子身后是覆盖着厚厚积雪的参天松树，以及在寒冷的天空下延伸至远方的雄伟雪山山脉。",
  "lighting": "柔和自然的 ambient 光线，典型的冬日傍晚光线，营造出冷色调，没有刺眼的阴影，突出了白色毛皮的质感。",
  "atmosphere": "寒冷、奢华、舒适的冬季美学，散发着高定时装 influencer 的气息。"
}
