---
id: "landscape-the-ghats-aarti-001"
title: "恒河双世镜"
category: landscape
subcategory: "15_特定场景环境生成"
aesthetic: null
tags: ["恒河", "倒影", "建筑", "人群", "灯火", "船只", "宗教", "仪式"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "16:9"
...
## 中文译文（源站提供）
这是一幅描绘瓦拉纳西（Varanasi）圣河岸边夜晚场景的细腻作品，拍摄于晚间的宗教仪式（“阿蒂”仪式）期间，视角正好位于恒河的对岸。图像的上半部分展现了现代城市的风貌：人群聚集在台阶上，祭司们手持燃烧的灯笼进行同步的仪式；阳台上悬挂着电灯；寺庙外墙经过翻新；古老的建筑与现代标识并存。火光和散落的提灯照亮了河面上缓缓升腾的烟雾。  

图像的下半部分则像是恒河平静水面上的完美倒影，呈现的是同一片河岸，但处于一个更古老的历史时期。这一倒影应展现出细微的建筑差异：电灯较少，取而代之的是油灯；石墙表面历经风化，没
