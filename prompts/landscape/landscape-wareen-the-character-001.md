---
id: "landscape-wareen-the-character-001"
title: "紫发少女花园静坐，花鸟毛衣映春光"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["紫发", "短发", "毛衣", "刺绣", "花园", "长椅", "草地", "明媚"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "8:5"
...
{
  "character_profile": {
    "name": "{\"character name\" \"Wareen\"}",
    "identity": "Wareen - 紫色波波头女孩",
    "visual_description": {
      "hair": {
        "color": "{\"hair color\" \"Vivid Purple\"}",
        "style": "齐刘海短波波头",
        "character_trait": "大胆且富有艺术气息"
      }
    },
    "scene_context": {
      "location": "{\"location\" \"宁静的植物园\"}",
      "activity": "Wareen 正安静地坐在一张木凳上",
      "atmosphere": "宁静而明亮"
    }
  }
}
