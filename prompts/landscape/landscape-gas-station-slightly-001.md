---
id: "landscape-gas-station-slightly-001"
title: "雾夜加油站的沉思女子"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["加油站", "忧郁", "傍晚", "风衣", "咖啡", "暖色调", "电影感", "孤独"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
# 正文 prompt
{
  ...
  "subject": {
    ...
    "pose": {
      ...
      "hands": "one hand holding a takeaway {"drink type" "coffee"} cup, other adjusting hair",
  ...
  "environment": {
    "location": "{"gas station brand" "Texaco"} gas station at dusk",
...
```json
{
  "genre": "电影公路写实主义",
  "mood": ["忧郁", "宁静", "怀旧", "深夜的孤独"],
  "theme": "加油站转瞬即逝的沉思时刻，介于移动与停顿之间"
},
  "subject": {
    "description": "年轻女子独自站在路边加油站",
    "face": {
      "expression": "若有所思，目光游离，略带防备",
      "skin": "自然纹理，毛孔可见，轻微瑕疵，未经修饰",
      "emotion": "微妙的内省，平静中带有潜在的紧张感"
    },
    "hair": {
      "style": "蓬松，齐肩长发",
      "motion": "微风吹拂的发丝掠过脸庞",
      "detail": "自然发质，未经造型或光泽处理"
    },
    "pose": {
      "body_language": "放松但内敛，重心略微偏移",
      "hands": "一只手拿着外带的 {\"drink type\" \"咖啡\"} 杯，另一只手整理头发",
      "gesture": "随意，不刻意摆拍，捕捉瞬间"
    }
  },
  "wardrobe": {
    "outerwear": "长款深色风衣，结构感强但有穿着痕迹",
    "accessories": "简单围巾紧贴颈部",
    "styling_notes": "经典，低调，无明显品牌标志或时尚潮流"
  },
  "environment": {
    "location": "黄昏时分的 {\"gas station brand\" \"德士古\"} 加油站",
    "weather": "寒冷的夜晚，空气中弥漫着薄雾",
    "ground": "湿润的柏油路面反射着路灯和霓虹灯光",
    "background_elements": [
      "附近停放的老式汽车",
      "远处人群的模糊剪影",
      "顶棚灯光下发光的加油泵"
    ],
    "atmosphere": "宁静的路边停靠点，微弱的城市噪音，电影般的静止"
  },
  "cinematography": {
    "shot_type": "中景全身肖像",
    "framing": "主体略微偏离中心，营造叙事张力",
    "camera_angle": "平视",
    "lens": {
      "focal_length": "35mm",
      "look": "电影感环境肖像",
      "distortion_control": "自然透视，垂直线笔直"
    },
    "depth_of_field": {
      "aperture": "f/2.8",
      "focus": "主体面部清晰",
      "background": "柔和模糊的灯光和人物，可辨识的背景信息"
    }
  },
  "lighting": {
    "primary_source": "温暖的加油站顶棚灯光",
    "secondary_source": "凉爽的环境黄昏天空",
    "contrast": "平衡的暖冷色调交织",
    "highlights": "头发和外套边缘的柔和光晕",
    "shadows": "柔和的阴影过渡，无死黑",
    "notes": "灯光应感觉实用且自然合理"
  },
  "color_grade": {
    "style": "电影感黄昏调色",
    "palette": "暖琥珀色高光与冷蓝灰色天空对比",
    "saturation": "克制，电影胶片感",
    "contrast": "中等，自然过渡",
    "black_levels": "略微提升以增加柔和度"
  },
  "texture_details": {
    "skin": "逼真的微观纹理",
    "fabric": "外套编织可见，柔软褶皱",
    "environment": "湿柏油路面反射，细微"
  }
}
```
