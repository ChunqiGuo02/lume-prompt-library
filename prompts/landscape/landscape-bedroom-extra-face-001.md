---
id: "landscape-bedroom-extra-face-001"
title: "摇滚少女卧室弹贝斯写真"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["贝斯", "卧室", "女孩", "香烟", "海报", "摇滚", "慵懒", "写实"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
```json
{
  "main_prompt": "私密的卧室场景，一位 20 岁出头的年轻女子，留着长长的波浪形灰棕色头发，化着精致的烟熏眼妆，涂着大胆的深红色口红，盘腿坐在凌乱的床上弹奏电贝斯吉他，银色金属闪光贝斯吉他，带有可见的拾音器和指板上的 ★ 星形镶嵌，穿着黑色细肩带吊带背心，露出乳沟，宽松的浅色水洗蓝色牛仔裤，手指上戴着多个银色戒指，包括醒目的大戒指，黑色指甲油，戴着细黑色项圈项链，带一个小吊坠，多层精致项链，手腕上戴着手链，香烟叼在嘴边，冒着淡淡的烟雾，半闭着眼睛，向下看着吉他，表情放松而诱惑，昏暗舒适的青少年/青年卧室，从略低于视线的高度拍摄的低角度镜头，墙壁和天花板完全被分层海报和杂志剪报覆盖：向日葵、狼、动漫人物、咒术回战人物（可见宿傩），恐怖和摇滚海报，可见“BLACK STONES”海报，迷幻和垃圾美学拼贴画，天花板上挂着带有树叶和花朵的挂毯，暖色钨丝灯 + 冷色窗户光混合，头发上有黄金时段的轮廓光，电影级调色，胶片颗粒，柔和的背景虚化，高度详细的皮肤纹理，逼真的毛孔和细微瑕疵，超逼真，超细节，8k，锐利对焦，使用 Canon EOS R5 和 50mm f/1.4 镜头拍摄，浅景深",
  "negative_prompt": "模糊、低分辨率、手部变形、多余的手指、手指融合、解剖结构不良、肢体缺失、面部绘制不佳、比例失调、多余的肢体、克隆面部、毁容、比例粗大、肢体畸形、手臂缺失、腿部缺失、多余的手臂、多余的腿、手部变异、长脖子、丑陋、平铺、手部绘制不佳、脚部绘制不佳、画框外、变异、变形、jpeg 伪影、签名、水印、用户名、文本、错误、裁剪、最差质量、低质量、普通质量、卡通、动漫风格、3d 渲染、cgi、塑料皮肤、过曝、欠曝、平面照明、刺眼的阴影、白天明亮的窗户、干净简约的房间、成人专业卧室、办公室环境、微笑快乐的表情、浓妆艳抹的迷人造型、完美对称的脸、喷枪处理的皮肤、玩偶般、芭比娃娃、Instagram 滤镜、色彩饱和度过高",
  "style_tags": [
    "超逼真",
    "电影感",
    "垃圾美学",
  ...
  "technical": {
    "aspect_ratio": "4:5（肖像/垂直手机照片风格）",
    "lighting": "侧面暖色钨丝灯泡光 + 后方/右侧冷色自然窗户光混合，头发和肩膀上有强烈的轮廓光，面部有柔和的阴影，香烟余烬发光",
    "color_palette": "柔和的去饱和色调，大地棕色，褪色蓝色，深红色（嘴唇），银色"
  }
}
```
