---
id: "landscape-the-trunk-flowers-002"
title: "黑车花海中的时尚少女写真"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["女孩", "汽车", "玫瑰", "停车场", "黑色", "白色", "时尚", "摄影"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
## 中文译文（源站提供）
{
 "A girl sitting in the black open trunk of a Gelik in an underground parking lot, surrounded by many flowers; the entire trunk is filled with white roses. She is wearing a black tracksuit. Her hair is long, styled in the Old Money style. Her lips are painted soft matte pink, and her eyelashes are lush. She is looking at the flowers in the trunk, posing like a fashion shoot.": "一名女孩坐在地下停车场的黑色 Gelik 敞开的后备箱里，周围环绕着许多鲜花；整个后备箱都装满了白色玫瑰。她穿着黑色运动服。她的头发很长，是 Old Money 风格。她的嘴唇涂着柔和的哑光粉色，睫毛浓密。她正看着后备箱里的鲜花，摆出时尚大片般的姿势。",
      "pose": "坐在后备箱里，双腿微曲，双手轻触鲜花，以温柔沉思的表情看着玫瑰。"
    },
    "environment": {
      "location": "地下停车场",
      "lighting": "闪光灯摄影，高对比度以突出女孩和白色玫瑰，汽车表面有微妙的反光",
      "background": "停车场的混凝土墙壁和地板，昏暗的环境光"
    },
    "objects": [
      {
        "type": "汽车",
      ...
      },
      {
        ...
        "species": "玫瑰",
        "color": "白色",
        "placement": "整个后备箱都装满了，有些花朵在女孩周围略微溢出"
      }
    ],
    "style": {
