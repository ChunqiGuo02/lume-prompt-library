---
id: "landscape-the-prompt-sunglasses-002"
title: "高端时尚生活写真：女子身着Lucky Club T恤，倚靠保"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["女性", "跑车", "T恤", "牛仔裤", "墨镜", "别墅", "绿色", "写实"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
{
  "prompt_generation": {
    "positive_prompt": "高端生活方式时尚大片，超写实，垂直全身照，电影级写实感。一位时尚的年轻女性，留着柔和的蜂蜜金色波浪发，阳光亲吻的挑染，随意地站在一辆深森林绿色 {\"car model\" \"Porsche 911 GT3 RS\"} 的后四分之三侧。她穿着一件宽松的白色复古印花 T 恤，下摆略微裁剪至腰部，上面印有褪色的“Lucky Club”字样，搭配低腰宽松水洗蓝色牛仔裤，佩戴简约金色首饰和时尚黑色椭圆形太阳镜。她的姿态轻松自信，重心放在一条腿上，一只手放在口袋附近。巨大的碳纤维后扰流板和 GT3 RS 徽章清晰可见，车漆反射着棕榈树和天空。背景中，略微模糊，一位戴着深色太阳镜、穿着干净白色 Polo 衫的秃头男子，靠在一栋豪华现代别墅的入口附近。场景特色是白色混凝土建筑、大面积玻璃面板、飘逸的薄纱窗帘和地中海地区明亮的阳光。强烈的自然高光、深邃的阴影、高对比度、浅景深、主体锐利对焦、超精细纹理、逼真皮肤细节、毛孔可见、编辑级、HDR、UHD、8K、杰作摄影。",
    "negative_prompt": "低分辨率、柔焦、模糊、过曝、欠曝、平坦光线、糟糕的解剖结构、多余的肢体、手指缺失、比例扭曲、卡通、CGI、插画、绘画、动漫、水印、Logo 叠加、文字伪影、图像噪点、颗粒感、车辆变形、不正确的反射、错误的透视",
    "subject_details": {
      "primary_character": {
        "gender": "女性",
        "hair": "长款蜂蜜金色波浪发，带有微妙的挑染",
        "apparel": "白色复古风格露脐 T 恤，印有褪色的“Lucky Club”字样，宽松蓝色牛仔裤，金项链，黑色椭圆形太阳镜",
        "pose": "休闲时尚姿态，放松自信，重心放在一条腿上"
      },
      "secondary_character": {
        "gender": "男性",
        "hair": "光头",
        "apparel": "白色 Polo 衫，牛仔裤，太阳镜",
        "position": "背景中别墅入口附近，柔和失焦"
      }
    },
    "environment_details": {
      "vehicle": "Porsche 911 GT3 RS，深森林绿色，后四分之三角度，碳纤维扰流板，光泽反射",
      "location": "豪华现代别墅车道，白色极简主义建筑，落地玻璃，薄纱窗帘，棕榈树反射"
    },
    "technical_settings": {
      "image_quality": "超写实、HDR、UHD、8K",
      "lighting": "明亮的自然阳光，硬阴影，电影级对比度",
      "camera_angle": "略微后四分之三透视，视线水平",
      "aspect_ratio": "9:16",
      "orientation": "垂直"
    }
  }
