---
id: "landscape-park-body-smartphone-001"
title: "手机镜头下的街头穿搭解析"
category: landscape
subcategory: "06_图文排版视觉传达"
aesthetic: null
tags: ["超写实", "休闲", "街头", "手机", "公园", "连帽衫", "男士", "户外"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "16:9"
...
```json
{
  "image_metadata": {
    "format_version": "2.1.0",
    "aspect_ratio": "16:9",
    "shot_type": "复合超现实主义第一人称视角",
    "concept": "OOTD 穿搭分解 / 智能手机弹出式幻觉 (户外公园)"
  },
  "subject_profile": {
    "identity": {
      "gender": "男性",
      "ethnicity": "{\"ethnicity\" \"亚洲人\"}",
      "age_range": "20-25 岁",
      "identity_consistency": "保持面部和身体与参考图像一致"
    },
    "facial_architecture": {
      "facial_hair": "浅色胡须和络腮胡",
      "jawline": "轮廓分明且比例协调",
      "expression": "放松自信的微笑",
      "skin_rendering": "温暖的古铜色，自然纹理"
    },
    "hair_mechanics": {
      "color": "黑色",
      "style": "短发，有蓬松感，向后梳理",
    ...
    "body_anatomy": {
      "frame": "精瘦，比例协调",
      "posture": "站姿笔直，双手插在连帽衫口袋里"
    }
  },
  "wardrobe_and_styling": {
    "top_layer": {
      "item": "黑色连帽衫",
      "details": "白色胸部标志，红色抽绳头",
      "material": "哑光棉绒"
    },
    "bottom_layer": {
      "item": "黑色慢跑裤",
  ...
  "device_and_interface": {
    "hardware": {
      "model": "现代高端智能手机",
      "case": "哑光黑",
      "hand_interaction": "男性第一人称视角，手机在前景中"
    },
    "software_ui": {
      "app": "iOS 相机界面",
      "elements": [
      ...
      "screen_condition": "OLED 亮度，清晰像素"
    },
    "augmented_overlay": {
      "style": "白色手写注释",
      "notes": [
        { "text": "干净的连帽衫版型", "pointer": "上半身" },
        { "text": "休闲街头风", "pointer": "躯干" }
      ]
    }
  },
  "environment_optics": {
    "location": "{\"location\" \"公共公园\"}",
    "background_elements": {
      "bench": "绿色金属公园长椅",
      "ground": "碎石小径，散落的树叶",
      "trees": "周围的树叶，绿植"
  ...
  "technical_execution": {
    ...
    "special_effects": {
      "illusion": "3D 弹出效果；躯干从屏幕中弹出，下半身在用户界面内",
      "realism": "精确的边缘照明和自然的阴影融合"
    }
  },
  "safety_and_exclusions": {
    "negative_prompt": []
