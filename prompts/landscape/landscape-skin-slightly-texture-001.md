---
id: "landscape-skin-slightly-texture-001"
title: "自然光下瀑布旁的冷艳少女写真"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["人像", "少女", "户外", "自然", "瀑布", "金发", "蓝眼", "写实"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
```json
{
  "prompt": "一名年轻女性的特写自拍肖像，年龄 18-22 岁，空灵而精致的美感，极度苍白的瓷器般肌肤，带有细微的自然雀斑，引人注目的冰蓝色眼睛，强烈地直视镜头，柔和而忧郁的表情，丰满的双唇呈自然粉红色，略微张开，长长的波浪形铂金金发，具有自然的凌乱蓬松质感，发丝垂落在脸部和肩部，黄金时段柔和漫射的自然光线，浅景深，电影般的散景，带有微小瑕疵和毛孔的详细皮肤纹理，写实摄影风格，使用高端无反相机拍摄，85mm 镜头，f/1.4，超细节，8k 分辨率",
  "negative_prompt": "卡通、动漫、绘画、油画、插画、变形、模糊、低分辨率、过曝、欠曝、塑料皮肤、浓妆、眼线、睫毛膏、口红、滤镜、美颜滤镜、无毛孔光滑皮肤、多余肢体、扭曲的脸、不对称的眼睛、丑陋、糟糕的解剖结构、文字、水印、标志、拥挤的背景",
  "reference_image": {
    "enabled": true,
    "strength": 0.75,
    "description": "使用提供的参考图片作为强烈的风格和面部特征指导：年轻女性，长波浪金发，蓝色眼睛，自然妆容，户外自然瀑布背景，黑色毛绒夹克，内搭白色上衣，带有红色格子边饰，自拍角度略微俯视"
  },
  "style": "写实时尚肖像",
  "aspect_ratio": "9:16",
  "lighting": "柔和的自然日光，轻柔的阴影，长满苔藓的绿色岩石和瀑布背景",
  "camera": "使用 Sony A7R IV 拍摄，85mm 定焦镜头，f/1.8，自然环境光",
  "additional_details": [
    "穿着超大号深炭黑色抓绒夹克，纹理清晰可见",
    "内搭白色短款上衣，领口可见小红白格纹荷叶边饰",
    "背景：郁郁葱葱的绿色苔藓覆盖的岩石，小瀑布倾泻而下，天然森林溪流环境，蕨类植物和绿植",
    "头发：非常长，蓬松，发梢因环境湿度略显湿润，自然波浪和飞散的发丝",
    "表情：平静，略显严肃/内省，微妙的撅嘴，直视的眼神",
    "无过度修饰，保持真实的皮肤纹理和细微瑕疵"
  ],
  "seed": "随机或固定以保持一致性（如果需要）",
  "cfg_scale": 7.5,
  "steps": 35
}
```
