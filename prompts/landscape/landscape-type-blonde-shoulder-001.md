---
id: "landscape-type-blonde-shoulder-001"
title: "高定婚纱写真：石柱旁的优雅新娘"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["金发", "纹身", "单肩", "白裙", "开叉", "裸足", "石墙", "石柱"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
```json
{
  "image_generation_request": {
    "subject": {
      "identity": "参考图片中一致的年轻金发女性",
      "features": {
        "eyes": "绿色",
        "lips": "丰满，专业妆容",
        "hair": "金色长发，飘逸，垂落肩头",
        "distinguishing_marks": "肩部有小纹身",
        "body_type": "苗条，优雅"
      }
    },
    "attire": {
    ...
    "setting": {
      "environment": "带有古老石墙的质朴室内空间",
      "props": ["古老的石柱"],
      "lighting": {
        "type": "温暖的环境光",
        "sources": ["暖色灯丝灯泡", "悬挂的爱迪生灯"],
        "effects": ["微妙的焦外虚化", "柔和的阴影"]
      }
    },
    "composition": {
      "pose": "优雅地站立，身体后倾，左手扶柱",
      "framing": "全身超写实肖像",
      "style": "电影摄影风格",
      "technical_specs": {
        "resolution": "8K",
    ...
    "negative_prompt": "鞋子，鞋类，彩色衣服，模糊，解剖结构扭曲，手指畸形，多余肢体，水印，文字，签名，低分辨率，卡通，绘画"
  }
}
```
