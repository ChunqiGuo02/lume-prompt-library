---
id: "landscape-korean-silver-product-001"
title: "韩式奢华护肤礼盒广告，大理石背景配丝绸点缀，中央主品环绕多款"
category: landscape
subcategory: "03_创意广告品牌设计"
aesthetic: null
tags: ["护肤", "美妆", "广告", "奢华", "韩式", "高级", "大理石", "玻璃"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
SIGNATURE: A stylish handwritten signature "{"signature name" "Willy"}" elegantly placed at bottom right corner (small letters)
...
## 中文译文（源站提供）
奢华韩国护肤品广告，社交媒体动态，4:5 比例。

版式：居中（主产品作为核心）+ 环绕式（辅助元素围绕）
方向：放射状排列——互补产品以不同距离环绕核心产品

背景：深色大理石表面带纹理，黑色漆盘，传统韩国丝绸点缀，散落的细微银箔
...
动态：主产品散发出的蒸汽（细微），银色闪光点缀
色调：奢华深色——黑色/炭灰色基调，搭配冷银色和传统白色瓷器对比
风格：奢华 + 现代混合，传统韩式美学
...
字体：品牌名称采用优雅书法风格，银箔效果，韩文 + 英文

相机：哈苏 X2D，90mm 微距 f/3.5，俯拍，冷钨丝灯 + 柔和补光

签名：时尚手写签名 “Willy” 优雅地放置在右下角（小字）

风格关键词：韩式美学，精华液排列，传统奢华，传承护肤。
时尚手写签名 Willy 优雅地以小字放置在右下角。
