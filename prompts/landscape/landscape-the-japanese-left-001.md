---
id: "landscape-the-japanese-left-001"
title: "星纺传奇画报"
category: landscape
subcategory: "06_图文排版视觉传达"
aesthetic: japanese-zen-garden
tags: ["二次元", "日系", "幻想", "紫色", "少女", "法杖", "星星", "魔法"]
recommended_models: []
recommended_params:
  aspect_ratio: "3:4"
  quality: null
...
## 中文译文（源站提供）
一张竖版日本动漫奇幻游戏或轻小说宣传海报，采用柔和的淡紫色、白色和金色调，以一位英姿飒爽的少女为主角，背景为宏伟的空中之城。她呈动态的三分之四全身姿势，身体微向左转，左手持一柄华丽的法杖，右手向后伸展，仿佛正处于风中。她的面部被一个位于头部的平坦淡色方形遮挡块覆盖，但可见的设计暗示着这是一位精致的动漫女主角，拥有极长的飘逸银丁香色长发、侧刘海、散落的发丝以及带有深靛蓝色丝带蝴蝶结的星形发饰。她身着精致的魔法少女风格连衣裙：露肩白色紧身胸衣，配有海军蓝和紫罗兰色饰边及金色星星图案；不对称的层叠裙摆，色彩融合了白色、长春花蓝、紫罗兰色和深靛蓝色；腰间饰有巨大的深蓝色蝴蝶结和金色星形宝石；配有分离式的飘逸袖子，臀部垂挂着带有微型星星挂饰的金色链条，穿着白色过膝袜，大腿上饰有蓝色星形吊带。她的法杖高挑优雅，深色杖身配有金色框架元素，顶部附近悬挂着一颗多面蓝色水晶，并饰有蝴蝶结和星星装饰。背景是轻盈的奇幻天际线，包含白色塔楼、大教堂般的尖顶、云朵、羽毛和飘落的粉色花瓣，伴有明亮空灵的背光和梦幻般的英雄氛围。构图仿照精致的主视觉海报，并将丰富的日语排版融入画面中。左上方放置日语标语“願いが、未来を照らす。”，下方附带两行较小的文字。右上方放置一个星形徽章、大号角色名“ルミナ”、副标题“— Lumina —”以及一行较小的声优信息。右侧添加 3 个垂直排列的功能标注，每个标注包含一个小图标、一个粗体日语标题以及下方两行较小的短文。左侧添加一个沿角色身侧垂直排列的日语文案块。右下方包含 3 个该角色的斜向堆叠小肖像插图：1 个平静的正面表情、1 个严肃的侧面表情和 1 个闭眼微笑的表情。左下方放置大号日语标题“星紡ぐレガシア”，下方附带英文副标题“— LEGACIA: Weave the Stars —”。右下角添加日期文本“2025. 夏”及下方一行简短的日语标语。最底端边缘左侧包含 2 个小型社交或网站信息块，右侧包含一行微小的版权声明。采用高端现代动漫宣传插画风格，呈现明亮的柔和奇幻氛围、优雅的构图、流畅的线条和色彩、柔和的赛璐珞阴影、细腻的织物动感、光泽高光、复杂的服装细节、整洁的排版布局以及精致的商业海报质感。
