---
id: "landscape-fashion-title-item-001"
title: "MANGO 25春夏时尚排版海报"
category: landscape
subcategory: "06_图文排版视觉传达"
aesthetic: null
tags: ["春季", "穿搭", "轻透", "松弛", "简约", "轻奢", "红色", "波点"]
recommended_models: []
recommended_params:
  aspect_ratio: "3:2"
  quality: null
...
## 中文译文（源站提供）
{"type":"时尚编辑排版海报","brand":"MANGO","collection":"25 SPRING COLLECTION","style":"极简奢华杂志排版，干净的白色背景，柔和日光，通透现代的编辑设计，高端时尚 Lookbook 项目","subject":{"gender_presentation":"女性","pose":"坐在浅色藤椅上，姿态放松，躯干向左倾斜，头部转向一侧","face":"刻意模糊/遮挡","outfit":{"outerwear":{"item":"短款轻量拉链夹克","color":"{argument name=\"jacket color\" default=\"鲜红色\"}"},"top":{"item":"半透修身长袖针织衫","color":"柔白色"},"bottom":{"item":"中长裙","color":"白色","pattern":"大号黑色波点"}},"accessories":{"bag":"产品行和搭配变体中展示的结构感黑色手提包","shoes":"产品行中展示的黑色平底鞋"}},"layout":{"format":"单页时尚项目，左侧为大幅主图，右侧为信息栏","sections":[{"title":"风格关键词","position":"右上角","count":3,"labels":["01 轻透 Sheer","02 松弛 Relax","03 细节 Detail"]},{"title":"搭配变体","position":"中上右侧","count":2,"labels":["朱和一— / OFF WHITE","浅蓝 / PALE BLUE"]},{"title":"细节","position":"搭配变体下方右侧","count":3,"labels":["透明边缘感","布料垂坠","柔软结构"]},{"title":"单品推荐","position":"中下右侧","count":5,"labels":["风衣","上衣","裤子","包","鞋"]}],"hero_text":{"headline":"{argument name=\"headline text\" default=\"LIGHT LAYERS\"}","subheadline":"轻层叠穿","body":["春日轻盈叠加，从空气开始","Light layering for spring, built on air and softness.","轻透材质与松弛轮廓的叠加，不是为了展示造型，而是让身体与空气形成关系。","Layering is not about structure, it's about how fabric meets air."]},"additional_note":{"title":"编辑寄语","text":"春天的穿搭不需要用力，轻透与柔软的叠加，是季节给予我们的温柔语言。"},"bottom_right_inset":"小型极简室内窗户照片条"},"visual_details":{"color_palette":["红色","白色","黑色","柔米色","浅蓝色"],"materials":["透视针织","柔软垂坠面料","顺滑拉链细节"],"lighting":"侧面柔和的自然晨光","composition":"左侧为主体模特大图，右侧为整洁的编辑网格排版，配有细分割线和宽裕的留白"},"rendering_notes":"创建一个精致的时尚广告 Slides 或杂志风格的服装展示，采用中英双语排版，包含逼真的服装摄影、优雅的间距、低调的高级感品牌形象以及宁静的春日氛围"}
