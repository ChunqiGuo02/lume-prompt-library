---
id: "landscape-pure-delicate-youthful-001"
title: "日系偶像风街头时尚写真"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: japanese-zen-garden
tags: ["街拍", "都市", "黄昏", "金发", "高马尾", "卡其色", "风衣", "项链"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
{
  "subject": {
    "type": "惊艳的东亚女性，具有日系写真偶像美学",
    "framing": "中景，腰部以上特写肖像",
    "age_vibe": "青春、纯真，20岁出头，散发着纯净治愈的氛围",
    "features": {
      "face_structure": "小巧的鹅蛋脸，轮廓柔和青春，下巴精致",
      "eyes": "大而圆，迷蒙的深棕色眼睛，眼神柔和纯真，闪烁着光芒",
      "nose": "鼻梁高挺笔直，鼻尖精致小巧",
      "hair": "时尚的高马尾，淡金色，丝滑直发，带有轻盈透气的空气刘海",
      "expression": "纯净治愈的表情，带着柔和湿润的半微笑，散发着温暖和温柔的魅力"
    },
    "skin_texture": {
      "description": "极致光滑、无瑕、半透明的肌肤，质地水润清透，无痣",
      "details": [
        "零瑕疵，完美清透光滑的表面",
        "无痣或雀斑",
        "柔和自然的毛孔",
      ...
      "makeup": "自然清透的妆容，湿润感裸粉色唇彩，柔和自然的眉毛"
    },
    "pose_structural_lock": {
      "overall": "自信而温柔，静止站立姿势，直接面向镜头",
      "arms": "一只手臂微弯，手持一个有结构感的手拿包",
      "hands": "纤细的手指展示独特的戒指，轻柔地握着包",
      "shoulders": "放松的姿态，突出服装的结构感肩部"
    }
  },
  "apparel_specification": {
    "runway_outfit_main_piece": {
      "description": "前卫解构风衣，被重新设计成连衣裙",
      "material": "结构感米色华达呢与虹彩 PVC 面板的混合",
      "silhouette": "超大不对称剪裁，夸张的肩部和收腰设计",
      "details": "外露拉链、大号工装口袋和飘逸的肩带"
    },
    "accessories": {
      "neck": "粗犷工业风银色链条项圈",
      "bag": "小巧几何雕塑感金属银色手拿包",
      "jewelry_detail": "多指佩戴大胆的建筑感戒指"
    }
  },
  "environment": {
    "setting": "东京或首尔繁华的都市街道",
    "lighting": "傍晚黄金时段，温暖的阳光",
    "background": "动态街景，背景行人极度模糊，呈现为快速长曝光的光线和运动轨迹",
    "atmosphere": "柔和纯净的主体与狂乱模糊的城市动态之间的视觉对比"
  },
  "realism_and_rendering": {
    "style": "电影感街头时尚摄影，纪录片风格，带有柔和光泽感",
    "camera": "移轴摄影结合慢快门效果"
  }
}
```
