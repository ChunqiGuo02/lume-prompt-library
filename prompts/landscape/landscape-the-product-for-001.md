---
id: "landscape-the-product-for-001"
title: "白底产品变创意广告"
category: landscape
subcategory: "03_创意广告品牌设计"
aesthetic: null
tags: ["可乐", "饮品", "罐装", "蓝色", "写实", "产品", "摄影", "木桌"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "16:9"
...
## 中文译文（源站提供）
请严格按照上传的产品图片原样使用，不得对其进行任何修改、重新绘制或重新诠释。请遵循以下指南来制作高质量、具有电影感的产品展示内容：

• 确保产品保持完整无损——所有文字、标签、比例、包装和颜色都必须保持与原图完全一致。
