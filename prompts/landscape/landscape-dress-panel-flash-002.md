---
id: "landscape-dress-panel-flash-002"
...
version: "1.0.0"
related_to: ["landscape-dress-panel-flash-001"]
---
...
## 中文译文（源站提供）
{
  "场景描述": "这是一组由4幅图片组成的时尚生活方式拼贴画，同一位年轻女性身着迷人的晚礼服，在城市灯光下摆出各种富有电影感的姿势。"
  "主题人物": {
    "类型": "年轻女性（角色一致）",
    "年龄": "二十出头",
    "特征": {
    ...
    "服装": "黑色缎面抹胸裙，肩上披着皮夹克，穿着细高跟鞋",
    "配饰": "闪亮的手提包，耳环"
  },
  "拼贴布局": {
    "结构": "2x2网格布局（4幅大小相同的图片）",
    "面板1左上角": "全身特写：站在金属门或百叶窗前，一条腿向前迈出，表情充满自信（采用闪光灯摄影风格）。",
    "面板2右上角": "半身侧视：转身朝向相机，朝霓虹灯闪烁的城市走去，展示裙子和夹克的背面。",
    "面板3左下角": "坐姿侧面像：坐在高脚凳或天鹅绒包厢里，手持鸡尾酒，向镜头外的人开心地笑着。",
    "面板4右下角": "艺术肖像：站在霓虹灯旁，面部被粉蓝色光线照亮，梦幻般地仰望着天空。"
  },
  "环境": {
    "场景设定": "夜晚的城市/屋顶酒吧",
    "背景元素": [
