---
id: "landscape-the-slightly-dark-001"
...
# 正文 prompt
{
  ...
  "generation_parameters": {
    "prompt": "A candid photograph from the 1990s of {"man's identity" "Donald Trump"} in a dark suit and red tie, stan"
  }
}
...
```json
{
  "lighting": {
    "mood": "抓拍，略显刺眼的夜晚灯光",
    "type": "机顶闪光灯",
    "shadows": "阴影明显，尤其在女士颈部和主体背后",
    "direction": "正面照明",
    "intensity": "刺眼，在面部和连衣裙上形成高光"
  },
  "background": {
    "setting": "可能是一个室内的晚间活动或派对",
    "elements": "远处有人或其他物体的模糊不清的形状",
    "description": "由于闪光灯，背景极暗且曝光不足",
    "depth_of_field": "景深较浅，背景完全模糊"
  },
  "typography": {
    "details": "无可见文字或标志",
    "present": "无"
  ...
  "composition": {
    "angle": "略微从右侧，视线水平",
    "focus": "对两位主体，特别是他们的面部，对焦清晰",
    "framing": "对这对情侣进行紧密构图",
    "shot_type": "中景",
    "orientation": "竖向",
    "positioning": "女士在左，男士在右，紧密站立"
  },
  "color_profile": {
    "palette": "深色西装，亮红色领带，银色闪光连衣裙，暖色皮肤，深色背景",
    "contrast": "由于闪光灯，对比度高",
    "saturation": "中等饱和度",
    "color_grading": "典型的 1990 年代闪光摄影，略带暖色调",
    "dominant_colors": [
      "#000000",
      "#FFFFFF",
      "#C0C0C0",
  ...
  "technical_specs": {
    "grain": "可见的胶片颗粒",
    "source": "照片，可能为 1990 年代的胶片照片",
    "sharpness": "主体相对清晰，背景模糊且黑暗",
    "resolution": "中等分辨率扫描",
    "aspect_ratio": "约 9:16（正方形）"
  },
  "subject_analysis": {
    "man": {
      "hair": "金色，向后梳理",
      "attire": "深海军蓝西装，白色领衬衫，亮红色领带",
      "identity": "唐纳德·特朗普（年轻时）",
      "position": "画面右侧",
      "expression": "嘴巴张开，可能在说话或做鬼脸"
    },
    "woman": {
      "hair": "齐肩金色头发",
      "attire": "银色闪光吊带连衣裙",
      "jewelry": "左耳可见小耳环",
      "identity": "金发女士（可能是 Kara Young）",
      "position": "画面左侧",
      "expression": "直视镜头，嘴巴微张"
    }
  },
  "artistic_elements": {
    "mood": "略显尴尬，抓拍瞬间",
    "style": "名人抓拍快照",
    "texture": "女士闪光银色连衣裙的纹理突出",
    "expression": "男士在说话或做鬼脸，女士直视镜头，嘴巴微张",
    "compositional_balance": "平衡，两位主体占据画面大部分"
  },
  "generation_parameters": {
    "prompt": "一张 1990 年代的抓拍照片，照片中 {\"man's identity\" \"Donald Trump\"} 穿着深色西装和红色领带，站立"
  }
}
```
