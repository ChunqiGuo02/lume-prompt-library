---
id: "landscape-the-denim-hair-001"
title: "夏日森林中金发少女倚树写真，牛仔套装，自然光影"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: biophilic
tags: ["户外", "夏日", "肖像", "金发", "牛仔", "树木", "绿植", "阳光"]
recommended_models: 
  - banana-pro
  - flux-pro
recommended_params:
...
```json
{
  "main_prompt": "电影般的户外夏日肖像，一位惊艳的年轻女子，拥有超长的波浪形蜜金色头发，眼神宁静而引人注目，自然肤质带有微妙的阳光亲吻光泽，身穿时尚的结构化 {\"outfit material\" \"denim\"} 紧身胸衣式上衣，下摆尖锐，搭配同款牛仔短裤，优雅地斜靠在有纹理的树干上，明亮的自然阳光透过树叶洒下斑驳的阴影，背景是郁郁葱葱的绿色植物和树木，50mm 人像摄影，超写实，牛仔面料纹理和发丝超高细节 --ar 1:2 --stylize 250 --v 6 --q 2",
  "negative_prompt": "模糊，变形，多余肢体，糟糕的解剖结构，丑陋，过曝，刺眼阴影，厚重滤镜，微笑，室内，合成感，卡通，绘画，浓妆，影棚灯光，塑料皮肤",
  "style_tags": ["夏日户外美学", "牛仔时尚大片", "蜜金色头发", "自然阳光", "宁静肖像"],
  "technical": {
    "aspect_ratio": "1:2",
    "lighting": "明亮的自然阳光与斑驳的阴影",
    "camera": "50mm 专业人像镜头"
  },
  "extra_parameters": {
    "recommended_model": "Flux.1 [dev]",
    "guidance_scale": "7.0",
    "steps": "40",
    "image_reference": "使用上传的参考图，以获取特定的蜜金色头发长度/波浪、牛仔紧身胸衣式上衣设计、斜靠树干的姿势以及明亮的夏日户外氛围"
  }
}
```
