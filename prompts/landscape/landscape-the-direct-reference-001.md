---
id: "landscape-the-direct-reference-001"
title: "时尚的夜生活体验与优雅的设计——Gemini Nano Banana 3.0 Pro"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["时尚", "高级", "夜景", "黑色", "蕾丝", "高跟", "手袋", "轻奢"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
version: "1.0.0"
related_to: ["landscape-the-direct-reference-002"]
---
...
## 中文译文（源站提供）
{
  "image_generation_parameters": {
    ...
    "aspect_ratio": "1:1",
    "reference_usage": "严格保留参考图像中的面部特征"
  },
  "visual_style": {
    "genre": "高级时尚杂志专题",
    "technique": "直射闪光摄影",
    "atmosphere": "迷人、大胆的夜生活氛围，具有狗仔队风格的视觉效果",
    "lighting": "强烈的直射闪光在深色背景下形成清晰的阴影和高对比度"
  },
  "subject_breakdown": {
    "appearance": {
      "hair": "长而乌黑、波浪形的头发，蓬松有光泽",
      "expression": "自信而迷人，回头看向后方",
      "gaze": "与相机进行直接的眼神交流"
    },
    "pose": "优雅地坐在扶手椅上，扭转身体向后看",
    "wardrobe": {
      "garment": "黑色蕾丝褶边套装（上衣和下装）",
      "footwear": "黑色高跟鞋，鞋底为标志性红色",
      "accessories": "除道具外未指定其他配饰"
    }
  },
  "environment_details": {
    "setting": "现代豪华客厅内部",
