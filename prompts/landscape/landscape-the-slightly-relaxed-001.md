---
id: "landscape-the-slightly-relaxed-001"
title: "地下车库时尚写真：坐姿女性穿搭展示"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["时尚", "写实", "女性", "车库", "蓝色", "红色", "浅景深", "卷发"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
# 正文 prompt
{
  ...
  "accessories": {
    "bag": "small {"bag color" "red"} shoulder bag",
...
```json
{
  "subject": {
    ...
    "style": "超现实主义、时尚杂志风格",
    "mood": "平静、自信、沉稳",
    "appearance": "自然的皮肤纹理、真实的比例、高细节",
    "identity": "通用角色，可替换为自定义面部或参考"
  },

  "pose": {
    "position": "坐在地上",
    "legs": "侧向弯曲，向前伸展，膝盖略微抬起，脚踝轻微交叉",
    "arms": "置于身后支撑身体",
    "hands": "手掌平放在地上，手指放松",
    "torso": "挺直，身体略微向后倾斜",
    "shoulders": "放松",
    "body_language": "放松而有目的性，自信的姿态"
  },
  ...
  "environment": {
    "location": "地下停车场",
    "atmosphere": "充满活力、生动",
    "lighting": "暖色灯光，带霓虹灯点缀",
    "background_style": "色彩斑斓的反射，略微模糊"
  },

  "photography": {
    "camera_angle": "平视至略低角度",
    "lens": "35mm",
    "framing": "中广角镜头",
    "focus": "主体清晰对焦，背景柔和模糊",
    "depth_of_field": "浅景深",
    "lighting_setup": {
      "key_light": "左前方柔和主光",
      "fill_light": "柔和补光以柔化阴影",
      "rim_light": "微妙的背光以将主体与背景分离"
    },
    "style": "电影感时尚摄影",
    "color_grading": "柔和的电影色调，带微妙的色彩点缀",
    "contrast": "平衡、自然"
  },

  "negative_prompt": {
    "style": "卡通、动漫、插画、绘画、CGI、3D 渲染",
    "anatomy": "身体扭曲、比例不真实、多余肢体、多余手指",
    "quality": "模糊的面部、低细节、低分辨率、噪点、颗粒感",
    "skin": "塑料皮肤"
  }
}
```
