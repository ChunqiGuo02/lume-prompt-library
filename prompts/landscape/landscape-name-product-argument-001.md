---
id: "landscape-name-product-argument-001"
title: "MEAN WELL ELG-100-24B 100W LED驱动电源"
category: landscape
subcategory: "06_图文排版视觉传达"
aesthetic: industrial-loft
tags: ["深色", "橙色", "科技感", "工业风", "明纬", "电源", "驱动", "户外"]
recommended_models: []
recommended_params:
  aspect_ratio: "9:16"
  quality: null
  ...
  "layout": {
    "sections": [
      ...
      },
      {
        ...
        "count": 3,
        "panels": [
          { "title": "精密制造", "visual": "规格标签特写" },
          { "title": "稳固连接", "visual": "电缆入口及安装耳特写" },
          { "title": "核心特性", "visual": "产品斜侧面展示图，配有 3 条指向文字的引线：'100~305VAC 输入'、'恒流输出'、'IP67 / IP65 防护外壳'" }
        ]
      },
      {
        "name": "应用场景",
        ...
        "panels": [
          ...
          { "title": "户外工程", "visual": "带有建筑景观照明的现代建筑外观" },
          { "title": "室内系统", "visual": "安装有线性吸顶灯的现代商业走廊" },
          { "title": "调光控制", "visual": "带有 4 个标签的电气控制箱：'0-10V'、'PWM'、'电阻'、'DALI'" }
        ]
      },
      {
        "name": "环境防护",
