---
id: "landscape-name-openai-argument-002"
title: "模拟OpenAI直播带货场景"
category: landscape
subcategory: "14_社交媒体营销"
aesthetic: null
tags: ["直播", "恶搞", "AI", "带货", "抖音", "GPT", "整活", "电商"]
recommended_models: []
recommended_params:
  aspect_ratio: "9:21"
  quality: null
...
## 中文译文（源站提供）
{
  ...
  "subject": {
    "person": "Sam Altman",
    "action": "直视镜头，右手向前伸出做手势",
    "clothing": "深绿色毛衣"
  },
  "background": "房间背景，架子上摆放着 3 瓶红酒，墙上有一个写着 'AGI' 的标志和 OpenAI 的 Logo",
  "layout": {
    "top_bar": {
      "time": "20:34",
      "battery": "77+"
    ...
    "banners": {
      "count": 4,
      "labels": ["OpenAI 官方旗舰店榜第 1 名", "更多直播", "00:12", "520 好礼季"]
    },
    "host_label": {
      "name": "{argument name=\"host name\" default=\"山姆奥特曼 Sam Altman\"}",
      "status": "直播中",
      "subtitle": "{argument name=\"host quote\" default=\"大家好，我是山姆奥特曼，GPT 滞销，帮帮我们！\"}"
    },
    "chat_box": {
      "message_count": 6,
      "messages": [
        ...
        "AI 爱好者: GPT Plus 买起来！",
        "小太阳: 先拍一单试试",
        "OpenAI 小助理: 点击下方小黄车，了解更多产品信息~",
        "淡定哥: 已拍，支持！"
      ]
    },
    "product_card": {
      "title": "{argument name=\"product name\" default=\"OpenAI ChatGPT Plus 订阅服务 (一个月)\"}",
      "features": "正品保障 7 天无理由 过期自动退 随时可退",
      "price": "{argument name=\"product price\" default=\"¥199\"}",
      "button": "抢"
    },
    "bottom_bar": {
