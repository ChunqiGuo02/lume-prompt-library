---
id: "landscape-boat-sunglasses-luxury-001"
title: "奢华游艇上的优雅女性，湖光山色间尽显高级时尚风范"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["优雅", "老钱", "时尚", "度假", "游艇", "湖景", "白裙", "墨镜"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
# 正文 prompt
{
  "image_prompt_structure": {
    ...
    "environment": {
      "location": "{"location" "Lake Como Italy"}, middle of the lake",
...
```json
{
  "image_prompt_structure": {
    "subject": {
      "description": "一位精致的亚洲女性坐在一艘豪华木制摩托艇上",
      "features": "乌黑长直发，无瑕白皙肌肤，涂抹红色口红，姿态优雅地调整太阳镜",
      "action": "一只手触摸太阳镜镜框，另一只手放在船座上靠近手提包"
    },
    "apparel": {
      "dress": "白色无肩带褶裥雪纺长款连衣裙，面料飘逸，高级定制风格",
      "accessories": "超大棕色渐变太阳镜，叠戴金色项链，金色手链，米色绗缝奢华手提包（Lady Dior 风格）"
    },
    "environment": {
      "location": "{\"location\" \"意大利科莫湖\"}，湖中央",
      "boat": "经典 Riva 风格木船，抛光桃花心木饰面，奶油米色皮革内饰",
      "background": "风景优美的群山，郁郁葱葱的绿色海岸线，点缀着意大利别墅，深蓝色水面泛着船尾波，蓝天白云"
    },
    "technical_specs": {
      "style": "超现实主义，8k 分辨率，电影摄影，时尚杂志编辑美学，老钱风",
      "lighting": "明亮的自然日光，强烈阳光形成锐利阴影，高对比度，光泽感",
      "camera": "使用 35mm 镜头拍摄，f/2.8 光圈，主体对焦锐利，纹理细节丰富"
    },
    "parameters": {
      "aspect_ratio": "--ar 9:16",
      "quality": "--q 2",
  ...
  "full_prompt_string": "一位精致的亚洲女性，坐在科莫湖上经典的 Riva 木船中，身穿白色无肩带褶裥长款连衣裙，佩戴叠戴金色项链，调整超大太阳镜，涂抹红色口红，米色绗缝奢华手提包放在奶油色皮革座椅上，背景是风景优美的群山和意大利别墅，深蓝色水面泛着船尾波，明亮的自然阳光，电影级光线，超现实主义，8k，时尚杂志编辑风格，老钱美学 --ar 9:16 --v 6.0 --style raw"
}
```
