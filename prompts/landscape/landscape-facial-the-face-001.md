---
id: "landscape-facial-the-face-001"
title: "温柔少女窗边写真"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["女性", "丸子头", "粉色", "鲜花", "衬衫", "室内", "自然光", "宁静"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
# 正文 prompt
{
  ...
  "appearance": {
    "hair": {
      ...
      "accessory": "single {"flower color" "pink"} flower tucked into the bun"
    },
    "skin": {
...
```json
{
  ...
  "appearance": {
    "hair": {
      ...
      "accessory": "发髻中插着一朵 {\"flower color\" \"粉色\"} 花"
    },
    "skin": {
      "texture": "自然、真实",
