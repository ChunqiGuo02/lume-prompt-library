---
id: "landscape-the-frame-depth-001"
title: "雪夜公园三帧写真"
category: landscape
subcategory: "09_故事分镜角色设定"
aesthetic: null
tags: ["冬季", "雪景", "公园", "傍晚", "女孩", "长椅", "路灯", "写实"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
# 正文 prompt
use the face from the attached image without any changes to facial features, preserve identity with nano-level precision and maintain all natural micro-expressions exactly as in the reference. create an ultra-photorealistic three-frame winter portrait sequence set in a snow-covered park
...
## 中文译文（源站提供）
使用附件图像中的面部，不对面部特征做任何改动，以纳米级精度保留身份，并精确保持参考图像中所有自然的微表情。创建一个超逼真的三帧冬季肖像序列，场景设定在白雪覆盖的公园中。

在蓝色时刻。第一帧，描绘人物坐在木凳上，阅读一本书，雪花轻轻地飘落在他们周围。以电影般的景深渲染环境：结霜的树木，远处发出柔和暖光的朦胧路灯，以及寒冷的蓝色环境氛围。第二帧，捕捉一个平静的侧面特写，景深较浅，突出雪花与头发、织物和空气之间逼真的互动。第三帧，展示人物向后靠着，双眼轻轻闭合，沉浸在宁静的冬日夜晚中，外套、围巾和所有纺织品表面必须展现分子级的纹理细节、精确的光线衰减和符合物理规律的阴影。保持背景柔和模糊，带有路灯的自然散景、微妙的薄雾和分层景深中悬浮的清晰雪花，确保通过智能上下文感知和精确的大气渲染实现完全的照片级真实感。
