---
id: "landscape-instagram-create-feed-001"
title: "Instagram动态"
category: landscape
subcategory: "14_社交媒体营销"
aesthetic: null
tags: ["饮品", "九宫格", "ins风", "粉色", "绿色", "清新", "夏日", "自然"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
## 中文译文（源站提供）
为这款产品创建一个包含9张图片的Instagram动态，保持统一的视觉风格。使用不同的拍摄地点、角度和构图方式，融入人物、动物、自然元素以及各种场景，同时确保整体视觉效果的连贯性。
