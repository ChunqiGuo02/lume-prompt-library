---
id: "landscape-the-face-same-002"
title: "夜拍三连帧：真实自然的海滩度假瞬间"
category: landscape
subcategory: "09_故事分镜角色设定"
aesthetic: null
tags: ["海滩", "夜晚", "度假", "三格", "休闲", "暖光", "松弛", "欧美"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
Outfit (locked):
{"shirt color" "Lime green"} vertically striped button-down shirt, top buttons open showing slight chest. Full Sleeves rolled to forearms.
...
## 中文译文（源站提供）
请使用上传的参考照片作为唯一且专属的面部识别源。
在所有三个画面中，必须出现完全相同的面孔，不得有任何变化。
请勿在画面之间重新诠释、重新生成、美化或修改面部。
面部识别的优先级高于光线、角度、模糊或真实感。
超现实的垂直图像，平均分成三个堆叠的画面（顶部 / 中间 / 底部），置于一张照片中。所有画面都显示同一个人，拥有相同的面孔、相同的服装、相同的地点，拍摄时间间隔仅数秒，如同智能手机的连拍抓拍。只有细微的动作变化。感觉像是偶然、真实、自然。
地点和背景：
夜晚，现代度假村的开放海滩户外。背景是木制帐篷，帐篷附近柔和地散发着温暖的光线。可见漆黑的夜空。海滩氛围。真实的瞬间——而非摆拍。
服装（锁定）：
{"shirt color" "Lime green"} 竖条纹纽扣衬衫，顶部纽扣解开，微露胸部。长袖卷至前臂。
高腰米色修身长裤。一只手腕戴着金属腕表。无夹克，除手表外无其他配饰。

发型和面部（锁定）：
中等长度，浓密，自然卷曲的头发，略显凌乱，有生活气息的质感。
浅色胡茬 / 短胡须。
真实的皮肤纹理，毛孔可见。
无平滑处理，无美化。
画面分解（非常重要）：
顶部画面 — 背影
人物的背影。
他正在触摸颈部附近的头发后部，手指略微缠绕在头发中。
头部略微向下倾斜并偏向一侧。放松的姿势，自然的动作。从后面清晰可见头发的质感。
中间画面 — 特写
眼睛和上半脸的紧密特写。凌乱的发丝自然地垂落在眼睛附近。
眼睛部分可见，柔和对焦。
因动作而产生的非常轻微的动态模糊。感觉亲密、偶然，而非摆拍。
底部画面 — 中景
从腰部或胸部以上的中景。
人物随意地靠在栏杆上。侧视，不看镜头。表情平静、自信、沉思。
自然的姿势，不费力的存在感。
光线（锁定）：
温暖的人造壁灯光线与凉爽的夜间环境光线混合。
面部和衬衫上有柔和的照明。
背景略暗。
无闪光灯。无强烈对比。
相机感觉（锁定）：
