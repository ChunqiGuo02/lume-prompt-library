---
id: "landscape-cocoa-the-pod-001"
title: "可可果裂开，豆子飞出化作烘焙漩涡"
category: landscape
subcategory: "03_创意广告品牌设计"
aesthetic: null
tags: ["可可果", "可可豆", "树枝", "绿叶", "写实", "暖光", "棕色", "绿色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
Motion:  The cocoa pod beans rapidly fly out and transform into {"motion effect" "roasted cocoa vortex"}

## 中文译文（源站提供）
高质量、逼真的商业摄影作品，横向构图，展现可可种植园风光，以可可树为背景，画面中央有一颗部分裂开的可可豆荚挂在树枝上，内部新鲜的可可豆清晰可见，带有纤维状的自然纹理，裂口略不规则，周围的豆荚和叶子柔和虚化，色彩是浓郁的泥土棕和绿色调，温暖的自然日光带来柔和的方向性高光，景深较浅，呈现出优质的农业写实感，无文字，无人，无品牌标识。

动态：可可豆荚中的豆子迅速飞出，并幻化成 {"motion effect" "烘焙可可旋涡"}
