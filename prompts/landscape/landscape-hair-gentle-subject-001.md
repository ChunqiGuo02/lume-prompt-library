---
id: "landscape-hair-gentle-subject-001"
title: "富士山下的和服少女——电影感黄昏静谧时刻"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: japanese-zen-garden
tags: ["富士山", "和服", "草地", "抹茶", "发簪", "女性", "暖色调", "日系"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
{
  "主题": {
    "描述": "一位25岁的日本女性，身材曲线优美，站在富士山前的草地上，微风轻拂着她的头发。",
    "姿势": "姿势轻松自然，一只手拿着一杯冰镇抹茶拿铁，另一只手搭在和服上；姿态优雅，目光柔和地注视着镜头。",
    "表情": "眼神宁静而温暖，嘴角带着温柔的微笑。",
    "头发": "深棕色，长而直，被风吹得有些凌乱。",
    "服装": {
      "和服": {
        "类型": "传统的振袖（furisode）",
        "颜色": "柔和的象牙色，带有淡淡的玫瑰色调",
        "细节": "精致的花卉刺绣，浅粉色的腰带，飘逸的袖子随风摆动"
      }
    },
    "妆容": "自然妆容，肌肤充满光泽，嘴唇涂着有光泽的裸色口红"
  },
  "配饰": {
    "头发装饰": "一根带有花卉图案的金色发夹",
    "珠宝": "简单的珍珠耳环",
  ...
  "摄影风格": {
    "风格": "电影艺术风格的静态画面",
    "构图": "远景拍摄，主体位于画面下半部分，上方留有较大的空白空间",
    "构图原则": "三分法则，主体偏左，富士山作为画面的右侧焦点",
    "景深效果": "浅景深，前景的草地模糊处理，呈现出柔美的散景效果",
    "镜头": "复古的50毫米变形镜头，轻微的镜头光晕，柔和的画面边缘效果",
    "画面比例": "3:4"
  },
  "色彩处理": {
    "风格": "低画质模拟胶片效果——黑色调更鲜明，色彩饱和度降低，带有温暖的琥珀色和棕褐色调，对比度适中，画面带有朦胧感，能清晰看到胶片的颗粒感，带有70年代阳光般的温暖色调"
  },
  "背景": {
    "场景": "富士山脚下的开阔草地，处于黄金时刻（日出或日落时分）",
    "元素": "高大的野草，零星开放的野花，山坡上的晨雾，营造出丰富的层次感",
    "光线": "柔和的金色背光，头发边缘带有淡淡的光晕，花朵部分有明亮的高光，没有强烈的阴影",
  },
  "氛围": "宁静的怀旧感，充满思辨色彩，带有王家卫电影中的那种诗意与静谧"
}
