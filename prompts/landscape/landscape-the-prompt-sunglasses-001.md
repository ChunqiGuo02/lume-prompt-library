---
id: "landscape-the-prompt-sunglasses-001"
title: "高端时尚人像摄影，超写实豪车与现代别墅场景"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["写实", "时尚", "高端", "跑车", "美女", "墨镜", "牛仔裤", "豪宅"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
version: "1.0.0"
related_to: ["landscape-the-prompt-sunglasses-002"]
---
...
{
  "prompt_generation": {
    "positive_prompt": "高端生活方式时尚编辑大片，超写实，垂直全身照，电影级真实感。一位时尚的年轻女性，留着柔和的蜂蜜金色波浪发，阳光亲吻过的挑染，随意地站在一辆深森林绿色 {\"car model\" \"Porsche 911 GT3 RS\"} 的后四分之三侧。她穿着一件宽松的白色复古图案 T 恤，下摆略微裁剪至腰部，上面有褪色的“Lucky Club”字样，搭配低腰宽松水洗蓝色牛仔裤，佩戴简约的金色首饰和时尚的黑色椭圆形太阳镜。她的姿态轻松自信，重心放在一条腿上，一只手放在口袋附近。巨大的碳纤维尾翼和 GT3 RS 标志清晰可见，车漆反射着棕榈树和天空。背景中，略微模糊，一位戴着深色太阳镜、穿着干净白色 Polo 衫的秃头男子，靠在一栋豪华现代别墅的入口附近。场景特色是白色混凝土建筑、大面积玻璃面板、飘逸的薄纱窗帘和地中海地区明亮的阳光。强烈的自然高光、深邃的阴影、高对比度、浅景深、主体锐利对焦、超精细纹理、逼真的皮肤细节、毛孔可见、编辑级、HDR、UHD、8K、杰作摄影。",
    "negative_prompt": "低分辨率、柔焦、模糊、过曝、欠曝、平光、解剖结构错误、多余肢体、手指缺失、比例扭曲、卡通、CGI、插画、绘画、动漫、水印、标志叠加、文本伪影、图像噪点、颗粒感、车辆变形、反射不正确、透视错误",
    "subject_details": {
      "primary_character": {
        "gender": "女性",
        "hair": "蜂蜜金色长波浪发，带有微妙的挑染",
        "apparel": "白色复古风格露脐 T 恤，带有褪色的“Lucky Club”字样，宽松蓝色牛仔裤，金项链，黑色椭圆形太阳镜",
        "pose": "休闲编辑姿态，放松自信，重心放在一条腿上"
      },
      "secondary_character": {
        "gender": "男性",
        "hair": "光头",
        "apparel": "白色 Polo 衫，牛仔裤，太阳镜",
        "position": "背景中别墅入口附近，轻微失焦"
      }
    },
    "environment_details": {
      "vehicle": "保时捷 911 GT3 RS，深森林绿色，后四分之三角度，碳纤维尾翼，光泽反射",
      "location": "豪华现代别墅车道，白色简约建筑，落地玻璃，薄纱窗帘，棕榈树反射"
    },
    "technical_settings": {
      "image_quality": "超写实、HDR、UHD、8K",
      "lighting": "明亮的自然阳光，硬阴影，电影级对比度",
      "camera_angle": "略微后四分之三视角，平视",
      "aspect_ratio": "9:16",
      "orientation": "垂直"
    }
  }
