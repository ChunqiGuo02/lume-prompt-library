---
id: "landscape-the-visible-finish-001"
title: "悉尼·斯威尼风格写真：四格场景下的时尚穿搭与神态展现"
category: landscape
subcategory: "09_故事分镜角色设定"
aesthetic: null
tags: ["写实", "金发", "女性", "自拍", "穿搭", "户外", "都市", "海滩"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
```json
{
  ...
  "master_specification": {
    "project_id": "SYDNEY_SWEENEY_STYLE_V3.5",
    "rendering_fidelity": "超逼真 / 8K / 原始照片",
    "aspect_ratio": "4:5 肖像构图"
  },
  "subject_biometrics": {
    "primary_subject": "Sydney Sweeney",
    "facial_architecture": {
      "skin_finish": "超逼真的皮肤纹理，可见的细微毛孔，柔和的雀斑，颧骨和鼻梁上的水润高光",
      "eye_detail": "充满活力的冰蓝色虹膜，带有逼真的光线反射，深色睫毛线和自然的羽状眉毛",
      "mouth": "微启的柔和双唇，带有自然的蜜桃色调和微妙的光泽"
    },
    "hair_engineering": {
      "color": "分层蜂蜜金色，带有铂金挑染和较深的灰金色发根",
      "style": "蓬松的 90 年代大卷发，柔软有弹性的卷发，中分并带有法式刘海修饰脸型",
      "physics": "可见的单根发丝，柔软的碎发，呈现真实的质感"
    }
  },
  "wardrobe_encyclopedia": {
    "upper_layer_inner": {
      "item": "优质罗纹棉抹胸短上衣",
      "branding_specs": "2 英寸宽的白色松紧腰带上绣有粗体无衬线字体黑色 'CELINE' 字样",
      "fabric_texture": "可见的垂直罗纹，柔软的哑光棉质表面"
    },
    "upper_layer_outer": {
      "item": "轻质府绸纽扣衬衫",
      "pattern_details": "天蓝色和纯白色超细垂直细条纹",
      "draping": "完全敞开穿着，袖口卷至前臂中部，面料自然垂坠，远离躯干"
    },
    "lower_body": {
      "item": "高品质牛仔裤",
      "wash": "石洗浅靛蓝色，臀部有微妙的猫须效果",
      "construction": "可见的铜铆钉，重型缝线和金属纽扣细节"
    },
    "accessories": {
      "eyewear": "高光黑色醋酸纤维太阳镜，带有银色金属铰链，精确地放置在头顶",
      "earrings": "14K 金微型耳环，抛光处理"
    }
  },
  "composition_logic": {
    "layout_type": "双联画（并排比较）",
    "panel_left_logic": {
      "emotional_state": "真诚的快乐",
      "pose_dynamics": "低头看向左侧，灿烂的笑容，眼睛半闭，双手插在口袋里",
      "vibe": "随性而快乐"
    },
    "panel_right_logic": {
      "emotional_state": "魅惑的时尚大片",
      "pose_dynamics": "头部略微向上倾斜，眼睛看向镜头外，中性/柔和的表情，大拇指勾在口袋里",
      "vibe": "自信而高端时尚"
    }
  },
  "optical_and_environmental_engine": {
    "lighting": {
      "primary_source": "左前方的大型柔光箱，以最大程度减少刺眼阴影",
      "rim_light": "微妙的背光，将金色头发与白色背景分离",
      "quality": "高调、干净、商业化"
    }
  }
}
