---
id: "landscape-the-slightly-hair-002"
title: "花田中的宁静女子"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["人像", "女性", "长发", "花田", "蓝天", "远山", "蓝色", "户外"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
# 正文 prompt
The mood when Google drop Gemini Flash 3 in LLM arena under the name seahawk 😀
{
...
## 中文译文（源站提供）
"shot_type": "中景全幅照片（跪姿）",
  "composition": "画面以人物为中心，地平线较低",
  "angle": "平视或略低的角度"
},
  "subject": {
    "subject_type": "人类",
    "identity_summary": "一位年轻女性，长发乌黑，被风吹得飘扬，正跪在田野中。",
    "visual_signature": {
      "facial_signature":
