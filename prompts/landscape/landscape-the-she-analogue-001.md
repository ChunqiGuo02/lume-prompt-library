---
id: "landscape-the-she-analogue-001"
title: "90年代夏日码头胶片写真"
category: landscape
...
## 中文译文（源站提供）
一张低角度、广角模拟照片，一名女子在阳光普照的码头上俏皮地摆姿势，背景是湛蓝的天空。照片以一定角度拍摄。太阳在模特身后，形成光晕。她深棕色的头发散开，看起来又酷又美。她穿着一件简单的白色 T 恤、粗剪的牛仔短裤（带有一些线头），以及运动鞋和袜子。图像呈现出原始、未经雕琢的外观——用 35 毫米胶片拍摄，具有粗犷的模拟美学，并使用了闪光灯。没有数字修饰，自然光线和瑕疵完好无损，照片上有一些自然的颗粒斑点和划痕。照片给人一种随意、无忧无虑、真实的感覺，捕捉了怀旧的 90 年代夏日氛围。刺眼的阳光营造出微妙的镜头光晕和戏剧性的阴影。模特佩戴极少的配饰，强调自然、真实的生活感。背景包括白色木栅栏和远处海边的山丘。
