---
id: "landscape-material-concept-the-001"
title: "电路板上的巴黎微缩城市景观"
category: landscape
...
## 中文译文（源站提供）
（巴黎，PC）锚点：[{argument name="location" default="Location"}] :: [{argument name="material concept" default="Material Concept"}]::4
形态：[Location] 的微缩建筑城市景观，整个天际线由 [Material Concept] 组件组装而成，摩天大楼和结构由 [Material Concept] 的构成部分形成，主题结构工程，超精细立体模型::3
材料物理：[Material Concept] 的物理特性应用于建筑，[Material Concept] 纹理取代混凝土和玻璃，[Material Concept] 的固有材料逻辑，高保真表面细节::3
光照：展现 [Material Concept] 表面特性的照明，环境光遮蔽，与材料主题相匹配的体积大气::2
渲染堆栈：移轴摄影，微距镜头，f/2.8，8k，比例模型美学，详细纹理映射，虚幻引擎 5 渲染::1
负面：[有人物，大规模，模糊，低分辨率，糟糕的几何形状，扭曲，扁平 2D，文字，水印] :: -1
