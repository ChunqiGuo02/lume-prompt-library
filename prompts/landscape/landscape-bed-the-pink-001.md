...
```json
{
  "image_generation_request": {
    "subject": {
      "description": "一位年轻女性，留着铂金色长直发，蓝色眼睛",
      "pose": "仰卧在床上，直视观者，双腿伸向镜头（透视缩短），食指俏皮地轻触脸颊，左臂抱着一只粉色泰迪熊",
      "expression": "柔和、可爱的微笑，放松的神情"
    },
    "attire": {
      "headwear": "灰色羊毛贝雷帽",
      "top": "粉色长袖罗纹上衣，领口有蕾丝边饰",
      "bottom": "黑白格纹百褶迷你裙"
    },
    "environment": {
      "setting": "卧室",
      "details": "木质床头板，米色和奶油色枕头，凌乱的米色床单",
      "lighting": "柔和的自然窗光，漫射阴影"
    },
    "technical_specs": {
      "style": "写实主义，数码单反相机风格，高质量",
      "aspect_ratio": "4:5",
      "camera_angle": "平视视角，从床尾向上拍摄"
    },
    "full_prompt_string": "写实肖像，一位美丽的年轻女性仰卧在床上，戴着灰色贝雷帽，穿着粉色蕾丝边长袖上衣，黑白格纹百褶裙，抱着一只粉色泰迪熊，手指轻触脸颊，直视观者，金色长发，木质床头板，米色床上用品，柔和自然光，锐利对焦，8k，高度细节，从床尾拍摄的 POV 视角。",
    "negative_prompt": "绘画，动漫，卡通，3D 渲染，糟糕的解剖结构，变形的手，缺失的手指，多余的肢体，模糊，低质量，水印，文字，噪点，扭曲的脸，丑陋"
  }
}
```
