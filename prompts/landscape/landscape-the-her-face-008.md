---
id: "landscape-the-her-face-008"
title: "高质感8K人像分镜：阳光下女性面部特写，眼唇细节与发丝光泽展"
category: landscape
subcategory: "09_故事分镜角色设定"
aesthetic: null
tags: ["女性", "人像", "拼接", "光影", "自然光", "暖调", "暗调", "特写"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
## 中文译文（源站提供）
两部分照片，请勿改变面部特征。创建一张女性（我的脸与上传照片 100% 相同）躺着的照片，她的脸被柔和的阳光照亮，突出她脸部的每一个细节。她的皮肤看起来光滑，带有自然的红晕。照片的上半部分聚焦在她的眼睛和长长的睫毛上，她的手放在头发上，拍摄角度是从上方和侧面。下半部分是她嘴唇的特写，她的手拂过嘴唇，画面中只有嘴唇。头发浓密有光泽，带有明亮的挑染，突出了其质感和丰盈度。周围环境黑暗，阳光只照在女性的脸上。高质量 8K 图像，纹理细节丰富。两个画面中的头发都是长直发。嘴唇带有微妙、柔和的粉色光泽。每个画面都具有电影效果，并添加了颗粒感。
