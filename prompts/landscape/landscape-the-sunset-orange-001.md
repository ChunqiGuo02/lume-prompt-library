---
id: "landscape-the-sunset-orange-001"
...
```json
{
  "meta": {
    ...
    "resolution": "8K",
    "aspect_ratio": "2:3",
    "color_grading": "暖橙与青色调",
    "dynamic_range": "高",
    "mood": "戏剧性、氛围感、情绪化的电影剧照"
  },
  "subject": {
    "description": "年轻的东亚女性",
    "pose": "侧面特写，站在户外，若有所思地望向远方",
    "expression": "平静而沉思",
    "hair": "松散地向后扎起，柔软的自然发丝勾勒脸庞",
    "makeup": "淡妆",
    "skin": "自然肤质，逼真的面部细节"
  },
  "wardrobe": {
    "coat": "{argument name=\"coat color\" default=\"black\"} 大衣",
    "scarf": "深色围巾"
  },
  "lighting": {
    "type": "黄金时段日落",
    "direction": "柔和温暖的光线照亮脸部一侧",
    "quality": "柔和、自然、电影感"
  },
  "environment": {
    "location": "户外风景",
    "background": "模糊的背景，带有柔和的焦外虚化",
    "sky": "从暖橙色到冷绿色调柔和过渡的天空渐变"
  },
  "camera": {
    "lens": "85mm",
    "aperture": "f/1.8",
