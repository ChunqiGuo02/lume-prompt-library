---
id: "landscape-the-elegant-neckline-001"
title: "伦敦夜景奢华写真"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["女性", "夜晚", "奢华", "优雅", "黑色", "皮草", "亮片", "汽车"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
# 正文 prompt
{
  ...
  "environment": {
    "location": "Upscale city street at night ({"city" "London"} implied by Union Jack flags).",
    "background_elements": [
...
{
  "subject": {
    "description": "一位年轻女性，留着波浪状的乌黑长发。",
    "pose": "站立面向镜头，带着优雅的浅笑，双臂自然放松。",
    "expression": "柔和、自信且迷人。",
    "makeup": "经典的黑色烟熏妆，脸颊柔和修容，肌肤呈现自然缎面光泽，裸色/玫瑰色唇妆。",
    "styling_notes": [
      "优雅、得体的乳沟（不深，不挑逗）",
      "精致奢华的氛围"
    ]
  ...
  "outfit": {
    "top": "优雅的黑色衬衫，领口得体：甜心领或柔和的 V 领（深度适中），胸部有结构缝线，无透明面料，无镂空。",
    "outerwear": "一件毛绒大号黑色人造皮草外套，脱下搭在肩上，垂落在手肘处。",
    "bottoms": "黑色亮片长裤或黑色亮片裙，部分可见。",
    "accessories": "手中拿着一个黑色小手拿包（哑光皮革或缎面）。",
    "jewelry": [
      "一条黑色钻石心形吊坠项链，配有精致链条（位于领口上方）"
    ],
    "color_rule": "所有服装和配饰均为黑色（单色黑对黑造型）。"
  },
  "environment": {
    "location": "夜晚的高档城市街道（通过米字旗暗示为伦敦）。",
    "background_elements": [
      "带有大型石柱的宏伟建筑入口。",
      "建筑外墙上悬挂着米字旗。",
      "华丽的黑色金属大门。",
      "覆盖着暖白色小彩灯的大片绿色树篱。",
      "街上停放着一辆黑色豪华轿车（劳斯莱斯风格）。",
      "远处的城市路灯和模糊的行人。"
    ]
  },
  "lighting": {
    "type": "夜晚城市环境光。",
    "qualities": "建筑和彩灯散发出的暖光与冷色街灯混合。主体被附近的街灯或店面溢出的光线清晰照亮，带有自然的夜间颗粒感。"
  },
  "style": {
    "aesthetic": "迷人的夜生活，奢华生活方式，网红快照（优雅，不挑逗）。",
    "perspective": "平视视角，中景。",
    "camera_feel": "高质量智能手机照片，轻微夜间颗粒感，抓拍但有摆拍痕迹，真实的皮肤纹理（无美颜修饰）。"
  },
  "negative_prompt": [
    "深 V 领",
    "过度暴露的乳沟",
