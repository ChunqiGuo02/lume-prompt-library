---
id: "landscape-the-her-she-015"
title: "单幅四格漫画构图真人四宫格"
category: landscape
subcategory: "16_表情包趣味拼图"
aesthetic: null
tags: ["少女", "人像", "写真", "日系", "自然光", "写实", "自拍", "长发"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
## 中文译文（源站提供）
使用上传的参考图片，生成一个由4个面板组成的构图（左上角、右上角、左下角、右下角）。  
所有面板的面部、发型和服装都需与参考图片完全一致。  
- 左上角：从高角度拍摄她的特写，她抬头看着上方。  
- 右上角：她一边打哈欠一边抬起一只手臂伸懒腰。  
- 左下角：从她背后拍摄的肩部以上视角，展示她的手部动作或正在做的事情。  
- 右下角：她吐着舌头自拍。  
要求风格为真实照片，角色身份一致，光线自然。
