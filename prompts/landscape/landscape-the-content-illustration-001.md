---
id: "landscape-the-content-illustration-001"
title: "AI研究时代转型信息图"
category: landscape
subcategory: "06_图文排版视觉传达"
aesthetic: null
tags: ["手绘", "卡通", "信息图", "AI", "AGI", "思维导图", "科技", "安全"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "16:9"
...
## 中文译文（源站提供）
请根据提供的内容，按照以下指南创建卡通风格的信息图：
-手绘插图风格，横向（16:9纵横比）。
-包括少量简单的卡通元素、图标或名人，以增强视觉兴趣和可记忆性。
-如果内容包含敏感或受版权保护的数字，请用视觉上相似的替代品替换它们；不要拒绝生成插图。
-所有图像和文字必须严格遵循手绘风格；避免逼真的视觉元素。
-保持信息简洁，突出关键字和核心概念。使用足够的空白来清楚地强调关键点。
-除非另有说明，否则请使用与提供内容相同的语言。
请使用nano-banna pro根据提供的输入创建插图。
