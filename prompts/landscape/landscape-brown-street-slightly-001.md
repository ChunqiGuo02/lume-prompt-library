---
id: "landscape-brown-street-slightly-001"
title: "日系少女街拍写真风格生成提示词"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["女生", "可爱", "眼镜", "咖啡", "俯拍", "街头", "休闲", "青春"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
```json
{
  "image_generation": {
    "face": {
      "description": "年轻女性，面部特征柔和稚嫩，圆脸，自然肤质，淡妆，微醺腮红，嘴唇微噘",
      "expression": "俏皮、可爱的嘟嘴表情",
      "glasses": "圆形棕色细框眼镜"
    },
    "hair": {
      "color": "深棕色",
      "style": "长卷发，随意自然",
      "texture": "柔软，略带光泽，自然波浪"
    },
    "outfit": {
      "top": "灰色麻花针织毛衣，内搭白色翻领衬衫",
      "bottom": "棕色短裙",
      "socks": "及膝灰色袜子",
      "shoes": "棕色休闲系带鞋",
      "style": "可爱学院风，韩式街头时尚"
    ...
    "pose": {
      "body_position": "身体略微前倾，面向镜头",
      "hands": "双手捧着外带咖啡杯",
      "camera_angle": "高角度俯拍"
    },
    "environment": {
      "setting": "城市街道人行道",
      "background": "带有玻璃窗和金属栏杆的现代建筑",
      "details": "绿白相间的路边护栏，干净的城市街道"
    },
    "lighting": {
      "type": "自然日光",
      "direction": "直射阳光形成柔和阴影",
      "mood": "明亮、清新、抓拍感"
    },
    "camera": {
      "device": "智能手机摄像头",
