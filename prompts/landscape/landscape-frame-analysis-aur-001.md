---
id: "landscape-frame-analysis-aur-001"
title: "地中海极简风高端时尚写真，展现慵懒优雅的度假美学"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["明星", "度假", "泳池", "时尚", "休闲", "地中海", "简约", "暖棕"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
{
  "project_metadata": {
    "celebrity_name": "{"celebrity name" "Ana de Armas"}",
  ...
  "wardrobe_breakdown": {
    "set_combination": {
      "shirt": "Deep {"shirt color" "chocolate brown"}, lightweight linen ya silk blend, relaxed fit with button-down front",
...
{
  "project_metadata": {
    "celebrity_name": "安娜·德·阿玛斯",
    "shoot_category": "高端生活方式 / 时尚专题",
    "visual_aesthetic": "质朴优雅与地中海极简主义",
    "shooting_date": "2026 年 1 月 26 日 (参考：文件元数据)"
  },
  "detailed_environment_analysis": {
    "architectural_style": "伊维萨岛风格 / 基克拉迪极简主义 (白色灰泥墙，弧形壁龛)",
    "pool_characteristics": {
      "type": "无边泳池或下沉式泳池",
      "water_color": "碧绿色 / 水晶般清澈的蓝色",
      "decking": "浅米色天然石砖"
    },
    "furniture_elements": {
      "lounge_chairs": "木质框架和编织绳座椅",
      "sun_shade": "传统拉菲草/稻草遮阳伞，营造出非常自然的观感",
      "planters": "大型赤陶花盆，增添质朴气息"
    }
  },
  "wardrobe_breakdown": {
    "set_combination": {
      "shirt": "深巧克力棕色，轻薄亚麻或丝绸混纺，宽松版型，纽扣开衫",
      "skirt": "配套大地色系高腰中长裙，透气面料，简洁廓形",
      "inner_wear": "手工编织米色钩针文胸，纹理图案，三角形设计"
    },
    "styling_philosophy": "静奢风 (无需大 Logo，却显得昂贵且高品质的风格)"
  },
  "beauty_and_grooming": {
    "hair_style": "蓬松海滩波浪，侧分，带栗棕色挑染",
    "makeup_look": "水润“素颜”妆容，柔和粉唇，中性眼影，自然光泽肌肤"
  },
  "individual_frame_deep_dive": {
    "frame_01_analysis": {
      "filename": "20260126_150448.jpg",
      "composition": "运用三分法构图，模特位于左中位置",
      "narrative": "一个沉思或梦幻的时刻，模特望向远方"
    },
    "frame_02_analysis": {
      "filename": "20260126_150443.jpg",
      "composition": "特写肖像，背景虚化 (模糊背景)",
      "narrative": "一个平静的夏日微笑，眼神直接接触"
    },
    "frame_03_analysis": {
      "filename": "20260126_150436.jpg",
      "composition": "动态姿势，垂直对齐",
      "narrative": "拍摄期间自信而俏皮的姿势"
    }
  },
  "color_palette_hex_codes": {
    "earth_brown": "#4B3621",
