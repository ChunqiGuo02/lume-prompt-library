---
id: "landscape-the-morning-texture-001"
title: "清晨卧室自拍：金发少女裹圣诞红被，手臂花纹刺青，自然光下慵懒"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: nordic-minimal
tags: ["自拍", "卧室", "清晨", "自然光", "圣诞", "慵懒", "红色", "纹身"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
```json
{
  ...
  "scene": {
    ...
    "environment": [
      "凌乱的床铺，床单褶皱",
      "圣诞主题床上用品：红色法兰绒被子，带有白色北欧图案（雪花）",
      "阳光洒落在床上"
    ],
    "time": "明亮的清晨",
    "atmosphere": "慵懒、亲密、节日气氛但平静"
  },
  "lighting": {
    "type": "自然晨光",
    "source": "大窗户（侧面采光）",
    "flash": "关闭（仅有自然的柔和阴影）",
    "highlights": "阳光捕捉到空气中的灰尘颗粒和金色发丝",
    "shadows": "柔和，不生硬，勾勒出锁骨和床单的轮廓"
  },
  "camera_perspective": {
    "pov": "手持广角自拍（0.5 倍模式）",
    "framing": "上半身和部分腿部",
    "angle": "高角度或侧卧",
    "focus": "面部清晰，前景手臂因广角镜头略微变形",
    "composition": "动态角度，持手机的手臂从角落延伸可见"
  },
  "subject": {
    "demographics": {
      "gender": "女性",
    ...
    "face": {
      "expression": "略带惊讶/困惑的“刚睡醒”表情（眼睛睁大，嘴巴微张呈可爱的“O”形）",
      "features": {
        "cheeks": "柔软，因睡眠略带红晕",
        "lips": "丰满，自然，未涂口红但红润",
        "eyes": "明亮的蓝/灰色，惺忪但可爱"
      },
      "skin_texture": "清晨真实感：无妆皮肤的纹理，轻微的枕痕或泛红"
    },
    "hair": {
      "color": "金色，带有浅色挑染",
      "style": "凌乱的晨间发髻或松散的乱发",
      "texture": "阳光光晕效果，凌乱的发丝垂落在脸上"
    },
    "body_details": {
      "tattoo": {
        "location": "前臂内侧（可见于持手机的手臂或放在床单上的手臂）",
        "design": "精致的细线花卉或文字纹身",
        "color": "黑色墨水"
      }
    },
    "outfit": {
      "top": {
        "item": "紧身罗纹背心/吊带衫",
        "details": "细吊带，领口有轻微蕾丝边",
        "color": "白色或米色",
        "fit": "贴身"
      },
      "bottom": {
        "visibility": "腿部部分被红色圣诞被子覆盖"
      }
    }
  },
  "details": {
