---
id: "landscape-mirror-makeup-the-001"
title: "镜中女子涂唇膏的奢华酒店写真"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["写实", "美妆", "镜子", "化妆", "口红", "女性", "酒店", "暖光"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
## 中文译文（源站提供）
超逼真的抓拍编辑照片，一个化妆镜反射出一位正在涂口红的女性。化妆镜占据了画面的大部分，具有真实的玻璃反光、轻微的污迹和镜面眩光。镜中映照着一位妆容精致的年轻女性，她摆出自信而诱人的姿势。

环境：豪华酒店房间，暖色调环境光，微妙的焦外虚化高光。构图：化妆镜和化妆刷可见。光线：暖钨丝灯，柔和补光；面部锐利清晰；背景柔和虚化。相机感觉：真实的抓拍，极致的写实感。女性身穿丝绸浴袍并佩戴珠宝。

画面中只有 1 个人（一位女性）。完美的人体结构：手/手指、化妆刷的握持、面部对齐均正确；没有多余的肢体。逼真的皮肤纹理；没有塑料般的平滑感。反射中没有额外的人物或面孔。

负面提示词：任何可读文本、品牌名称、标志、水印、带有可读标签的真实化妆镜 UI、反射中有多余人物或面孔、身份漂移、变形的手、多余的手指、扭曲的镜面几何、卡通、动漫、CGI 效果、塑料感或过度平滑的皮肤、低分辨率、严重噪点、刺眼的过曝高光。右下角优雅地放置着一个时尚的手写签名 Willy，字体小巧。
