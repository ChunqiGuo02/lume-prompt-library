---
id: "landscape-subject-identity-ana-003"
title: "高保真面部融合与服饰风格迁移生成"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["女性", "肖像", "写实", "雀斑", "短发", "绿瞳", "逆光", "暖色调"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
version: "1.0.0"
related_to: ["landscape-subject-ana-armas-001", "landscape-subject-ana-armas-002", "landscape-subject-identity-ana-001", "landscape-subject-identity-ana-002", "landscape-subject-identity-source-001", "landscape-subject-sydney-sweeney-001"]
---
...
# 正文 prompt
{
  ...
  "source_references": {
    "primary_subject": {
      ...
      "subject_name": "{"subject name" "Ana de Armas"}",
  ...
  "generation_parameters": {
    ...
    "environment_specs": {
      "setting": {
        "location": "高档户外露台",
        "background_depth": "deep_blur",
        "elements": ["柔和的建筑线条", "黄金时段的温暖光线", "充满活力的绿色植物"]
      },
      "lighting": {
        "mode": "vibrant_high_key",
        "primary_source": "明亮的自然阳光",
        "secondary_source": "柔和的边缘光，将主体与背景分离",
        "hdr_profile": "超高动态范围"
      }
    },
    "camera_specs": {
