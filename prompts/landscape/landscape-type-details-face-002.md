---
id: "landscape-type-details-face-002"
title: "安娜·德·阿玛斯石墙写真造型指南"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["女性", "波西米亚", "碎花", "红色", "绿色", "皮靴", "石墙", "户外"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
```json
{
  "prompt_details": {
    "subject": {
      "type": "年轻女子 Ana de Armas",
      "appearance": {
        "hair": "长款、深栗色、蓬松波浪、散落在脸上、凌乱美学",
        "skin": "白皙肤色、光滑质感、自然妆面",
        "face": "向下看、脸部部分被头发遮挡、内省的表情",
        "body_type": "苗条、健美"
      },
      "pose": {
        "stance": "靠着石墙、身体略微倾斜",
        "hands": "右手轻柔地放在胸部/颈部、手指张开、左手拿着一个绿色物体（靴子）放在身体一侧",
        "gaze": "向下、避免眼神接触"
      }
    },
    "clothing": {
      "dress": {
        ...
        "fabric": "轻质棉或亚麻混纺",
        "color": "{\"dress color\" \"Red/off-Red\"} 底色",
        "pattern": "小巧精致的花卉图案、带有紫色和黄色野花",
    ...
    "environment": {
      "background": "纹理石砌墙",
      "details": "大块、不规则的灰色和米色石块、粗糙的质感、自然建筑背景",
      "setting": "户外或半户外日光环境"
    },
    "lighting": {
      "type": "柔和自然日光",
    ...
    "styling": {
      "aesthetic": "波西米亚、时尚、女性化、柔和的垃圾摇滚底蕴",
      "mood": "休闲、自然、略带忧郁、艺术感"
    },
    "camera_details": {
      "shot_type": "中景（大腿以上）",
      "angle": "视线水平",
      "lens": "85mm 定焦镜头、用于讨人喜欢的肖像压缩",
      "aperture": "f/2.8、用于与墙壁略微分离的景深",
      "focus": "主体和连衣裙纹理清晰对焦"
    },
    "technical_specifications": {
      "quality": "超逼真、8k 分辨率、高度细节化",
      "texture_quality": "高保真织物纹理、逼真皮肤毛孔、细节石砌结构",
      "engine": "Unreal Engine 5 渲染风格或高端摄影" Ratio 3.4
    }
  }
}
```
