---
id: landscape-description-the-clouds-0100
title: "孤独行者穿越苍茫山丘"
category: landscape
subcategory: "15_特定场景环境生成"
aesthetic: null
tags: ["旷野", "男子", "斗篷", "枯草", "孤树", "阴天", "光影", "孤独"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
## 中文译文（源站提供）
{
  "目标": "生成一张具有电影质感的高分辨率照片描述。",
  "场景细节": {
    "背景设定": "广阔的英国乡村景色，连绵起伏的金棕色山丘。",
    "氛围": "情绪低落且充满神秘感，天空中乌云密布。",
    "光线": {
      "描述": "柔和的散射阳光穿透云层，形成明亮的斑块。",
      "色调效果": "真实感强、具有电影风格的自然对比度，色彩过渡细腻。",
    },
    "植被": "高大的草丛被风吹得齐及人物的膝盖。",
    "背景元素": "远处山脊上有一棵孤零零的树，增强了场景的层次感和孤独感。"
  },
  "人物细节": {
    "描述": "一个孤独的男子正在这片风景中行走。",
    "动作": "他缓慢地穿过高高的草丛，斗篷轻轻飘动。",
    "服装": "穿着一件长款、深色的中世纪风格斗篷或带兜帽的外套。",
    "姿势": "站得笔直，但神情专注，头部微微低垂。",
    "面部特征": "侧面部分可见；面容轮廓分明，胡须修剪整齐；头发较短，两侧剪得很短，顶部则较为凌乱。",
  },
  "风格指导": {
    "色调风格": "具有电影质感、戏剧性的画面效果，强调人物的孤独感。",
    "色彩运用": "以大地色调的赭色和冷色调的灰色为主。",
    "情感基调": "画面具有史诗般的规模感，重点突出人物的内心情感。",
    "限制条件": "画面中不得出现任何文字、标志或可见的文字内容。"
  },
  "技术规格": {
    "相机": "专业单反相机。",
    "镜头": "广角镜头，既能捕捉到广阔的景色，又能将焦点对准人物。",
    "画面比例": "1:1",
    "分辨率": "输出的照片需保持高分辨率。"
  }
}
