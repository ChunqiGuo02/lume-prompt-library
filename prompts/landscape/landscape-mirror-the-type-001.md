---
id: "landscape-mirror-the-type-001"
title: "阳台享受春日时光"
category: landscape
subcategory: "15_特定场景环境生成"
aesthetic: null
tags: ["阳台", "度假", "休闲", "慵懒", "浴袍", "郁金香", "酒杯", "雪山"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
# 正文 prompt
Is this okay ???
this is the best nano banana pro slideshow prompt:
{
"subject": {
...
{
  "subject": {
    "description": "一位年轻女性正在对着镜子自拍，俏皮地咬着一杯冰镇绿茶饮料的吸管。",
    "mirror_rules": "忽略镜像中的物理效果（例如衣物上的文字不会被反射），确保文字正向显示且清晰可见，不要添加多余的字符。",
    "age": "年轻成人",
    "expression": "俏皮的表情，鼻子微微皱起，正在咬吸管。",
    "hair": {
      "color": "棕色",
      "st
