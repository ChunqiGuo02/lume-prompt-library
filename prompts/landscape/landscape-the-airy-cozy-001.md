---
id: "landscape-the-airy-cozy-001"
title: "日系女友风秋日咖啡馆写真，温暖治愈的日常瞬间"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: japanese-zen-garden
tags: ["日系", "少女", "秋日", "温馨", "针织衫", "酒红", "短裙", "黑丝"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
"upper_body": "Oversized {"sweater color" "cream-colored"} cable-knit sweater, chunky wool texture, voluminous balloon sleeves bunching softly at the wrists, exuding comfort and warmth",
...
{
"prompt_configuration": {
"art_style": "日系“女友感”美学（Kanojo-kan），高品质生活摄影，柔焦通透写实，生活化抓拍，温馨秋日氛围",
"aspect_ratio": "--ar 2:3",
"stylization": "--stylize 400",
"mood_and_tone": "宁静、暖心、甜美、怀旧、亲密、柔和放松、温柔阳光"
},
"visual_elements": {
"subject_description": {
"appearance": "迷人的年轻女性，面容青春纯真，肌肤如瓷般柔滑，齐肩栗色波波头，搭配空气感“透视”刘海修饰脸庞",
"expression": "温柔、略带羞涩却又充满爱意的眼神交流，回眸一笑，柔和而亲切"
},
"apparel_and_accessories": {
"upper_body": "宽松的 {\"sweater color\" \"米色\"} 麻花针织毛衣，粗羊毛质感，蓬松的灯笼袖在手腕处柔软堆叠，散发着舒适和温暖",
"lower_body": "酒红色短款 A 字迷你裙，采用纹理羊毛或灯芯绒材质，营造出浓郁的秋日色彩对比",
"legwear": "透明黑色连裤袜（约 20 丹），半透明光滑质地，为这身舒适的装扮增添了一丝优雅的成熟感"
},
"pose_and_composition": {
"pose": "背对镜头站立，但上半身扭转回望（回眸），姿势动感而自然",
"framing": "中景镜头（大腿以上），聚焦于她的眼神与观者之间的互动"
},
"environment_context": {
"setting": "乡村咖啡馆的安静角落或宁静的学校休息室",
"background_elements": "带有白色网格框的大窗户，窗外可见郁郁葱葱的绿色植物，但被严重虚化（散景），前景是一张木桌，上面放着一个冒着热气的陶瓷杯和一本打开的笔记本"
}
},
"technical_details": {
"lighting_setup": "来自背景的漫射自然窗户光（逆光/轮廓光），在头发上形成光晕效果，面部柔和补光以消除强烈阴影",
"camera_settings": "使用 Sony A7III 拍摄，85mm f/1.4 人像镜头，浅景深以将主体与背景分离",
"image_quality": "8k 分辨率，照片级写实，精细织物纹理，柔和胶片颗粒模拟，高动态范围"
}
}
```
