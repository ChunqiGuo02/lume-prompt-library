---
id: "landscape-bottle-green-forest-001"
...
version: "1.0.0"
related_to: ["landscape-bottle-green-forest-002"]
---
...
```json
{
  ...
  "module_1": {
    ...
    "environment": {
      "setting": "茂密的森林氛围",
      "background": "柔和模糊的绿色树叶，具有深度分离感",
      "foreground": "带有土壤、苔藓和少量碎屑的自然森林地面",
      "props": [
        "扁平的天然石台",
        "瓶子后方稍远处放置的不规则岩石",
        "右侧带有可见松针的松树枝"
