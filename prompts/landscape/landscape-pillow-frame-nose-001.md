---
id: "landscape-pillow-frame-nose-001"
title: "自然素颜少女枕边自拍特写"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["特写", "人像", "东亚", "女性", "棕发", "长发", "刘海", "雀斑"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
```json
{
  "frame": {
    ...
    "shot_size": "特写 (ECU)",
    "orientation": "竖屏",
    "composition_guide": "偏离中心对角线构图；脸部占据画面大部分，枕头主导画面右侧；眼睛靠近中上部"
  },
  "subject": {
    "subject_type": "人物",
    "identity_summary": "东亚成年女性，长深棕色/黑色头发，带有稀疏的空气刘海，自然纹理的皮肤，有浅色雀斑，粉色亮泽唇部，脸颊（观看者左侧）有一颗小美人痣。",
    "visual_signature": {
      "facial_signature": {
        "face_shape": "柔和的鹅蛋脸，下巴略尖（被枕头轻微挤压）",
        "eye_details": "大棕色杏仁眼，细微眼线，清晰的眼神光",
        "nose_details": "笔直的窄鼻梁，小巧柔和的鼻尖",
        "lip_details": "丰满嘟唇，高光泽，粉色/珊瑚色调",
        "unique_features": "观看者左侧脸颊有一颗小黑美人痣（痣）"
      },
      "body_signature": {
        "build": "苗条",
        "skin_tone_and_texture": "白皙肤色，具有真实的皮肤微观纹理：脸颊和鼻部毛孔可见，细微的桃色绒毛，鼻梁和上脸颊散布着浅色雀斑，轻微的泛红/潮红和轻度自然斑驳；无过度平滑处理"
      }
    },
    "pose_and_action": {
      "description": "侧卧自拍，脸颊靠在奶油色枕头上，头部略微向下倾斜对着镜头。",
      "body_position": "上半身大部分在画面外；可见领口",
      "limb_positions": "手臂在画面外；暗示手持手机/相机",
      "facial_expression": "困倦/轻微嘟嘴，放松的嘴巴，平静亲密的氛围",
      "gaze_direction": "与镜头直接眼神接触"
    },
    "inventory": {
      "wardrobe": "白色圆领棉质 T 恤",
      "accessories": "无",
      "hair_style": "长直黑发散落在床上，稀疏的刘海部分遮住额头和眼睛之间"
    }
  },
  "environment": {
    "setting_type": "室内",
    "location_description": "床，靠近枕头",
    "background_elements": "画面右侧是奶油色/白色柔软质感的枕头，白色床上用品，物品极少"
  },
  "lighting": {
    "global_illumination": "柔和、漫射、能展现纹理",
    "primary_source": "来自相机左上方（窗户状）的大面积柔和光源",
    "direction": "大部分为正面光，略带侧光偏向，以展现毛孔和雀斑，无强烈阴影",
    "shadow_quality": "非常柔和；鼻部和刘海下方有柔和的渐变",
    "color_temperature": "中性暖色调（约 4500K–5200K）"
  },
  "camera": {
    "angle": "手机自拍视角，略高于且靠近",
    "lens_type": "手机广角镜头等效",
    "focal_length_mm_equiv": 24,
    "aperture": "f/1.8",
    "focus": "眼睛清晰锐利；细节足以分辨脸颊和鼻部的毛孔/雀斑；头发和枕头边缘有轻微的景深衰减"
  },
  "post_processing": {
    "art_medium": "照片"
  }
