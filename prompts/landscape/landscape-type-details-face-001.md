---
id: "landscape-type-details-face-001"
title: "奶油碎花裙少女倚石墙写真"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["少女", "棕发", "石墙", "碎花", "露肩", "短裙", "绿色", "短靴"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
```json
{
  "prompt_details": {
    "subject": {
      "type": "年轻女性",
      "appearance": {
        "hair": "深栗色长发，波浪松散，部分遮脸，凌乱美学",
        "skin": "白皙肤色，光滑质感，自然妆容",
        "face": "向下看，脸部部分被头发遮挡，若有所思的表情",
        "body_type": "苗条，健美"
      },
      "pose": {
        "stance": "靠着石墙，身体略微倾斜",
    ...
    "environment": {
      "background": "有纹理的石砌墙",
      "details": "大块不规则的灰色和米色石块，粗糙质感，自然的建筑背景",
      "setting": "户外或半户外日光环境"
    },
    "lighting": {
      "type": "柔和自然日光",
    ...
    "styling": {
      "aesthetic": "波西米亚风，时尚，女性化，柔和的垃圾摇滚底蕴",
      "mood": "休闲，随性，略带忧郁，艺术感"
    },
    "camera_details": {
      "shot_type": "中景（大腿以上）",
