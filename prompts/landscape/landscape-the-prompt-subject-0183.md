---
id: landscape-the-prompt-subject-0183
title: "雪山日出时分，男子手持热饮远眺山谷美景。"
category: landscape
subcategory: "15_特定场景环境生成"
aesthetic: japanese-zen-garden
tags: ["冬季", "雪景", "山脉", "河流", "日出", "暖光", "背影", "冬装"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
```json
{
  "image_prompt": {
    "subject": {
      "description": "一名 20 多岁末的男子，神情沉思，眺望远方",
      "features": ["短黑发", "白皙肤色", "略带胡茬"],
      "attire": [
        "厚重的橄榄绿色冬季派克大衣，带有大毛边兜帽",
        "粗针织棕色羊毛围巾",
        "黑色保暖手套",
        "手插在口袋里"
      ],
      "action": "手持冒着热气的银色保温瓶，靠在桥栏杆上"
    },
    "environment": {
      "setting": "俯瞰山区或高海拔地区的冰冻河谷",
      "background": "金色时段，远处现代摩天大楼的城市剪影",
      "elements": [
        "白雪覆盖的松树，挂满厚霜",
        "冰冷水面上升起的薄雾",
        "积雪的铸铁桥栏杆"
      ],
      "atmosphere": "隆冬时节，气温严寒，宁静的早晨，安详而充满希望"
    },
    "technical_specs": {
      "lighting": "金色时段日出，柔和的橙色和黄色光芒，电影般的逆光",
      "composition": "中景侧面拍摄，三分法构图，浅景深（背景虚化）",
      "camera_settings": "使用 85mm 镜头拍摄，f/1.8 光圈，主体面部对焦清晰",
      "style": "超现实主义，照片级真实感，8k 分辨率，电影级色彩分级"
    },
    "negative_prompt": "过饱和，模糊的脸，扭曲的手，卡通化，低分辨率，凌乱的头发"
  }
}
```
