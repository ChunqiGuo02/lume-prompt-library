---
id: "landscape-type-texture-hair-001"
title: "嘻哈运动员更衣室写真：炫酷墨镜与钻石牙套特写"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: industrial-loft
tags: ["黑人", "男性", "嘻哈", "人像", "写实", "太阳镜", "编发", "纹身"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
# 正文 prompt
{
  ...
  "subject": {
    ...
    "expression_and_pose": {
      ...
      "mouth": "teeth gritted/exposed to show {"jewelry type" "jewelry"}",
...
```json
{
  "meta": {
    ...
    "camera": "Hasselblad H6D-100c",
    "lens": "Macro 80mm f/2.8",
    "style": "高对比度运动社论风格，细节纹理写实，后台美学，原始闪光摄影"
  },
  "scene": {
    "location": "运动员更衣室",
    "environment": [
    ...
    "lighting": {
      ...
      "direction": "前上方偏右",
      "intensity": "高",
      "highlights": "前额、鼻尖和颧骨有强烈镜面高光，模拟汗水/油光",
      "shadows": "下巴和鼻子下方有深对比阴影",
      "reflections": "太阳镜镜片上有清晰的影棚灯反射"
    }
  },
  "subject": {
    "identity_features": {
      "gender": "男性",
      "ethnicity": "非裔美国人",
      "skin_texture": "超写实毛孔可见度，肤色不均，可见皮脂光泽（非塑料哑光），颈部有剃须引起的疙瘩，痣的纹理",
      "facial_structure": "下颌线分明，颧骨高，颈部肌肉发达"
    },
    "hair_and_grooming": {
      "hair_style": "紧密编织的玉米辫",
      "hair_texture": "头皮纹路可见，发际线有自然卷曲",
      "facial_hair": "修剪整齐的山羊胡和胡须，逼真的粗糙毛发质感，下颌有明显的胡茬"
    },
    "expression_and_pose": {
      "action": "用右手食指拉下下唇",
      "mouth": "咬紧牙关/露出牙齿以展示 {\"jewelry type\" \"珠宝\"}",
      "mood": "攻击性展示，自信，兴奋",
      "gaze": "眼睛藏在眼镜后面，脸部略微转向观看者的右侧"
    },
    "accessories_detailed": {
      "sunglasses": {
        "brand": "{\"sunglasses brand\" \"Oakley\"}",
        "model_type": "未来感环绕式护目镜/遮阳板款式",
        "frame_material": "哑光银色/镁合金饰面",
        "lens_color": "深火橙至红色渐变",
        "branding": "眉梁上压印有独特的“OAKLEY”标志",
        "details": "镜片下角可见小字“BE INSPIRED”"
      },
      "grillz": {
        "type": "粘合式牙齿宝石/独立钻石镶嵌",
        "placement": "镶嵌在下门牙（切牙和犬齿）上",
        "material": "圆形切割透明钻石",
        "look": "闪闪发光，唾液带来的湿润感（真实，非金属块状）"
      },
      "earring": {
        "type": "钻石十字耳钉",
        "location": "右耳垂",
