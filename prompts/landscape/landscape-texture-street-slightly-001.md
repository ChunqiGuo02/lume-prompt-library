---
id: "landscape-texture-street-slightly-001"
title: "都市街头女性写真：自然真实，简约时尚"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["都市", "街头", "肖像", "女性", "松弛", "皮衣", "黑色", "灰色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
```json
{
  "scene": "安静的城市人行道上的都市街头肖像",
  "subject": {
    "gender": "女性",
    "age_range": "20 岁末至 30 岁初",
    "expression": "中性、内省、沉着自信",
    "pose": "随意站立，身体略微倚靠砖墙，重心放在一条腿上，手臂放松",
    "gaze": "直视镜头，从容不迫，低调的存在感"
  },
  "wardrobe": {
    "outerwear": "黑色皮夹克，带有自然磨损和柔软褶皱",
    "top": "深炭灰色罗纹背心",
    "bottom": "高腰定制羊毛长裤，柔和的灰色调",
    "accessories": "小巧的深色皮革斜挎包，极简首饰",
    "styling_notes": "不费力、实用、有生活气息的时尚，没有过度追逐潮流"
  },
  "hair_and_makeup": {
    "hair": "自然中长发，蓬松微乱，略带风吹痕迹，无造型产品光泽",
    "makeup": "极少或无妆，可见自然肤质，眼下有细微阴影，真实毛孔可见"
  },
  "environment": {
    "location": "狭窄的城市街道，有砖墙和店面",
    "background": "远处自行车和行人柔和虚化",
    "era_feel": "永恒的当代感，日常写实主义"
  },
  "lighting": {
    "type": "自然阴天日光",
    "direction": "柔和正面光，带有轻微侧面衰减",
    "contrast": "低至中等对比度",
    "notes": "无刺眼高光，无戏剧性轮廓光"
  },
  "camera": {
    "lens": "50mm 全画幅效果",
    "framing": "全身肖像，平视视角",
    "depth_of_field": "适度浅景深，主体与背景微妙分离",
    "movement": "静态，纪录片般的静止"
  },
  "color_and_texture": {
    "color_palette": "柔和的大地色系，柔和的灰色，自然肤色",
    "texture": "可见织物纹理、砖墙纹理、轻微胶片颗粒",
    "grading": "中性，略冷色调，电影感，无青橙色调"
  },
  "aesthetic_constraints": [
    "无塑料感皮肤",
    "无美颜修饰",
  ...
  "overall_vibe": "沉静自信，观察性，扎实的写实主义，现代街头肖像"
}
```
