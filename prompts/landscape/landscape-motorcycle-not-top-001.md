---
id: "landscape-motorcycle-not-top-001"
title: "具有中性气质的摩托车手风格"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["机车", "女性", "牛仔", "城市", "复古", "胶片", "叛逆", "酷感"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
## 中文译文（源站提供）
{
  "image_generation_parameters": {
    ...
    "prompt_structure": {
      "subject": {
        "description": "一位年轻、具有中性气质的摩托车女骑手的完整肖像",
        "build": "身材曲线优美，不过于肥胖",
        "expression": "神情忧郁，带有叛逆的气质",
        "constraint": "不得修改面部特征"
      },
      "attire": {
        "top": "深色无袖上衣",
      ...
      "environment": {
        "backdrop": "透过玻璃窗可以看到一家城市咖啡馆",
        "details": "窗户上有一些淡淡的文字装饰，窗外的城市景色有些模糊"
      },
      "lighting_and_mood": {
        "light": "柔和的自然光",
        "shadows": "高对比度的阴影",
        "tones": "忧郁的灰绿色调",
        "atmosphere": "戏剧性、充满叛逆氛围"
      },
      "photographic_style": {
        "medium": "35毫米胶片摄影",
        "textures": "粗糙、有颗粒感的画面质感",
        "focus": "浅景深效果",
        "composition": "具有电影感的戏剧性构图"
      }
    }
  }
}
