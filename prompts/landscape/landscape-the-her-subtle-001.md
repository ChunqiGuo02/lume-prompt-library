---
id: "landscape-the-her-subtle-001"
title: "时尚白裙少女写真"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["年轻", "女性", "时尚", "白色", "简约", "室内", "优雅", "自然光"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
{
  "prompt_description": {
    "subject": "一位年轻女性，看起来约莫十几岁到二十出头，身材苗条而富有运动感。",
    "face": "目光柔和，略微下垂，双唇微启，形成一种微妙的嘟嘴姿态。眉毛修饰得完美无瑕，眼线锐利且上扬。皮肤看起来光滑无瑕，几乎看不到纹理。脸颊上带有淡淡的腮红。",
    "hair": "深棕色长发，以柔和的波浪状披散过肩。头发自然光泽，造型顺滑，没有一丝杂乱。几缕发丝轻柔地勾勒出她的脸庞。",
    "clothing": "两件式服装。上衣是一件白色修身短款吊带背心，细细的意面肩带。领口是迷人的心形。面料似乎略有弹性，胸部周围有轻微的张力。裙子是高腰 A 字形迷你裙，同样是白色。它从腰部向外展开，结构感强却又流畅，下摆整洁。裙子的面料似乎更厚实，略带硬挺，能很好地保持形状，营造出光滑、近乎雕塑般的轮廓。腰部没有可见的张力或拉伸。",
    "accessories": "左手腕上戴着一只精致纤细的手链，可能是银色或玫瑰金，带有一个小吊坠。耳垂上戴着小巧精致的耳钉。左前臂上有一个非常淡，几乎难以察觉的纹身。",
    "environment": "室内场景，类似于明亮的现代工作室或极简主义生活空间。背景中可见一扇带有黑色窗格的大窗户，挂着薄薄的浅色窗帘。窗前摆放着一张光滑的白色桌子，桌腿略微可见。桌上有两盆小型绿色盆栽。植物后面架子或台面上还有一幅带有植物插画的画框。地板是浅色木质的。",
    "lighting": "柔和、漫射的自然光从窗户射入，在她的皮肤和服装面料上形成柔和的高光。颧骨和肩膀上有微妙的镜面高光。阴影柔和，略带漫射感，表明光源较大或当天是阴天。整体光线明亮通透。",
    "atmosphere": "宁静、别致、时尚，略带诱惑。氛围干净精致，充满青春优雅感。"
  },
  "style": {
    "art_style": "超现实商业时尚摄影，高端杂志风格。",
    "color_grade": "干净、明亮，略微去饱和。主色调为白色、自然肤色，以及背景中柔和、低饱和度的绿色和灰色。整体图像带有一丝微妙的冷色调。",
    "texture_quality": "极其锐利和细致，具有高微对比度。每一个毛孔和织物纹理都应清晰可辨。照片般逼真。"
  },
  "camera_settings": {
    "camera": "中画幅"
  }
