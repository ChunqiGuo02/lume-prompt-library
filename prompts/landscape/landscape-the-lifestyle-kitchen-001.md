---
id: "landscape-the-lifestyle-kitchen-001"
title: "日常厨房中的年轻女性侧影，自然生活感写真"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["写实", "摄影", "胶片", "厨房", "居家", "女性", "纹身", "松弛"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
```json
{
  ...
  "sexualization": "无",
  "description": {
    "subject": "一位年轻女性随意地站在家中厨房里，侧面视角",
    "pose": "放松的姿态，一只手放在臀部，另一只手拿着一个带吸管的小饮料盒",
    "expression": "中性，若有所思，目光略显疏远地向前看",
    "appearance": {
      "hair": "深色头发扎成松散的低发髻，自然的发丝垂在脸庞两侧",
      "clothing": "随意穿着一件宽松的白色 T 恤，由于衬衫的宽松剪裁，简单的内衣部分可见",
      "tattoos": "前臂上有小巧、简约的黑色墨水纹身，精致而低调"
    }
  },
  "environment": {
    "location": "一个朴实、充满生活气息的家庭厨房",
    "details": "木质橱柜，台面电器，冰箱上贴满了彩色磁铁和纪念品",
    "lighting": "窗户透进柔和的自然日光，温暖而略显柔和",
    "atmosphere": "安静、日常的居家时刻"
  },
  "camera": {
    "angle": "侧面视角",
    "framing": "中景，捕捉主体从大腿中部到头部",
    "lens": "35mm 生活方式镜头",
    "depth_of_field": "适中，背景柔和对焦以保留环境背景"
  },
  "image_quality": {
    "realism": "高",
    "texture_detail": "可见自然的织物褶皱、皮肤纹理和厨房表面细节",
    "grain": "轻微的自然胶片颗粒，营造真实感"
  },
  "mood": "平静、亲密、纪录片风格",
  "constraints": [
    "非性化，日常写实主义",
