---
id: "landscape-details-creamy-white-item-002"
title: "雪夜时尚芭蕾舞者动态写真"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: japanese-zen-garden
tags: ["电影感", "冬季", "女性", "雪景", "快乐", "时尚", "摄影", "夜景"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
version: "1.0.0"
related_to: ["landscape-details-creamy-white-item-001"]
---
...
# 正文 prompt
{
  "image_generation_request": {
    ...
    "subject": {
      "identity": "Young adult woman, {"likeness inspiration" "Shakira"}-inspired likeness",
      "pose": {
...
```json
{
  "image_generation_request": {
    ...
    "quality": "8K / 超高细节",
    "subject": {
      "identity": "年轻成年女性，形象灵感来自 {\"likeness inspiration\" \"Shakira\"}",
      "pose": {
        "description": "充满活力的芭蕾舞姿，自然而愉悦",
        "position": "单腿站立，另一条腿弯曲高高抬起，身体略微倾斜",
        "arms": "一只手臂抬起，手掌张开接住雪花，另一只手臂随动作流动"
      },
      "expression": {
        "mood": "真诚快乐，充满活力",
      ...
      "physical_details": {
        "skin": "逼真的皮肤纹理，细微毛孔，微妙的不对称，柔和高光，无塑料感平滑",
    ...
    "apparel": {
      ...
      "layers": [
        {
          "item": "超大号羽绒服",
          "details": "厚实的米白色，蓬松质感，可见缝线，逼真的羽绒体积和压缩褶皱"
        },
        {
          "item": "短款连帽衫",
          "details": "米白色柔软棉质，轻微褶皱，穿在夹克内"
        },
        {
          "item": "高腰打底裤",
          "details": "哑光弹力面料，米白色，膝盖和臀部有微妙的张力"
        }
      ],
      "accessories": [
        {
          "item": "针织毛线帽",
          "details": "超蓬松，可见纱线纹理，米白色"
        },
        {
          "item": "连指手套",
          "details": "长款米白色蓬松纤维，接住飘落的雪花"
        }
      ],
      "footwear": {
        "style": "月球靴风格系带冬靴",
    ...
    "environment": {
      ...
      "props": "一辆黑色豪华 SUV 停在附近，部分被霜雪覆盖",
      "ground": "厚实不平的雪毯，有可见的脚印和受压点",
      "weather": "大雪纷飞，大片雪花在空中凝固，略带模糊"
    },
    "lighting_and_atmosphere": {
      "primary_lighting": "寒冷的蓝白色环境冬日灯光",
