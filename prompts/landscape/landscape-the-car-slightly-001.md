---
id: "landscape-the-car-slightly-001"
title: "车内东京风自拍写真"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["自拍", "车内", "年轻", "女性", "休闲", "酒红", "浅蓝", "墨镜"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
"selfie_type": "front passenger seat car selfie, arm extended slightly forward and inward while holding the camera, shot from inside the car close to the window, natural eye-level perspective, car window edge visible in frame, clear glass reflections and subtle window glare visible on the glass surface, authentic in-car selfie composition"
  ...
  "outfit": {
    "top": "{"top color and text" "dark crimson red fitted crop top with bold white 'TOKYO' lettering and small Japan flag detail underneath"}",
...
```json
{
  ...
  "camera": {
    ...
    "framing": "近距离且亲密，非广角",
    "aspect_ratio": "3:4",
    "focus_area": "上半身和躯干，部分腿部可见",
    "composition": "编辑式，自信",
    "selfie_type": "前排乘客座位汽车自拍，手臂略微向前内侧伸展并握持相机，从车内靠近车窗处拍摄，自然的平视视角，车窗边缘在画面中可见，玻璃表面有清晰的玻璃反光和微妙的车窗眩光，真实的汽车内自拍构图"
  },
  "lighting": {
    "time_of_day": "白天",
    "source": "透过车窗的自然阳光",
  ...
  "outfit": {
    "top": "深绯红色修身短款上衣，带有醒目的白色“TOKYO”字样和下方的小日本国旗细节",
    "jeans": "浅蓝色宽松牛仔裤，休闲略显宽松，腰部略低",
    "waistband_detail": "Calvin Klein 腰带的极微细一瞥，简约而雅致",
    "shoes": "黑色 Nike 运动鞋，部分可见"
  },
  "jewelry": {
    "type": "精致的戒指、手链、微妙的配饰",
    "appearance": "与参考照片完全相同",
    "lighting_effect": "柔和阳光下的轻微光泽"
  },
  "accessories": {
    "sunglasses": "戴在头顶上方"
  },
  ...
  "makeup": {
    "style": "柔和干净",
    "lips": "温暖柔和的粉色",
    "skin": "细腻健康的皮肤纹理，带有自然光泽",
    "lighting_effect": "阳光反射带来的清新、容光焕发的效果"
  },
  "pose": {
    "body_position": "自信放松",
    "orientation": "身体略微转向",
