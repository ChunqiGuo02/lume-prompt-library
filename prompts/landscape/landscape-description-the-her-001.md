---
id: "landscape-description-the-her-001"
title: "雪夜自拍的电影感肖像"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["冬季", "下雪", "夜晚", "自拍", "近景", "户外", "黑色", "积雪"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
{
  "pose": {
    "描述": "她用左手握着相机，相机位置略低于眼睛水平线，从自信的角度向上拍摄她的面部；嘴唇微微张开，表情平静而富有深度。",
  },
  "background": {
    "描述": "一个黑暗的冬夜天空，树枝上覆盖着薄薄的一层霜冻，几乎看不见，营造出一种戏剧性的氛围。",
  "atmosphere": {
    "描述": "寒冷、充满电影感的冬日氛围；这是一幅风格现代的雪景肖像，具有自然的质感和细节。",
  },
  "reference_style": {
    "描述": "概念性变体。",
    "细节": {
      "拍摄方式": "在夜间大雪纷飞时拍摄的近距离户外自拍。",
      "主体": "女性的面部特征与参考图片完全一致。",
      "皮肤": {
        "描述": "肤色自然，皮肤纹理真实可见。她的脸颊因寒冷而略微泛红。",
      },
      "雪的细节": "雪花落在她的睫毛和头发上。",
      "服装": "她戴着一顶几乎被雪完全覆盖的黑色人造毛皮帽子，以及一件闪亮的黑色羽绒服，肩膀和领口上也沾满了雪。",
      "相机": "她用左手自拍。",
      "光线": "来自上方和前方的柔和冷光，在她的脸颊上营造出微妙的光晕，并在羽绒服上形成柔和的高光。",
    }
  },
  "negative_prompt": {
    "描述": [
