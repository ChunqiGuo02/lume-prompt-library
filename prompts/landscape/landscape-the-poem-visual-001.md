---
id: "landscape-the-poem-visual-001"
title: "清明诗韵微缩景"
category: landscape
subcategory: "12_手工玩具手办"
aesthetic: null
tags: ["清明", "古诗", "国风", "3D", "微缩", "杏花", "春雨", "牧童"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
Poem Title: 【清明】
Dynasty / Author: 【唐・杜牧】
Core Verses Context: 清明时节雨纷纷，路上行人欲断魂。借问酒家何处有？牧童遥指杏花村。(Visual Focus: A rainy spring scene. A detailed small village with 杏花 (apricot blossoms), a traveler with an umbrella, a shepherd boy pointing, wet stone paths, mud, rain streaks, lush wet vegetation, rustic tavern flag.)

## 中文译文（源站提供）
这是一幅垂直视角（9:16比例）、细节极为丰富的45°自上而下的等轴测微缩3D卡通场景。画面中心部分生动再现了一首中国古代诗歌中的意象，构图丰富且建模精细。

该场景采用了柔和但触感强烈的PBR（物理基础渲染）纹理，同时运用了哑光材质（例如手工雕刻的效果）。
