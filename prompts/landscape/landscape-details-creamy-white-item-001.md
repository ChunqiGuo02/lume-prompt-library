---
id: "landscape-details-creamy-white-item-001"
title: "雪夜奢华冬装时尚摄影，展现活力女性动态姿态"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: japanese-zen-garden
tags: ["冬季", "雪景", "女性", "开心", "米白", "夜景", "时尚", "摄影"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
version: "1.0.0"
related_to: ["landscape-details-creamy-white-item-002"]
---
...
# 正文 prompt
{
  "image_generation_request": {
    ...
    "subject": {
      "identity": "Young adult woman, {"subject inspiration" "Shakira-inspired likeness"}",
      "pose": {
...
```json
{
  "image_generation_request": {
    ...
    "quality": "8K / 超高细节",
    "subject": {
      "identity": "年轻成年女性，{\"subject inspiration\" \"夏奇拉风格的肖像\"}",
      "pose": {
        "description": "充满活力的芭蕾舞姿，自然而愉悦",
        "position": "单腿平衡，另一条腿弯曲高高抬起，身体略微倾斜",
        "arms": "一只手臂抬起，张开手掌接住雪花，另一只手臂随动作流动"
      },
      "expression": {
        "mood": "真诚快乐，充满活力",
        "features": "自然灿烂的笑容，嘴唇微张，眼睛闪烁着情感，脸颊因寒冷而泛红"
      },
      "physical_details": {
        "skin": "逼真的纹理，细微的毛孔，微妙的不对称，柔和的高光，无塑料感平滑处理",
        "hair": "长长的深色头发从毛线帽中流泻而出，融化的雪水使发丝湿润地贴在脸颊/额头上"
      }
    },
    "apparel": {
      "theme": "单色奶油白冬季造型",
      "layers": [
        {
          "item": "超大号羽绒服",
          "details": "厚实的奶油白色，蓬松的质感，可见的缝线，逼真的羽绒体积和压缩褶皱"
        },
        {
          "item": "短款连帽衫",
          "details": "奶油白色柔软棉质，轻微褶皱，穿在夹克里面"
        },
        {
          "item": "高腰打底裤",
          "details": "哑光弹力面料，奶油白色，膝盖和臀部有微妙的张力"
        }
      ],
      "accessories": [
        {
          "item": "针织毛线帽",
          "details": "超蓬松，可见的纱线纹理，奶油白色"
        },
        {
          "item": "连指手套",
          "details": "长长的奶油白色蓬松纤维，接住飘落的雪花"
        }
      ],
      "footwear": {
        "style": "月球靴风格系带冬靴",
        "details": "白色毛皮内衬，逼真的橡胶鞋底，边缘有积雪"
      }
    },
    "environment": {
      "setting": "现代豪华建筑的夜间外部",
      "architecture": "带有三角形图案的锋利几何木结构",
      "props": "附近停放的黑色豪华 SUV，部分被霜雪覆盖",
      "ground": "厚实不平的雪毯，有可见的脚印和受压点",
      "weather": "大雪纷飞，大片雪花在空中凝固，略带模糊"
    },
    "lighting_and_atmosphere": {
      "primary_lighting": "寒冷的蓝白色环境冬季光线",
      "secondary_lighting": "建筑内部/窗户透出的温暖橙色光芒",
      "visual_effects": [
        "电影色彩分离",
        "背景柔和的散景高光",
        "浅景深",
