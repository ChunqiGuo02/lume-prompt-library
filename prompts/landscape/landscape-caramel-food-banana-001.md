---
id: "landscape-caramel-food-banana-001"
title: "超写实香蕉焦糖挞特写，奢华甜点摄影"
category: landscape
subcategory: "03_创意广告品牌设计"
aesthetic: null
tags: ["甜点", "香蕉", "焦糖", "挞", "开心果", "巧克力", "暖调", "写实"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: null
...
```json
{
"prompt": "超写实特写食物摄影，拍摄一个新鲜出炉的香蕉焦糖挞，质朴的金棕色酥皮外壳，带有片状质感，内馅是奶油焦糖蛋奶沙司，顶部铺着完美切片的微烤熟香蕉，淋上金黄色的焦糖酱，撒上碎开心果和细小的巧克力卷，勺子舀出一部分，展示出奶油焦糖和香蕉层诱人的横截面，温暖的烘焙店环境，柔和的背景虚化，背景中可见其他甜点：巧克力松露、迷你蛋白酥（配浆果）和撒有杏仁片的羊角面包，木质质朴的砧板表面，黄金时段光线，柔和的散景，奢华甜点美学，高度细致的纹理，照片级真实感，电影级食物摄影，8k 分辨率，使用 Sony A1 85mm f/1.4 拍摄，挞和勺子对焦锐利，温暖浓郁的调色板，包含焦糖棕色、香蕉黄色和微妙的绿色点缀",
"negative_prompt": "模糊、低分辨率、jpeg 伪影、卡通、插画、绘画、塑料感、假食物、变形的勺子、比例失调、文字、水印、签名、标志、过饱和、褪色、刺眼闪光、冷光、3d 渲染、cgi、玩具食物、娃娃屋微缩模型",
"aspect_ratio": "4:5",
"seed": -1,
"cfg_scale": 7.5,
"steps": 40,
