---
id: landscape-the-edge-ocean-0071
title: "世界尽头的巨瀑与彩虹奇观"
category: landscape
subcategory: "15_特定场景环境生成"
aesthetic: null
tags: ["海洋", "悬崖", "瀑布", "遗迹", "彩虹", "闪电", "船只", "深渊"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
```json
{
  "intent": "一幅宏伟而令人眩晕的构图，描绘了一个大陆尺度的构造裂谷，巨大的深海洋流在一个完美的几何悬崖处终止，倾泻入一个充满分层云层和闪电的无底大气虚空。",
  "frame": {
    "aspect_ratio": "21:9 超宽屏",
    "composition": "画面采用消失点透视，沿着世界的边缘延伸至无限。左上象限被黑暗、汹涌的大西洋规模海洋所占据，而右侧和底部则展现了垂直落入朦胧、多层云层深渊的恐怖规模。",
    "style_mode": "原始写实主义，具有超精确的流体动力学和大气瑞利散射，以确立巨大的尺度感。"
  },
  "subject": {
    "identity": "一座古老的巨石灰岩桥梁遗迹，宽四公里，曾横跨裂隙，但现在在悬崖处突然终止，边缘参差不齐，断裂破碎。",
    "wardrobe": "一艘微小、几乎看不见的研究船停泊在瀑布边缘附近，通过尺寸对比提供了巨大的尺度感。",
    "placement": "这座废弃的结构锚定在构成世界尽头的“大陆架”的玄武岩基岩中。"
  },
  "environment": {
    "location": "“大裂口”——一个非欧几里得的地理终点，地壳在此简单地终止，展现出地质地层的垂直横截面，然后下降到对流层。",
    "atmosphere": "极端的大气深度，可见的“云瀑”，海洋水滴中的水分在初级海平面以下数千米处凝结成次级天气系统。",
    "weather": "来自深渊的剧烈上升气流在边缘形成喷雾涡流，而裂谷的遥远深处则被内部的云间闪电照亮。"
  },
  "camera": {
    "sensor_format": "大画幅数码相机 (Phase One IQ4 150MP)，针对最大像素细节和峡谷深影中的宽动态范围进行了优化。",
    "lens": "14mm 超广角直线镜头，以夸大透视畸变和垂直度的巨大尺度。",
    "camera_position": "悬臂式视角，位于虚空数百米之外，回望世界边缘和倾泻而下的海洋。",
    "aperture_depth_of_field": "f/11，以确保前景中倾泻而下的水流纹理和远处的地质地层以清晰的锐度被捕捉。"
  },
  "lighting": {
    "type": "刺眼的高空阳光以 45 度角照射，在垂直悬崖面的陨石坑和裂缝中形成深邃、清晰的阴影。",
    "color_temperature": "5400K（中性日光），由于大气影响，深渊阴影深处显著偏向 12000K（深天蓝色）"
  }
}
```
