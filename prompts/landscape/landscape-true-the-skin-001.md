---
id: "landscape-true-the-skin-001"
title: "超写实海滩度假女性肖像生成"
category: landscape
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["海滩", "女性", "草帽", "墨镜", "沙滩", "阳光", "休闲", "度假"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
# 正文 prompt
{
  ...
  "clothing_and_accessories": {
    ...
    "hat": "wide-brim straw hat decorated with {"hat decoration" "seashells and starfish"} on the side",
    "jewelry": [
...
```json
{
  ...
  "identity_reference": {
    "use_uploaded_photo": true,
    "face_preservation": "严格",
    "no_facial_modification": true,
    "no_identity_change": true
  },
  "subject": {
    "gender": "年轻女性",
    "pose": "以近距离休闲肖像姿势，轻松地躺在沙滩上，脸轻轻地靠在一只手上",
    "expression": "宁静、平静、度假心情",
    "hair": {
      "color": "棕色",
      "style": "短款香奈儿波波头，带有柔和的浅色挑染，蓬松自然",
      "texture": "光滑逼真"
    },
    "eyes": "棕色",
    "skin": "自然晒黑，带有温暖的阳光光泽",
    "makeup": "极简、自然妆容，带有淡色唇彩"
  },
  "clothing_and_accessories": {
    "sunglasses": "圆形太阳镜，带有细金属边框和深色反光镜片",
    "hat": "宽边草帽，侧面装饰有 {\"hat decoration\" \"贝壳和海星\"}",
    "jewelry": [
      "手腕上带有贝壳细节的金色手链",
      "手指上带有明亮反光石的戒指"
    ]
  ...
  "environment": {
    "location": "阳光明媚的热带海滩",
    "background": "柔和模糊的蓝色海洋，带有轻柔的波浪，远处可见一艘小船",
    "ground": "细沙，轻轻覆盖脚部"
  },
  "pose_details": {
    "legs": "向后弯曲，呈放松的度假姿势",
    "body_language": "宁静、放松、假日氛围"
  },
  "lighting": {
    "type": "自然阳光",
    "quality": "温暖、柔和、逼真",
    "effect": "帽子投下的柔和阴影，皮肤上的发光高光"
  },
  "camera": {
    "shot_type": "特写生活方式肖像",
    "lens": "50mm 单反镜头",
    "focus": "面部、太阳镜、珠宝和皮肤纹理清晰对焦",
    "depth_of-field": "柔和的背景虚化"
  },
  "color_palette": {
    "tones": "温暖的夏季色彩，自然的肤色，海洋蓝色，沙色中性色"
  },
  "aesthetic": {
    "mood": "热带、放松、度假感觉",
    "style": "高端旅行生活方式摄影",
    "realism": "极致的超写实主义，皮肤、头发、沙子和反光都清晰锐利"
  },
  "constraints": {
    "no_artificial_stylization": true,
    "no_face_distortion": true,
