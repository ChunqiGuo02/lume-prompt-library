---
id: "landscape-face-the-skin-001"
title: "超现实恐怖人脸撕裂效果"
category: landscape
subcategory: "04_创意脑洞特效合成"
aesthetic: null
tags: ["写实", "恐怖", "超现实", "骷髅", "人像", "深色", "对比", "光影"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
# 正文 prompt
{
  ...
  "quality": "ultra high",
  "resolution": "8k",
  "signature": "{"signature" "Karim Sat0oshi"}"
}

## 中文译文（源站提供）
```json
{
  "prompt": "超写实、电影概念艺术肖像特写：一名年轻男子，身穿黑色高领毛衣，头戴黑色 New Era 棒球帽，双手将脸部皮肤向两侧拉开，露出右脸下方逼真的人类头骨。裸露的皮肤看起来有弹性、湿润、内脏感十足，可见汗珠、栩栩如生的毛孔和极致的纹理细节。她双眼圆睁，表情强烈，传达出震惊和恐惧。戏剧性、情绪化的电影灯光，具有强烈对比、深邃阴影和黑暗、极简的背景。超现实恐怖美学，微距摄影效果，超细节，8K 分辨率，照片级真实感。",
  "negative_prompt": "卡通、动漫、插画、3D 渲染、CGI、素描、绘画、模糊、低分辨率、低质量、解剖结构不佳、手指扭曲、多余手指、手部畸形、面部变异、文字、水印、标志、签名、构图杂乱",
  "aspect_ratio": "3:4",
  "style": "超现实恐怖、电影感、超写实",
  "quality": "超高",
  "resolution": "8k",
