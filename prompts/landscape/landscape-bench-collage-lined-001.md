---
id: "landscape-bench-collage-lined-001"
title: "秋日时尚女性写真预设"
category: landscape
subcategory: "15_特定场景环境生成"
aesthetic: null
tags: ["秋季", "时尚", "穿搭", "户外", "暖色调", "大地色", "氛围感", "人像"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
# 正文 prompt
Try with Google Gemini Nano Banana
Prompt:~
...
## 中文译文（源站提供）
制作一幅高分辨率的秋季时尚拼贴画，由12张单独的照片组成，排列成整齐的网格，每张照片都有一个时尚的年轻女子，她有着不同的随机面孔和发型，与任何真实或名人都不相似。让她摆出各种舒适的户外姿势：坐在一个旧玻璃温室旁，拿着一个外卖咖啡杯，沿着一条长满橙色树叶的林荫小路走，独自坐在森林深处的木凳上，靠在公园围栏上，拿着皮革手提包在石阶上休息，穿着短裙和及膝靴躺在绿色公园长椅上，侧身坐在长椅上，站在一个平静的橙树湖畔，站在被高大树木环绕的雾蒙蒙的小路上。服装应混合长羊毛外套、超大毛衣、围巾、宽边帽、中性裤子、针织连衣裙和土色调的靴子，如米色、棕色、奶油
