---
id: branding-profile-flavor-tonal-0159
title: "四款甜品创意广告视觉方案"
category: branding
subcategory: "03_创意广告品牌设计"
aesthetic: null
tags: ["美食", "甜品", "摄影", "简约", "高级", "浅灰", "巧克力", "红丝绒"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
```json
{
  "production_manifest": {
    ...
    "technical_stack": {
      "hardware": {
        "camera": "ARRI Alexa 65",
        "lens_profile": "大画幅电影定焦镜头"
      },
      "film_emulation": {
        "stock": "Kodak Portra 400",
        "characteristics": ["细颗粒", "自然肤色", "暖色高光"]
      },
      "lighting_rig": {
        "style": "电影柔和光晕",
        "atmosphere": "永恒室内",
    ...
    "artistic_direction": {
      "visionary_style": "Greta Gerwig",
      "composition_rule": "图形中心对称",
      "physics_engine": "悬浮动画 / 零重力",
      "background_specification": "平坦米白 / 影棚骨色"
    },
    "variant_registry": [
      {
        "id": "VAR-001",
        "flavor_profile": "黑巧克力片燕麦",
        "tonal_emotion": "俏皮、活泼而别致",
        "ingredients": {
          "primary_solids": ["黑巧克力片曲奇"],
          "fluid_fx": ["燕麦奶飞溅"],
          "debris": ["曲奇碎屑"]
        }
      },
      {
        "id": "VAR-002",
        "flavor_profile": "红丝绒",
        "tonal_emotion": "大胆、俏皮别致",
        "ingredients": {
          "primary_solids": ["红丝绒蛋糕块"],
          "fluid_fx": ["奶油芝士糖霜漩涡"],
          "debris": ["可可粉", "细红蛋糕屑"]
        }
      },
      {
        "id": "VAR-003",
        "flavor_profile": "开心果马卡龙",
        "tonal_emotion": "精致、俏皮别致",
        "ingredients": {
          "primary_solids": ["开心果马卡龙"],
          "fluid_fx": ["奶油夹心漩涡"],
          "debris": ["碎开心果仁"]
        }
      },
      {
        "id": "VAR-004",
        "flavor_profile": "草莓酥饼",
        "tonal_emotion": "甜美、俏皮而别致",
        "ingredients": {
          "primary_solids": ["新鲜草莓片"],
          "fluid_fx": ["鲜奶油漩涡"],
          "debris": ["酥饼碎屑"]
        }
      }
