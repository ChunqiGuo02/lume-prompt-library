---
id: branding-the-cake-reveal-0140
title: "品牌标志蛋糕创意设计"
category: branding
...
# 正文 prompt
Cake Logos by NANO BANANA PRO on @BasedLabsAI 🍰🍌
Prompt👇🏻 https://t.co/lFyAJyGbmm
...
## 中文译文（源站提供）
“制作一个超现实的数字插图，将蛋糕精心风格化，就像一个放在原始白色桌子上的[LOGO]。展示它被咬了一部分，露出多层美味的层（海绵、糖霜、面包屑），打破幻觉。用咬痕中错综复杂的细节捕捉惊喜的时刻。使用略微高出的角度强调现实外壳和蛋糕内部之间的对比。用柔和的漫射光照亮场景，增强纹理，并投射微妙的阴影以增加深度。保持背景最小和明亮，专注于欺骗性的甜点。在模仿外部的物体上为蛋糕层使用充满活力、俏皮的调色板。以具有异想天开色彩的照片级真实感风格渲染，使展示在视觉上令人信服。开胃”
