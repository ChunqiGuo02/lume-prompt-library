---
id: branding-the-products-side-0396
title: "选择你的阵营"
category: branding
subcategory: "03_创意广告品牌设计"
aesthetic: null
tags: ["暗调", "写实", "霓虹", "氛围", "竞争", "品牌", "广告", "烟雾"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
## 中文译文（源站提供）
一个戏剧性的电影场景，两个竞争对手的产品并排放置在一个定制设计的环境中，在视觉上反映了他们的身份。构图应包括高对比度的照明、雾、霓虹灯等大气效果以及超细节的纹理。在产品下方或背后加入一个强大的3D口号，采用符合场景情绪的大胆风格化排版。产品必须通过颜色、灯光和摆放来体现[品牌A]和[品牌B]的精髓。超现实、喜怒无常的色调，1:1方形格式，具有锐利的景深和高分辨率。
