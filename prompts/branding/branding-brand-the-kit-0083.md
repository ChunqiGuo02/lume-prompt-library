---
id: branding-brand-the-kit-0083
title: "个人品牌视觉形象展示"
category: branding
subcategory: "03_创意广告品牌设计"
aesthetic: nordic-minimal
tags: ["现代", "极简", "高级", "暖色调", "肖像", "品牌", "样机", "T恤"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
## 中文译文（源站提供）
**设计要求：**
- 设计一个简洁、现代的个人品牌展示素材，适合女性创作者或企业家使用，需要体现统一的视觉识别风格。
- 背景采用柔和的中性色调，展示一个极简风格的品牌资料包：
  - 一张带装饰性文字的框架内肖像照；
  - 一个圆形徽标，上面印有一个手绘的人脸图案；
  - 品牌周边产品，如印有相同徽标的白色T恤、挎包和陶瓷马克杯。
- 社交媒体布局采用网格形式，展示肖像照片、幕后内容、名言短句以及温暖的米色、奶油色和浅土褐色调的品牌信息块。
- 整体风格具有创意性和现代感，采用柔和的自然光线、高
