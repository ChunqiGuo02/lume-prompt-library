---
id: branding-motion-surface-droplets-0459
title: "高端饮品广告视觉设计模板"
category: branding
subcategory: "03_创意广告品牌设计"
aesthetic: japanese-zen-garden
tags: ["商业", "摄影", "超写实", "雀巢", "拿铁", "咖啡", "罐装", "金色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
```json
{
  "master_prompt": {
    ...
    "module_1_image_1_style": {
      "subject": {
        "type": "塑料蛋白饮料瓶",
        "color": "{\"bottle color\" \"深哑光蓝\"}",
        "surface_details": "瓶身布满冷凝水珠",
        "label_text_visible": [
          "牛奶和酸奶",
          "模型",
          "蛋白质",
      ...
      "liquid_and_motion": {
        ...
        "texture": "光滑、奶油状、流动感",
        "motion": "围绕瓶底和瓶身四周向上飞溅的漩涡"
      },
      "floating_elements": {
        "blueberries": "不同深度的完整和半个蓝莓",
        "mint_leaves": "带有可见叶脉的小绿薄荷叶",
        "droplets": "悬浮在空中的牛奶水滴和球体"
      },
      "background": {
        "color_gradient": "深蓝色到暖琥珀色",
        "bokeh": "散布着柔和的圆形光斑"
      },
      "surface_and_reflection": {
        "base": "哑光地面，有少量液体积聚",
        "shadow_style": "瓶子下方柔和的分离阴影"
      }
    },
    "module_2_image_2_style": {
      "subject": {
      ...
      "liquid_and_motion": {
        "liquid_color": "咖啡和牛奶混合物",
        "motion": "从底部喷溅而出的液体",
        "droplet_behavior": "向外散布的细小水滴"
      },
      "floating_elements": {
        "coffee_beans": "罐子周围漂浮着完整的烘焙咖啡豆",
        "steam": "向上升腾的浓密蒸汽",
        "embers": "背景中微小的发光颗粒"
      },
      "background": {
        "color_palette": "深棕色、琥珀色、金色",
        "atmosphere": "温暖、烟雾缭绕、浓烈"
      },
      "surface_and_reflection": {
        "base": "湿润的表面"
      }
