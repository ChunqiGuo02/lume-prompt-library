---
id: illustration-ink-art-reference-0267
...
# 正文 prompt
{
  ...
  "visual_elements": {
    "overlays": [
      "{"overlay element 1" "cryptic handwritten notes"}",
...
```json
{
  ...
  "face_likeness": {
    ...
    "usage": "作为比例和相似度的主要面部参考"
  },
  "portrait_style": {
    "composition": "戏剧性的侧面肖像",
    "mood": "强烈、混乱、情感充沛",
    "art_direction": "富有表现力的水墨速写与混合媒体插画"
  },
  "subject_details": {
    "pose": "侧面",
    "presence": "大胆而叛逆",
    "wardrobe": {
      "type": "深色抽象夹克",
      "treatment": "厚重的纹理、棱角分明的笔触、粗犷的墨迹细节"
    }
  },
  "visual_elements": {
    "overlays": [
      "{\"overlay element 1\" \"神秘的手写笔记\"}",
      "符号和抽象字形",
      "环绕面部轮廓的碎片化文字"
    ],
    "meaning": "暗示内心冲突、隐藏的思绪和心理深度"
  },
  "art_technique": {
    "linework": "锐利的钢笔细节与富有冲击力的笔触",
    "effects": [
      "墨水飞溅",
      "受控的混乱",
      "分层纹理"
    ],
    "style_blend": "编辑插画与概念艺术的融合"
  },
  "background": {
    "texture": "老旧的羊皮纸",
    "tone": "苍白、颗粒感、去饱和",
