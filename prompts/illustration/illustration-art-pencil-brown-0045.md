---
id: illustration-art-pencil-brown-0045
title: "冬日雪景中两位女星自拍插画"
    ...
    "characters": [
      ...
      },
      {
        ...
        "features": {
          "hair": "深棕色，梳成高发髻",
          "eyes": "浅棕色/淡褐色",
          "outfit": "优雅的连衣裙，肩部有白色羽毛细节",
          "expression": "温暖、温柔的笑容"
        }
      }
    ],
    "objects": {
      "device": "带三摄像头镜头的现代智能手机",
      "action": "正在拍摄特写自拍"
    },
    "background": {
      "location": "白雪皑皑的户外度假村",
      "structures": ["木制山区小屋", "溜冰场"],
      "nature": "白雪覆盖的松树"
    }
  },
  "technical_details": {
    "color_palette": ["柔和粉", "奶油色", "蓝色", "棕色"],
    "shading_style": "平滑渐变与清晰轮廓",
    "aspect_ratio": "肖像"
  }
}
```
