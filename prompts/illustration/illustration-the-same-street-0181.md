---
id: illustration-the-same-street-0181
title: "现实与卡通双重视角的街头人像创作"
category: illustration
subcategory: "07_艺术插画创意风格"
aesthetic: null
tags: ["写实", "插画", "卡通", "暖调", "黄昏", "街景", "女孩", "建筑"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "21:9"
...
## 中文译文（源站提供）
{ "Prompt": "分析上传的参考图像，并创建一张 64K DSLR 分辨率的都市街头肖像。保留参考图像中的面部，不改变面部特征，保持相同的眼神、表情、妆容和纹理细节，保持参考图像中的发型。将此人以放松的慵懒姿势（靠在路边，手肘放在膝盖上，下巴托在手里）重现在一条安静的城市街道的水泥路边，保持其自然表情。在旁边放置一个较小的手绘卡通版同一个人，具有相同的面部特征、表情和前卫的街头服饰（腰间系着宽松的复古乐队 T 恤、高腰破洞牛仔短裤、厚底白色运动鞋和短款黑色皮夹克），以柔和的动画风格绘制，线条清晰，暖色调柔和，与怀旧复古的黄金时刻氛围相匹配。背景：纹理化的鹅卵石路面，带有细微的苔藓斑点，风化的建筑立面，带有柔和的赤陶色和灰色调，远处褪色的路牌，柔和自然的黄金时刻日光。混合媒体构图，融合了超现实街头摄影和异想天开的插画，唤起身份和自我反思的主题。电影般的真实感，Octane 渲染质量，主体面部和卡通人物清晰对焦，浅景深使背景略微模糊，服装面料和路面具有精细的纹理细节。", "text_elements": "@seven_cuz at the bottom", "aspect_ratio": "4:3" }
