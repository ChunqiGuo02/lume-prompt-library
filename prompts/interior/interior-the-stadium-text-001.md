---
id: "interior-the-stadium-text-001"
title: "四大足球场3D卡通模型"
category: interior
subcategory: "01_建筑室内空间设计"
aesthetic: null
tags: ["3D", "微缩", "球场", "足球", "体育", "建筑", "卡通", "简约"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
# 正文 prompt
3D Stadiums by NANO BANANA PRO on @atomu_ai 🏟️🍌
Prompt👇🏻 https://t.co/RlRG6sE9vr
...
Beautiful workflow on Atomu👇🏻🔥
Workflow link: https://t.co/3nv33riwuI

## 中文译文（源站提供）
呈现一个清晰的45°自上而下等距微型3D卡通场景[STADIUM]，具有柔和精致的纹理、逼真的PBR材料和柔和逼真的灯光。使用干净的纯色[COOR]背景。在顶部中心，以粗体显示该体育场的名称，然后在其正下方以中号文本显示其实际座位容量，并将与该体育场相关的官方标志放置在容量下方。所有文本必须自动匹配背景对比度（白色或黑色）。居中布局，方形1080x1080尺寸。
