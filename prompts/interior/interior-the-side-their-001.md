---
id: "interior-the-side-their-001"
title: "病毒式封面图"
category: interior
subcategory: "06_图文排版视觉传达"
aesthetic: null
tags: ["缩略图", "美食", "早餐", "牛油果", "吐司", "厨房", "亮色调", "高饱和"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
## 中文译文（源站提供）
使用图1中的人物设计一个病毒式视频缩略图。面部一致性：保持人的面部特征与图1完全相同，但改变他们的表情，让他们看起来兴奋和惊讶。动作：将人摆在左侧，将手指指向画面的右侧。主题：在右侧，放置一张高质量的[美味的鳄梨吐司]图片。图形：添加一个大胆的黄色箭头，将人的手指连接到吐司上。文本：在中间覆盖巨大的流行风格文本：'3分钟搞定!（3分钟后完成！）。使用粗白色轮廓并投下阴影。背景：模糊明亮的厨房背景。高饱和度和对比度。
