---
id: "interior-the-books-must-001"
title: "印度多语言艺术书籍封面展示"
category: interior
subcategory: "06_图文排版视觉传达"
aesthetic: null
tags: ["书店", "印度", "书籍", "艺术", "多语", "文化", "摄影", "写实"]
recommended_models: []
recommended_params:
  aspect_ratio: "9:16"
  quality: null
...
## 中文译文（源站提供）
我想创建一个杂志页面，展示在一家印度书店中的专业且逼真的摄影作品。这家书店出售用印度各种语言出版的书籍。照片中应包含印地语、孟加拉语、马拉地语、泰卢固语、泰米尔语、乌尔都语、古吉拉特语和卡纳达语版本的书籍封面。这些书籍都是虚构的，书名与“艺术”相关，但看起来要像真实的书籍封面，而不是一组摆拍的作品。出版商必须是“OpenAI”。所有文字都必须清晰可见。拍摄这些照片的目的是为了展现印度语言的多样性。这个页面应该完全由图片组成，不要有任何元文本或标题。画面比例：1440x2560（竖屏）。
