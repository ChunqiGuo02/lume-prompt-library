---
id: "interior-reference-the-skin-001"
title: "银发精灵耳少女在日式居酒屋的夜拍写真"
category: interior
subcategory: "05_人物肖像与写实摄影"
aesthetic: japanese-zen-garden
tags: ["精灵", "银发", "蓝眼", "自拍", "居酒屋", "日式", "暖光", "黑色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
```json
{
  ...
  "subject": {
    "type": "woman_identity_perfectly_matched_to_reference_image",
    "framing": "特写_高角度_自拍_肖像_室内",
    "identity_lock": "保持与参考图像完全相同的面部特征和骨骼结构",
    "features": {
      "eyes": "如参考所示的性感_半闭_睡眼_配有浓烈的榛灰色隐形眼镜",
      "hair": "发型和发色与参考图像完全匹配",
      "expression": "迷人_诱惑的表情_舌头略微俏皮地伸出_配以半闭的勾人眼神"
    },
    "skin_texture": {
      "description": "水润_光泽的肌肤_脸颊上带有明显的鲜艳粉色腮红",
      "details": [
        "光滑_无毛孔的妆面_带有湿润的光泽",
        "浓烈的粉色腮红_晕染至脸颊和鼻梁",
        "在昏暗灯光下_柔和温暖的肤色底调"
      ],
      "makeup": "迷人的夜间妆容_配有亮泽的粉色唇部和精致锐利的飞翼眼线"
    },
    "pose_structural_lock": {
      "overall": "随意的自拍姿势_头部倾斜_直接向上看向镜头",
      "arms": "右臂部分可见_以高角度握持相机",
      "hands": "左手放在颈部附近_增添亲密感",
      "shoulders": "略微向前弓起_营造出动态而亲密的视角"
    }
  },
  "apparel_specification": {
    "outfit_main_piece": {
      "description": "与参考图像完全相同的服装复制品",
      "material": "与参考所示的材质和纹理相匹配",
      "silhouette": "与参考图像相同的版型和设计",
      "details": "复制参考中的所有缝线和镂空细节"
    },
    "accessories": {
      "necklace": "与参考中匹配的项链"
    }
  ...
  "environment": {
    "setting": "夜晚_富有氛围的日式居酒屋或传统餐厅",
    "lighting": "昏暗_情绪化的室内灯光_带有温暖的琥珀色调和脸部凉爽的紫色镜头光晕",
    "background": "模糊的木墙_装饰着传统的日式书法菜单牌匾和远处的食客",
    "atmosphere": "活泼_亲密的夜生活氛围_带有一种随意的乐趣感"
  },
  "realism_and_rendering": {
    "style": "抓拍的社交媒体快照摄影",
    "camera": "高端智能手机前置摄像头_带有轻微的广角畸变和浅景深",
    "image_quality": "超现实的皮肤纹理"
  }
}
```
