---
id: "interior-subject-type-dark-001"
title: "夜景少女温柔写真，复古格纹裙装搭配柔和妆容"
category: interior
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["肖像", "夜晚", "少女", "阳台", "建筑", "格纹", "盘发", "暖色调"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
## 中文译文（源站提供）
{ "composition": { "framing": "垂直肖像构图", "shot_type": "中景，从腰部到头部", "camera_angle": "与视线齐平，略微向右倾斜", "subject_position": "画面右中", "pose": "四分之三侧面，面向左侧，头部转向镜头", "negative_space": "大片黑暗天空占据画面上半部分", "depth_of_field": "景深从浅到中等，主体清晰对焦，背景柔和模糊" }, "subject": { "type": "女性形象主体", "age_appearance": "年轻成人", "expression": "柔和、平静、略带好奇", "gaze": "与镜头直接眼神交流", "skin_tone": "白皙，带暖色调", "facial_features": { "eyes": "大而深棕色，对比度增强", "cheeks": "腮红明显，呈玫瑰色", "lips": "柔和的红粉色，哑光质地", "nose": "自然形状，带有微妙高光" }, "hair": { "color": "深棕色", "style": "凌乱的盘发，有几缕发丝散落在脸旁", "texture": "光滑，略带飞发" } }, "wardrobe": { "outfit_type": "连衣裙搭配叠穿衬衫", "dress": { "pattern": "格子", "colors": ["柔和粉", "米色", "灰色"], "fit": "修身胸衣" }, "blouse": { "color": "米白色", "fabric": "轻薄，半透明", "sleeves": "短泡泡袖，带有柔软的荷叶边下摆" }, "style_influence": "柔和复古 / 田园风美学" }, "lighting": { "primary_light": "机顶闪光灯", "light_quality": "硬朗的正面光", "direction": "正面，略高于视线", "effect_on_subject": "面部和躯干被明亮照亮，边缘清晰", "background_lighting": "环境城市灯光和室内灯光", "shadow_behavior": "面部阴影极少，主体后方略有衰减" }, "color_palette": { "dominant_colors": ["黑色", "柔和粉", "奶油色", "暖米色"], "accent_colors": ["暖黄色灯光", "冷蓝色窗户光"], "overall_tone": "暖色调主体衬托冷暗背景" }, "background": { "environment": "夜间室外住宅区", "elements": [ "前景阳台栏杆", "房屋和建筑", "带有暖色室内灯光的窗户", "漆黑的夜空" ], "setting_mood": "宁静、亲密的夜晚氛围" }, "artistic_style": { "aesthetic": "柔光夜间肖像", "mood": "浪漫、温柔、略带梦幻", "influences": ["社交媒体肖像摄影", "现代田园风"], "retouching_style": "以美颜为主，强调皮肤平滑度和腮红" }, "technical_details": { "camera_type_assumption": "智能手机相机", "lens_equivalent": "广角到标准（等效 24–35mm）", "flash_usage": "已启用", "iso_appearance": "低到中等，噪点极少", "sharpness": "主体清晰度高，背景降低", "contrast": "中等，高光提升" }, "post_processing": { "skin_smoothing": "中等", "color_grading": "暖色高光，中性阴影", "blush_enhancement": "强", "eye_enhancement": "微妙的亮度和对比度增加" }
