---
id: "interior-foreground-slightly-the-001"
title: "光影中的回眸少女：电影感氛围人像"
category: interior
subcategory: "05_人物肖像与写实摄影"
aesthetic: japanese-zen-garden
tags: ["女生", "逆光", "暖调", "胶片", "室内", "文艺", "复古", "安静"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
```json
{
  ...
  "clothing": {
    "upper_body": "深色、有型的夹克或西装外套，可能有细条纹或纹理面料。",
    "visibility": "大部分被阴影和前景元素遮挡。"
  },
  "hair": {
    "color": "深棕色至黑色。",
    "style": "长发，散开的蓬松波浪，略显凌乱。",
    "lighting_interaction": "强烈的逆光，在散落的发丝上形成发光的轮廓光效果。"
  },
  "face": {
    "skin_tone": "白皙/苍白，暖色调。",
    "features": "柔和的面部结构，杏仁状眼睛，自然眉毛。",
    "makeup": "极简的“裸妆”效果，自然唇色。"
  },
  "accessories": {
    "visible_items": "由于构图和光线，没有清晰可见的物品。"
  },
  "environment": {
    "setting": "杂乱的室内空间，类似于工作室、储藏室或旧书店。",
    "background_elements": "堆满模糊物品、纸张、盒子和塑料包装的木质货架。",
    "foreground_elements": "模糊的半透明物体（可能是玻璃、塑料片或防尘罩），营造出层次感和反光效果。"
  },
  "lighting": {
    "source": "左侧窗户透进的自然阳光。",
