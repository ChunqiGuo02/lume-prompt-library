---
id: "interior-the-indian-casual-001"
title: "印度年轻夫妻厨房共制烤饼的温馨瞬间"
category: interior
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["厨房", "情侣", "欢笑", "温馨", "写实", "暖光", "面粉", "擀面杖"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
```json
{
  "prompt_type": "descriptive_portrait",
  "subject_details": {
    "demographics": "年轻的印度夫妇（一男一女），肤色温暖自然，身材健美。",
    "facial_features": {
      "expression": "两人自然地一起欢笑，捕捉到真诚而愉悦的瞬间，脸颊和鼻子上沾有白色小麦粉（atta）。",
      "eyes": "明亮有神，彼此对视或看向面团。",
      "hair": "女士：凌乱的发髻或散发，随意的居家发型。男士：短而整洁的休闲发型。"
    },
    "apparel": {
      "dress": "女士：休闲棉质库尔蒂（Kurti）或舒适的居家 T 恤。男士：纯色休闲 T 恤和运动裤或短裤。",
      "accessories": "极简（例如，女士佩戴简单的耳环）。",
      "footwear": "赤脚或居家拖鞋。"
    }
  },
  "pose_and_action": {
    "body_position": "两人站在厨房台面旁。一人正在用擀面杖（belan）擀薄饼（roti），另一人则凑近，帮忙或 playfully teasing。",
    "hands": "手上沾有干小麦粉，积极地揉搓面团。"
  },
  "background_environment": {
    "location": "现代印度厨房。",
    "lighting_source": "温暖明亮的厨房顶灯。",
    "objects": {
      "details": "木制擀面板（chakla）、擀面杖（belan）、不锈钢小麦粉容器（dabba）、背景中燃气灶上的平底锅（tawa），一小碗酥油。"
    }
  },
  "technical_specs": {
    "style": "抓拍、居家、超现实、面粉质地和皮肤毛孔细节丰富、电影级灯光。",
    "aspect_ratio": "4:5"
  },
  "constraints": [
    "保持自然的印度面部特征",
  ...
  "output_goal": "创作一幅温馨、超现实的年轻印度夫妇一起烹饪的肖像，捕捉他们在凌乱但舒适的厨房里制作薄饼时欢笑的真诚瞬间。"
}
```
