---
id: "interior-the-gray-she-001"
title: "超写实艺术肖像：笑坐地板的少女与黑白侧颜背景"
category: interior
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["超写实", "肖像", "女性", "笑容", "辫子", "长发", "休闲", "灰调"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
## 中文译文（源站提供）
请根据提供的照片，创作一幅高度细致、专业、超现实的艺术肖像画，保持面部完整。画中女子优雅地坐在地板上，身穿时尚黑色上衣、柔软宽松的灰色牛仔裤和厚实的时尚灰色运动鞋。她留着及腰的波浪长发，其中一半编成辫子。她面带笑容，目光向上。

背景应为艺术性的单色构图（黑白），描绘同一张侧脸的柔和特写。
