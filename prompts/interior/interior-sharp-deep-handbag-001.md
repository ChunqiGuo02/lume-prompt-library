---
id: "interior-sharp-deep-handbag-001"
title: "高端时尚人像摄影提示词模板"
category: interior
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["女性", "优雅", "时尚", "奢华", "晚宴", "黑色", "红色", "暖调"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
    },
    "pose": "Leaning gracefully against a marble counter, one hand holding a {"handbag color" "red"} handbag, body angled slightly to create a dynamic silhouette."
  },
  "attire": {
...
{
  "subject": {
    "description": "一位年轻女性，表情自信而沉着，目光望向镜头之外。",
    "physical_traits": {
      "hair": "蜂蜜金色长直发，柔顺及腰，发根颜色较深。",
      "makeup": "迷人的“晚宴”妆容，特色是犀利的飞翼眼线、精致的眉毛和深勃艮第色或牛血色哑光唇膏。",
      "jewelry": "优雅的钻石款网球项链和精致的耳钉。"
    },
    "pose": "优雅地斜靠在大理石台面旁，一只手拿着一个 {\"handbag color\" \"红色\"} 手提包，身体略微倾斜，营造出动感的轮廓。"
  },
  "attire": {
    "main": "黑色修身无肩带甜心领迷你连衣裙。",
    "accessories": [
      "精致的花卉图案黑色蕾丝连裤袜/丝袜。",
      "亮樱桃红色光面鳄鱼纹压花皮革手提包。"
    ]
  },
  "environment": {
    "setting": "高档、现代的休息室或豪华洗手间内部。",
    "elements": [
      "深红色天鹅绒或软垫吧台装饰。",
      "深色大理石台面配现代哑光黑色水龙头。",
      "大型、造型独特的红色边框镜子，反射出温暖、昏暗的氛围。",
      "背景人物略微失焦，以增加景深。"
    ]
  },
  "lighting_and_color": {
    "palette": "浓郁的深红色、深黑色和温暖的金色肤色。",
    "lighting": "低光氛围光，主体上有锐利的主光，营造出高对比度的明暗效果。",
    "mood": "优雅、忧郁、高级时装感和奢华。"
  },
  "technical_camera_specs": {
    "camera": "高端数码单反相机，可能是 Canon EOS R5 或 Sony A7R IV。",
    "lens": "35mm 定焦镜头，提供广阔而亲密的视角。",
    "settings": {
      "aperture": "f/2.8，用于浅景深（焦外虚化）。",
      "iso": "800，用于低光环境下的轻微颗粒感和纹理。",
      "shutter_speed": "1/125s，以捕捉清晰的细节。"
    },
    "quality": "超逼真、8k 分辨率、电影级灯光、面部特征清晰对焦、逼真的皮肤纹理。"
  }
}
```
