---
id: "interior-the-flash-true-001"
title: "晚宴闪光人像写真"
category: interior
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["复古", "暖色调", "室内", "人像", "写真", "闪光", "白裙", "鲜花"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
# 正文 prompt
stunning 🤩💫
nano banana pro did it again 🍌
you only need input photo + prompt⤵️⤵️
prompt:
{
"meta":{
...
```json
{
  "meta": {
    ...
    "ratio": "4:5 纵向",
    "device": "iPhone 16 Pro",
    "style_reference": "将输入照片调整成这种风格。",
    "look": "黄昏闪光效果、暖色调的复古风格、真实的纹理、逼真的皮肤质感（无需平滑处理）。"
  },
