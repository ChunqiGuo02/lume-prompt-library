---
id: "interior-the-mirror-red-001"
title: "奢华卧室镜前自拍，红裙金饰尽显优雅气质"
category: interior
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["奢华", "优雅", "卧室", "金色", "暖光", "烛光", "吊灯", "古典"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
```json
{
  "image_request": {
    "subject": {
      "description": "一位肤色白皙、留着波浪形黑色长发的优雅女性。",
      "features": {
        "makeup": "大胆的红色唇膏，精致的烟熏眼影，眉毛清晰。",
        "expression": "自信而成熟地凝视镜子。",
        "pose": "镜子自拍姿势，手持一部现代智能手机。"
      },
      "attire": {
        "dress": "一件深宝石红色奢华及地缎面礼服，深 V 领口。",
        "jewelry": "一条精致的金色项链和手腕上配套的金色手链。"
      }
    },
    "environment": {
      "setting": "奢华高端主卧室。",
      "furniture": [
        "带有复古圆形镜子的华丽木制梳妆台。",
        "一张带毛绒米色绗缝床上用品和装饰枕头的大号特大床。",
        "背景中有一个经典的木制衣柜。"
      ],
      "view": "一扇大窗户，窗外是模糊的夜景城市，灯光闪烁。"
    },
    "technical_details": {
      "lighting": "吊灯发出的温暖室内环境光，头发上有柔和的轮廓光。",
      "composition": "中景，视线水平，镜面反射风格。",
      "quality": "8k 分辨率，照片级真实感，电影质感，高对比度。",
      "details": "高保真皮肤纹理，丝绸面料反射，手机壳背面图像清晰。"
    }
  }
}
```
