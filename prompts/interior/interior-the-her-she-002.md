---
id: "interior-the-her-she-002"
title: "车内红发女子夜景写真提示词"
category: interior
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["红发", "卷发", "车内", "夜景", "都市", "冷艳", "露肩", "黑丝"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
# 正文 prompt
{
  "prompt": {
    "subject": {
      ...
      "clothing": "She is wearing a fitted {"top color" "white"} off-shoulder knit top paired with high-waisted charcoal grey shorts and sheer black pantyhose.",
...
```json
{
  "prompt": {
    "subject": {
      "description": "一位年轻女性，齐肩卷曲红发，留着刘海。她皮肤白皙，有浅色雀斑，画着上扬眼线，戴着鼻中隔穿环。她表情妩媚，食指轻轻搭在下唇上。",
      "clothing": "她身穿一件修身的 {\"top color\" \"白色\"} 露肩针织上衣，搭配高腰炭灰色短裤和黑色透明连裤袜。",
      "pose": "她坐在汽车后座上，双腿交叉并蜷缩到胸前，露出穿着透明丝袜的双脚。"
    },
    "environment": {
      "location": "豪华轿车内部，具体是后座。",
      "details": "浅灰色真皮座椅，侧门板上可见菱形缝线图案。头枕上绣有“B”字标志（很可能是宾利）。",
      "background": "透过车窗，可见夜间城市景观，模糊的城市灯光、路灯以及高速公路上行驶车辆留下的光线轨迹。"
    },
    "lighting_and_quality": {
      "lighting": "直射闪光灯摄影，照亮主体，背景较暗。",
      "resolution": "4K 高清画质，头发、皮肤和真皮座椅纹理高度精细。",
      "style": "抓拍、都市夜景美学、写实照片。"
    }
  }
}
```
