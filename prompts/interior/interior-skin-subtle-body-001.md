---
id: "interior-skin-subtle-body-001"
title: "优雅女性身着香槟色礼服倚墙而立"
category: interior
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["写实", "女性", "长发", "黑发", "抹胸", "纱裙", "香槟色", "走廊"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
# 正文 prompt
{
    ...
    "apparel_and_materials": {
        "dress": "luxury strapless mini cocktail dress, soft {"dress color" "champagne beige"} color, multi-layered design: fitted ruched satin-like bodice with subtle vertical pleating, voluminous tulle skirt with multiple sheer layers, ruffled tulle hem with fluffy textured frills, delicate gathered detailing throughout skirt",
...
{
    "subject": {
        "skin": "超精细写实皮肤:1.3，可见毛孔，白皙光滑肤色，微妙的暖中性底色，自然皮肤纹理，锁骨和肩膀处有淡淡的自然光泽，脸颊有非常轻微的自然红晕",
        "facial_features": {
            "core_face": "使用参考图片中的同一张脸，不改变面部特征"
        },
        "hair": "极其长的直黑发，柔顺有光泽，中分，头发顺滑地垂过肩膀，直至下背部，略带自然动感",
        "body_figure": {
            "figure_type": "纤细精致的沙漏型身材:1.1，优雅的女性轮廓",
            "chest": "适中胸部，无肩带结构紧身胸衣凸显自然柔和的乳沟",
            "waist_and_hips": "纤细分明的腰部，平滑过渡到柔和展开的臀部",
            "legs": "修长双腿，比例优雅，膝盖以下部分被及膝裙摆部分遮挡"
        },
        "position_and_proportion": {
            "framing": "四分之三到几乎全身肖像，主体占据画面高度的约 80-85%",
            "composition_rule": "构图略微偏离中心，主体轻轻倚靠在画面左侧的墙壁上，形成自然的对角线流动",
            "main_focus": "整体优雅的轮廓，精致的连衣裙纹理和层次感，脸部和上半身为主要焦点"
        }
    },
    "pose_and_action": {
        "body_pose": "放松地靠墙站立，重心主要在左腿，右腿略微弯曲并交叉在前，自然柔和的 S 形姿态",
        "arms": "双手在小腹前优雅地合拢，手指轻轻交错，展现出自然的张力和柔和感",
        "head_position": "头部正对镜头，略微向下倾斜，表情柔和而富有女性魅力",
        "weight_distribution": "身体重心自然落在后腿上，肩膀放松，臀部略微前倾，形成优雅的曲线"
    },
    "apparel_and_materials": {
        "dress": "奢华无肩带迷你鸡尾酒裙，柔和的 {\"dress color\" \"香槟米色\"}，多层设计：合身的褶皱缎面紧身胸衣，带有微妙的垂直褶皱，蓬松的薄纱裙摆，多层透明薄纱，荷叶边薄纱裙摆带有蓬松的纹理褶边，裙身各处有精致的褶皱细节",
        "shoes": "不清楚可见（可能是裸色或中性高跟鞋）",
        "accessories": "左手戴纤细银戒指，整体首饰极简"
    },
    "scene_and_environment": {
        "location": "现代豪华酒店/公寓走廊",
        "background": "深棕色木质护墙板，带有垂直镶板，温暖哑光饰面，简洁极简的高端内饰",
        "details": "嵌入式天花板照明，微妙的墙壁阴影，d"
    }
}
```
