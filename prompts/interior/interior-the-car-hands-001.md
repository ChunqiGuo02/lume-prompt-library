---
id: "interior-the-car-hands-001"
title: "女机械师在车库中手持扳手，面带自信微笑"
category: interior
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["汽修", "女性", "车库", "油污", "扳手", "写实", "摄影", "深蓝"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
```json
{
  "image_generation_prompt": {
    "subject": {
      "identity": "年轻女机械师",
      "hair": "长长的深棕色头发，微卷，自然垂落，搭在右肩上",
      "facial_features": "柔和的面部特征，略带微笑，直视镜头",
      "skin_details": "脸上（脸颊、额头、下巴）有明显的油污，表明正在进行体力劳动",
      "makeup": "自然妆容，与油污形成对比"
    },
    "apparel_and_accessories": {
      "clothing": "海军蓝色机械师连体工作服（工装裤），顶部拉链未拉，露出里面的灰色圆领背心",
      "jewelry": "多层细银项链，其中一条带有十字架吊坠，小圈耳环",
      "hands": "修剪整齐的指甲（黑色指甲油）与沾满油污的双手形成对比"
    },
    "pose_and_action": {
      "posture": "身体前倾，俯身在一辆打开引擎盖的汽车上方",
      "action": "双手握着一把银色扳手，手臂搭在汽车框架上",
      "expression": "友好、自信，与观众坦诚互动"
    },
    "environment": {
      "setting": "汽车修理店 / 车库内部",
      "background_elements": [
        ...
        "挂有整齐排列的扳手和工具的白色洞洞板墙",
        "放有各种汽车液体和零件的工作台",
        "前景中的汽车引擎盖细节（软管、发动机盖、散热器盖）"
      ]
    },
    "technical_specifications": {
      "quality": "4K 超高清，超现实主义",
      "style": "电影肖像，抓拍摄影风格",
      "lighting": "明亮、均匀的车间照明，柔和的阴影",
      "focus": "主体面部和手部对焦清晰，背景工具略微模糊，景深较浅",
      "texture_details": "牛仔连体工作服、金属工具和油性皮肤的高保真纹理细节"
    }
  }
}
```
