---
id: "interior-hair-skin-satin-001"
title: "性感卧室自拍：金发美女配爱心特效"
category: interior
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["金发", "自拍", "卧室", "黑色", "缎面", "性感", "暖光", "爱心"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
## 中文译文（源站提供）
{
  "prompt": "一位年轻女性在床上摆出诱惑的卧室自拍肖像，她用手肘支撑身体，上半身向前倾斜对着镜头，皮肤白皙如瓷，散发着柔和自然的微光和细腻的质感，一头浓密的长款铂金色波浪发，松散的卷发垂落在肩上并环绕着脸庞，发丝略显凌乱，一双引人注目的大号浅绿色-淡褐色眼睛，画着浓重的黑色飞翼眼线和长长的睫毛，目光强烈而直接地凝视着镜头，丰满而富有光泽的深粉红色-红色嘴唇微微嘟起，身穿一件光泽的黑色缎面吊带裙，细细的意大利面肩带，深 V 领口和高开衩的侧边凸显出曲线，银色项链清晰可见，头顶上方漂浮着粉色心形表情符号，呈现出俏皮的数字叠加效果，卧室背景是米色墙壁，白色床单，带有衣架的黑色衣架，侧面柔和温暖的金色灯光在头发、皮肤和缎面光泽上营造出轮廓光，卷发、嘴唇和锁骨上有微妙的高光，景深较浅，背景有强烈的电影感焦外虚化，逼真的性感私密自拍摄影，头发的丰盈度、卷发、皮肤毛孔、眼线的锐度、缎面质感和自然瑕疵都高度细致，以智能手机特写风格拍摄，略带广角，超高细节，8k 分辨率",
  "negative_prompt": "卡通、动漫、插画、绘画、变形、模糊、低分辨率、塑料皮肤、玩偶般、浓重修容、厚重假睫毛、滤镜、美颜滤镜、磨皮、多余肢体、比例失调、面部不对称、刺眼闪光、冷光、白天、穿着整齐、短发、深色头发、站立姿势、拥挤的房间、除了漂浮的心形以外的文字水印、标志、丑陋、糟糕的解剖结构、闭眼、没有心形、攻击性表情",
  "reference_image": {
    "enabled": true,
    "strength": 0.92,
    "description": "极其强烈的参考，用于精确构图：一位年轻女性，留着长长的铂金色波浪发，躺在床上，用手肘支撑身体，穿着黑色缎面吊带裙，细肩带，深 V 领口，目光强烈地直视镜头，头顶上方漂浮着粉色心形表情符号，温暖的卧室灯光，背景是黑色衣架，营造出诱惑私密的自拍氛围"
  },
  "style": "逼真的性感卧室自拍，私密光泽美学，温暖的金色室内照明与俏皮的数字心形",
  "aspect_ratio": "3:4",
  "lighting": "侧面柔和温暖的金色灯光，头发卷发皮肤和缎面织物上的柔和轮廓光，眼睛嘴唇和锁骨上的微妙高光，舒适的环境光",
  "camera": "智能手机自拍（iPhone 风格），略微从上方拍摄的特写角度，自然的室内暖光，轻微的颗粒感以增加真实感",
  "additional_details": [
    "头发：铂金色，浓密的长款波浪和卷发，柔和的光泽，发丝环绕着脸庞",
    "服装：光泽的黑色缎面吊带裙，细细的意大利面肩带，深 V 领口，高开衩的侧边，丝滑的光泽捕捉着光线",
    "姿势：俯卧/手肘支撑，上半身向前倾斜对着镜头，放松"
  ]
}
