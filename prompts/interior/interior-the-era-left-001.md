---
id: "interior-the-era-left-001"
title: "时代交融的纽约时报广场"
category: interior
subcategory: "04_创意脑洞特效合成"
aesthetic: null
tags: ["纽约", "街景", "时空", "融合", "复古", "现代", "对比", "马车"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "4:3"
...
# 正文 prompt
A horizontal split-screen cinematic shot of {"Scene" "Times Square, New York"}, seamlessly blending two different eras: {"Era A" "1880s"} on the left and {"Era B" "present day"} on the right (default: about 100 years ago vs. present day).
...
## 中文译文（源站提供）
一幅水平分屏的电影式镜头，展现了 {"Scene" "纽约时代广场"}，将两个不同时代无缝融合：左侧是 {"Era A" "19 世纪 80 年代"}，右侧是 {"Era B" "现代"}（默认：大约 100 年前与现代）。
