---
id: "interior-facial-resolution-hair-001"
title: "Y2K复古风格下的豪华SUV车内写真：女性夜景时尚肖像"
category: interior
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["怀旧", "夜景", "车内", "美女", "复古", "名包", "暖色调", "粉调"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
{
  "项目约束条件": {
    "面部渲染": "保留100%的原始面部特征（不得修改面部），"
    "分辨率": "1200x1200像素，"
    "输出质量": "具有照片级真实感的8K分辨率"
  },
  "相机与风格": {
    "设备模拟": "21世纪初的数码相机（佳能IXUS/索尼Cyber-shot），"
    "视角": "从后方以3/4的角度进行低角度拍摄，"
    "视觉美学": "电影风格，充满怀旧感，"
    "后期处理": {
      "颗粒感": "轻微的薄膜颗粒效果，"
      "景深": "浅景深，"
  ...
  "姿势与动作": {
    "姿势": "侧坐于副驾驶座位上，"
    "手部动作": "右手握住方向盘，左手将头发撩起，"
    "表情": "回头看向后方，眼神充满诱惑与自信，"
  },
  "服装与配饰": {
    "上衣": "背面开口的闪亮白色连体衣，饰有精致的十字纹图案，"
    "下装": "浅蓝色高腰牛仔裤（紧身款），"
    "珠宝": "佩戴多枚金色戒指和配套的手链，"
    "包袋": "小巧的香奈儿Vanity包，配黑色金色链条（放在扶手上），"
  },
  "环境": {
    "拍摄地点": "豪华SUV的内部（奔驰风格），"
    "室内装饰": "木质装饰条，米黄色真皮座椅，"
