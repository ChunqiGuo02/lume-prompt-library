---
id: "interior-hair-face-type-001"
title: "车内阳光少女写真，优雅梦幻风"
category: interior
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["车内", "美女", "长发", "棕发", "墨镜", "蓝色", "项链", "耳饰"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
  ...
  "prompt": {
    "subject": {
      ...
      "hair": {
        "color": "深棕色",
        "length": "及腰",
        "style": "左侧分，发梢处有松散的波浪，少量发丝垂在前方，韩式风格",
        "motion": "头发轻微拂过脸庞"
      },
      "face_makeup": {
        "eyebrows": "自然浅色，整洁",
        "eyelashes": "假睫毛，簇状",
        "cheeks": "脸颊和鼻子上涂有柔和的裸粉色腮红",
        "lips": "裸红色，水润有光泽"
      },
      "eyes": {
        "accessory": "黑色猫眼太阳镜，戴在头上"
      },
      "clothing": {
        "top": "细吊带背心，蓝色，边缘有蓝色镶边",
        "accessories": [
          "短款银色项链，带小蓝色叶子吊坠",
          "小银色耳环，蓝色叶子形状"
        ]
    ...
    "environment": {
      "car_interior": "深色，背景是棕色座椅",
      "outside_view": "右侧车窗外可见明亮的蓝色天空"
    },
    "lighting": {
      "type": "左侧射入的自然阳光",
      "effect": "头发和皮肤上有强烈的高光，超亮，自然"
    },
    "camera": {
      "angle": "与视线齐平，特写",
      "focus": "脸部、表情和头发细节"
