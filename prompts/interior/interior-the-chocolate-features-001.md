---
id: "interior-the-chocolate-features-001"
title: "深夜偷吃巧克力蛋糕被拍的俏皮少女"
category: interior
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["少女", "深夜", "厨房", "巧克力", "蛋糕", "睡衣", "眼罩", "牛奶"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
      "expression": "{"expression" "Playfully defensive pout (lips pursed in a cute, angry way)"}, looking directly at the camera as if interrupted. A visible smudge of rich dark chocolate frosting on the corner of her mouth and the tip of her nose.",
...
```json
{
  "prompt_type": "hyper_realistic_portrait",
  "subject_details": {
    "demographics": "年轻女性，与参考照片中的身份一致，皮肤白皙，穿着舒适、略显宽松的丝绸或棉质睡衣。",
    "facial_features": {
      "features": "面部特征应与参考图像匹配。",
      "expression": "{\"expression\" \"俏皮的防御性撅嘴（嘴唇可爱地、生气地噘起）\"}，仿佛被打断般直视镜头。嘴角和鼻尖上有一抹清晰可见的浓郁黑巧克力糖霜污迹。",
      "eyes": "眼睛睁大，略带挑衅但又显得心虚（“被抓现行”的表情），反射着厨房的灯光。",
      "hair": "凌乱的“刚睡醒”发型，也许睡眼罩推到了额头上。"
    },
    "apparel": {
      "outfit": "舒适、居家感的睡衣（可能带有可爱的印花或纯色柔和色调），质地略显褶皱。",
      "accessories": "一个睡眼罩搭在额头上（增加了“醒来吃东西”的叙事感）。"
    }
  },
  "pose_and_action": {
    "body_position": "保护性地靠在厨房台面上，或站在打开的冰箱前。",
    "hands": "一只手拿着叉子，上面有一块吃了一半的巧克力蛋糕，另一只手可能护着蛋糕盘，或者双手叉腰，摆出俏皮的姿势。"
  },
  "background_environment": {
    "location": "夜晚灯光昏暗的居家厨房。",
    "lighting_source": "电影般的“深夜零食”灯光：来自打开的冰箱的冷光（轮廓光）与照在她脸上的橱柜下方暖色氛围灯光混合。",
    "objects": {
      "details": "盘子里放着一块吃了一半、糖霜浓郁的巧克力蛋糕，一杯牛奶，台面上可能还有一些碎屑。"
    }
  },
  "technical_specs": {
    "style": "超现实主义摄影，电影般的日常生活快照，光泽巧克力和柔软皮肤之间的高对比度纹理。",
    "camera": "35mm 镜头，营造亲密、环境人像的感觉。浅景深，聚焦于脸部和蛋糕。",
    "visual_fidelity": "巧克力粘稠的质感和皮肤的自然瑕疵都具有极高的细节。",
    "aspect_ratio": "4:5"
  },
  "constraints": [
    "面部特征和身份必须严格匹配参考图",
    "确保巧克力看起来诱人且逼真（有光泽、浓稠），而不是像颜料或泥浆",
    "保持“生气/撅嘴”的表情，但要在喜剧/可爱的语境中呈现"
  ],
  "output_goal": "创作一张幽默且超现实的照片，描绘一位年轻女性深夜偷吃巧克力蛋糕被抓现行，脸上沾着巧克力，生气地对着镜头撅嘴。"
}
```
