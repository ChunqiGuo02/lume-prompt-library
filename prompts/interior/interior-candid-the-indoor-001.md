---
id: "interior-candid-the-indoor-001"
title: "室内 candid 自拍写真"
category: interior
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["男性", "青年", "室内", "书桌", "笔记本", "手机", "毛衣", "暖光"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
"Hands": {
"Right_or_Left": "Holding an iPhone 16 Pro as if checking something or capturing a mirror-style selfie"
},
"Vibe": "Realistic, relaxed, effortlessly cool"
},
"Wardrobe": {
"Sweater": {
"Type": "White distressed knit sweater",
...
## 中文译文（源站提供）
- **目标**：根据提供的参考图像，生成一张逼真的室内自然照片。
- **身份保护**：确保面部特征、发型和整体外观与参考图像一致。
- **主体信息：**
  - **年龄**：年轻男性。
  - **发型**：自然蓬乱的黑色头发，柔和地修饰着面部轮廓。
  - **表情**：平静、随意，展现出自然、真实的瞬间。
- **姿势**：
  - **身体姿势**：坐在桌子前，面前放着一台打开的笔记本电脑。
  - **手部动作**：右手或左手拿着 iPhone 16 Pro，仿佛在查看某样东西或正在自拍。
