---
id: "interior-retro-material-brown-001"
title: "70年代复古室内电影感肖像写真"
category: interior
subcategory: "05_人物肖像与写实摄影"
aesthetic: biophilic
tags: ["复古", "电影感", "七十年代", "暖色调", "女性", "沙发", "落地灯", "绿植"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
```json
{
  ...
  "character_model": {
    ...
    "performance": {
      "pose": "斜倚在沙发上，放松自信，一只手臂搭在靠背上",
      "expression": "柔和妩媚，直视镜头，嘴唇微张"
    },
    "wardrobe": {
      "item": "缎面吊带裙",
      "color": "{\"dress color\" \"深勃艮第酒红色\"}",
      "features": ["低胸 V 领", "细吊带", "宽松垂坠剪裁"],
      "finish": "丝滑光泽"
    }
  },
  "cinematography": {
    ...
    "optics": {
      "depth_of_field": "适中",
      "background_blur": "略微柔和",
      "balance": "不对称（主体在右，灯在左）"
    },
    "color_profile": {
      "dominant": ["暖棕色", "勃艮第色", "米色"],
      "accents": ["深红色", "米白色"],
      "grading": "暖电影感，提亮暗部，柔和高光"
    }
  },
  "render_quality": {
    "positive_attributes": [
