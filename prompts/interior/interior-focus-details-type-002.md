---
id: "interior-focus-details-type-002"
title: "金发红裙美女在奢华室内优雅凝视镜头"
category: interior
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["红色", "金发", "写实", "优雅", "奢华", "室内", "夜景", "景深"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
version: "1.0.0"
related_to: ["interior-focus-details-type-001", "interior-focus-details-type-003"]
---
  ...
  "request": {
    "image_properties": {
      ...
      "quality": {
        "type": "ultra-high-resolution",
        "focus": {
          "sharpness": "对主体面部极其锐利的聚焦",
          "depth_of_field": "景深较浅，前景手部模糊"
        },
        "details": "超现实、照片级真实感图像"
      }
    },
    "subject_details": {
      "reference_person": {
    ...
    "photography_style": {
      "focus_type": "面部和服装清晰聚焦",
      "lighting_effects": [
        "面部和连衣裙被柔和的阴影照亮",
        "背景柔和模糊，以突出主体"
      ],
      "visual_style": "照片级真实感，高保真细节"
    }
  }
}
```
