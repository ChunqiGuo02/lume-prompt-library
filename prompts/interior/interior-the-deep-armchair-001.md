---
id: "interior-the-deep-armchair-001"
title: "优雅女性书房写真，丝质睡袍与蕾丝内衣的光影艺术"
category: interior
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["电影感", "复古", "人像", "写实", "书房", "沙发", "台灯", "书架"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
```json
{
  "meta": {
    ...
    "camera": "Sony A7R IV",
    "lens": "50mm f/1.2 GM",
    "quality": "超逼真、8k 分辨率、杰作、高度精细的纹理",
    "style": "电影感肖像、奶油般散景、柯达 Portra 400 胶片颗粒、高端杂志美学、深色调色"
  },
  "scene": {
    "location": "舒适复古书房",
    "visibility_rule": "正面肖像，主体面向镜头",
    "environment_details": [
      "背景是装满古董书的深色木质书架",
      "左侧有一盏发出柔和光芒的经典暖色台灯",
      "奢华的棕色天鹅绒扶手椅",
    ...
    "time": "傍晚",
    "atmosphere": "私密、优雅、宁静、精致、富有情调"
  },
  "lighting": {
    "type": "柔和的明暗对比照明，对比度适中",
    "source": "侧面漫射的暖色环境灯光，背面微妙的柔和冷色轮廓光",
    "color_temperature": "暖金色时段光线映衬深冷色阴影",
    "effect": "皮肤上的漫射高光，平滑的阴影过渡勾勒出身形轮廓，灯周围微妙的体积感光晕"
  },
  "camera_perspective": {
    "pov": "正面视角",
    "angle": "平视",
    "framing": "中景，上半身和大腿可见",
    "real_world_visibility": "主体位于扶手椅中央",
    "phone_visibility": "无"
  },
  "subject": {
    "gender": "女性",
    ...
    "ethnicity": "K-pop 偶像",
    "hair": {
      "color": "黑色，带有微妙的紫色和紫罗兰色挑染",
      "style": "高马尾，齐刘海",
      "behavior": "柔顺，垂落在肩上，捕捉到柔和的轮廓光"
    },
    "outfit": {
      "lingerie": {
        "type": "黑色花卉蕾丝文胸和配套内裤",
        "color": "深黑色",
        "material": "精致的透明蕾丝、高清刺绣、触感网状纹理",
        "fit": "精致、贴身"
      },
      "outerwear": {
        "type": "丝绸缎面浴袍",
        "color": "深午夜蓝",
        "style": "露肩，宽松地披在手臂上",
        "material": "如液体般丝滑、垂坠感强、柔和的各向异性高光"
      }
    },
    "pose": {
      "position": "舒适地靠在毛绒扶手椅上，斜倚姿势",
      "legs": {
        "stance": "一条腿优雅地突出地搭在另一条膝盖上",
        "detail": "腿部可见柔软的皮肤纹理，肌肉放松"
      },
      "hips": {
        "action": "放松，深陷在座垫中"
      },
      "arms": {
        "left_arm": "随意地搭在扶手椅扶手上",
        "right_arm": "放在大腿附近或舒适地搭在椅子结构上"
      },
      "vibe": "放松、诱人"
    }
  }
