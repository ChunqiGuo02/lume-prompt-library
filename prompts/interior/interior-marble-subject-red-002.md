---
id: "interior-marble-subject-red-002"
title: "奢华浴室镜中，银紫亮片裙女子慵懒躺卧，光影迷离，尽显后派对颓"
category: interior
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["奢华", "派对", "亮片裙", "高跟鞋", "浴室", "镜子", "香槟", "Y2K"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
# 正文 prompt
{
  ...
  "aspect_ratio": "3:4",
  "subject": {
    "identity": "{"subject identity" "Josephine Langford"}",
...
```json
{
  ...
  "subject": {
    "identity": "{\"subject identity\" \"Josephine Langford\"}",
    "fidelity": "精确的面部保留，高细节皮肤纹理",
    "expression": {
      "eyes": "浅蓝色",
      "mouth": "红色唇膏",
      "gaze": "慵懒、自信、派对后的疲惫",
      "mood": "颓废、超现实的魅力，美丽的不适感"
    },
    "pose": {
      "position": "坐在红黑大理石浴室梳妆台上，看向镜头",
      "body_language": "优雅地躺在大理石台面上，头部看向镜头",
      "legs": "双腿抬起，膝盖弯曲，脚放在梳妆台边缘",
      "hands": "一只手放在腹部，另一只手自然垂下"
    }
  },
  "wardrobe_accessories": {
    "clothing": "修身银色金属迷你连衣裙，虹彩紫色点缀，甜心领口，反光亮片纹理，下摆卷起露出大腿上部",
    "jewelry": [
      "长款垂坠钻石耳环",
      "叠戴串珠手链",
      "优雅奢华腕表"
  ...
  "environment": {
    "setting": "凌晨 3:00 的奢华浴室",
    "materials": "红黑大理石台面，金色饰面固定装置",
    "key_elements": "主体身后巨大的落地镜，映出背部和侧面的多重倒影",
    "props": "散落的香槟杯，颓废的派对残余物"
  },
  "lighting_style": {
    "aesthetic": "Guy Bourdin 超现实主义与 Y2K 千禧闪光混合",
    "key_light": "直射机内闪光灯（高强度，Y2K 风格）",
    "accent_lights": {
      "camera_left": "亮粉色和洋红色泛光",
      "camera_right": "电青色和蓝色边缘照明"
    },
    "effects": "大理石上的高饱和度光影效果，镜面反射营造偷窥张力，亮片高光处细微的光晕"
  },
  "technical_specs": {
    "camera": "35mm 胶片美学",
    "lens": "35mm 广角镜头，f/2.8 光圈",
    "angle": "略微低角度，以强调高度和主导性",
    "focus": "眼睛和连衣裙纹理清晰对焦",
    "film_stock_simulation": {
      "contrast": "高对比度",
      "grain": "细微胶片颗粒",
      "color_grading": "鲜明、饱和、高级时装编辑风格"
    }
  }
}
```
