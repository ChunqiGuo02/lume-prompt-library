---
id: "interior-the-mirror-lipstick-001"
title: "镜中红唇：女星私密妆容写真"
category: interior
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["写实", "镜像", "口红", "红色", "金色", "暖光", "室内", "复古"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
# 正文 prompt
{
  ...
  "subject": {
    ...
    "accessories": [
      ...
      },
      {
        ...
        "material": "{"dress material" "Red silk satin"} with liquid-like texture",
        "position": "Body"
      }
    ]
  },
  ...
  "environment": {
    ...
    "objects": [
      ...
      "Red lipstick writing on the mirror surface reading '{"mirror writing" "Teresa Palmer ❤️"}'",
...
{
  "style": {
    "realism": "高保真电影摄影，超写实纹理",
    "cinematic": true,
    "camera_angle": "四分之三越肩视角，看向镜中倒影",
    "aspect_ratio": "9:16",
    "depth_of_field": "浅景深，镜中倒影清晰对焦，前景模糊"
  },
  "subject": {
    "gender": "女性","Teresa Palmer"
    "appearance": {
      "skin_tone": "Teresa Palmer 肤色，带有光泽、阳光亲吻般的妆效",
      "body_type": "Teresa Palmer 身材，轮廓分明，胸部突出",
      "abdomen": "通过缎面连衣裙的垂坠感可见光滑的皮肤纹理",
      "features": "湿发波浪卷，性感表情，饱满的嘴唇涂有亮红色唇膏，修剪整齐的指甲"
    },
    "accessories": [
      {
        "type": "圈形耳环",
      ...
      {
        "type": "细肩带连衣裙",
        "material": "{\"dress material\" \"红色丝绸缎面\"}，具有液体般的质感",
        "position": "身体"
      }
    ]
  },
  "pose": {
    "overall_posture": "背对镜头站立，头部转向镜中倒影",
    "left_arm": {
      "position": "抬向镜面",
      "interaction": "手持一支红色唇膏，仿佛刚在玻璃上写完字"
    },
    "right_hand": {
      "position": "在近前景模糊，握住唇膏底部",
      "interaction": "营造景深"
    },
    "legs": {
      "position": "不可见，画面在躯干中部截断"
    }
  },
  "framing": {
    "composition": "画中画构图，以华丽的金色镜子为中心",
    "camera_position": "低角度，位于主体右肩后方",
    "focus_progression": [
      "主体背部和手臂的模糊前景",
      "镜中倒影的面部、湿发和唇膏字迹清晰对焦"
    ]
  ...
  "environment": {
    "location": "日落时分的优雅室内梳妆室",
    "objects": [
      "大型华丽镀金维多利亚式镜子，带有精致的贝壳和卷轴雕刻",
      "镜面上的红色唇膏字迹，写着“{\"mirror writing\" \"Teresa Palmer ❤️\"}”",
      "镜面上的红色唇膏吻痕"
    ]
  },
  "visual_emphasis": [
    "鲜艳的红色缎面与温暖的金属金色形成对比",
    "性感的灯光，柔和的阴影和日落时分的金色高光",
    "湿发质感与光滑丝绸面料的对比",
    "面部和胸部的光彩照人肌肤光泽高光"
  ]
}
