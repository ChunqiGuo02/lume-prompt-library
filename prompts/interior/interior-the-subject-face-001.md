---
id: "interior-the-subject-face-001"
title: "银发双马尾少女卧室自拍，Y2K暗黑美学风格"
category: interior
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["女性", "银白发", "双马尾", "黑裙", "十字架", "项链", "卧室", "紫光灯"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
```json
{
     ...
     "subject": {
       ...
       "face_and_makeup": {
         "eyes": "绿色/淡褐色眼睛，浓重的飞翼眼线，长睫毛",
         "expression": "魅惑的眼神，微张的嘴唇",
         "action": "右手食指轻触下唇或嘴角"
       }
     },
     "attire": {
       "clothing": "无袖束身衣式上衣，深 V 领口，可见的钩扣，部分可见的裙子或短裤",
       "accessories": "细链条银色十字架吊坠项链"
     },
     "pose": {
       "type": "高角度自拍",
       "body_position": "手臂伸向镜头，身体略微倾斜"
     },
     "setting": {
       "location": "卧室内部",
       "background_elements": [
       ...
       "ambient_lighting": "床头板后方水平延伸的紫色 LED 灯带",
       "atmosphere": "光线昏暗的房间，带有彩色强调照明"
     },
     "style_and_technical": {
       "aesthetic": [
         "E-girl",
       ...
       "lighting_technique": "直射机内闪光灯，主体在较暗背景下呈现强烈高对比度照明",
       "camera_settings": {
         "angle": "高角度广角自拍",
         "distortion": "轻微广角畸变",
         "color_profile": "全彩，自然色彩渲染，带有鲜艳的霓虹紫色强调色"
       },
       "aspect_ratio": "3:4"
      }
    }
...
运动控制提示：
生成一个逼真的视频，使用所附参考图像作为身份锚点。精确保留主体在参考图像中显示的所有整体外观，包括面部结构、肤色、发色和发质、身体比例以及整体轮廓。在所有帧中保持强烈的身份一致性，同时允许自然的运动、细微的表情变化和逼真的身体动作。不要改变主体的身体特征；只引入流畅、逼真的动画和摄像机运动。确保视频中的光照、真实感和视觉保真度与参考图像保持一致。
