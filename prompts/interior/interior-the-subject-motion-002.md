---
id: "interior-the-subject-motion-002"
title: "监控视角下商店内女子挑衅举中指的低清画面"
category: interior
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["监控", "冷色调", "颗粒感", "挑衅", "墨镜", "店铺", "收银台", "购物袋"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
version: "1.0.0"
related_to: ["interior-the-subject-motion-001"]
---
...
```json
{
   ...
   "visual_elements": {
     "subject": {
       "framing": "从躯干中部向上居中",
       "pose": "头部后仰，向上看向摄像头，姿态放松但充满挑衅",
       "action": "手抬起，伸出中指（剪影，因运动而模糊不清）",
       "facial_features": "大部分被模糊遮挡，嘴巴张开，舌头隐约可见",
       "apparel": "深色超大墨镜反射环境光"
     },
     "environment": {
       "location": "拥挤的零售店内部",
       "foreground": "凌乱的收银台，纸张，一个带有红色绳柄的白色购物袋",
       "background": "密密麻麻的货架上摆满了小物件、纪念品和雕像（因低分辨率而抽象化）"
     }
   },
   "technical_specifications": {
     "camera_perspective": "高位安装，陡峭的向下角度，俯视 CCTV 视角",
     "lens_distortion": "画面边缘有轻微的鱼眼畸变",
     "lighting": "刺眼的平面荧光灯，高光过曝，阴影暗淡",
     "color_grading": "冷绿色调，色彩再现不均匀，可见色带，动态范围减小"
   },
   "image_fidelity": {
     "quality": "故意降级，低保真",
     "artifacts": [
     ...
     "sharpness": "感知锐度低，细节拉伸且不清晰"
   },
   "full_prompt_text": "一张严重扭曲、低保真度的监控风格图像，描绘了主体站在一家杂乱商店内拥挤的零售收银台后面，由高位安装的摄像头以陡峭的向下角度从俯视 CCTV 视角捕捉。图像质量被故意降级，带有强烈的运动模糊、数字涂抹、压缩伪影、严重噪点、扫描线以及轻微的鱼眼畸变扭曲了画面边缘，使得精细细节模糊不清且拉伸。主体从躯干中部向上居中，头部后仰，向上看向摄像头；面部特征大部分被模糊和伪影遮挡，尽管深色超大墨镜占据了面部，反射着环境光，嘴巴似乎张开，舌头隐约可见。一只手向上伸向摄像头，伸出中指，剪影清晰可辨，但因运动和低清晰度而柔化和模糊，传达出一种放松但充满挑衅的姿态。前景的收银台堆满了纸张和一个带有红色绳柄的白色购物袋，而背景货架上则密密麻麻地摆满了小物件、纪念品和雕像，由于低分辨率和噪点，它们融合成了抽象的形状。刺眼、平面的荧光灯产生了过曝的高光、暗淡的阴影、不均匀的色彩再现，以及"
}
```
