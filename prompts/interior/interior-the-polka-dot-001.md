---
id: "interior-the-polka-dot-001"
title: "波点主题时尚写真"
category: interior
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["时尚", "波点", "肖像", "室内", "沙发", "蝴蝶结", "眼镜", "珍珠"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
# 正文 prompt
{
  ...
  "environment": {
    ...
    "color_palette": "Dominated by monochromatic black and white patterns, complemented by warm skin tones, honey-blonde hair, and a pop of {"lip color" "red"} from the lipstick."
  },
...
```json
{
  "image_description": "一张高质量的年轻女性肖像照，风格华丽时尚，以黑白波点为主题，贯穿始终。",
  "subject": {
    "pose": "坐在中性色调的沙发上，身体略微前倾，双腿膝盖交叉，双手放在膝上；一只手优雅地轻触眼镜框。",
    "features": "长长的直发，蜂蜜金色，脸部周围有挑染，头顶扎着两个小小的“太空发髻”。妆容华丽，眼线犀利上扬，睫毛浓密，腮红红润，嘴唇涂着亮泽的红色唇膏。指甲是尖长的亚克力美甲，带有裸色/棕色渐变。",
    "attire": "一件黑白波点迷你连衣裙，一个配套的超大波点领结，作为颈链佩戴在珍珠项链上方，头发上也有一个配套的波点蝴蝶结。"
  },
  "accessories": "无框矩形无边眼镜，鼻梁和铰链处有装饰性的银色/钻石点缀。",
  "environment": {
    "setting": "室内休息室或客厅，背景是柔和的暖灰色墙壁。",
    "lighting": "柔和的直射影棚式灯光，在后墙上投下淡淡的阴影，并突显出织物和妆容的质感。",
    "color_palette": "以单色的黑白图案为主，辅以温暖的肤色、蜂蜜金发色，以及唇膏带来的 {\"lip color\" \"红色\"} 亮色点缀。"
  },
  "technical_style": "高分辨率时尚摄影，浅景深，面部特征和配饰对焦清晰，皮肤纹理光滑。"
}
```
