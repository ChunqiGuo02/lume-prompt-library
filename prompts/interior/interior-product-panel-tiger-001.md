---
id: "interior-product-panel-tiger-001"
title: "电影感商业广告分镜脚本"
category: interior
subcategory: "03_创意广告品牌设计"
aesthetic: null
tags: ["电影感", "写实风", "广告", "分镜", "老虎", "猫咪", "猫粮", "女性"]
recommended_models: []
recommended_params:
  aspect_ratio: "3:2"
  quality: null
...
场景概念：
【一位女性住在一个安静的公寓里，身边有一只紧张且难以预测的老虎。老虎表现得像家猫，但时刻带有危险气息。当她奉上产品（猫粮）时，老虎明显放松下来，并转变为一只平静的家猫。】
...
产品规则：
- 产品在第 3、4、6 面板中必须清晰、易读且光照充足
- 无畸变，无重新设计
- 包装必须保持一致

视觉优先级：
- 紧张感（老虎）与放松感（猫）之间的强烈对比
- 每一帧都具备清晰的易读性
- 无抽象或超现实的扭曲，基于现实主义

文字：
- 极简，仅使用小型专业标签（面板编号 + 简短镜头备注）
- 无额外图形
