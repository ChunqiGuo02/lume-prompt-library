---
id: "interior-stadium-subject-texture-001"
title: "体育场内时尚青年女性写真，展现潮流穿搭与运动氛围"
category: interior
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["美女", "长发", "浅肤", "休闲", "白色", "背心", "牛仔", "长裤"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
      "layering": "Visible white underwear waistband with black '{"underwear logo" "Miu Miu"}' logo peeking above jeans",
      "accessories": [
...
```json
{
  "prompt_structure": {
    "subject_details": {
      "demographics": "年轻女性，浅肤色",
      "hair": "长直深棕色头发，中分，丝滑质感",
      "face": "自然妆容，眉毛清晰，略微撅嘴/鸭子脸表情，看向镜头左侧（偏离镜头）",
      "body": "健美身材，露出中腹部"
    },
    "apparel_and_styling": {
      "top": "白色罗纹方领背心，短款，紧身廓形",
      "bottoms": "低腰蓝色牛仔裤，复古水洗",
      "layering": "可见白色内裤腰带，带有黑色“{\"underwear logo\" \"Miu Miu\"}”标志，从牛仔裤上方露出",
      "accessories": [
        "腋下夹着小号黑色单肩包",
        "金色链条项链，带小四叶草/花朵吊坠",
        "左手腕戴金色链式手链",
        "右手腕戴银色手表",
        "银色肚脐环",
        "腰间挂着紫色“Postgame Field”凭证徽章"
      ]
    },
    "pose_and_action": {
      "posture": "站姿笔直，随意站立",
      "hands": "手部部分被遮挡，可能拇指勾在口袋里或放在臀部",
      "gaze": "不看镜头，漫不经心的态度"
    },
    "environment_and_background": {
      "location": "SoFi 体育场内部，NFL 橄榄球场",
      "ground": "人造绿色草坪，有清晰的白色码线和哈希标记",
      "background_elements": [
        "空置的体育场座位（蓝色座位）",
        "模糊的 LED 丝带板和体育场标牌",
        "远处黄色球门柱",
    ...
    "lighting_and_atmosphere": {
      "type": "体育场人工泛光灯",
      "quality": "明亮、均匀、漫射光线，极少刺眼阴影",
      "tone": "略冷色调，清晰的色彩，典型的体育场氛围"
    },
    "camera_and_technical": {
      "shot_type": "中景（大腿以上构图）",
      "lens": "85mm 人像镜头",
      "aperture": "f/2.8，使主体与背景略微分离（散景）",
      "resolution": "8K，超高清",
      "style": "原始摄影，网红美学，抓拍"
    },
    "quality_tags": [
