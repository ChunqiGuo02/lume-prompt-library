---
id: "interior-dress-museum-subtle-001"
title: "红裙美女坐于美术馆大理石台，古典油画背景，时尚写真风格"
category: interior
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["写实", "时尚", "人像", "美术馆", "古典", "红色", "连衣裙", "黑丝"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
# 正文 prompt
{
  ...
  "subject": {
    ...
    "clothing": "striking bright {\"dress color\" \"red\"} halter-neck mini dress with intricate geometric cutouts across bodice and midriff creating bold revealing design, fitted stretch fabric ending mid-thigh, paired with sheer black pantyhose or stockings with subtle opacity",
...
{
  "prompt_type": "超写实时尚肖像",
  "main_composition": "一位年轻女性优雅地坐在宏伟艺术博物馆画廊的大理石桌或展示台边缘，中等全身视角，双腿交叉，一只手轻扶台面以保持平衡，略微自信地斜视镜头，头部微倾，鲜艳的红色连衣裙与身后古典画作形成对比，精致的博物馆环境配有天鹅绒绳索围栏",
  "subject": {
    "description": "20 岁出头的漂亮年轻女性，迷人的女性特征，化着淡雅的妆容（精致的眼线、长睫毛、 subtle contour、中性光泽唇），一头蓬松的浅棕色或赤褐色长卷发自然垂落肩头，皮肤白皙光滑，散发健康光泽，身材苗条，呈沙漏形",
    "clothing": "引人注目的亮 {\"dress color\" \"红色\"} 挂脖迷你连衣裙，胸衣和腰部有复杂的几何镂空设计，形成大胆的露肤效果，修身弹力面料及大腿中部，搭配半透明黑色连裤袜或丝袜，具有微妙的透明度",
    "details": "放松的坐姿，双腿优雅地交叉，身体略微前倾，修剪整齐的中性指甲，头发自然蓬松，带有柔和的波浪，自信而微妙的表情，眼神直视，嘴角微扬"
  },
  "environment": {
    "foreground": "抛光暖色调木质拼花地板反射光线，左侧有黑色天鹅绒绳索立柱围栏",
    "midground": "女性居中坐在大理石台面或带有粉红色纹理石材的展示台上",
    "background": "宏伟的艺术博物馆画廊，深灰色或炭灰色墙壁上装饰着大型华丽金色边框的古典油画（洛可可或新古典主义风格，描绘穿着时代服装的人物），画作下方有微妙的信息牌，优雅正式的博物馆内部"
  },
  "lighting_and_atmosphere": "柔和漫射的博物馆顶灯，散发着温暖的环境光，突显皮肤、红色连衣裙面料和金色画框，柔和的阴影增强了镂空细节和画作纹理，精致奢华的艺术画廊氛围，鲜艳的红色连衣裙与柔和的古典背景形成高对比度，超写实细节唤起文化背景下的高级时装编辑感",
  "technical_quality": "高度细节化，对连衣裙镂空、面料纹理、发丝、皮肤光泽和画框细节有清晰的焦点，8k 分辨率，红色面料和大理石表面具有逼真的材质光泽，专业时尚摄影风格，自然景深柔和虚化远处的画作",
  "negative_prompt_suggestions": "模糊、变形、多余肢体、刺眼的博物馆闪光灯、连衣裙过曝、画作曝光不足、低质量、卡通、动漫、文字水印、多余人物、杂乱的画廊、现代艺术、明亮的日光"
}
```
