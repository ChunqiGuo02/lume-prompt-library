---
id: "interior-mirror-flash-film-001"
title: "镜前私密瞬间抓拍"
category: interior
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["胶片", "闪光灯", "浴室", "少女", "私密", "复古", "随性", "慵懒"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
## 中文译文（源站提供）
- **主题**：一位年轻女性的自然、真实的镜像照片（采用快门闪光拍摄风格）。  
- **构图**：  
  - **画面比例**：4:5（竖屏）  
  - **主体位置**：女性上半身（大腿以上）映照在梳妆台镜面上，前景摆放杂乱物品以增加层次感。  
  - **风格**：结合“快照美学”（snapshot_aesthetic）、“原始快门摄影”（raw_flash_photography）和“模拟胶片效果”（analog_film_emulation）。  
- **人物信息**：  
  - **年龄**：20岁
