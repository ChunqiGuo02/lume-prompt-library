---
id: "interior-the-bed-brown-001"
title: "慵懒卧室写真：时尚单品与生活气息融合"
category: interior
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["女性", "卧室", "床", "慵懒", "复古", "暖色调", "胶片", "背心"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "16:9"
...
# 正文 prompt
{
  ...
  "subject_details": {
    "appearance": "Young woman, long natural blonde hair, loose wavy.",
  ...
  "props_and_clutter": {
    "foreground_items": [
      ...
      "Black insulated water bottle with white logo text ({"water bottle brand" "Prada"} style)"
    ]
  },
  "technical_aspects": {
...
```json
{
  "main_prompt": "一张年轻女性斜躺在凌乱的床上，身穿黑色拉链连帽衫和白色船袜，手托下巴，表情或无聊或沉思的抓拍高角度全身照。床铺铺着米色纹理床单，配有木质床头板。前景散落着一件棕色皮背心、一条印花丝巾和一个黑色 Prada 水瓶。光线柔和温暖，带有复古胶片颗粒感。",
  "subject_details": {
    "appearance": "年轻女性，长长的自然金色波浪发。",
    "expression": "沉思，略显无聊，目光平静，右手托腮。",
    "pose": "仰卧，双腿伸展但放松，身体略微斜向横跨床铺。"
  },
  "apparel": {
    "upper_body": "黑色长袖拉链连帽运动衫，略短款或塞入。",
    "lower_body": "黑色修身短裤或紧身衣（几乎不可见），白色罗纹船袜拉高。",
  "environment": {
    "setting": "卧室，凌乱未铺的床。",
    "background": "木质中世纪现代床头板，大号米色枕头，一件米色毛衣随意地搭在背景枕头上。",
    "surfaces": "有纹理的白色或米色床罩（华夫格或褶皱棉）。"
  },
  "props_and_clutter": {
    "foreground_items": [
      "棕色复古皮背心或束身衣上衣",
      "带有波点和花卉图案的折叠丝巾",
      "黑色保温水瓶，带有白色标志文字（Prada 风格）"
    ]
  },
  "technical_aspects": {
    "camera_angle": "高角度拍摄，俯视主体（约 45 度或正上方）。",
    "lighting": "柔和的室内环境光，可能混合了直射的机载闪光灯，营造出“快照”效果。",
    "style": "抓拍，生活方式摄影，胶片颗粒，复古 90 年代美学，柔焦。",
    "color_palette": "柔和的大地色系，米色、米白、黑色和棕色。"
  }
}
```
