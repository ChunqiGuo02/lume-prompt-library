---
id: "interior-reference-face-the-001"
title: "粉色仙女裙镜前自拍"
category: interior
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["粉色", "自拍", "浪漫", "鲜花", "咖啡馆", "高跟鞋", "长发", "温柔"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
hair = black
hairstyle = exact hairstyle from reference
makeup = Natural style as per reference
expression = Soft, calm, looking at phone screen

[subject.facial_features]
0 = Preserve exact face shape
1 = Match eye structure and eyebrow shape
2 = Retain lip shape and natural color
...
4 = Different dress color or style
5 = Different shoes
6 = Text
7 = Watermark
8 = Blurry
9 = Low resolution
10 = Artificial looking skin

## 中文译文（源站提供）
[subject]
reference_adherence = 严格按照参考照片，面部特征需完全一致
hair = 黑色
hairstyle = 与参考照片中的发型完全一致
makeup = 参照参考照片，自然风格
...
[apparel]
main_garment = 柔和的淡粉色，浪漫的束身衣式迷你连衣裙，灵感来自仙女核心美学。露肩领口，带有精致的褶皱面料，系带束身衣式胸衣收紧腰部，飘逸的雪纺裙摆分层灵动。长款、轻薄、喇叭形袖子，轻盈面料透明，优雅垂坠。连衣裙的颜色、廓形和浪漫风格与参考照片中的粉色连衣裙完全一致。
fabric_physics = 轻盈的雪纺和缎面混纺，飘逸灵动，自然褶皱，如风般轻柔流动
footwear = 淡腮红粉色缎面高跟凉鞋，方头设计。精致的细带上装饰有刺绣 3D 蝴蝶贴花，分布在鞋面和脚踝处。纤细的女性化鞋跟，优雅的仙女核心美学，颜色、质感和浪漫细节与参考照片中的蝴蝶高跟鞋完全一致。
...
[pose_and_action]
type = 全身镜面自拍
stance = 优雅地低蹲，一只膝盖向前，身体略微倾向镜子
head_position = 头部略微向下倾斜
props = 智能手机，配有柔和的粉色手机壳，柔和的淡色调，极简设计

[pose_and_action.hands]
right_hand = 垂直握持手机于脸前
left_hand = 轻轻搭在膝盖上

[environment]
location = 迷人的花卉咖啡馆内部
background = 浪漫的欧式花卉咖啡馆，石材纹理墙壁，悬挂的柳条篮，干花布置，淡色花束，复古木质置物架，乡村风格横梁，以及柔和的装饰镜。温暖的中性石材色调与柔和的粉色、绿色、奶油色和薰衣草色花卉混合。舒适、美观、女性化的氛围。
