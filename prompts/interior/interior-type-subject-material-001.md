---
id: "interior-type-subject-material-001"
title: "暖光卧室中优雅女性的写真肖像"
category: interior
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["女性", "卧室", "暖色调", "温柔", "睡衣", "腕表", "手链", "耳钉"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
```json
{
  "metadata": {
    "version": "1.0",
    "description": "逼真的室内肖像，具有详细的主体、服装、配饰、灯光和构图限制",
    "aspect_ratio": 3.4
  },
  "subject": {
    "identity": {
      "name": "我上传的人物",
      "likeness_constraint": "100% 相同的面部和身体",
      "age_representation": "成年"
    },
    "physical_attributes": {
      "gender": "女性",
      "body_type": "苗条，匀称",
      "skin_tone": "自然，暖色调",
      "facial_expression": "柔和，平静，放松",
      "hair": {
        "color": "深棕色",
        "style": "蓬松，自然垂坠",
        "length": "中长发"
  ...
  "camera_and_composition": {
    ...
    "focus": {
      "priority": "面部",
      "background_blur": "柔和的散景"
    }
  },
  "rendering_style": {
    "realism_level": "逼真",
    "detail_level": "高",
    "skin_rendering": "自然纹理，不过度平滑",
    "color_grading": "暖色电影色调"
  },
  "constraints": {
    "must_include": [
      "睡裙装束",
