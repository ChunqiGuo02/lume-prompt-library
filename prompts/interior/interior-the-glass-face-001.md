---
id: "interior-the-glass-face-001"
title: "雨夜窗后少女的忧郁凝视"
category: interior
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["雨夜", "肖像", "女性", "电影感", "忧郁", "湿发", "白衬衫", "蓝调"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
```json
{
  "image_prompt": {
    ...
    "subject": {
      "description": "21 岁女性，拥有自然、迷人的美",
      "face": "透过被雨水浸湿的窗玻璃可见，神情沉思，脸颊贴近玻璃，呼出的气息在玻璃上形成一小片雾气",
      "skin": "苍白、冷色调的皮肤，透过湿润的玻璃显得柔和而朦胧",
      "hair": "散乱的头发，发梢湿润",
      "pose": "站在玻璃后面，一只手放在脸旁的玻璃上，凝视着窗外夜景",
      "outfit": "只穿一件宽松的男士白色衬衫，半解开扣子，滑落一侧肩膀"
    },
    "environment": {
      "location": "暴雨中的高层公寓窗户",
      "background_elements": [
    ...
    "photography_style": {
      "style": "情绪化的电影剧照",
      "camera_look": "35mm 镜头，浅景深",
      "imperfections": "水滴引起的折射和扭曲，玻璃边缘的色差，真实的胶片颗粒",
      "mood": "忧郁、亲密、迷人、宁静"
    },
    "render_quality": {
      "realism": "光线穿过玻璃上水滴的折射效果",
      "detail_level": "聚焦于玻璃表面清晰的雨滴与其后柔焦处理的面部"
    }
  }
}
```
