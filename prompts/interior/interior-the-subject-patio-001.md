---
id: "interior-the-subject-patio-001"
title: "都市夜生活时尚写真四格拼图"
category: interior
subcategory: "09_故事分镜角色设定"
aesthetic: null
tags: ["夜晚", "户外", "餐厅", "拼贴", "金发", "黑色", "皮衣", "红酒"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
## 中文译文（源站提供）
{ "scene\_type": "nightlife\_lifestyle", "setting": { "location": "户外餐厅或酒廊露台", "time": "夜晚", "environment": "都市、私密、高档", "lighting": "来自露台加热器和串灯的暖色环境光" }, "composition": { "format": "四图拼贴", "layout": "2x2 网格", "continuity": "所有图片中主题、服装和地点保持一致" }, "subject": { "type": "参考图片中的人物", "appearance": { "hair": { "color": "金色", "length": "长发", "style": "蓬松、柔和波浪" } }, "clothing": { "outerwear": "黑色皮夹克", "top": "黑色镂空露脐上衣", "bottom": "黑色修身迷你裙" }, "expressions": [ "自信", "放松", "沉思", "摆拍" ], "poses": [ "站立，手持酒杯", "坐着，手持酒杯", "倚靠，双手置于腰部附近", "手托下巴" ] }, "objects": [ { "type": "wine\_glass", "content": "{"drink color" "red wine"}", "held": true }, { "type": "patio\_heater", "description": "高大的户外燃气加热器，散发暖光" }, { "type": "met"

首先，将场景设定为夜间的户外餐厅或酒廊露台。环境应营造出都市、私密和高档的氛围。使用露台加热器和串灯等暖色环境光，营造出舒适而奢华的夜间氛围。

接下来，确保视觉连续性。所有图片中都使用相同的主题、服装和地点。这种一致性赋予最终拼贴画专业、编辑感十足的风格。

为主题人物搭配一套全黑的夜生活服装。黑色皮夹克搭配黑色镂空露脐上衣和修身黑色迷你裙，完美展现自信摩登的造型。头发应为金色长发，蓬松且带有柔和的波浪，以保持轻松随性的夜生活氛围。

在四张图片中，改变主题人物的表情和姿势。其中一张图片可以展示主题人物自信地站立，手持一杯红酒。另一张可以坐着放松，手持酒杯。第三个姿势可以是稍微倚靠，双手置于腰部附近，呈现出沉着冷静的姿态。最后一张图片可以更具沉思感，主题人物手托下巴。

正确生成后，Nano Banana Pro 将制作出高端夜生活照片拼贴画，充满电影感、时尚感，并适合社交媒体分享，适用于时尚杂志、生活方式品牌和优质 AI 视觉内容。在下方分享您的夜生活照片拼贴画！
