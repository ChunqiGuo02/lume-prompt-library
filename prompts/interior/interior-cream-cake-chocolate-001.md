---
id: "interior-cream-cake-chocolate-001"
title: "超写实美食摄影，动态悬浮元素，金色标注，高端甜品与菜肴视觉呈"
category: interior
subcategory: "04_创意脑洞特效合成"
aesthetic: japanese-zen-garden
tags: ["美食", "甜品", "开心果", "奶油", "芝士", "糖浆", "暖调", "写实"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
# 正文 prompt
{
  ...
  "module_1_image_1_style": {
    ...
    "background": {
      "color": "{"background color" "soft pastel pink"}",
...
```json
{
  "global_settings": {
    "resolution": "8K 超高清",
    "aspect_ratio": "3:4",
    "camera_style": "影棚美食摄影，带电影级布光",
    "depth_of_field": "浅景深，主体清晰，背景柔和",
    "lighting": "柔和定向主光，微妙轮廓光，受控高光",
    "style": "超写实美食插画，带编辑信息图叠加",
    "composition_rules": [
      "无变焦",
      "无裁剪",
      "中心加权垂直构图",
    ...
    "text_design": {
      "ingredient_name_color": "金属金色",
      "ingredient_description_color": "纯白色",
      "font_style": "标题采用优雅衬线字体，描述采用简洁无衬线字体",
      "indicator_lines": "长、细、光滑的金色线条，带圆角"
    }
  },
  "module_1_image_1_style": {
    "scene_description": "一叠各式蛋糕片垂直漂浮在白色陶瓷盘上方，背景为柔和的粉色渐变。",
    "background": {
      "color": "{\"background color\" \"soft pastel pink\"}",
      "texture": "平滑渐变",
      "lighting": "均匀的影棚布光，无刺眼阴影"
    },
    "main_subjects": [
      "多层海绵蛋糕片",
      "白色鲜奶油层",
    ...
    "text_labels": [
      "香草蛋糕 – 柔软蓬松的海绵蛋糕，夹有白色奶油馅",
      "马卡龙 – 杏仁蛋白酥皮之间夹着奶油馅",
      "覆盆子 – 多汁新鲜的覆盆子",
      "巧克力棒 – 顺滑牛奶巧克力块",
      "覆盆子奶油 – 柔软海绵蛋糕，夹有奶油状果味覆盆子奶油"
    ]
  },
  "module_2_image_2_style": {
    "scene_description": "卷状叙利亚甜点垂直呈现，糖浆从上方倾泻而下，置于温暖质朴的厨房环境中。",
    "background": {
      "environment": "传统厨房",
      "elements": [
        "温暖的灯笼光",
