---
id: misc-ingredients-bowl-indonesian-0038
title: "印尼传统美食超写实信息图设计"
category: misc
subcategory: "08_图像分析信息拆解"
aesthetic: japanese-zen-garden
tags: ["超写实", "美食", "信息图", "印尼菜", "暖色调", "木质", "背景", "悬浮"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
```json
{
  "image_prompt": {
    ...
    "composition": {
      "layout": "简洁的垂直构图",
      "arrangement": "逼真的反重力/漂浮元素",
      "background": "质朴的木质表面",
      "visual_hierarchy": "碗固定在底部，食材垂直上升"
    },
    "graphic_design_elements": {
      "labels": "清晰的印尼语文本",
      "lines": "细白色指示线",
      "style": "编辑信息图布局，专业美食杂志风格"
    },
    "lighting_and_mood": {
      "lighting": "电影级影棚灯光",
      "color_palette": "暖色调",
      "effects": "戏剧性的蒸汽，凝固的食材动态"
    },
    "technical_specs": {
      "camera_settings": "浅景深，锐利对焦，单反相机效果",
      "details": "超精细纹理",
      "resolution": "8K 超现实"
    }
  }
