---
id: misc-the-embroidery-character-0173
title: "定制刺绣人像，精准还原照片人物细节与神韵"
category: misc
subcategory: "11_图像编辑与修复增强"
aesthetic: null
tags: ["刺绣", "手工", "写实", "家庭", "亲子", "温馨", "治愈", "温暖"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
请精确保留人物的面部结构、表情、肤色、发型、服装、比例和姿势，不得有任何改动。

除了刺绣转化之外，不得以任何方式修改、美化、风格化或重新诠释人物面部。

请将人物呈现为超精细的手工刺绣艺术品，使用逼真的缎面绣、长短针绣和密实的填充绣，以创造自然的深度、织物质感和丝线光泽。

需有可见的绣线、遵循面部轮廓的精确针迹方向、通过叠线形成的平滑渐变、高针迹密度、博物馆级的纺织工艺。

{argument name="background" default="中性织物背景"}，柔和的影棚灯光，超清晰的微距细节，照片级的刺绣写实感，无插画或卡通风格。
