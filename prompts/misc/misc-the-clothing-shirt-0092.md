---
id: misc-the-clothing-shirt-0092
title: "男士穿搭分解图：外套、内搭、长裤、皮鞋四件单品展示"
category: misc
subcategory: "08_图像分析信息拆解"
aesthetic: japanese-zen-garden
tags: ["男装", "西装", "内搭", "西裤", "皮鞋", "穿搭", "商务", "休闲"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "8:5"
...
每个提取的单品都必须准确反映原始服装的颜色、材质纹理、形状和细节。
请勿以任何方式重新设计、修改、风格化或重新诠释服装。
请勿展示人体。仅提取并展示服装单品。
输出图像必须是：
・白色背景
・正面视图
...
创建一张简洁、易读的目录风格图片。
超高分辨率，逼真，影棚产品照明，平面照明，极其详细的织物纹理，服装目录品质

负面提示词：
动漫，插画，卡通，风格化，重新设计的服装，时尚草图，人体模型，穿衣服的人体，背景，阴影，反射，模糊，低质量，嘈杂的图像，戏剧性照明
