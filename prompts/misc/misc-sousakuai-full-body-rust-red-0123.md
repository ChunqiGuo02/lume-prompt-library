---
id: misc-sousakuai-full-body-rust-red-0123
title: "赛博朋克监控时尚特辑"
category: misc
subcategory: "08_图像分析信息拆解"
aesthetic: null
tags: ["赛博", "街头", "时尚", "监控", "光影", "红色", "都市", "复古"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
## 中文译文（源站提供）
**主题：**网络风格的“垃圾摇滚”风格监控时尚专题，采用8K超高清（4:5分辨率，1440×1920像素）。画面来自高角度的CCTV摄像头，使用35毫米镜头拍摄，具有强烈的深度感。画面中的女性（约20岁出头）正迈着步伐穿过被阳光晒白的灰色广场地面；傍晚的金色光线在地面投下明显的对角线阴影。她留着齐下巴的波浪发型，搭配随意的刘海，戴着厚实的黑色太阳镜，头部微微低垂。她穿着一件白色T恤（领口为锈红色），T恤上印有小型品牌标志；T恤下搭配宽松的黑色工装裤（白色缝线），脚穿酒
