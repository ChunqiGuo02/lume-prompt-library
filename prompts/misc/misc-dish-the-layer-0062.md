---
id: misc-dish-the-layer-0062
title: "意式披萨分层解构美食海报"
category: misc
subcategory: "08_图像分析信息拆解"
aesthetic: deconstructivism
tags: ["黑色", "背景", "写实", "美食", "西餐", "披萨", "食材", "蒸汽"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "16:9"
...
# 正文 prompt
{"dish name" "Tiramisu"}], [vertical] arrangement, premium culinary promotional poster with pure black background (#000000), presenting a deconstructed layered display of this dish. Arranged from top to bottom or left to right following the cooking sequence. 
...
## 中文译文（源站提供）
{"dish name" "提拉米苏"}，[垂直] 排列，高端美食宣传海报，纯黑背景（#000000），展示该菜肴的解构分层展示。按照烹饪顺序从上到下或从左到右排列。

视觉结构：5-7 层，展示从原材料到成品菜肴的完整解构。一端是酱汁或调味液，中间层包括香料、主要食材和关键调味料，另一端是成品菜肴。

每层之间留有适当的间距，以突出质地和细节；成品菜肴层与相邻层之间保持明显更大的间距，以营造戏剧性的最终呈现效果。

食材质地：

- 酱汁层：展示干净、优质的酱汁或调味料
- 香料层：色彩鲜艳，轻盈漂浮，散发温暖的香气，触感逼真
- 主要食材层：纹理清晰，层次分明，展现优质食材的天然纹理，新鲜水润

- 调味料层：晶莹剔透，颗粒分明，
温暖的光泽
- 成品菜肴层：光泽诱人，质地柔嫩，裹着浓郁的酱汁，表面微微颤动，热气升腾，香气仿佛穿透画面。

成品菜肴应略大于其他分解层
视觉风格：
- 所有元素漂浮在纯黑背景上，没有白色底座或平台

- 统一 45 度角拍摄，高度写实风格
- 成品菜肴放置在合适的器皿中，与上方分解层保持一致的角度
注释：优雅的标签，带有精致的箭头指向每个组件，标注每层的食材或调味料。

氛围细节：

- 过渡区域有微妙的漂浮蒸汽、油滴和香料颗粒轻轻落下，增强动感和真实的烹饪氛围

- 成品菜肴附近有柔和的高光，呼应食材的光泽和酱汁的釉面质感
