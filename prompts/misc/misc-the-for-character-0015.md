---
id: misc-the-for-character-0015
title: "Pop Mart怪物家族×真人时尚互动生成器"
category: misc
subcategory: "08_图像分析信息拆解"
aesthetic: null
tags: ["时尚", "优雅", "联名", "玩偶", "白色", "穿搭", "精致", "高跟"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
## 中文译文（源站提供）
核心指令：**时尚合作伙伴双胞胎主题###A.锚：真实的人（严格约束）***身份锁定：**您必须严格遵守上传的用户参考图像的面部特征、头发颜色/风格和身体比例。不要更改用户的身份。***服装复制：**精确复制参考中的服装项目（例如卡其色夹克、格子衬里、蕾丝束腰外衣、分体式领带、报童帽）。***表情：**自然、自信，适合街头抓拍。###B.伴游：Pop-Mart IP角色（动态选择）怪物们**Labubu:*适合俏皮、淘气或休闲风格。老板喜欢**Tycoco:*适合古怪、前卫或骨架/结构厚重的外观。微型时装***材质现实：**用超现
