---
id: misc-city-the-travel-0030
title: "儿童手绘北京七日游手账"
category: misc
subcategory: "08_图像分析信息拆解"
aesthetic: null
tags: ["手账", "旅行", "北京", "蜡笔风", "可爱", "暖色调", "手绘", "美食"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
## 中文译文（源站提供）
{城市名称}旅行生成了一个充满活力、儿童风格的垂直（9:16）旅行日记插图，自动创建了一条蜿蜒的路线，其中包含每日推荐的景点、可爱的涂鸦、当地地标、食物和有趣的手写笔记。语气温暖、有趣，充满了孩子般的好奇心。---提示---请创建一个充满活力的、孩子般的蜡笔风格垂直（9:16）插图，标题为“{城市名称}旅游日记”这件艺术品应该看起来像是一个好奇的孩子用彩色蜡笔画的，以柔和、温暖的浅色背景（如淡黄色）为特色，结合明亮的红色、蓝色、绿色和其他欢快的颜色，营造出舒适、有趣的旅行氛围。一、主要场景：旅游日记式路线图在插图的中心，绘制一条“蜿蜒曲折的旅行路
