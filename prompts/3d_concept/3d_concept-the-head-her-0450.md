---
id: 3d_concept-the-head-her-0450
title: "星穹之梦颅内宇宙"
category: 3d_concept
...
## 中文译文（源站提供）
一幅超现实、异想天开的数字插图，描绘了一位年轻女子，她有着淡粉色的皮肤和蓬松飘逸的黑发。她的头在鼻子水平处水平张开。在她的脑袋里，一个小小的、微型的自己（穿着同样的衣服）站着，用手抬起头的上半部分（包括闭着的眼睛和额头）。裂头内部的空间显示了一个深蓝色的星空或宇宙虚空。艺术风格：现代平面插图，具有低保真、颗粒状纹理。柔和的粉彩，包括薰衣草、长春花和桃色。使用渐变，阴影微妙而柔和。有一种噪音叠加/点画效果，使其具有复古印花外观。背景是一个坚实的软紫色渐变，散布着白色星尘。情绪化的、梦幻般的、隐喻性的。
