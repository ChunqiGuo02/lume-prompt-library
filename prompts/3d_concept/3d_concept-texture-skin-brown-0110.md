---
id: 3d_concept-texture-skin-brown-0110
title: "人马 hybrid 超写实肖像特写"
category: 3d_concept
subcategory: "04_创意脑洞特效合成"
aesthetic: null
tags: ["写实", "肖像", "棕色", "暖调", "特写", "人马", "奇幻", "肌肉"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
# 正文 prompt
{
  ...
  "background": {
    ...
    "color": "{"background color" "Warm beige to light tan gradient"}",
...
{
  "image_type": "逼真的数字肖像",
  "resolution_target": "8K 超高分辨率",
  "aspect_ratio": "2:3 (垂直)",

  "subject": {
    "form": "半人半马的混合人形生物",
    "composition": "可见上半身和头部",
    "pose": "四分之三侧面，面向右侧",
    "expression": "中性到强烈，平静，专注的凝视"
  },

  "head_and_face": {
    "face_structure": "男性人类面部解剖结构",
    "skin_texture": "高度精细，粗糙，饱经风霜的皮肤，可见毛孔、细纹和自然的凹凸不平纹理",
    "skin_tone": "中等棕色，带暖色调",
    "facial_hair": {
      "beard": "短而修剪整齐的胡须",
      "mustache": "与胡须相连，修剪整齐",
  ...
  "horse_features": {
    "ears": {
      "type": "马耳",
      "position": "直立，略微向后倾斜",
      "texture": "短毛，带有逼真的皮肤褶皱"
    },
    "neck_and_torso": {
      "build": "肌肉发达，强壮有力",
      "definition": "可见明显的肌肉线条",
      "skin_texture": "马皮，带有短而细的毛发",
      "color": "深暗棕色"
    }
  },
  ...
  "lighting": {
    "style": "柔和的电影式灯光",
    "direction": "主光源来自左前方",
    "contrast": "中等对比度，阴影平滑过渡",
    "highlights": "额头、颧骨、鼻子和颈部肌肉上的微妙高光"
  },

  "background": {
    "type": "摄影棚背景",
    "color": "{\"background color\" \"暖米色到浅棕褐色渐变\"}",
    "texture": "光滑，略带颗粒感",
    "depth": "景深较浅，完全模糊"
  },
