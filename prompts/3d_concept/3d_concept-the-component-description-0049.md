---
id: 3d_concept-the-component-description-0049
title: "“制造复杂性”——纳米级香蕉产品的制作艺术"
category: 3d_concept
subcategory: "04_创意脑洞特效合成"
aesthetic: industrial-loft
tags: ["工作室", "组装", "无人机", "全息", "技术", "工业", "特写", "专注"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "16:9"
...
{
  "promptDetails": {
    "description": "这是一个车库/工作坊的场景，主角正在组装一个复杂的机械装置，并查看一个悬浮在空中的3D分解装配图。",
    "styleTags": [
      "工业风格",
      "高细节",
      "技术风格",
  ...
  "scene": {
    "background": {
      "setting": "一个杂乱但井然有序的家庭工作坊/车库工作台",
      "details": "背景中有工具挂板，小零件容器摆放整齐，还有一个烙铁架，工作台的木质纹理以及少量的金属屑。",
    },
    "subject": {
      "description": "主角的形象来自[上传的图片]，佩戴着安全眼镜或工作手套，神情专注。",
      "pose": "身体前倾，用镊子或小螺丝刀拿着一个小型零件（例如转子或电路板）。"
      "focus": "手部、零件以及装配图是画面中最清晰的元素。"
    },
    "overlayObject": {
      "type": "3D分解视图全息图",
      "relationshipToEnvironment": "悬浮在工作台上拆解的无人机零件正上方。",
      "transform": "一个完全渲染的、可旋转的3D模型，清晰地显示所持有的零件应该放置的位置。",
      "surfaceInteraction": "使用明亮、高对比度的黄色/橙色矢量线，配以方向箭头和零件编号；该全息图必须在空间位置上显示正确。"
      "components": {
        "partID": "转子支架（零件编号：M24B）",
        "instruction": "将其连接到主轮毂上（扭矩为1.5牛米）",
        "position": "悬浮在工作区的中心位置。"
      }
    },
    "technicalStyle": {
      "aspectRatio": "16:9",
      "photographyStyle": "产品/技术风格，高对比度",
      "camera": {
        "shotType": "特写",
        "angle": "略微从上方拍摄（设计师/技术视角）。"
        "depthOfField": "非常浅，仅聚焦于手部、零件和投影的装配图；背景应呈现柔和的模糊效果（散景）。"
      },
      "lighting": {
        "type": "荧光车间灯光和全息光效",
        "description": "来自上方的冷色调、明亮且均匀的白光，与黄色/橙色全息图的温暖、定向光效形成对比。"
      },
      "color": {
        "palette": "灰色、深红色、金属银色以及图形的霓虹黄色。"
      }
    }
  }
}
