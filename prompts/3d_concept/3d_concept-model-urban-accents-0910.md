---
id: 3d_concept-model-urban-accents-0910
title: "都市黄昏下的奢华街头风时尚大片"
category: 3d_concept
subcategory: "04_创意脑洞特效合成"
aesthetic: null
tags: ["街头", "奢华", "黄昏", "拼贴", "球鞋", "时尚", "混搭", "蕾丝"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
STYLE: Luxury + Streetwear fusion. Model in {"dress type" "silk slip dress with lace trim"}, diamond jewelry, and messy high ponytail. Raw urban setting juxtaposed with high-end fashion elements.
...
## 中文译文（源站提供）
惊艳的欧亚混血（中国/法国）模特，Instagram 动态，4:5 比例。

布局：不规则网格（主图像占据60%的空间，细节填充剩余空间）+ 分层（图像重叠以增加深度）。

方向：从左上角到右下角的对角线导流眼。

背景：日落时分，城市天际线在屋顶上被模糊的城市灯光映照，涂鸦艺术点缀其间，营造出一种高级时尚的编辑氛围。

产品：磨损效果图——展示银色高帮运动鞋，带有粉色点缀，主图上方叠加运动鞋纹理和设计的特写细节图。

动态效果：金粉颗粒在运动鞋和模特周围旋转，裙子的布料飘逸，光线捕捉到金粉。

色调：色彩对比——在温暖的夕阳背景下，酷炫的银色运动鞋与粉色的点缀在城市灰调中格外醒目。

风格：奢华与街头风的融合。模特身着{"连衣裙类型" "带蕾丝镶边的丝绸吊带裙"}，佩戴钻石珠宝，扎着凌乱的高马尾。原始的城市环境与高端时尚元素并存。

用户界面元素：无。

相机：哈苏H6D，85mm f/1.2，戏剧性边缘照明，柔和补光，合成拍摄。

风格关键词：街头风与奢华的融合、出人意料的优雅、金色时光的魅力、都市童话……时尚的手写签名“Willy”优雅地以小写字母形式置于右下角
