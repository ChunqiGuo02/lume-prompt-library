---
id: 3d_concept-the-bottle-river-0182
...
```json
{
  "composition": {
    "layout": "双面板垂直双联画",
    "symmetry": "镜像结构构图，色彩对比鲜明",
    "perspective": "高角度，异想天开的风景，中央有一个焦点瓶子",
    "central_focal_point": "一个超大、优雅的玻璃瓶，位于每个面板的上方中央"
  },
  "left_panel": {
    "theme": "温暖、丰收、金色芝麻",
    "title_text": "SESAME SILK",
    "color_palette": ["琥珀色", "金棕色", "青铜色", "深赭色", "落日橙"],
    "elements": {
      "liquid_source": "一顶金色的芝麻冠，将浓稠的琥珀色油倒入瓶中",
      "landscape": "烤谷物和秋色树叶连绵起伏的山丘",
      "river": "一条蜿蜒的粘稠金色油河从瓶底流出",
      "flora_and_fauna": ["切片牛油果", "整个椰子", "散落的芝麻", "点缀用的小蓝色野花"],
      "human_activity": "身着传统服饰的微型人物在收割、在油河上划船，并与巨大的种子互动"
    }
  },
  "right_panel": {
    "theme": "清新、活力、杏仁琼浆",
    "title_text": "ALMOND AMBROSIA",
    "color_palette": ["翠绿色", "天蓝色", "淡金色", "深紫色", "青色"],
    "elements": {
      "liquid_source": "一顶紫色葡萄和杏仁冠，将奶油状的白色杏仁奶倒入瓶中",
      "landscape": "郁郁葱葱、充满活力的热带森林，拥有茂密的绿色树冠和开花的藤蔓",
      "river": "一条蜿蜒、闪闪发光的蓝色水河从瓶底流出",
      "flora_and_fauna": ["成串的紫色葡萄", "切片牛油果", "椰子", "茂盛的绿叶", "蓝色勿忘我花"],
      "human_activity": "微型人物划着木船、游泳，并在河岸边采摘水果"
    }
  },
  "artistic_style": {
    "genre": "超现实主义插画 / 童话奇幻",
    "technique": "精细的数字绘画，带有柔和、氛围感的光线和发光的亮点",
    "influences": ["Maxfield Parrish 的光线运用", "民间艺术的人物设计", "商业饮料广告艺术"],
    "details": "种子和叶子上的复杂纹理，瓶子后面柔和的体积光晕，以及比例失真感（微型人物与巨大水果）"
  }
}
```
