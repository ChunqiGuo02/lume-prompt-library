---
id: 3d_concept-letter-the-solid-0571
title: "熔化变异文本"
category: 3d_concept
subcategory: "04_创意脑洞特效合成"
aesthetic: null
tags: ["迷幻", "怪诞", "卡通", "文字", "眼睛", "粘液", "融化", "撞色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: null
...
## 中文译文（源站提供）
创造一个迷幻、怪诞的卡通风格文字设计，上面写着“GNARLY”。将字母排列成水平直线。每个字母都应该是块状、融化的，并渗出明亮、冲突的扁平颜色，如粘液绿、霓虹黄和艳粉色。每个字母只能用一种纯色填充，没有渐变或过渡。所有滴落、融化和渗出物必须是纯黑色的，没有阴影或渐变。使用干净、坚实的填充和大胆的黑色轮廓使设计矢量友好。添加额外的黑白眼球，让每个字母都感觉像一个奇怪的变异生物。保持构图混乱但可读，就像周六早上卡通的变种版本。黑色背景。方形纵横比。
