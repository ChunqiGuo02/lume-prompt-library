---
id: 3d_concept-type-variety-fruit-0157
title: "创意美食艺术摆盘设计指南"
category: 3d_concept
subcategory: "04_创意脑洞特效合成"
aesthetic: null
tags: ["意面", "桥梁", "美食", "创意", "料理", "摆盘", "精致", "黄色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
```json
{
  "scene": "热带水果的现代主义亭台式布置",
  "elements": [
    {"type": "fruit", "variety": "芒果", "shape": "立方体"},
    {"type": "fruit", "variety": "奇异果", "shape": "切片"},
    {"type": "fruit", "variety": "火龙果", "shape": "楔形块"}
  ],
  "composition": {
    "geometry": "几何形露台",
    "surface": "反光玻璃"
  },
  "lighting": "影棚灯光增强鲜艳色彩和阴影",
  "shot": "电影级高清微距",
  "style": ["超现实纹理", "商业美食摄影美学"]
}
```
