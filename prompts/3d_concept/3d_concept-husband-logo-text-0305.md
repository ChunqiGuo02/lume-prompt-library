---
id: 3d_concept-husband-logo-text-0305
title: "她懂什么最有效"
category: 3d_concept
subcategory: "04_创意脑洞特效合成"
aesthetic: null
tags: ["汰渍", "复古", "广告", "五十年代", "洗衣房", "主妇", "丈夫", "衣物"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
# 正文 prompt
{
  ...
  "branding": {
    ...
    "slogan": {
      "text": "{"slogan text" "SHE KNOWS WHAT WORKS"}",
...
```json
{
  "format": { "aspect_ratio": "9:16" },
  "subject": {
    "description": "一位自信的家庭主妇自豪地拿着刚洗好的衬衫，她的丈夫看起来很满意。",
    "pose": "妻子拿着洗衣篮，丈夫检查衬衫",
    "clothing": {
      "wife": "带围裙的短袖连衣裙",
      "husband": "汗衫和休闲裤"
  ...
  "branding": {
    "logo": {
      "brand": "Tide",
      "logo_type": "复古 Tide 靶心标志",
      "color": "橙色和蓝色",
      "placement": "上方三分之一居中",
      "size": "大"
    },
    "slogan": {
      "text": "{\"slogan text\" \"她知道什么管用\"}",
      "font_style": "粗体紧凑无衬线字体",
      "letter_spacing": "紧密",
      "case": "全部大写",
      "color": "蓝色",
      "placement": "下方三分之一居中",
      "text_rules": ["强烈对比", "1950年代印刷风格"]
    }
  },
  "background": {
    "setting": "经典洗衣房",
