---
id: 3d_concept-the-screen-phone-0404
title: "手机幻境：女子跃屏而出"
category: 3d_concept
subcategory: "04_创意脑洞特效合成"
aesthetic: null
tags: ["视错觉", "秋日", "公园", "穿搭", "手机", "拍照", "棕色调", "金戒指"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
"type": "{"bottom type" "Mini Skirt and Leather Boots"}",

"color": "{"bottom color" "Dark Grey (skirt), Brown (boots)"}",
...
"description": "一张超现实的光学错觉照片。一位年轻的白人女性似乎正从一只手中握着的智能手机屏幕中走出来。屏幕上显示着相机界面，捕捉到她的靴子，而她真实的上半身则从手机中延伸到现实世界。",

"mirror_rules": "确保手机屏幕清晰显示 iOS 相机用户界面（快门按钮、模式文字）。手写注释必须清晰可辨且不镜像。",
...
"makeup": "自然魅力妆，哑光粉底，轮廓分明的欧洲五官",

"features": "高鼻梁，双眼皮，清晰的下颌线"

},

"hair": {

"color": "{"hair color" "深棕色"}",

"style": "长而蓬松的波浪卷发，发量丰盈",
...
"position": "躯干和头部垂直从手机中伸出，双腿显示在屏幕上",
...
"effect": "精致的服装，高质量的纺织品摄影"

},

"bottom": {

"type": "{"bottom type" "迷你裙和皮靴"}",

"color": "{"bottom color" "深灰色（裙子），棕色（靴子）"}",

"details": "靴子在用户界面元素下方，在屏幕上可见"
...
"device": "带酒红色手机壳的智能手机。屏幕处于活动状态且细节丰富：显示 iOS 相机应用界面（底部白色圆形快门按钮，'PHOTO' 文字）。",

"prop": "手机屏幕上：白色手写风格文本叠加，带有指向服装元素的箭头（例如，带有箭头的文字“麂皮夹克”，带有箭头的“皮靴”）。"
...
"texture": "锐利的屏幕像素，屏幕上的指纹污迹，逼真的织物纹理",

"lighting": "阴天柔和的自然光",

"depth_of_field": "背景长凳模糊（散景），手机屏幕用户界面和主体清晰"
...
"wall_color": "绿色长凳，灰色地面",

"elements": [

"带有文字 'Le silence' 的绿色公园长凳",
