---
id: story_board-marble-action-environment-0152
title: "奢适生活美学：晨间仪式与静谧时光"
category: story_board
subcategory: "09_故事分镜角色设定"
aesthetic: null
tags: ["女性", "休闲", "健康", "养生", "护肤", "拉伸", "早餐", "米色系"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
# 正文 prompt
{
  ...
  "wardrobe": {
    "outfit_base": "Matching ribbed {"outfit color" "beige/cream"} activewear set.",
    "variations": [
...
{
  "overall_theme": {
    "description": "一系列精心策划的四幅超逼真插画，展现奢华、注重健康的精致生活方式。",
    "mood": "平静、宁静、平衡、精致、平和、焕发活力。",
    "style": "极简主义、高端、现代、干净美学、令人向往。"
  },
  "subject": {
    "description": "年轻女性。",
    "appearance": {
    ...
    "expression": "宁静、沉着、微微一笑、专注。"
  },
  "wardrobe": {
    "outfit_base": "配套的罗纹 {\"outfit color\" \"米色/奶油色\"} 运动服套装。",
    "variations": [
      "无袖短款上衣和高腰打底裤。",
      "长袖短款上衣和高腰打底裤。"
    ],
  ...
  "environmental_details": {
    ...
    "color_palette": {
      "dominant": ["暖米色", "奶油色", "白色", "大理石灰"],
      "accents": ["绿色（植物）", "金色（固定装置、细节）", "天然木材", "柔和紫色（冰沙）"]
    },
    "materials": ["白色大理石", "浅色木材", "石头", "陶瓷", "玻璃", "亚麻"]
  },
  "scenes": [
    {
      "location": "现代奢华厨房",
      "environment": "白色大理石岛台和台面，白色摇板橱柜，金色五金件，嵌入式酒柜，大窗户。",
      "pose": "站在岛台旁，身体略微倾斜，向下看。",
      "action": "在一个小碗里搅拌热饮。",
      "props": ["陶瓷碗", "木制打蛋器", "蒸汽", "带'H'的马克杯", "酒柜"]
    },
    {
      "location": "高端浴室",
      "environment": "大型背光镜，白色大理石梳妆台，白色墙壁，兰花盆栽。",
      "pose": "站在镜子前，一只手将产品涂抹在脸上。",
      "action": "涂抹护肤品。",
      "props": ["化妆棉", "护肤品瓶", "点燃的 Diptyque 蜡烛", "整个椰子", "玻璃罐"]
    },
    {
      "location": "极简主义健康空间",
      "environment": "带弧形拱门的米色纹理墙壁，石制喷泉，花瓶中的桉树。",
      "pose": "全身伸展，双臂举过头顶，头向后仰，闭着眼睛。",
      "action": "伸展。",
      "props": ["石制水景", "大瓶香水", "桉树花瓶"]
    },
    {
      "location": "明亮咖啡角",
      "environment": "圆形白色大理石桌，藤椅，俯瞰街道的大窗户。",
      "pose": "坐在桌旁，边吃边微笑，手里拿着叉子。",
      "action": "吃牛油果吐司。",
      "props": ["盘子里的牛油果吐司", "玻璃杯里的紫色冰沙", "叉子", "Assouline 书"]
    }
  ]
}
```
