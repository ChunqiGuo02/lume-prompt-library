---
id: story_board-sheet-illustration-textures-0291
title: "角色设计拆解图"
category: story_board
subcategory: "09_故事分镜角色设定"
aesthetic: null
tags: ["手绘", "插画", "时尚", "女性", "黑色", "服装", "配饰", "表情"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "4:3"
...
## 中文译文（源站提供）
这是一份采用手绘插画风格的时尚风格概念分解图。  



**中心部分：**  

一位时尚自信的女性角色的全身形象，散发着淡淡的性感魅力（但并不露骨），姿势充满动感却又自然。  
...
- **服装层次**：包括外套、内衣、紧身衣（蕾丝、透明材质）以及具有精美图案的塑形衣。  

- **面部表情**：展示3-4种不同的面部表情（中性、害羞、惊讶、专注）。  

- **特写细节**：展示面料褶皱的质感、皮肤细节以及手部动作。  

- **生活方式与配饰**：展示一个打开的手提包，里面装有日常用品，如口红、香水、迷你化妆镜、护手霜、日记本和营养补充品。  

- **材质说明**：每件物品旁边都配有手写风格的注释（例如：“柔软的蕾丝”、“哑光皮革”、“颜色#520”）。  



**背景设计：**  

采用柔和的米色或羊皮纸质感，营造出设计草图本的氛围。  

**光线处理：**  

运用清晰柔和的阴影效果，使整个画面和谐统一。  



**最终输出：**  

高质量2D插画，分辨率达到4K，完美平衡了性感与时尚感。  
