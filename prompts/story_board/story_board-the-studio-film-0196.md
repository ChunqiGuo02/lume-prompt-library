---
id: story_board-the-studio-film-0196
title: "时尚大片胶片拼贴模板"
category: story_board
subcategory: "09_故事分镜角色设定"
aesthetic: null
tags: ["胶片", "影棚", "时尚", "拼贴", "简约", "复古", "中性色", "人像"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
1. 选择一张人物参考图片。  
2. 复制并粘贴提供的提示内容。  
3. 修改图片中央的手写签名名称，替换为您想要的名称。  

**提示内容：**  
```json
{
  "项目标题": "高端工作室时尚插画：5格宽幅电影风格拼贴画（High-End Studio Fashion Editorial '5-Panel Wide Film' Collage)":  
  "布局结构": "非对称双列布局：左侧列包含2个堆叠的图片；右侧列包含3个堆叠的图片。两列的总高度相同。"  
  "宽高
