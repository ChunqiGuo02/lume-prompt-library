---
id: story_board-true-reference-match-0131
title: "复古风少女四格写真模板"
category: story_board
subcategory: "09_故事分镜角色设定"
aesthetic: null
tags: ["复古", "法式", "温柔", "浪漫", "优雅", "发饰", "碎花", "裙子"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
version: "1.0.0"
related_to: ["interior-true-reference-match-001"]
---
...
# 正文 prompt
{
  "image_prompt": {
    ...
    "hair": {
      ...
      "accessory": "{\"hair accessory\" \"large cream ribbon bow\"}",
    ...
    "outfit": {
      "dress": {
        "color": "white",
        "pattern": "{\"dress pattern\" \"blue floral print\"}",
...
```json
{
  "image_prompt": {
    ...
    "panel_3": {
      "view": "镜子自拍",
      "pose": "手机遮挡部分脸部，身体侧向倾斜",
      "framing": "腰部以上",
      "match_reference": true
    },
    "panel_4": {
      "view": "侧面肖像",
      "pose": "头转向肩膀看向镜头，将花束抱在胸前",
      "expression": "柔和浪漫的凝视",
      "framing": "上半身躯干",
      "match_reference": true
    },
    ...
    "hair": {
      "style": "长直发，半扎",
      "accessory": "{\"hair accessory\" \"大号米色丝带蝴蝶结\"}",
      "placement": "与参考图片完全相同的位置"
    },
    "outfit": {
      "dress": {
        "color": "白色",
        "pattern": "{\"dress pattern\" \"蓝色花卉印花\"}",
        "style": "复古泡泡袖连衣裙",
        "neckline": "方领"
      },
      "jewelry": [
