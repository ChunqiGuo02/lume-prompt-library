---
id: story_board-texture-lips-angle-0265
title: "草莓甜心高定美妆写真"
category: story_board
subcategory: "09_故事分镜角色设定"
aesthetic: null
tags: ["美妆", "写真", "拼贴", "暖调", "超写实", "淡紫", "金发", "草莓"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
  ...
  "global_assets": {
    "subject_definition": {
      "hair": {
        "style": "长发，微卷，蓬松",
        "texture": "自然，发丝分明",
        "behavior": "凌乱但有型，修饰脸部和肩部"
      },
      "complexion": {
        "skin_texture": "毛孔可见，超写实",
        "finish": "水润，玻璃肌效果",
        "makeup": {
          "cheeks": "浓郁腮红",
          "lips": "高光泽，饱满，自然粉色",
    ...
    "environment_definition": {
      "studio_setup": {
        "background": "无缝纸背景，柔和米白/米色",
        "atmosphere": "干净，温暖，私密"
      },
      "lighting_rig": {
        "key_light": "大型柔光箱 (左前方)",
        "fill_light": "反光板 (右侧)",
        "highlights": "唇部、颧骨和肩部的镜面高光"
      }
    }
  },
  "panel_architecture": [
