---
id: story_board-the-panel-subject-0226
title: "热带海滩度假四格写真模板"
category: story_board
subcategory: "09_故事分镜角色设定"
aesthetic: null
tags: ["沙滩", "度假", "四宫格", "女性", "泳装", "草帽", "黄花", "晴天"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
      "outfit": {
        "swimwear": "{"swimsuit color" "Black"} one-piece swimsuit (monokini) with a center cutout and plunging neckline.",
...
```json
{
  "type": "2x2 照片拼贴（四格网格）。",
  "theme": "热带海滩度假写真。",
  "layout": "同一主体在白色沙滩上的四张不同照片。",
  "consistency": "所有照片中的主体、服装和地点保持一致。"
},
"subject_details": {
  "demographics": "年轻亚洲女性，肤色白皙。",
  "hair": "黑色长发，梳成两个松散的辫子（麻花辫）。",
  "outfit": {
    "swimwear": "{\"swimsuit color\" \"Black\"} 黑色连体泳衣（monokini），带中间镂空和深 V 领。",
    "bottoms": "白色超短裙或缠绕在腰间的纱笼。",
    "accessories": "宽边草帽、连接帽子或眼镜的长珍珠项链、金色手镯、耳后别着一朵大黄色花朵。"
  }
},
"environment": {
  "location": "阳光明媚的热带海滩。",
  "elements": "白色沙滩、碧蓝色海水、远处的绿色岛屿/山丘、蓝天白云。",
  "props": "红白条纹手提袋/沙滩巾。"
},
"panel_breakdown_poses": {
  "panel_1_top_left": {
    "framing": "低角度，全身。",
    "pose": "站立，身体微微后倾，仰望太阳。手持条纹包。",
    "background": "顶部可见棕榈树叶，蓝天。"
  },
  "panel_2_top_right": {
    "framing": "高角度/俯视。",
    "pose": "仰卧在沙滩上，双腿伸展（一膝弯曲），头部转向侧面，面向镜头。身下铺着红色条纹毛巾。",
    "background": "沙滩纹理和水边的一艘红色小船。"
  },
  "panel_3_bottom_left": {
    "framing": "自拍角度/特写。",
    "pose": "主体手持相机（手臂伸展），直视镜头。头部微倾，展示帽子和花朵。",
    "background": "以蓝天为主。"
  },
  "panel_4_bottom_right": {
    "framing": "中景，坐姿。",
    "pose": "坐在沙滩上，调整泳衣肩带或项链。随意地向下看或看向侧面。",
    "background": "海平面和远处的山脉。"
  }
},
"camera_technical_values": {
  "lens": "广角镜头（16mm - 24mm），用于自拍和低角度拍摄，以突出高度和背景风景。",
  "aperture": "f/8.0（景深大，保持明亮的阳光背景清晰）。",
  "shutter_speed": "1/500s（明亮的白天）。",
  "iso": "ISO 100。",
  "lighting": "强烈的自然阳光。高对比度，清晰的阴影，鲜艳的色彩。"
}
```
