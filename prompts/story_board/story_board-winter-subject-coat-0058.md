---
id: story_board-winter-subject-coat-0058
title: "冬日雪景中青年男子时尚穿搭多角度写真"
category: story_board
subcategory: "09_故事分镜角色设定"
aesthetic: null
tags: ["冬季", "雪景", "男性", "穿搭", "时尚", "拼贴", "写实", "户外"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "4:3"
...
```json
{
  "style": "电影感、写实、高分辨率、多镜头拼贴、五格网格",
  "subject": "20 多岁年轻男子，自然面部特征，自信放松的表情",
  "scene": "雪地户外小径，冬季景观，鹅毛大雪，寒冷天气氛围",
  "outfit": "时尚冬装大衣、羊毛围巾、手套、修身冬裤、冬靴、舒适的毛线帽",
  "action": "随意行走，手持热饮，整理大衣，自然环顾四周",
  "composition": "五格画面展示不同角度：正面特写、侧面轮廓、面部近景、行走动作抓拍、过肩视角",
  "lighting": "柔和自然日光，主体轻微高光，微妙的轮廓光，逼真的阴影",
  "camera": "混合使用 35mm 和 85mm 镜头，浅景深，专业摄影风格",
  "mood": "平静、电影感、生活时尚摄影",
  "quality": "8k 超高清细节，锐利对焦，干净背景，照片级真实感，极少噪点"
}
```
