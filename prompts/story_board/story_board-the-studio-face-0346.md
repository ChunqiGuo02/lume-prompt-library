---
id: story_board-the-studio-face-0346
title: "高定时尚人像九宫格：湿发少女多表情肖像"
category: story_board
subcategory: "09_故事分镜角色设定"
aesthetic: null
tags: ["人像", "湿发", "白色", "棚拍", "肖像", "女性", "表情", "时尚"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
```json
{
  ...
  "prompt": "保持相同的面部和身份。垂直高定时装美容拼贴画，以 3x3 网格排列，特写肖像置于干净、无缝的纯白色影棚背景前。明亮、均匀的正面影棚照明，柔和补光，消除刺眼阴影，营造光泽的时尚杂志效果。颧骨、鼻梁、嘴唇和白色 T 恤领口有微妙的高光，而背景保持统一的白色。年轻女性的构图从颈部中部向上，肩膀方正，在每个面板中都面向镜头。长而松散的湿发自然地垂落在肩膀上，部分遮住脸部，几缕湿发轻轻地贴在脸颊和下颌线上，一些垂向嘴唇，增加了动感和原始、不费力的美感。湿润的质地带有柔和的光泽，捕捉光线，将光泽与自然的瑕疵形成对比。在整个网格中，她的面部表情变化显著；其中一个表情包括伸出舌头。",
  "negative_prompt": "低分辨率、模糊、刺眼阴影、不均匀光照、偏色、背景纹理、多余肢体、扭曲面部、过度曝光高光、曝光不足区域",
  "aspect_ratio": "2:3",
  "style": "high-fashion editorial",
  "lighting": "bright even studio lighting, soft fill",
  "background": "pure white seamless studio",
  "output": {
    "grid": "3x3",
    "orientation": "vertical",
    "framing": "mid-neck upward"
  }
}
```
