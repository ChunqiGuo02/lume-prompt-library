---
id: story_board-the-more-original-0102
title: "四格动态视角下的时尚写真，突出肢体特写与空间纵深感"
category: story_board
subcategory: "09_故事分镜角色设定"
aesthetic: null
tags: ["写实", "人像", "室内", "黑色", "皮草", "丝袜", "广角", "透视"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
## 中文译文（源站提供）
将原始照片转换为 4 种不同风格的戏剧性、超逼真、超详细图像，每种风格都是中景特写广角镜头，具有极端的动态摄像机角度（包括更多来自正下方或正上方的网格视图），其中一个或多个身体部位紧邻镜头并显得巨大，身体的其余部分在透视中强烈后退，同一个人在原始环境的扩展版本中摆出时尚、复杂、有力的姿势，具有电影级布光、高对比度、清晰的纹理和精确的色彩分级。
