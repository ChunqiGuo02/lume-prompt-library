---
id: "video-anime-shots-animation-001"
title: "现代动漫精细动作战斗序列的 JSON 提示词"
category: video
subcategory: "04_动漫游戏视觉与IP改编"
aesthetic: null
tags: ["Seedance 2.0", "动作动漫", "sakuga", "高质量", "流畅战斗", "角色表情", "动态摄像", "背景运动"]
recommended_models: []
recommended_params:
  aspect_ratio: "16:9"
  quality: null
...
## 中文译文（源站提供）
{
  ...
  "genre": "动漫动作战斗",
  "style": {
    "animation_style": "高质量现代动漫萨库加",
    "aesthetic": "现代动漫",
    "finish": "完全完成的专业制作品质",
    "painting": "专业动漫绘画",
    "lighting": "电影化动漫灯光",
    "shadows": "完整渲染阴影，具有抛光深度和对比",
    "resolution": "最高分辨率"
  },
  "motion_quality": {
    "fluidity": "极其流畅且专业动画",
    ...
    "animation_priority": "所有角色动作必须感觉生动、响应迅速、有重量感且连贯"
  },
  "fight_design": {
    "core_description": "一场具有独特、精心执行编舞的动漫战斗",
    "choreography": [
      "多次交锋",
      "创意攻击与防御流动",
      "清晰的冲击节拍",
  ...
  "camera": {
    ...
    "editing": "锐利、激动人心的动漫动作剪辑，具有强烈视觉节奏"
  },
  "character_animation": {
    "face": "高度表现力的动漫面部动画",
    "eyes": "细致眼睛动画，情感强度与清晰焦点",
    "hair": "流畅头发动画，自然响应运动、力量和速度",
    "fabric": "布料与服装移动必须动态且物理响应",
    "limbs": "手臂和腿部必须解剖学清晰，快速且在战斗中专业动画"
  },
  "backgrounds": {
    "movement": "背景必须具有实质性动画运动和视觉能量",
    "integration": "背景运动应增强速度、规模与冲击力，而不降低战斗可读性",
    "quality": "完全绘制并抛光的动漫背景"
  },
  "dialogue": {
    "rule": "如果存在任何对白，必须仅使用英文"
  },
  "visual_keywords": [
    "萨库加",
    "现代动漫",
