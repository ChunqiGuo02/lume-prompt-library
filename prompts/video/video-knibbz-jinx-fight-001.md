---
id: "video-knibbz-jinx-fight-001"
title: "形拳动画战斗编排提示"
category: video
subcategory: "04_动漫游戏视觉与IP改编"
aesthetic: null
tags: ["Seedance 2.0", "动作", "武术", "翼拳", "快节奏", "单边战斗", "失败感", "震波特效"]
recommended_models: []
recommended_params:
  aspect_ratio: "16:9"
  quality: null
...
## 中文译文（源站提供）
扮演一名拥有深厚咏春与中国武术格斗风格知识的动漫行业专业动作编排师。

创作一个节奏快速、动态十足的战斗场景，主角为 Jinx @图片4 与 Knibbz @图片5。Jinx 在此战中面部略带泥土和划痕，类似于 @图片6 的效果。他们双脚来回摆动，Jinx 慢慢失去地盘，而 Knibbz 则不断推进。这是一场单方面的对决，尽管 Jinx 尽力而为，却始终无法给 Knibbz 留下干净的一击。Jinx 试用一系列咏春式攻击（快速拳、极速旋转踢、连环拳接蝴蝶踢等），但所有动作最终都被 Knibbz 在最后时刻挡住或闪避。

镜头运动包括快速 360 度轨道，关键击打与闪躲瞬间的特写（ECU）以及面部表情的硬切。  
冲击波效果、风爆发效应及 Knibbz 重拳所产生的狂风只在其更重攻击时出现。

整体氛围绝望无助，Jinx 被 Knibbz 完全压制。不得添加额外对白或角色，只使用音频参考来呈现 Knibbz 的声音。所有 Jinx 的攻击均面向 Knibbz。
