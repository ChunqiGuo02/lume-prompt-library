---
id: "video-red-energy-radial-001"
title: "详细JSON提示词，用于维度斩击效果"
category: video
subcategory: "04_动漫游戏视觉与IP改编"
aesthetic: null
tags: ["Seedance 2.0", "Dimensional Slash", "Space Shattering", "Anime 风格", "能量轨迹", "径向裂纹", "玻璃碎片", "宇宙背景"]
recommended_models: []
recommended_params:
  aspect_ratio: "16:9"
  quality: null
...
## 中文译文（源站提供）
{
  "effect_analysis": {
    "theme": "维度斩击与空间破碎",
    "primary_colors": ["鲜艳红色", "深黑色", "亮白色", "淡青色（角色）"],
    "visual_elements": [
      "锐利的弯曲能量轨迹",
      "放射状玻璃破裂线条",
      "碎片与漂浮岩石碎块",
  ...
  "reproduction_prompts": {
    "character_action": {
      "description": "角色攻击动作用",
      "prompt": "动态动作镜头，动漫风格女孩，淡蓝色头发，持有发光剑，执行宽幅水平斩击，鲜艳红色能量弧形轨迹，火花与光粒子，白色网格地板，电影级照明。"
    },
    "impact_shatter": {
      "description": "空间破裂瞬间演出用",
      "prompt": "屏幕破碎效果，放射状裂纹从中心扩散，红黑高对比线条，碎玻璃碎片向摄像机飞去，中间强烈白光爆炸，高能量，锐利边缘。"
    },
    "cosmic_explosion": {
      "description": "后半段空间崩溃与宇宙背景用",
      "prompt": "宇宙爆炸余波，漂浮的暗色岩石碎片，发光红色星云背景，星星与星尘，电影景深，高分辨率，戏剧性冲击，红光射线穿透黑暗。"
    }
  },
  "technical_parameters": {
    "rendering_style": "高保真动漫/游戏VFX",
    "motion_keywords": ["快速过渡", "放射模糊", "屏幕抖动", "时间膨胀（慢动作）"],
    "aspect_ratio": "16:9"
  }
}
