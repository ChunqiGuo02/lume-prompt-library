---
id: "video-the-red-screen-001"
title: "复杂动作序列视频提示"
category: video
subcategory: "04_动漫游戏视觉与IP改编"
aesthetic: null
tags: ["Seedance 2.0", "轨道运动", "光效", "能量爆炸", "金色框架", "红色符文", "紫色火焰", "黑暗背景"]
recommended_models: []
recommended_params:
  aspect_ratio: "16:9"
  quality: null
...
## 中文译文（源站提供）
深海蓝背景。几件小物体沿着宽大的圆形轨道漂移——旋转中心位于画面右上角，摄像机从外缘观看。一个装饰盒子、一颗条纹球和几个嘉年华道具依次拱过，向左弯曲穿过视野。稀疏的彩纸条和金币在空气中漂浮。

三枚奶油色矩形护符出现在同一轨道上，每个都刻有不同的绘制徽章。它们一次接着一次靠近摄像机，沿宽弧扫过画面。

一张发光金框卡片携带角色插图沿轨道进入。它漂移到屏幕中央，摄像机拉近。金色边框膨胀至超出屏幕边缘后消失——只剩下角色。金色闪光和十字形火焰围绕揭示。

红色护符在角色周围以不规则圆轨道旋转。火焰色丝带穿过头发。一颗火球在伸出的手附近点燃，膨胀至几乎填满屏幕的一半，呈现白热光。火球收缩回向双手。能量转换——火焰化为噼啪作响的紫色弧线。护符变成大型发光红矩形，覆盖着火纹图案，以阵列展开。

角色旋转，护符扩散更宽。摄像机推进——金色光芒点燃双眼，保持一拍电荷。拉回至全身。白金爆炸向外喷射。护符朝摄像机发射——一个大型护符冲锋前进，暗面旋转着品红波纹，增长直至覆盖整个画面。黑。

新场景。无角色可见。红色发光矩形在深空中以宽圆弧划过，拖带火焰。它们聚集到屏幕中央的一个点上。撞击时，红色闪光填满屏幕——热粉色晕染扩散，然后消退。

中心有红橙发光核心，螺旋能量弧环绕其转动。更多红矩形从各方聚集到中央能量球体。所有物压缩成一个明亮点——彻底白屏。

火球向外爆炸，伴随辐射神之光束。它扩展至半屏，然后散开。红色矩形碎片漂浮在火焰中。颜色变化——红变品红，品红转紫。在一帧中，冷蓝紫取代所有。新场景。
