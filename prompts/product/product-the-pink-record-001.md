---
id: "product-the-pink-record-001"
title: "黑发少女唱片店淘碟写真"
category: product
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["女生", "唱片店", "黑胶", "复古", "Y2K", "休闲", "霓虹", "潮流"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
{
  "subject": {
    "description": "一位身材苗条的年轻东亚女性。侧身站立，双手拿着一张黑胶唱片，仔细端详。",
    "expression": "专注、平静、若有所思。她正低头看着专辑封面。",
    "pose": "侧身对着镜头，正在唱片架中翻找。"
  },
  "clothing": {
    "top": "白色露肩印花 T 恤，上面有黑色涂鸦/漫画风格的图案。肩带上系有粉色丝带。",
    "bottom": "浅色水洗、宽松的牛仔工装裤，带有大口袋。",
    "footwear": "白色复古运动鞋，配有蓝色条纹和生胶鞋底。"
  },
  "hair": {
    "color": "乌黑。",
    "style": "长发，波浪卷发自然垂落在背部。中分或略微偏分。"
  },
  "face": {
    "makeup": "柔和、年轻的妆容。脸颊和鼻子上涂有明显的粉色腮红，柔和的玫瑰色唇妆，睫毛根根分明。"
  },
  "accessories": {
    "items": "黑色皮革单肩包，配有银色铆钉和五金件，并用浅粉色丝带蝴蝶结装饰。简约的银色项链和小耳环。"
  },
  "environment": {
    "setting": "拥挤的复古唱片店内部。",
    "details": "一排排装满黑胶唱片的木制唱片架。墙壁上密密麻麻地挂满了装裱好的音乐海报、专辑封面和霓虹灯牌（一个蓝色的“OPEN”标志和一个粉色的长方形标志）。背景中模糊可见其他顾客正在浏览。",
    "atmosphere": "繁忙、复古、都市。"
  },
  "lighting": {
    "source": "室内混合人工照明。",
    "quality": "头顶的荧光灯提供整体照明，背景中粉色和蓝色霓虹灯发出多彩的环境光。",
    "tone": "霓虹灯的冷色调与主体上的中性照明形成对比。"
  },
  "camera": {
    "shot_type": "中全景（膝盖以上）。",
    "focus": "主体对焦清晰。适度的景深使背景中繁忙的海报和其他购物者变得模糊。",
    "perspective": "平视，侧面视角。"
  },
  "style": {
    "aesthetic": "Y2K / 娇媚街头时尚与复古垃圾摇滚风格的结合。抓拍式生活摄影。",
    "mood": "酷炫、时尚、沉浸在音乐文化中，具有 Instagram/Pinterest 风格的美感。"
  }
}
```
