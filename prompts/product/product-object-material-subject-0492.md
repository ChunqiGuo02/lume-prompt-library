---
id: product-object-material-subject-0492
title: "报纸折纸雕塑：爱因斯坦与鹰头艺术肖像"
category: product
subcategory: "12_手工玩具手办"
aesthetic: null
tags: ["爱因斯坦", "纸艺", "雕塑", "报纸", "折纸", "肖像", "侧颜", "黄色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
```json
{
  "concept_type": "超现实物体雕塑摄影",
  "subject": {
    "object_identity": "{argument name=\"subject identity\" default=\"Einstein\"} 的头部",
    "orientation": "侧面轮廓，朝右",
    "expression": "警觉而专注"
  },
  "material_construction": {
    "primary_material": "纸",
    "material_source": "折叠的报纸页面",
    "folding_technique": "分层折纸式折叠",
    "layer_density": "高密度分层"
  },
  "surface_details": {
    "text_visibility": "部分可读的报纸文字",
    "color_accents": ["柔和的黄色", "柔和的灰色"],
    "edge_quality": "锐利、清晰的折痕"
  },
  "composition": {
    "framing": "紧凑的物体肖像",
    "perspective": "视平线",
    "background": "深灰色工作室墙壁",
    "negative_space": "极简，画廊风格"
  },
  "lighting": {
    "type": "柔和定向工作室灯光",
    "direction": "左侧照明",
    "shadow_behavior": "墙壁上投射出微妙的自然阴影"
  },
  "mood": "知性、精致、沉思",
  "style": "美术概念雕塑摄影",
  "negative_prompt": "卡通、奇幻生物、凌乱的拼贴画、过度曝光的白色、CGI 纹理、水印"
}
```
