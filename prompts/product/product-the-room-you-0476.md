...
# 正文 prompt
3D miniature isometric room with Nano Banana Pro. More examples in the comments.
...
## 中文译文（源站提供）
- **房间描述**：  
  一个等轴测的 3D 立方体形状的微型房间（采用浅层切割方式呈现真实立方体的结构；所有元素都严格限制在立方体内部）。房间内包含以下内容：  
    - **主题**：  
    - **家具**：  
    - **具体杂物**：  
    - **墙面装饰**：  
