---
id: product-subject-details-chocolate-0093
title: "奢华巧克力美食摄影创意方案"
category: product
...
version: "1.0.0"
related_to: ["landscape-subject-details-chocolate-002"]
---
  ...
  "images": [
    {
      ...
      "background": "{"background color" "teal-to-navy"} gradient with suspended gold motes",
...
## 中文译文（源站提供）
"style": "超写实食物摄影，奢华编辑风格，微距细节，自然纹理",
  "images": [
    {
      "id": "image_1",
      "subject": "什锦果仁糖塔",
      ...
      "details": {
        ...
        "accent": "每种馅料类型在层间过渡处放置一颗独特的金属金色坚果",
      ...
      "background": "{"background color" "teal-to-navy"} 渐变色，带有悬浮的金色微粒",
      "mood": "奢华、放纵、匠心独运"
    },
    {
      "id": "image_2",
      "subject": "红宝石巧克力片",
      "composition": "漂浮在黑色纹理衬纸上方的六边形巧克力块",
      "details": {
        "surface": "手工调温的瑕疵，半透明的红宝石粉色",
        "inclusions": "嵌入的果肉斑点透过巧克力可见",
        "motion": "红宝石可可碎粒从其中一块巧克力上以逼真的重力弧线落下"
      },
      "lighting": {
        "key": "顶部 12 点钟方向主光",
        "rim": "3 点钟方向柔和的粉色轮廓光",
        "effects": "真实的阴影，增强的半透明度"
      },
      "background": "黑色到暖粉色的径向渐变，带有微妙的闪光斑点",
      "mood": "现代、活力、漂浮的张力"
    },
    {
      "id": "image_3",
      "subject": "白巧克力夹心糖",
      "composition": "透明玻璃支架上的有机簇状排列",
      "details": {
        "marbling": [
          "中央夹心糖带有不规则的橙色百香果纹路",
          "周围夹心糖带有粉色覆盆子漩涡",
