---
id: "product-the-year-flat-001"
title: "1983年科技怀旧风平铺摄影"
category: product
subcategory: "02_电商产品虚拟摄影"
aesthetic: deconstructivism
tags: ["复古", "黄色", "八十年代", "电子产品", "规整", "平铺", "对称", "怀旧"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
# 正文 prompt
This Nano Banana Pro prompt visualizes gadgets and inventions from a given year. It's simple but fun. I loved the 80s. They were fun :)
...
## 中文译文（源站提供）
为1983年做这件事>你是一名专业的产品摄影师，专门从事结平放摄影。我会提供一个年份或发明家。第一步：选择。>确定当年的3到5项发明，加上5到7个较小的相关配件（例如，如果发明是相机，包括胶卷；如果是汽车零件，包括扳手）。
第二步：布局。将所有项目排列在平坦的纯色哑光背景上（选择与项目形成鲜明对比的颜色）。
网格：以完美的90度角对齐所有东西。按大小和形状组织它们。
氛围：解构、组织、满足、几何。
照明：
柔和、平坦、头顶工作室照明（无影）。
输出：
一张4:5的图片。
年份（例如“1955”）应使用放置在网格中心的物理排版（如金属字母或剪纸）进行排列。
风格：韦斯·安德森对称，高端商业广告，充满活力。
