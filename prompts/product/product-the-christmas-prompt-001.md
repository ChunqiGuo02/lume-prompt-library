---
id: "product-the-christmas-prompt-001"
title: "圣诞彩球中的AI工程师"
category: product
subcategory: "12_手工玩具手办"
aesthetic: null
tags: ["圣诞", "3D", "Q版", "可爱", "玻璃球", "挂饰", "科技", "AI"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
## 中文译文（源站提供）
一个用红色丝带悬挂的透明圣诞装饰球。球内是一个根据参考图像重新设计的可爱 3D 角色模型。这个角色坐在一张迷你化的未来主义风格的人工智能办公桌前，桌面上有三块发光的全息屏幕，显示着神经网络和代码信息。再添加一些小植物、一个迷你咖啡杯、柔和的桌面灯光、悬浮的 UI 图标，以及底部的雪花装饰。整个场景散发着温暖的节日氛围，玻璃表面
