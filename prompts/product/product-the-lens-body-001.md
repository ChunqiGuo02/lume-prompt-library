---
id: "product-the-lens-body-001"
title: "漫画风多角度街拍生成器"
category: product
subcategory: "04_创意脑洞特效合成"
aesthetic: japanese-zen-garden
tags: ["日系", "漫画风", "三格", "街拍", "透视", "潮流", "休闲", "美女"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
①人物の写真をアップロード
②このプロンプトをそのまま貼る
This app uses the motifs in the attached images to generate multi-angle shots and create a three-panel manga-style scene with powerful effects.
...
## 中文译文（源站提供）
**相机与视角设置：**  
– 始终将相机角度与原始图片有显著差异。例如，可以使用以下戏剧性的视角：  
• 从正下方拍摄的虫眼视角  
• 从正上方拍摄的鸟瞰视角  
• 从地面拍摄的极低角度  
• 从正上方拍摄的高角度  
• 荷兰视角（45度斜角）  
– 始终添加明显的透视效果：离镜头最近的身体部位应显得更大，而其他部位则应逐渐远缩。  
– 最终效果应完全风格化（类似大胆的时尚或街头摄影作
