---
id: product-food-bite-cheese-0679
title: "超写实汉堡咬痕特写，银河内核，蒸汽升腾，引爆食欲"
category: product
subcategory: "12_手工玩具手办"
aesthetic: null
tags: ["汉堡", "星空", "超写实", "美食", "创意", "特写", "热气", "暗调"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
# 正文 prompt
{
  ...
  "subject": {
    "description": "large gourmet {argument name="food item" default="burger"} captured mid-bite",
...
```json
{
  "content_goal": "具有极致诱惑力的病毒式美食视觉",
  "image_type": "超写实美食动作摄影",
  "visual_style": {
    "aesthetic": "电影级美食专题片，超现实",
    "vibe": "多汁、放纵、令人无法抗拒",
    "realism": "高端商业美食写实主义"
  },
  "composition": {
    "framing": "特写或中景特写",
    "camera_angle": "略低或正面",
    "subject_position": "居中英雄咬食瞬间",
    "perspective": "景深丰富，前景焦点突出"
  },
  "subject": {
    "description": "大型美食 {argument name=\"food item\" default=\"汉堡\"} 咬食中",
    "bite_action": "可见咬痕，分层被压缩",
    "ingredients": "多汁牛肉饼、融化奶酪、新鲜生菜、番茄、酱汁滴落",
    "details": "奶酪拉丝、酱汁光泽、蒸汽升腾"
  },
  "texture_details": {
    "bun": "柔软烤面包，撒有芝麻",
    "patty": "多汁，可见肉纤维",
  ...
  "human_element": {
    "hands": "逼真的手握汉堡",
    "bite_mark": "自然的牙齿印记",
    "skin_detail": "自然的皮肤纹理，干净的指甲"
  },
  "lighting": {
    "type": "戏剧性美食照明",
    "quality": "温暖、定向、高对比度",
    "direction": "侧光或顶侧光，强调光泽",
    "highlight_focus": "奶酪融化和酱汁质感",
    "shadow_style": "深邃但受控的阴影"
  },
  "color_palette": {
    "primary": ["金棕色", "奶酪黄色", "深红色"],
    "accent": ["生菜绿色"],
    "mood": "浓郁、大胆、放纵"
  },
  "environment": {
    "location": "汉堡店、咖啡馆或工作室美食布景",
    "background": "深色、模糊背景以突出汉堡",
    "atmosphere": "温暖、放纵、街头美食的奢华感"
  },
  "camera_details": {
    "camera_type": "专业单反/无反模拟",
    "lens": "85mm 或微距美食镜头",
    "focus": "咬食区域锐利对焦",
    "depth_of_field": "浅景深营造戏剧性散景",
    "resolution": "广告级清晰度"
  },
  "quality_control": {
    "food_realism": "超真实纹理，无塑料感",
    "bite_accuracy": "食材自然压缩",
    "ai_artifacts": "无",
    "professional_finish": "商业美食摄影品质"
  },
  "overall_mood": "令人垂涎欲滴、大胆、放纵",
  "intended_use": {
    "primary": "X 上的病毒式美食帖子",
    "secondary": "餐厅品牌推广、美食专题、广告"
  }
}
```
