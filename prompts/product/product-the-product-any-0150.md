---
id: product-the-product-any-0150
title: "电商产品精修"
category: product
subcategory: "02_电商产品虚拟摄影"
aesthetic: null
tags: ["玻璃", "杯子", "茶色", "透明", "简约", "电商", "主图", "纯白"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: null
...
## 中文译文（源站提供）
识别上传照片中的主要产品（自动删除任何握住它的手或杂乱的背景细节）。将其重新打造成一款高端电子商务产品。受试者隔离：清洁地提取产品，完全去除任何手指、手或杂物。背景：将产品放在纯白色的工作室背景（RGB 255255255）上，在底部有一个微妙、自然的接触阴影，使其接地。照明：使用柔和的商业工作室照明来突出产品的纹理和材质。确保均匀照明，无刺眼眩光。润色：自动修复任何镜头畸变，提高清晰度，校正颜色，使产品看起来全新而专业。
