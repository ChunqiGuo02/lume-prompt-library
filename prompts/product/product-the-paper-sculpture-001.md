---
id: "product-the-paper-sculpture-001"
title: "纸艺雕塑：高精度折纸风格人物肖像创作"
category: product
subcategory: "12_手工玩具手办"
aesthetic: null
tags: ["折纸", "雕塑", "纸艺", "写实", "极简", "女性", "西装", "包包"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: null
...
## 中文译文（源站提供）
创作一个超精细的折纸风格人物雕塑，完全由高质量纸张折叠而成，边缘清晰、精确，纸张纤维纹理逼真。

折纸的褶皱错综复杂，几何感十足，精心构造以捕捉人物可识别的面部特征、比例和表情，同时忠实于真实的折纸逻辑。

使用与参考照片完全相同的调色板——无黑色调，无颜色替换。

雕塑放置在干净的工作室表面上，柔和自然的阴影使雕塑更具立体感，并增强了深度。

极简主义收藏艺术美学，高端设计品感觉。

超逼真的渲染，锐利对焦，高材质真实感，纸张褶皱处有微妙的高光，无插画或卡通风格。
方形构图，1080 × 1080 分辨率。
