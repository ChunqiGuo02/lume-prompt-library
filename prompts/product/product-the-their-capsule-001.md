---
id: "product-the-their-capsule-001"
title: "透明扭蛋场景模型_1"
category: product
subcategory: "12_手工玩具手办"
aesthetic: null
tags: ["微缩", "模型", "扭蛋", "名人", "手办", "收藏", "写实", "创意"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
## 中文译文（源站提供）
这是一个精美的透明卡式人偶模型，可以夹在手指之间展示。[NAME] 以他们标志性的姿势或造型呈现。内部包含对人物外貌、服装和配饰的简要描述，背景元素包括相应的场景（如体育场、舞台、演讲厅等）。灯光效果需设计得恰到好处。
