---
id: "product-logo-mascot-true-001"
title: "将你的Logo变成吉祥物"
category: product
subcategory: "03_创意广告品牌设计"
aesthetic: null
tags: ["可爱", "卡通", "机器人", "吉祥物", "品牌", "标识", "插画", "简约"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
## 中文译文（源站提供）
根据以下 JSON 规范为 [BRAND NAME] 的标志创建一个吉祥物：  
```json
{
  "style": "品牌风格的创意吉祥物设计",
  "subject_handling": {
    "adapt_touploaded_image": true,
    "preserve_uploaded_logo_shape_and_text": true,
    "extract_dominant_brand_colors": true,
    "analyze_logo_style_for_mood": true,
    "useuploaded_image_as_primary_reference": true
  },
  "mascot_generation": {
    "character_type": "开放型——可以是动物、类人生物、物体、机器人、幻想生物或抽象形态",
    "design_strategy": "根据提取的品牌色彩、风格和情感元素，生成一个与上传品牌视觉上相配的吉祥物概念",
    "style_alignment": "吉祥物应体现品牌特性——与品牌整体调性一致（如趣味性、优雅、科技感、极简主义等）",
    "color_usage": "在吉祥物的身体、服装、皮肤或材质上使用品牌的主色调",
    "personality.embedding": "赋予吉祥物符合品牌调性的特征（例如好奇、大胆、宁静、自信）"
  },
  "composition": {
    "includeuploaded_logo_in_final_image": true,
    "arrangement": "吉祥物和标志以清晰、平衡的方式共同呈现",
    "environment": "简约的场景或与品牌风格相符的抽象背景——避免画面过于复杂",
    "interaction": "吉祥物可以靠近标志、怀抱标志或做出手势——但不得遮挡或修改标志",
  },
  "lighting": {
    "type": "根据品牌调性选择中性或柔和的方向性光源",
    "shadow_behavior": "在地面元素上产生柔和的阴影效果",
  },
  "camera": {
    "view_angle": "根据布局选择居中正面或四分之三视角",
    "focus": "确保吉祥物和标志都清晰可见"
  },
  "post_processing": {
    "enhance_color.harmony_between_mascot_and_logo": true,
    "disable_style_overrides_or_artistic_distortion": true
  },
  "image_constraints": {
    "transparent_background": false,
    "aspect_ratio": [插入所需的纵横比],
    "include_text_if_present_in_logo": true,
    "preserveuploaded_logogeometry": true,
    "prevent_logo_modification": true
  },
  "notes": "请使用上传的品牌标志或产品图片作为核心参考。自动生成一个独特的吉祥物，使其看起来像是属于该品牌的原创作品——设计灵感来自提取的品牌色彩、形状和情感元素。吉祥物不得抄袭其他吉祥物或使用预设模板。最终图片应创意地展示标志和新吉祥物，并确保两者视觉上既统一又各有特色。"
}
```
