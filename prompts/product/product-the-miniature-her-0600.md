---
id: product-the-miniature-her-0600
title: "真人手持3D迷你版自己"
category: product
subcategory: "12_手工玩具手办"
aesthetic: null
tags: ["写实", "卡通", "红发", "毛衣", "迷你", "手办", "人像", "温馨"]
recommended_models: []
recommended_params:
  aspect_ratio: "3:4"
  quality: null
...
## 中文译文（源站提供）
一张基于照片的超写实电影感肖像，主角为 【一位女性】，完整保留其面部特征、自然皮肤纹理、逼真的发丝以及简约的日常服装。这位女性手掌中托着一个自己的 3D 微缩模型。她正带着明显的惊讶与一丝愉悦注视着模型，眉毛微挑，嘴角带着柔和的微笑，眼神充满表现力。她的面部表情看起来自然且真实。微缩模型在面部结构、发型和服装上与该女性高度相似，但以流畅、高质量的 【3D 卡通风格】 进行渲染。该模型拥有不成比例的大卡通头部以及夸张、俏皮的表情。两人均穿着相同的休闲装——一件 【图案毛衣】，且色彩搭配和织物纹理准确。比例差异明显，视觉效果生动有趣。采用专业的电影级布光，主体分离清晰，皮肤上有柔和的高光，且两人周围均有细腻的轮廓光。真人部分具有超精细纹理，微缩模型则呈现干净、逼真的 3D 质感。整体实现写实与风格化的平衡。
