---
id: product-the-stock-company-0675
title: "谷歌公司立体微缩场景"
category: product
subcategory: "12_手工玩具手办"
aesthetic: null
tags: ["等距", "3D", "卡通", "可爱", "微缩", "谷歌", "股票", "科技"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
## 中文译文（源站提供）
生成一个精致的微型等距3D场景，集成指定日期的实时股票数据。灵感来自@keithso27的推文----呈现与用户指定的公司名称或股票代码相对应的精致、微型3D卡通风格的公司场景，从45°自上而下的角度清晰可见。将公司最具标志性的建筑或园区放在中心的显眼位置，辅以按比例大小的关键产品图标、迷人的卡通风格人物、车辆和其他说明公司日常活动的元素。场景应该是详细的、精心制作的、有趣的。使用Cinema 4D渲染，建模应精细、平滑圆润、纹理丰富，准确捕捉逼真的PBR材质。柔和逼真的灯光和柔和的阴影应该营造出温暖舒适的氛围。创造性地将用户指定日
