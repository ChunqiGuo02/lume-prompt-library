---
id: "product-mirror-reflection-top-001"
title: "定格那完美的瞬间"
category: product
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["自拍", "后视镜", "汽车", "女生", "棕发", "黄昏", "暖光", "户外"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
## 中文译文（源站提供）
{
  "image_generation_prompt": {
    "subject": {
      "description": "一位年轻女子，长着棕色的长发",
      "pose": "轻轻倚在车窗上，头靠在一只手上，神情放松且自信",
      "action": "在侧后视镜的反射中自拍"
    },
    "clothing": {
      "top": "一件简单的白色高领长袖上衣",
    ...
    "props": {
      "item": "iPhone 16 Pro Max",
      "details": "比例真实，镜头设计精确，手机握在手中"
    },
    "environment": {
      "location": "户外，反射在黑色丰田陆地巡洋舰（Toyota Land Cruiser）的侧后视镜中",
      "background": "树木和橙蓝色的晚空",
      "depth_of_field": "背景略微模糊以营造纵深感（虚化效果）"
    },
    "lighting": {
      "type": "黄金时刻（Golden Hour）",
      "characteristics": "温暖的阳光，柔和的自然光，傍晚的光线，真实的阴影"
    },
    "style": {
      "aesthetic": "自然、超写实、极简主义、Instagram风格的画面",
      "quality": "8K分辨率，细节丰富，焦点清晰，具有电影般的摄影效果"
    },
    "technical_constraints": {
      "perspective": "后视镜中的反射要准确，光学方向要正确",
      "distortion_control": "避免对人物特征或手机本身进行夸张或扭曲的处理"
    }
  },
  "negative_prompt": "卡通风格、插画、绘画、草图；人物解剖结构错误；面部变形或残缺；画质低劣、像素化；光线不自然；手机图像失真；反射角度不正确；手指数量异常；头发凌乱；妆容浓重；画面中有文字或水印"
}
