---
id: product-ingredients-motion-green-0186
title: "超现实美食摄影：食材爆炸瞬间的视觉盛宴"
category: product
subcategory: "02_电商产品虚拟摄影"
aesthetic: japanese-zen-garden
tags: ["超写实", "美食", "摄影", "动态", "沙拉", "烟熏", "深色", "高清"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
```json
{
  "global_settings": {
    ...
    "clarity": "极致锐利，微观纹理可见",
    "motion": "凝固动作，食材悬浮",
    "lighting_quality": "影棚级，高对比度，电影感",
    "background_separation": "主体强烈分离，景深干净"
  },
  "module_1_image_1_style": {
    "scene_description": "一个动态的沙拉爆炸，从一个哑光黑碗中迸发而出，碗放在一个圆形木质表面上。食材在半空中，向上和向外散开。",
    "ingredients_visible": [
      "绿色生菜叶",
      "圣女果（整颗和切片）",
      "黄瓜片呈弧形堆叠",
