---
id: product-kinetic-sculpture-subject-0062
title: "动感雕塑"
category: product
subcategory: "02_电商产品虚拟摄影"
aesthetic: null
tags: ["雕塑", "金属", "机械", "动态", "现代", "艺术", "铜色", "银色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "16:9"
...
## 中文译文（源站提供）
这是一件有关某主题的动态雕塑，由相互连接的金属杆和面板构成，表面经过抛光处理（颜色1），同时部分金属板还发生了氧化（颜色2）。整个雕塑处于动态悬停状态，其旋转部件会在混凝土基座上投下机械阴影。
