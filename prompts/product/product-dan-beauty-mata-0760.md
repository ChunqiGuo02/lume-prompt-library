---
id: product-dan-beauty-mata-0760
title: "超高清韩系玻璃肌美妆拼贴，复古格纹帽点缀梦幻光泽感"
category: product
subcategory: "13_虚拟购物试穿试用"
aesthetic: null
tags: ["韩系", "高级", "精致", "拼贴", "写真", "美妆", "短发", "格纹"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
```json
{
  "collage": {
    "style": {
      "type": "超高质量超写实美妆编辑拼贴",
      "layout": "4 张照片面板以倾斜的对角网格布局排列",
      "grid_details": "每个画框之间有干净的白色边框，形成现代高端美妆广告拼贴。每个画框都以不同的角度轻微旋转，营造出动态的对角构图。",
      "resolution": "8K UHD，超写实，美妆编辑写真",
      "consistency": "所有面板清晰显示同一位女性，面部特征一致，保留原始面部结构，请勿改变面部。"
    },
    "subject": {
      "hair": "齐肩短款凌乱棕色波波头，额头和太阳穴有细小的胎毛。",
      "accessories": "小金耳环和带有百合花细节的金色项链。",
      "specific_accessory": "其中一个画框中戴着复古棕色格子帽。"
    },
    "makeup": {
      "skin": "陶瓷玻璃肌，超级光泽，水润湿润感，真实细致的皮肤纹理。颧骨、眼下和鼻尖有强烈的湿润高光。",
      "blush": "浓郁的玫瑰粉色腮红，以宿醉妆风格从脸颊蔓延至眼下和鼻梁。",
      "eyes": "大大的娃娃眼，非常清澈锐利的蓝灰色美瞳。抖音风格的卷翘长睫毛，下睫毛纤细但可见。粉桃色眼影带柔和微闪，内眼角闪亮。纤细整洁的棕色眼线。",
      "lips": "光泽饱满的粉色唇部，看起来水润反光。"
    },
    "frames": [
      {
        "id": 1,
