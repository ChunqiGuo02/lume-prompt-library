---
id: product-true-glow-the-0200
title: "霓虹灯风格工具"
category: product
subcategory: "02_电商产品虚拟摄影"
aesthetic: null
tags: ["3D", "渲染", "超写实", "霓虹", "炫彩", "渐变", "发光", "黑色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "16:9"
...
## 中文译文（源站提供）
根据以下 JSON 中描述的美学风格，对附件中的图像进行重新处理：

```json
{
  "style": "超写实 3D 渲染",
  "material": "带有虹彩涂层的高光泽半透明橡胶",
  "surface_texture": "细粒状纹理，带有微小的镜面反光",
  "lighting": {
    "type": "工作室级 HDRI 光源",
    "intensity": "高",
    "direction": "多光源照明（包括边缘光和背光）",
    "colors": ["电蓝色", "品红色", "霓虹紫色", "日落橙色"],
    "glow_effect": true,
    "chromatic_aberration": true,
    "bloom": true
  },
  "color_scheme": {
    "primary": "虹彩渐变",
    "highlights": "白色光亮区域",
    "accent_edges": "带有轻微光晕的黑色边缘"
  },
  "background": {
    "color": "纯黑色",
    "texture": "无纹理",
    "contrast": "极高（以增强主体物体的光泽）"
  },
  "camera": {
    "angle": "正前方中心视角",
    "focus": "前景清晰，无深度模糊",
