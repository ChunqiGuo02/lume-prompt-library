---
id: product-off-white-balenciaga-oversized-0751
title: "潮牌联名夸张廓形外套展示"
category: product
subcategory: "13_虚拟购物试穿试用"
aesthetic: null
tags: ["潮牌", "联名", "街头", "先锋", "米白", "黑色", "深灰", "冷峻"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
```json
{
  "title": "Off-White × Balenciaga — 比例错误",
  "prompt": {
    "subject": {
      "description": "一位年轻女性，身穿 Off-White x Balenciaga 联名夹克，比例夸张，用于潮牌宣传活动",
      "age": "20 岁出头",
      "ethnicity": "东欧裔",
      "expression": {
        "overall": "冷酷、强势、不可触及"
      ...
      "clothing": {
        "jacket": {
          "type": "超大廓形派克大衣",
          "color": "{argument name=\"jacket color\" default=\"米白色，带黑色点缀\"}",
          "fit": "刻意夸张的超大尺寸，雕塑感",
          "details": {
            "collab_design_language": [
              "Balenciaga 夸张廓形，点缀 Off-White 测量文字",
              "超大五金件作为设计元素"
            ],
            "branding": [
              "Balenciaga 标志被拉伸并部分遮挡",
              "Off-White 箭头环绕服装体积"
            ]
          }
        },
        "top": {
          ...
          "color": "水洗炭灰色",
          "details": {
            "design": "极简的 Balenciaga 字体被 Off-White 图案打断",
            "fit": "方正、夸张的街头剪裁"
          }
        }
      }
