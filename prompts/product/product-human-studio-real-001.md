---
id: "product-human-studio-real-001"
title: "真人与皮克斯风格迷你卡通自我的趣味互动肖像"
category: product
subcategory: "12_手工玩具手办"
aesthetic: null
tags: ["写实", "Q版", "3D", "卡通", "可爱", "趣味", "影棚", "人像"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
```json
{
  "Objective": "创作一张工作室肖像照，将一个真人与一个迷你的皮克斯风格 3D 卡通版自己以一种俏皮、异想天开的方式融合在一起",
  "PersonaDetails": {
    "PrimarySubject": {
      "Type": "真人",
      "Wardrobe": "休闲灰色毛衣或 T 恤",
      "Expression": "惊讶而欣喜",
      "Pose": "一只手托着迷你角色，另一只手指着它",
      "Skin": "逼真的皮肤纹理，细节自然"
    },
    "SecondarySubject": {
      "Type": "人类的迷你 3D 卡通版本",
      "Scale": "微缩，置于人手中",
      "Style": "皮克斯风格 3D 角色",
      "Proportions": "夸张可爱的比例，圆润的特征",
      "FacialFeatures": {
        "Eyes": "大而富有表现力",
        "Expression": "友好，俏皮"
      },
      "Consistency": "与真人发型和服装一致"
    }
  },
  "Composition": {
    "Framing": "中景特写工作室肖像",
    "InteractionFocus": "人与迷你角色之间清晰的视觉关系",
    "DepthOfField": "浅景深",
    "Focus": "两张脸都超清晰对焦"
  },
  "LightingAndBackground": {
    "LightingStyle": "柔和的电影级工作室灯光",
    "LightQuality": "平滑的高光，柔和的阴影过渡",
    "Background": "深蓝色渐变工作室背景",
    "Separation": "微妙的轮廓光，用于区分主体与背景"
  },
  "ArtDirection": {
    "StyleFusion": [
      "超写实人物肖像摄影",
    ...
    "Integration": "真实与 3D 元素无缝融合",
    "DetailLevel": "皮肤、织物和 3D 材质的超精细纹理"
  },
  "MoodAndTone": {
    "Mood": "异想天开，有趣，轻松愉快",
    "Energy": "俏皮的惊喜和喜悦"
  ...
  "PhotographyStyle": {
    "Genre": "专业工作室肖像摄影",
    "CameraLook": "高端电影级写实主义",
    "ImageQuality": "高分辨率，清晰锐利"
  },
  "NegativePrompt": [
    "恐怖谷效应",
    "卡通人物",
