---
id: "product-prompt-mirror-reflection-001"
title: "车镜自拍少女写真"
category: product
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["自拍", "汽车", "后视镜", "长发", "女子", "红色", "暖光", "傍晚"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "4:3"
...
Folllow me @MahnoorAi12 more Ai updates

## 中文译文（源站提供）
{  
  "image_generation_prompt": {  
    "subject": {  
      "description": "一位长着棕色长发的年轻女性",  
      "pose": "轻轻倚靠在车窗上，头靠在一只手上，神情放松且自信",  
      "action": "在侧后视镜的反射中自拍"  
    },  
    "clothing": {  
      "top": "一件简单的红色高领长袖上衣",  
