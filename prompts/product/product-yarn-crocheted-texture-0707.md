---
id: product-yarn-crocheted-texture-0707
title: "钩针编织名人肖像超写实艺术创作"
category: product
subcategory: "12_手工玩具手办"
aesthetic: null
tags: ["钩针", "编织", "梅西", "写实", "肖像", "手工", "黄色", "蓝色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
```json
{
  "image_type": "超精细工作室肖像",
  "resolution": "8K",
  "style": "手工钩针/阿米古鲁米写实风格",
  "overall_aesthetic": "超逼真的针织纹理，具有栩栩如生的比例和富有表现力的面部细节",
  "composition": {
    "framing": "居中肖像",
    "crop": "从上半身到头部",
    "camera_angle": "平视视角，正对前方",
    "depth_of_field": "浅景深，主体清晰对焦，背景柔和模糊"
  },
  "lighting": {
    "type": "柔和工作室灯光",
    "direction": "前置为主，辅以微妙的侧面补光",
    "contrast": "适中",
    "shadows": "柔和，自然衰减",
    "highlights": "柔和高光，突出纱线纹理"
  },
  "background": {
    "description": "深色、绘画风格背景，带有暖棕色、橄榄色和柔和琥珀色调",
    "pattern": "抽象的叶状图案",
    "focus": "刻意模糊"
  },
  "texture_details": {
    "material": "钩针纱线",
    "stitch_visibility": "所有表面均可见清晰、紧密的均匀针脚",
    "surface_quality": "哑光纱线纤维，带有细微绒毛",
    "consistency": "面部、衣物和头发的针脚密度均匀"
  },
  "subject_1": {
    "appearance": {
      "skin_material": "浅米色纱线",
      "facial_structure": "圆润面部，脸颊丰满",
      "eyes": {
        "shape": "圆形",
        "color": "浅灰蓝色",
        "pupils": "深色圆形瞳孔",
        "whites": "清晰分明",
        "expression": "睁大的眼睛，传达出惊讶或顽皮的好奇心"
      },
      "eyebrows": "粗钩针白色纱线眉毛",
      "nose": "突出的钩针鼻子，鼻梁分明，鼻尖圆润",
      "mouth": {
        "state": "张开",
        "tongue": "可见的粉色钩针舌头伸出"
      },
      "facial_hair": {
        "mustache": "白色钩针胡须，略带卷曲",
        "beard": "无"
      },
      "hair": {
        "color": "白色",
        "style": "凌乱、蓬松、向外弯曲的纱线发丝",
        "texture": "松散的扭曲纱线发束"
      }
    },
    "clothing": {
