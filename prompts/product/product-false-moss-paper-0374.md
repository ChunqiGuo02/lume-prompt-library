---
id: product-false-moss-paper-0374
title: "可爱微缩场景"
category: product
subcategory: "12_手工玩具手办"
aesthetic: null
tags: ["微缩", "手工", "黏土", "可爱", "治愈", "树屋", "童趣", "自然"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "4:3"
...
{
    "风格": "微型手工制作的三维场景模型",
    "材料": "树枝、硬纸板、黏土、苔藓、干花、纸张",
    "表面质感": "自然的、粗糙且多样（木质纹理、柔软的苔藓、纸张质感）",
    "光照效果": {
        "类型": "柔和的自然环境光线",
        "强度": "低至中等",
        "照射方向": "从上方均匀散射",
        "重点颜色": ["森林绿", "土棕色", "柔和米色", "柔和的粉红色"],
        "反射效果": "无",
        "折射效果": "无",
        "色散效果": "无",
        "光晕效果": "无"
    ...
    "色彩方案": {
        "主色调": "自然绿和棕色",
        "辅助色调": "柔和的中性色调（硬纸板、黏土、纸张）",
        "高光部分": "照射在打开的书本和猫咪眼镜上的光线",
        "边缘光线": "来自森林缝隙的柔和自然光线"
    },
    "背景": {
        "颜色": "自然苔藓绿",
