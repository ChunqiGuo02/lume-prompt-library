---
id: "product-character-gentle-doll-like-001"
title: "打造超萌娃娃风少女写真，细节精致温暖治愈"
category: product
subcategory: "04_创意脑洞特效合成"
aesthetic: null
tags: ["可爱", "玩偶", "红发", "暖色调", "针织", "条纹", "大眼", "温馨"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
```json
{
  "Objective": "创作一幅高度精细的可爱洋娃娃般的角色肖像，具有舒适、异想天开、魔幻现实主义的美学风格",
  "PersonaDetails": {
    "Subject": {
      "Type": "洋娃娃般的年轻女孩角色",
      "Hair": {
        "Color": "鲜艳的红橙色",
        "Style": "柔软的双马尾，蓬松的刘海",
        "Texture": "丝滑的发丝，带有柔和的蓬松感"
      },
      "Face": {
        "Eyes": "超大、有光泽的动漫风格眼睛",
        "Skin": "瓷器般光滑，带有柔和的玫瑰色脸颊",
        "Expression": "温柔、天真的微笑"
      },
      "Pose": {
        "Position": "坐着，双膝并拢",
        "Hands": "双手托腮",
        "BodyLanguage": "害羞、舒适、惹人喜爱"
      }
    }
  },
  "WardrobeAndAccessories": {
  ...
  "LightingAndColor": {
    "Lighting": "柔和的影棚灯光，带有轻微的衰减",
    "Highlights": "微妙的高光，增强洋娃娃般的皮肤质感",
    "ColorPalette": {
      "Primary": "柔和的粉彩色",
      "Secondary": "温暖的秋季色调"
    }
  ...
  "ArtDirection": {
    "Style": "照片级写实洋娃娃美学",
    "Aesthetic": "可爱、舒适、魔幻现实主义",
    "TextureEmphasis": [
      "可见的纱线纤维",
      "针织面料细节",
      "光滑的瓷器皮肤质感"
    ],
    "DetailLevel": "极其高细节，手工制作的感觉"
  },
  "PhotographyStyle": {
    "Genre": "角色肖像 / 收藏级洋娃娃摄影",
    "RealismLevel": "风格化的照片级写实",
    "Resolution": "8K 超高细节"
  },
  "Mood": {
    "Tone": "异想天开、可爱、舒适",
    "EmotionalFeel": "天真、温暖、温柔的魅力"
  },
  "NegativePrompt": [
    "真实的人体比例",
    "刺眼的灯光",
