---
id: "product-top-the-gold-001"
title: "时尚博主生活美学拼贴-2"
category: product
subcategory: "09_故事分镜角色设定"
aesthetic: null
tags: ["欧美", "时尚", "拼贴", "蛋糕", "奢华", "街拍", "自拍", "穿搭"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
  ...
  "panels": [
    {
      ...
      "props": {
        ...
        "details": [
          ...
          "Black icing text reading '{"cake text" "bad bitch energy"}'"
        ]
      }
    },
    {
...
```json
{
  "image_layout": "2x2 网格拼贴画，展示了同一位女性主体的四张不同照片。",
  "subject_general": {
    "gender": "女性",
    "hair_color": "深棕色/黑色",
    "hair_style": "三张照片中是长发，造型为蓬松波浪；一张照片中是光滑的高马尾",
    "aesthetic": "迷人、网红、时尚、奢华生活方式"
  },
  "panels": [
    {
      "position": "左上",
      ...
      "props": {
        ...
        "details": [
          "顶部有红色樱桃",
          "边缘有装饰性白色裱花",
          "黑色糖霜文字写着 '{\"cake text\" \"bad bitch energy\"}'"
        ]
      }
    },
    {
      "position": "右上",
      "setting": "白天城市街道，可能是高档购物区（例如罗迪欧大道），可见棕榈树和店面",
      "action": "主体从黑色豪车的开着车门探出身子，看向镜头",
      "outfit": {
        "top": "白色无袖罗纹短款上衣",
        "bottom": "蓝色牛仔裤",
    ...
    },
    {
      ...
      "outfit": {
        ...
        "top": "天鹅绒/麂皮束身衣式胸衣上衣",
        "bottom": "迷你裙",
        "accessories": "图案设计师手袋（类似迪奥马鞍包）、一叠金色手镯"
      },
      "background_details": [
        "靠墙放置的带金色边框的大矩形镜子",
        "角落里有插着蒲苇的瓶子",
    ...
    },
    {
      ...
      "action": "特写自拍，手举到嘴边/下巴附近",
      "outfit": {
        "top": "浅粉色/淡紫色罗纹背心",
        "outerwear": "米色毛绒/羊羔绒夹克，露肩穿着",
        "jewelry": "叠戴的带吊坠金色项链、圈形耳环"
      },
      "hair_styling": "光滑的高马尾",
