---
id: "product-the-subject-should-002"
title: "疯狂动物城微缩模型"
category: product
subcategory: "12_手工玩具手办"
aesthetic: null
tags: ["3D", "卡通", "Q版", "可爱", "微缩", "精致", "蓝色", "城市"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
## 中文译文（源站提供）
呈现用户指定主题的精致微型3D卡通风格场景，从45°自上而下的角度清晰可见。将主体最具标志性的代表、人物或地标突出地放置在中心，辅以按比例大小的关键元素、象征性物品、迷人人物、道具和其他细节的图标，以说明主体的核心主题或叙事。场景应该是详细的、精心制作的、有趣的。使用Cinema 4D渲染，建模应精细、平滑圆润、纹理丰富，准确捕捉逼真的PBR材质。柔和逼真的灯光和柔和的阴影应该营造出温暖舒适的氛围。保持干净、简约的布局和纯色背景，以突出主要内容。在场景的顶部中心，以大字体突出显示主题名称。所有文本应以用户指定或输入的语言显示，没有任何背景，并可能与场景元素微妙地重叠，以增强整体设计集成。参数：纵横比：{用户输入，默认1:1}主题名称/主题：{用户输入}——主题名称/题目：鱿鱼游戏
