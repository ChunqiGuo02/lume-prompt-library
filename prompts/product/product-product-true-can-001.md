---
id: "product-product-true-can-001"
title: "高端能量饮料广告视觉设计"
category: product
subcategory: "03_创意广告品牌设计"
aesthetic: japanese-zen-garden
tags: ["商业", "摄影", "饮料", "能量", "绿色", "银色", "清新", "清爽"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
```json
{
  ...
  "subject": {
    ...
    "brand_text": "{\"brand name\" \"AFENON\"}",
    "finish": "拉丝铝，带深绿色点缀",
    "orientation": "对角倾斜，悬浮在半空中"
  },
  "environment": {
    "background": "柔和的薄荷绿到白色渐变，背景有微妙的径向光爆",
    "atmosphere": "凉爽的薄雾，淡淡的蒸汽轨迹，清新洁净的空气感"
  },
  "motion_elements": {
    "liquid": "半透明的绿色液体飞溅，以动态螺旋状环绕罐身",
    "fruit": [
      "新鲜的奇异果切片，带有可见的籽和湿润的质感",
      "带自然果皮细节的完整奇异果"
    ],
    "extras": [
      "带有逼真纹理的薄荷叶",
  ...
  "lighting": {
    "key_light": "左上方柔和的工作室主光",
    "rim_light": "清晰的轮廓光勾勒出罐身边缘",
    "accent_light": "酷炫的绿色背光增强清新感",
    "shadows": "柔和、受控，无强烈对比"
  },
  "camera": {
    "lens": "85mm 产品镜头视角",
    "aperture": "浅景深",
    "focus": "对焦在品牌文字和罐身表面",
    "motion_freeze": "高速闪光效果，凝固液体和水滴"
  },
  "color_grading": {
    "palette": "清新绿、银色金属、洁净白",
    "contrast": "中等",
    "saturation": "自然，非霓虹色"
  },
  "realism_constraints": {
