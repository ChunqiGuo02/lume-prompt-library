---
id: product-the-miniature-city-0494
title: "掌中世界：四大名城微缩景观"
category: product
...
# 正文 prompt
3D Miniature Cities by GPT-1.5 on @BasedLabsAI 🌍✨
Prompt👇🏻 https://t.co/mnINUUFngm
...
## 中文译文（源站提供）
“制作一个超现实的 1080x1080 平方像素渲染图，画面中一只人手轻轻握着一个圆形、带有斜边的微型展示平台，上面展示着一个 [CITY] 的 3D 收藏模型。画面中应包含该城市最具标志性的地标、现代化及历史建筑，以及茂盛的微型植物和树木。在平台的前缘醒目地标注着‘[CITY]’三个字。使用精致、颜色饱和度较低的色调搭配哑光纹理，以增强模型的真实感。用柔和的室内照明、温暖的高光效果和细腻的阴影来营造光照效果。将整个场景设置在一个中性灰渐变色背景下，
