---
id: "product-street-the-texture-001"
title: "街头静思女郎写真"
category: product
subcategory: "05_人物肖像与写实摄影"
aesthetic: null
tags: ["街头", "人像", "女性", "短发", "金发", "灰色", "毛衣", "牛仔裤"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "9:16"
...
```json
{
  "Objective": "创作一幅超写实的 8K 街头抓拍肖像，在拥挤的城市环境中捕捉宁静的情感和真实感。",
  ...
  "Subject": {
    ...
    "Appearance": {
      ...
      "Makeup": "淡妆，自然妆容",
      "Skin": {
        "Texture": "真实的皮肤纹理，带有细微雀斑",
        "Highlights": "柔和自然的打光，色调过渡平缓"
      },
      "Expression": "平静、沉思、内省",
      "Gaze": "目光略微偏向一侧，不直视镜头"
    },
    "Wardrobe": {
      "Top": "简约灰色针织毛衣，织物质感清晰可见",
      "Bottom": "休闲牛仔裤",
      "Accessories": "肩部可见细肩包带"
    }
  },
  ...
  "Scene_Description": {
    ...
    "Crowd": {
      "Density": "被密集的人流包围",
      "Background_Treatment": "人物虚化柔和，营造景深和动感"
    },
    "Environment": "充满自然律动的城市街头氛围"
  },
  ...
  "Mood_and_Storytelling": {
    ...
    "Atmosphere": "情感丰富、真实、低调的写实主义"
  },

  "Output_Requirements": {
    "Format": "图像",
    "Orientation": "肖像或电影感街头画面",
    "Quality": "专业纪实级写实感"
  }
}
```
