---
id: product-chocolate-dark-position-0223
title: "高端巧克力美食艺术展示"
category: product
subcategory: "02_电商产品虚拟摄影"
aesthetic: null
tags: ["巧克力", "甜品", "果仁", "果干", "松露", "礼盒", "喷泉", "草莓"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "16:9"
  ...
  "panels": [
    ...
    },
    {
      ...
      "details": {
        ...
        "dipping_items": ["{"dipping item 1" "Fresh red strawberries"}", "{"dipping item 2" "White and pink fluffy marshmallows"}"],
  ...
  "panels": [
    {
      ...
      "details": {
        "base": "两块厚实的黑巧克力板",
        "toppings": ["整颗杏仁", "核桃仁", "蔓越莓干", "腰果"],
        "surface": "质朴风化的木质桌面",
        "composition": "特写斜角镜头，突出质感"
      }
    },
    {
      "position": "top_right",
      ...
      "details": {
        ...
        "quantity": "12 颗可见的手工制作松露，置于独立纸衬中"
      }
    },
    {
      "position": "bottom_left",
      "subject": "巧克力喷泉",
      "details": {
        "fountain": "分层不锈钢喷泉，流淌着融化的牛奶巧克力",
        "dipping_items": ["{\"dipping item 1\" \"新鲜红草莓\"}", "{\"dipping item 2\" \"白色和粉色蓬松棉花糖\"}"],
        "background": "柔和的散景（模糊）背景，显示更多甜点",
        "vibe": "甜点派对或奢华自助餐场景"
      }
    },
    {
      ...
      "details": {
        "person": "身穿白色专业厨师服的厨师",
        "action": "将调温后的液态巧克力从金属壶中倒入透明聚碳酸酯模具",
        "equipment": ["巧克力模具", "搅拌碗", "专业厨房台面"],
        "focus": "巧克力调温的精准与工艺"
      }
    }
  ],
  "aesthetic_summary": {
    "lighting": "柔和、漫射的影棚灯光，以增强食物质感",
    "color_scheme": "浓郁的棕色、深红色、奶油白色和温暖的木色调",
    "overall_mood": "放纵、精致、诱人"
  }
}
```
