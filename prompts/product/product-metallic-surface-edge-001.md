---
id: "product-metallic-surface-edge-001"
title: "科技金属质感3D图标"
category: product
subcategory: "03_创意广告品牌设计"
aesthetic: null
tags: ["3D", "深蓝色", "铜色", "金属", "发光", "现代", "科技", "轻奢"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "1:1"
...
## 中文译文（源站提供）
创建一个比例为 1:1 的图像。  
将一个 [类型] 向量图标按照以下 JSON 样式进行设计：  
```json
{
    "object": "icon",
    "material": {
        "primary_surface": "平滑的磨砂金属质感",
        "finish": "虹彩光泽",
        "color_profile": {
            "base_color": "深蓝色",
            "secondary_tones": [
    ...
    "lighting": {
        ...
        "reflections": {
            "character": "散射但带有虹彩效果，暗示表面经过高度抛光或涂有漆层"
        },
        "shadows": "柔和的边缘效果，由于图像呈悬浮状态，与背景的接触最小"
    },
    "background": {
        "color": "#FFF",
        "style": "纯色磨砂"
    ...
    "composition": {
        "camera_angle": "居中、眼球水平",
        "depth_of_field": "无（整体画面清晰聚焦）",
        "presentation": "悬浮的独立元素",
        "angle": "等轴测视角"
    },
    "visual_style": {
        "tone": "现代、极具冲击力",
        "inspiration": "运动品牌与未来主义产品设计的融合",
        "aesthetic": "强烈的对比度，科技与奢华的结合"
    }
}
```
