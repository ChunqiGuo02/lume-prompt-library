---
id: "product-figurine-keychain-studio-001"
title: "蜘蛛侠钥匙扣广告片"
category: product
subcategory: "12_手工玩具手办"
aesthetic: null
tags: ["蜘蛛侠", "手办", "钥匙扣", "保镖", "银色", "纯白", "高级", "幽默"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
```json
{
  ...
  "environment": {
    "setting": "整洁的高级摄影棚",
    "lighting": "柔和定向的影棚灯光，高对比度，光泽反射，微妙的轮廓光",
    "mood": "幽默而高端"
  },
  "subjects": [
    {
    ...
    },
    {
      "type": "钥匙扣",
      "role": "受保护的物品",
      "details": "主打产品，居中，锐利聚焦"
    }
  ],
  "camera": {
    "movements": [
      "平滑的推轨跟踪拍摄，跟随小雕像",
      "太阳镜、小雕像面部和钥匙扣的微距特写镜头",
      "浅景深过渡"
    ],
    "lenses": "微距镜头，85mm 电影产品镜头感"
  },
  "visuals": {
    "composition": "高级产品广告美学",
    "textures": "小雕像和钥匙扣上的锐利微细节",
    "tones": "干净的中性背景，抛光表面"
  },
  "vibe": "俏皮的保镖场景，但时尚且富有电影感"
}
```
