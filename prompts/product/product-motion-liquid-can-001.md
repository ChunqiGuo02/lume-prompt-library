---
id: "product-motion-liquid-can-001"
title: "超写实商业饮品摄影提示词预设"
category: product
subcategory: "03_创意广告品牌设计"
aesthetic: japanese-zen-garden
tags: ["士力架", "啤酒", "浆果", "巧克力", "坚果", "粉色", "紫色", "蓝色"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "2:3"
...
```json
{
  "master_prompt": {
    ...
    "module_1_image_1_style": {
      ...
      "liquid_and_motion": {
        "liquid_color": "亮粉色",
        "liquid_texture": "浓稠、奶油状、搅打过的质地",
        "motion": "爆炸式向上飞溅，环绕罐身",
        "splash_shape": "带有尖锐液体峰和水滴的弧形飞溅"
      },
      "floating_elements": {
        "berries": [
          "覆盆子",
        ...
        "chocolate_pieces": "边缘锋利的矩形巧克力块",
        "nuts": "圆形和半切的坚果散落在底部附近和空中",
        "distribution": "悬浮在罐身周围不同深度"
      },
      "background": {
        "color_gradient": "紫色到蓝色",
        "light_effects": "罐身后面柔和的径向光晕",
        "particles": "漂浮着的小粉色水滴和斑点"
      },
      "surface_and_reflection": {
        "base": "光泽反射表面",
        "reflection_quality": "清晰的镜面反射，带有轻微的涟漪扭曲"
      }
    },
    "module_2_image_2_style": {
      "subject": {
      ...
      "pose_and_orientation": {
        "position": "略微向右倾斜",
        "angle": "四分之三视图",
        "motion_feel": "动态感，倾斜入飞溅物中"
      },
      "liquid_and_motion": {
        "liquid_color": "白色和浅米色牛奶混合物",
        "texture": "光滑、奶油状、流动性强",
        "motion": "围绕瓶底和瓶身两侧上升的漩涡状飞溅"
      },
      "floating_elements": {
        "blueberries": "不同深度的完整和半切蓝莓"
      }
    }
  }
}
