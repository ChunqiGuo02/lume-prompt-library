---
id: product-the-name-product-0433
title: "女仆魔法少女手办展示图_1"
category: product
subcategory: "12_手工玩具手办"
aesthetic: japanese-zen-garden
tags: ["手办", "女仆", "美少女", "棕发", "火焰", "寒冰", "爱心", "地台"]
recommended_models: 
  - banana-pro
recommended_params:
  aspect_ratio: "3:4"
...
## 中文译文（源站提供）
subject: >
  角色设计、比例、面部特征、发型、服装细节和配色均忠实于参考图像 A。
  该角色被塑造成一个高度精细、逼真的 PVC 手办。
  雕塑风格和整体美学直接从参考图像中推断。
  该手办以 1/7 比例收藏品的形式呈现。
...
composition: >
  ...
  纵向构图，宽高比为 3:4。
  一个大型的完整手办主视觉图。
  一个清晰定义的产品信息区域，包含所有文本元素。
  产品名称标志和制造商名称标志各显示一次。
  包含多个嵌入式特写面板。
  每个嵌入式面板必须聚焦于手办的不同物理区域或特征。
  任意两个嵌入式面板不得描绘相同的部分或相同的视觉特征。
  嵌入式面板必须在视觉和概念上彼此区分。
...
camera_lighting: >
  为清晰展示收藏手办而推断的摄像机角度和光照。
  逼真的工作室光照与 PVC 表面相互作用。
  头发和服装上的光泽高光。
  皮肤上的哑光效果。
  锐利对焦，具有自然的景深。
  手办下方有柔和的阴影，如同放置在平面上。
...
text: >
  ...
  价格：
  根据手办的比例、雕塑密度和涂装表现推断的日元零售价。

  尺寸：
  根据角色体型和 1/7 比例设定推断的总高度（厘米）。
